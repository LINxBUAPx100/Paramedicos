    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DIFUSA NO TIENE MASA QUE EVACUAR. Por eso su tratamiento es de soporte y no quirúrgico, y por eso su imagen puede ser normal al principio: el daño está repartido, no acumulado en un sitio.'),
          masPreguntado('Cuándo deja de ser «solo una concusión» —vómito repetido, cefalea que va a más, somnolencia creciente, convulsión, pupilas desiguales, debilidad de un lado o confusión que empeora— y la paradoja de la imagen en la lesión axonal difusa: paciente profundamente inconsciente con estudio inicial casi normal.'),
        ],
      },
      erroresFrecuentes([
        ['Descartar concusión porque no hubo desmayo', 'Puede haber o no pérdida de conciencia: la ausencia de desmayo no descarta nada.'],
        ['Quedarse en «solo una concusión»', 'Vómito repetido, cefalea creciente, somnolencia, convulsión, pupilas desiguales, debilidad de un lado o confusión que empeora obligan a reevaluar buscando una lesión con efecto de masa.'],
        ['Tranquilizarse con una imagen normal', 'En la lesión axonal difusa el daño está en la conexión entre neuronas y no en una colección de sangre. Un estudio normal no tranquiliza si el estado neurológico no cuadra.'],
        ['Esperar una solución quirúrgica', 'La lesión difusa no deja una masa que evacuar: su tratamiento es de soporte, evitando la lesión secundaria.'],
      ]),
      repasoRapido([
        'Una lesión focal se localiza: un hematoma que ocupa un sitio y comprime.',
        'Una difusa afecta al tejido de forma extendida, sin masa que evacuar.',
        'Difusas: concusión y lesión axonal difusa. Focales: hematoma epidural, subdural y contusión.',
        'El mecanismo difuso es de aceleración-desaceleración y rotación; el focal, impacto directo o laceración vascular.',
        'La imagen de la difusa puede ser normal al principio; en la focal suele verse la colección.',
        'El tratamiento de la difusa es de soporte; la focal puede requerir cirugía.',
        'Concusión: alteración transitoria de la función cerebral tras un golpe, sin daño estructural visible.',
        'Puede haber o no pérdida de conciencia; la ausencia de desmayo no descarta nada.',
        'Manifestaciones: confusión, desorientación, lentitud, amnesia del episodio, cefalea, mareo, náusea, visión borrosa, fotofobia, acúfenos, irritabilidad.',
        'Señales de alarma: vómito repetido, cefalea que va a más, somnolencia creciente, convulsión, pupilas desiguales, debilidad de un lado, confusión que empeora.',
        'Lesión axonal difusa: en una desaceleración brusca con rotación, las capas del encéfalo se mueven a velocidades distintas y los axones se estiran y se rompen.',
        'Paradoja: el paciente puede estar profundamente inconsciente con una tomografía inicial casi normal.',
      ]),
      preguntasOrales([
        'Diferencia lesión difusa de lesión focal en mecanismo, imagen y tratamiento.',
        '¿Qué es una concusión?',
        '¿Hace falta pérdida de conciencia para tenerla?',
        'Enumera sus manifestaciones.',
        'Di las señales que obligan a reevaluar buscando efecto de masa.',
        'Explica el mecanismo de la lesión axonal difusa.',
        '¿Qué es la paradoja de la imagen?',
        '¿Por qué la lesión difusa no tiene tratamiento quirúrgico?',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CONCIENCIA, PUPILAS, MOTOR, CONSTANTES Y TENDENCIA. Los cuatro primeros son la foto; el quinto es la película, y es el que informa. La tensión y la saturación no son constantes aparte: son parte de la valoración neurológica.'),
          masPreguntado('Que el dato más valioso no es una cifra sino un cambio, y la advertencia sobre el patrón de la tríada de Cushing: hipertensión con bradicardia es lo contrario del shock hipovolémico, donde la presión cae y el pulso sube.'),
        ],
      },
      erroresFrecuentes([
        ['Quedarse con una cifra aislada', 'Un valor que desciende en pocos minutos informa muchísimo más que ese mismo valor aislado. La valoración se hace repetida y se documenta con la hora.'],
        ['Esperar la tríada de Cushing como signo de vigilancia', 'Cuando aparece, la herniación está en curso. Es una alarma, no un dato de seguimiento.'],
        ['Confundir el patrón con un shock', 'Hipertensión con bradicardia es lo contrario del shock hipovolémico. El patrón se comprueba antes de interpretarlo.'],
        ['Taponar la salida de líquido por oído o nariz', 'Se cubre con gasa estéril sin comprimir y se deja drenar: taponarlo aumenta la presión intracraneal y favorece la infección. Por lo mismo se evita la vía nasal para sondas o dispositivos.'],
      ]),
      repasoRapido([
        'Se vigila en orden: nivel de conciencia con AVDI primero y la escala después.',
        'Pupilas: tamaño, simetría y reactividad a la luz.',
        'Función motora: fuerza y simetría en las cuatro extremidades.',
        'Constantes: la tensión y la saturación son parte de la valoración neurológica.',
        'Tendencia: repetir y comparar, con la hora anotada.',
        'El cráneo es una caja cerrada: si algo ocupa espacio, la presión sube.',
        'Primero se compensa desplazando líquido cefalorraquídeo y sangre venosa; agotada la reserva, la presión se dispara.',
        'Tríada de Cushing: la tensión aumenta, la frecuencia cardiaca disminuye y el patrón respiratorio se vuelve irregular.',
        'Es un signo tardío: cuando aparece, la herniación está en curso.',
        'Otros signos de herniación: pupila dilatada y arreactiva del lado de la lesión, deterioro rápido, postura de decorticación o descerebración, hemiparesia contralateral.',
        'Fractura de base: ojos de mapache, signo de Battle, salida de líquido por nariz u oído y sangre detrás del tímpano.',
        'No se tapona la salida de líquido, y se evita la vía nasal para sondas o dispositivos.',
      ]),
      preguntasOrales([
        'Estructura en voz alta la valoración neurológica del paciente con traumatismo craneal.',
        '¿Por qué la tensión y la saturación forman parte de ella?',
        '¿Cuál es el dato más valioso, y por qué?',
        'Di la tríada de Cushing con la dirección de cada componente.',
        '¿Por qué se dice que es un signo tardío?',
        '¿Cómo la distingues del patrón del shock hipovolémico?',
        'Nombra los otros signos de herniación.',
        'Enumera los signos de fractura de base y di qué no se hace con el drenaje.',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('TODO LO QUE HACES AQUÍ ES CONTRA LA SECUNDARIA. La primaria ocurrió antes de que llegaras. Evitar la hipoxia y la hipotensión no es un cuidado accesorio: es, literalmente, el tratamiento.'),
          masPreguntado('La hiperventilación: de rutina está proscrita porque la vasoconstricción que produce reduce el flujo cerebral y, en un cerebro ya isquémico, añade daño. Se reserva de forma transitoria y controlada para signos de herniación y según el protocolo, que define la frecuencia objetivo.'),
        ],
      },
      erroresFrecuentes([
        ['Ventilar demasiado rápido «porque está grave»', 'La hiperventilación de rutina está proscrita: la vasoconstricción que produce reduce el flujo cerebral y añade daño a un cerebro ya isquémico.'],
        ['Dejar pasar una hipotensión por atender solo la cabeza', 'La hipotensión es especialmente lesiva en el traumatismo craneal, y junto con la hipoxia es el agresor secundario mejor documentado.'],
        ['No medir la glucemia en un paciente confuso', 'La hipoglucemia imita y agrava el deterioro neurológico: sin medirla, se atribuye a la lesión lo que era corregible.'],
        ['Dejar el collarín apretado o la cabeza girada', 'Comprimen las yugulares y dificultan el drenaje venoso del cerebro: sube la presión intracraneal por un detalle mecánico evitable.'],
      ]),
      repasoRapido([
        'La lesión primaria es el daño del impacto: ocurrió antes de tu llegada y no se puede deshacer.',
        'La secundaria se añade después, por falta de oxígeno, de presión de perfusión o por edema, y es la que se puede evitar.',
        'Hipoxia e hipotensión son los dos agresores secundarios mejor documentados: cada episodio empeora el pronóstico.',
        'Prioridades: vía aérea permeable con control cervical si el mecanismo lo indica.',
        'Oxigenación evitando la desaturación, sin caer en hiperoxia innecesaria.',
        'Ventilación normal: ni poca ni excesiva.',
        'Presión arterial dentro de los objetivos del protocolo.',
        'Cabecera elevada si no hay contraindicación, para favorecer el drenaje venoso.',
        'Glucemia, porque la hipoglucemia imita y agrava el deterioro neurológico.',
        'Prevención de la hipotermia y control de convulsiones y dolor según protocolo.',
        'Cabeza en posición neutra y collarín que no comprima las yugulares.',
        'La hiperventilación es la excepción: transitoria, controlada y solo ante signos de herniación, según protocolo.',
      ]),
      preguntasOrales([
        'Distingue lesión primaria de lesión secundaria.',
        '¿Cuáles son los dos agresores secundarios mejor documentados?',
        'Recorre las prioridades del tratamiento prehospitalario.',
        '¿Por qué la posición de la cabeza es parte del tratamiento?',
        'Explica qué hace la hiperventilación y por qué está proscrita de rutina.',
        '¿Cuándo se reserva, y quién fija la frecuencia objetivo?',
        '¿Por qué se mide la glucemia en un paciente confuso?',
        'Enumera los errores frecuentes de esta lección.',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LO DE DELANTE SE PIERDE EN EL ANTERIOR; LO DE DETRÁS, EN EL POSTERIOR. Motor, dolor y temperatura van por delante. Posición y vibración, por detrás. Y Brown-Séquard es media médula: mezcla ambos, cruzados.'),
          masPreguntado('Cómo se manifiesta: el paciente camina mirándose los pies y empeora mucho al cerrar los ojos o en la oscuridad, porque compensa con la vista lo que ya no siente. Y que como la fuerza está intacta, es fácil darlo por normal si no se explora la sensibilidad.'),
        ],
      },
      erroresFrecuentes([
        ['Darlo por normal porque la fuerza está intacta', 'La fuerza, el dolor y la temperatura están conservados. Sin explorar la sensibilidad profunda, el cuadro pasa desapercibido.'],
        ['No probar con los ojos cerrados', 'El paciente compensa con la vista lo que ya no siente: es al cerrar los ojos o en la oscuridad cuando el déficit se hace evidente.'],
        ['Confundirlo con el síndrome anterior', 'Son inversos: el anterior pierde motor, dolor y temperatura y conserva la propiocepción; el posterior conserva lo primero y pierde la propiocepción.'],
        ['Olvidar que el tacto fino también se altera', 'Además de la propiocepción y la vibración, el tacto fino queda alterado.'],
      ]),
      repasoRapido([
        'Por los cordones posteriores viajan la propiocepción, la sensibilidad vibratoria y el tacto fino.',
        'La propiocepción es saber dónde están las partes del cuerpo sin mirarlas.',
        'Si se lesionan, el paciente conserva fuerza, dolor y temperatura.',
        'Y pierde la noción de la posición de sus miembros.',
        'El tacto fino queda alterado.',
        'Se manifiesta caminando mirándose los pies.',
        'Empeora mucho al cerrar los ojos o en la oscuridad, porque compensa con la vista.',
        'Como la fuerza está intacta, es fácil darlo por normal si no se explora la sensibilidad.',
        'Es raro y fácil de pasar por alto.',
        'El anterior pierde motor, dolor y temperatura y conserva la propiocepción.',
        'El posterior conserva motor, dolor y temperatura y pierde la propiocepción.',
        'Brown-Séquard es media médula: pierde motor y propiocepción del mismo lado y dolor y temperatura del contrario.',
      ]),
      preguntasOrales([
        '¿Qué funciones transportan los cordones posteriores?',
        'Describe qué se pierde y qué se conserva.',
        '¿Qué es la propiocepción?',
        '¿Cómo se manifiesta el cuadro en la forma de caminar?',
        '¿Por qué empeora en la oscuridad?',
        '¿Por qué es fácil darlo por normal?',
        'Diferéncialo del síndrome anterior.',
        'Di la regla que ordena los tres síndromes.',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL DOLOR CRUZA AL ENTRAR; EL MOTOR CRUZA ARRIBA. Las fibras del dolor y la temperatura cruzan nada más entrar en la médula; las motoras y las de propiocepción cruzan mucho más arriba. De ahí el cuadro cruzado.'),
          masPreguntado('El resultado del cruce: no siente el pinchazo en la pierna que sí puede mover, y mueve mal la pierna en la que sí siente. Y que es el síndrome medular incompleto que más recuperación funcional suele alcanzar: hay función que preservar.'),
        ],
      },
      erroresFrecuentes([
        ['Esperar que el déficit esté del mismo lado', 'El motor y la propiocepción se pierden del lado de la lesión; el dolor y la temperatura, del contrario. El cuadro es cruzado.'],
        ['Documentar el déficit sin decir el lado', 'Se documenta por lado y por función: es la referencia con la que se medirá la evolución.'],
        ['Descuidar el shock neurogénico', 'Se vigila si la lesión es cervical o torácica alta.'],
        ['Restar valor al manejo por su buen pronóstico', 'Es justo lo contrario: como es el que más recuperación alcanza, lo que se haga bien en la escena tiene más que preservar.'],
      ]),
      repasoRapido([
        'Es una hemisección medular: media médula lesionada.',
        'Las fibras del dolor y la temperatura cruzan al lado contrario nada más entrar en la médula.',
        'Las fibras motoras y las de propiocepción cruzan mucho más arriba, en el tronco encefálico.',
        'Por eso dentro de la médula el motor y la propiocepción viajan por su propio lado.',
        'Se pierden la fuerza y la propiocepción del mismo lado de la lesión.',
        'Se pierden el dolor y la temperatura del lado contrario.',
        'El resultado: no siente el pinchazo en la pierna que sí mueve, y mueve mal la pierna en la que sí siente.',
        'Lo produce típicamente un traumatismo penetrante que secciona un lado de la médula.',
        'También puede darse por fractura-luxación unilateral o compresión lateral.',
        'Es el síndrome medular incompleto que más recuperación funcional suele alcanzar.',
        'Eso hace más valioso lo que se haga bien en la escena: hay función que preservar.',
        'Manejo: restricción espinal, documentar el déficit por lado y por función, vigilar shock neurogénico y traslado neuroquirúrgico.',
      ]),
      preguntasOrales([
        'Explica por qué el déficit es cruzado.',
        '¿Dónde cruza cada vía?',
        'Di qué se pierde de cada lado.',
        'Describe lo que observarías en las piernas del paciente.',
        '¿Cuál es el mecanismo típico?',
        '¿Qué pronóstico tiene comparado con los otros síndromes incompletos?',
        '¿Por qué eso hace más valioso el manejo en la escena?',
        'Recorre el manejo prehospitalario.',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DOCUMENTA LO QUE ENCUENTRAS, NO LO QUE CONCLUYES. «Mueve los dedos de ambos pies, no eleva la pierna derecha, no percibe el pinchazo desde el ombligo hacia abajo» se puede comparar; «déficit neurológico» no.'),
          masPreguntado('Que la exploración se hace sin mover al paciente —no justifica por sí sola sentar ni girar a nadie— y que con alteración de conciencia, intoxicación o dolor distractor no es fiable: no descarta nada, y se asume lesión espinal por mecanismo.'),
        ],
      },
      erroresFrecuentes([
        ['Sentar o girar al paciente para explorarlo', 'Toda la valoración se hace en la posición en que se encuentra, o durante una movilización en bloque necesaria por otro motivo. La exploración no justifica por sí sola mover a nadie.'],
        ['Palpar antes de preguntar', 'Se pregunta por dolor en el cuello o la espalda antes de tocar.'],
        ['Escribir la conclusión en vez del hallazgo', '«Déficit neurológico» no se puede comparar entre valoraciones; la descripción concreta con su hora, sí.'],
        ['Dar por fiable la exploración de quien no puede colaborar', 'Con conciencia alterada, intoxicación o dolor distractor importante no descarta nada: se asume lesión espinal por mecanismo y se aplica restricción.'],
      ]),
      repasoRapido([
        'Toda la valoración se hace en la posición en que se encuentra al paciente.',
        'Se pregunta por dolor en el cuello o la espalda antes de tocar.',
        'Se palpa la línea media desde el occipucio hasta el sacro buscando dolor, escalón o deformidad.',
        'Se valora la fuerza en las cuatro extremidades y se comparan.',
        'Se valora la sensibilidad en un punto de cada extremidad, y por niveles si hay déficit.',
        'Se pregunta por hormigueo, quemazón o sensación de descarga eléctrica.',
        'Se documenta la hora y se repite la exploración.',
        'Signos de lesión medular: debilidad o parálisis, alteración de la sensibilidad con un nivel de cambio, parestesias.',
        'También priapismo en el varón y pérdida del control de esfínteres.',
        'Y respiración solo abdominal, que sugiere lesión cervical con afectación de los intercostales.',
        'Y la combinación de hipotensión con bradicardia y piel caliente: shock neurogénico.',
        'Con conciencia alterada, intoxicación o dolor distractor la exploración no es fiable y no descarta nada.',
      ]),
      preguntasOrales([
        '¿En qué posición se explora la columna, y por qué?',
        'Recorre la secuencia de exploración.',
        '¿Qué se pregunta antes de tocar?',
        'Enumera los signos de lesión medular.',
        '¿Qué sugiere una respiración solo abdominal?',
        '¿Qué combinación de constantes indica shock neurogénico?',
        '¿Cuándo deja de ser fiable la exploración, y qué se hace entonces?',
        'Explica la diferencia entre documentar el hallazgo y documentar la conclusión.',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL ANCIANO ROMPE LAS REGLAS. En una columna rígida y osteoporótica, una caída desde su propia altura puede fracturar vértebras cervicales: en el paciente mayor el umbral de sospecha baja mucho.'),
          masPreguntado('Que no se da la hipotensión por explicada: atribuirla al shock neurogénico y dejar de buscar hemorragia es un error clásico y mortal. Y los corticoides: su uso sistemático en la lesión medular aguda fue habitual durante años y hoy no se recomienda de rutina.'),
        ],
      },
      erroresFrecuentes([
        ['Dar la hipotensión por explicada con el shock neurogénico', 'En un politraumatizado con lesión medular, dejar de buscar hemorragia es un error clásico y mortal. Primero se descarta el sangrado.'],
        ['Aplicar el umbral del adulto joven al anciano', 'Una caída desde su propia altura puede fracturar vértebras cervicales en una columna rígida y osteoporótica.'],
        ['Extender el cuello al abrir la vía aérea', 'Se usan maniobras que no extiendan el cuello, y se vigila la ventilación en las lesiones cervicales.'],
        ['Administrar corticoides de rutina', 'Su uso sistemático en la lesión medular aguda fue práctica habitual durante años y hoy no se recomienda de rutina.'],
      ]),
      repasoRapido([
        'Mecanismos de alto riesgo: caída desde una altura superior a la del propio paciente y zambullida en agua poco profunda.',
        'También colisión a alta velocidad, vuelco o eyección del vehículo, y atropello.',
        'También trauma penetrante en la proximidad de la columna.',
        'Y cualquier traumatismo en paciente con osteoporosis o artritis avanzada, incluso de baja energía.',
        'En el paciente mayor el umbral de sospecha debe ser mucho más bajo.',
        'Prioridades: restricción del movimiento espinal cuando esté indicada, manteniendo alineación neutra.',
        'Vía aérea con maniobras que no extiendan el cuello, y vigilancia de la ventilación en lesiones cervicales.',
        'Movilización siempre en bloque, con el número de personas necesario.',
        'Buscar y tratar el shock neurogénico: hipotensión con bradicardia y piel caliente.',
        'Prevención activa de la hipotermia, porque sin vasoconstricción el paciente se enfría muy rápido.',
        'Exploración neurológica documentada y repetida, y traslado a centro con capacidad neuroquirúrgica.',
        'El uso sistemático de corticoides ya no se recomienda de rutina: es un ejemplo de por qué el temario se revisa contra la edición vigente.',
      ]),
      preguntasOrales([
        'Enumera los mecanismos de alto riesgo de lesión espinal.',
        '¿Por qué el anciano rompe las reglas?',
        'Recorre las prioridades del manejo.',
        '¿Qué maniobras de vía aérea se evitan, y por qué?',
        '¿Cómo reconoces un shock neurogénico?',
        '¿Puedes dar la hipotensión por explicada con él? Justifícalo.',
        '¿Por qué se previene la hipotermia de forma activa?',
        '¿Qué se enseña hoy sobre los corticoides, y qué se enseñaba antes?',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA TABLA SIRVE PARA SACAR, NO PARA TRASLADAR. Una vez en la camilla se retira y se traslada sobre la superficie acolchada, con la alineación mantenida por otros medios. Dejarla puesta todo el traslado es lo que produce las lesiones por presión.'),
          masPreguntado('El cambio de concepto: de «inmovilizar» a RESTRINGIR el movimiento espinal, y los criterios que casi siempre aparecen. Y el paciente que camina: despierto, orientado, sin dolor en la línea media, sin déficit y sin dolor distractor puede no necesitar restricción aunque el choque fuera aparatoso.'),
        ],
      },
      erroresFrecuentes([
        ['Trasladar sobre la tabla larga', 'Es herramienta de extracción y movilización, no superficie de transporte. Dejarla puesta durante todo el traslado es lo que produce las lesiones por presión.'],
        ['Atar por costumbre', 'Aplicar el criterio y documentarlo es mejor práctica que atar por costumbre: un paciente despierto, orientado, sin dolor en la línea media, sin déficit y sin dolor distractor puede no necesitar restricción.'],
        ['Usar un collarín de talla incorrecta', 'Uno grande extiende el cuello y uno pequeño lo flexiona; y apretarlo hasta comprimir las yugulares sube la presión intracraneal.'],
        ['Acolchar al niño como al adulto', 'En el adulto se acolcha el occipucio; en el niño, cuyo occipucio es proporcionalmente grande, hay que acolchar bajo los hombros para no flexionar el cuello.'],
      ]),
      repasoRapido([
        'Durante décadas todo paciente de trauma viajaba atado a una tabla rígida.',
        'La práctica se revisó al comprobar que la tabla causa daño propio y que el beneficio no estaba demostrado en la mayoría.',
        'Problemas documentados: úlceras por presión en occipucio, escápulas y sacro, y dolor que puede confundirse con lesión.',
        'También compromiso respiratorio por restricción de la caja torácica y riesgo de broncoaspiración en el paciente que vomita atado.',
        'Y aumento de la presión intracraneal por el collarín mal ajustado.',
        'El concepto nuevo es restringir el movimiento espinal: mantener la alineación neutra y limitar el movimiento con el conjunto de medidas adecuado.',
        'Ese conjunto incluye collarín, camilla de cuchara, colchón de vacío, sujeciones y las propias instrucciones al paciente.',
        'Indican restricción: alteración de conciencia o intoxicación, dolor en la línea media, déficit focal, parestesias o debilidad.',
        'También deformidad anatómica de la columna, dolor distractor y mecanismo de alto riesgo, en especial en el mayor.',
        'El paciente que camina, sin ninguno de esos criterios, puede no necesitar restricción aunque el choque fuera aparatoso.',
        'La tabla larga es herramienta de extracción, no de transporte: se retira una vez en la camilla.',
        'Detalles que marcan la diferencia: talla correcta del collarín, no comprimir las yugulares, acolchar los huecos, y girar en bloque si el paciente vomita.',
      ]),
      preguntasOrales([
        'Explica qué cambió respecto a la inmovilización sistemática y por qué.',
        'Enumera los problemas documentados de la tabla larga.',
        '¿En qué consiste restringir el movimiento espinal?',
        'Nombra los criterios que indican restricción.',
        '¿Puede un paciente no necesitarla tras un choque aparatoso? Justifícalo.',
        '¿Cuál es el papel de la tabla larga hoy?',
        '¿Qué problemas causa un collarín de talla incorrecta?',
        '¿Qué cambia al acolchar a un niño?',
      ]),
      SEC_FUENTES,
    ],
    conceptosClave: [
