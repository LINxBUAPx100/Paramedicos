    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('BAJA, ALTA Y COMPLICADA SON TRES COSAS. La altura dice dónde asienta; la complicación dice en qué paciente o en qué aparato urinario ocurre, y eso es independiente de la altura.'),
          masPreguntado('Que en el adulto mayor la confusión de aparición reciente puede ser la primera y a veces la única manifestación de una infección urinaria con repercusión, sin fiebre ni síntomas urinarios claros. Atribuirla a la edad retrasa la identificación.'),
        ],
      },
      erroresFrecuentes([
        ['Etiquetar toda disuria como infección', 'El ardor al orinar puede tener causas no infecciosas, y en la mujer joven un cuadro genital puede presentarse así. La etiqueta cierra la valoración antes de tiempo.'],
        ['Atribuir la confusión del adulto mayor a la edad', 'Puede ser la única manifestación de una infección con repercusión, sin fiebre ni síntomas urinarios.'],
        ['Retrasar el traslado para obtener una muestra de orina', 'La muestra puede tomarse en el hospital; el tiempo perdido no se recupera.'],
        ['Iniciar un antibiótico en la ambulancia', 'Su elección depende de factores que no están disponibles en la escena.'],
      ]),
      repasoRapido([
        'El aparato urinario es un conducto continuo: riñones, uréteres, vejiga y uretra.',
        'Infección baja: ardor al orinar, frecuencia y urgencia, molestia suprapúbica, orina turbia; estado general conservado.',
        'Infección alta: fiebre, escalofríos, dolor en flanco o región lumbar, náusea y vómito, con afectación general.',
        'Complicada es la que ocurre en un paciente o aparato urinario que la hacen más difícil de resolver.',
        'La complican el embarazo, la obstrucción incluida la litiasis, y las sondas o dispositivos urinarios.',
        'También la enfermedad renal previa o el riñón único, la diabetes y la inmunosupresión.',
        'También la edad avanzada con dependencia, las infecciones repetidas y las anomalías anatómicas.',
        'No toda disuria es infección.',
        'Cambian la categoría la alteración del estado mental, la hipoperfusión y la taquicardia mantenida o hipotensión.',
        'También el trabajo respiratorio aumentado, la fiebre elevada o la hipotermia y los vómitos que impiden la ingesta.',
        'Si al foco se añade disfunción de órganos, la sospecha es de sepsis y el traslado se vuelve tiempo-dependiente.',
        'En el adulto mayor la confusión reciente puede ser la única manifestación.',
      ]),
      preguntasOrales([
        'Distingue infección urinaria baja de alta por lo que predomina.',
        '¿Qué significa que una infección sea complicada?',
        'Enumera las situaciones que la complican.',
        '¿Es toda disuria una infección? Justifícalo.',
        'Di los signos que cambian la categoría del cuadro.',
        '¿Cuándo la sospecha pasa a ser de sepsis, y qué cambia?',
        '¿Qué advertencia hay que tener en el adulto mayor?',
        'Di las dos cosas que no se hacen.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO DUELE LA PIEDRA, DUELE LA OBSTRUCCIÓN. Al bloquearse la salida, la orina se acumula y el uréter se contrae para vencer el obstáculo. De ahí que el dolor sea cólico, en oleadas, y que el paciente no encuentre postura.'),
          masPreguntado('El primer cólico de un paciente mayor: un paciente con litiasis conocida que reconoce su dolor de siempre plantea una situación distinta de la de un paciente mayor con un primer episodio, donde la posibilidad de un cuadro vascular abdominal debe considerarse expresamente.'),
        ],
      },
      erroresFrecuentes([
        ['Descartar un cálculo porque la orina es clara', 'La sangre apoya cuando está presente pero puede faltar. Y confirmarla solo porque hay sangre también es erróneo: aparece en otras causas.'],
        ['Tratar todo dolor en flanco como un cólico', 'Hay otras causas, y algunas comprometen la vida: aneurisma de aorta abdominal complicado, embarazo ectópico, abdomen agudo, torsión y pielonefritis.'],
        ['No valorar la fiebre en un cólico renal', 'Obstrucción más infección es una combinación que puede deteriorar al paciente con rapidez: convierte el cuadro en tiempo-dependiente.'],
        ['Forzar la ingesta de líquidos para «expulsar la piedra»', 'No es una conducta prehospitalaria, y en un paciente con vómitos o con obstrucción puede empeorar el cuadro.'],
      ]),
      repasoRapido([
        'El cálculo se forma cuando sustancias de la orina se concentran y cristalizan.',
        'El dolor aparece al descender y obstruir el uréter, que es estrecho y muscular.',
        'El uréter se contrae intentando vencer el obstáculo: de ahí el dolor cólico en oleadas.',
        'Presentación: dolor brusco en flanco o región lumbar, intenso, con irradiación descendente.',
        'También inquietud motora, náusea y vómito, síntomas urinarios al acercarse a la vejiga y sangre en la orina.',
        'La ausencia de sangre en la orina no descarta un cálculo.',
        'Alternativas peligrosas: aneurisma de aorta abdominal complicado y embarazo ectópico.',
        'También abdomen agudo de otra causa, torsión de anexo o testículo e infección urinaria alta.',
        'El primer cólico de un paciente mayor merece más atención por la posibilidad vascular.',
        'Banderas rojas: fiebre o repercusión general, ausencia de emisión de orina, riñón único o trasplantado.',
        'También embarazo, dolor o vómito que no ceden, hipoperfusión, síncope o masa pulsátil, y enfermedad renal previa.',
        'Obstrucción más infección no espera.',
      ]),
      preguntasOrales([
        'Explica por qué un cálculo produce dolor y por qué es cólico.',
        'Describe la presentación característica.',
        '¿Descarta un cálculo la orina clara?',
        'Enumera los diagnósticos alternativos peligrosos.',
        '¿Por qué el primer cólico de un paciente mayor merece más atención?',
        'Di las banderas rojas.',
        '¿Por qué obstrucción más infección no espera?',
        'Desmonta las dos ideas erróneas con que cierra la lección.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL CONTEXTO CONSTRUYE LA SOSPECHA, NO EL SÍNTOMA. Confusión, debilidad y calambres aparecen en varias alteraciones distintas y en cuadros que nada tienen que ver: lo que orienta es qué enfermedad tiene el paciente, qué toma y qué ha perdido.'),
          masPreguntado('Por qué el potasio se prioriza: es la alteración que puede matar en menos tiempo, alterando la actividad eléctrica del corazón. Y que la debilidad puede ser el único aviso: una debilidad progresiva en un paciente renal, o una sesión de diálisis perdida, valen más que cualquier síntoma llamativo.'),
        ],
      },
      erroresFrecuentes([
        ['Identificar el electrolito por el síntoma', 'Los síntomas se solapan entre alteraciones y con cuadros ajenos. La sospecha se construye con el contexto.'],
        ['Esperar síntomas llamativos en la hiperpotasemia', 'Puede producir muy pocos antes de la arritmia. Una debilidad progresiva en un paciente renal o una diálisis perdida bastan para elevar la sospecha.'],
        ['Descartar una alteración porque el trazo no cambió', 'El trazo no puede cuantificar, no puede identificar el electrolito y no puede descartar.'],
        ['Corregir a ciegas', 'Administrar un electrolito, o algo para bajarlo, sin haberlo medido puede convertir una alteración en la contraria y producir un daño mayor.'],
      ]),
      repasoRapido([
        'Los electrolitos gobiernan la excitabilidad de las células, y su alteración se manifiesta ahí.',
        'Sodio: manifestaciones neurológicas; el descenso rápido se tolera peor que el lento.',
        'Potasio: debilidad muscular y, sobre todo, riesgo de arritmia grave.',
        'Calcio: excitabilidad neuromuscular alterada, con calambres, espasmos y hormigueos cuando desciende.',
        'Magnesio: debilidad, temblor y arritmias, con frecuencia acompañando a otras alteraciones.',
        'Los síntomas no identifican el electrolito: el contexto sí.',
        'El potasio se prioriza porque puede matar en menos tiempo, alterando la actividad eléctrica del corazón.',
        'Hacen pensar en hiperpotasemia la insuficiencia renal y la diálisis, y sobre todo una sesión perdida o acortada.',
        'También ciertos fármacos que retienen potasio, la destrucción muscular extensa, las quemaduras extensas y la acidosis.',
        'La debilidad puede ser el único aviso.',
        'El trazo puede apoyar una sospecha y mostrar un deterioro al compararlo, pero no cuantifica ni identifica ni descarta.',
        'Lo útil al hospital no es una etiqueta, sino el contexto que sostiene la sospecha.',
      ]),
      preguntasOrales([
        'Relaciona cada electrolito principal con lo que predomina al alterarse.',
        '¿Identifican los síntomas el electrolito? ¿Qué lo hace entonces?',
        'Explica por qué el potasio se prioriza.',
        'Enumera los pacientes que deben hacer pensar en hiperpotasemia.',
        '¿Por qué la debilidad puede ser el único aviso?',
        'Di qué puede y qué no puede hacer el trazo aquí.',
        '¿Por qué nunca se corrige a ciegas?',
        '¿Qué se transmite al hospital?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('HIPOVOLEMIA, CONGESTIÓN U OBSTRUCCIÓN. El perfil de volumen se determina ANTES de cualquier otra decisión, porque es el que dice si el líquido ayuda, agrava o no resuelve nada.'),
          masPreguntado('Que la ausencia de orina no es un requisito del fallo renal: hay lesión renal aguda con volumen de orina conservado, y usar la diuresis como criterio único lleva a descartar el cuadro en pacientes que sí lo tienen. Y que la extremidad del acceso de diálisis no se usa ni se comprime a la ligera.'),
        ],
      },
      erroresFrecuentes([
        ['Usar la diuresis como criterio único', 'Hay lesión renal aguda con volumen de orina conservado.'],
        ['Decidir los líquidos antes de valorar el volumen', 'Es la decisión que más se equivoca, y en las dos direcciones: el deshidratado necesita volumen y el congestivo empeora con él.'],
        ['Tomar la presión o puncionar en la extremidad del acceso', 'El acceso es el medio de vida del paciente. No se usa salvo que el protocolo lo autorice expresamente en una situación concreta.'],
        ['No preguntar por la última sesión de diálisis', 'Es uno de los datos que más orientan, y del que depende la sospecha de sobrecarga y de hiperpotasemia.'],
      ]),
      repasoRapido([
        'El riñón regula agua, electrolitos y acidez, y participa en el control de la presión.',
        'Lesión renal aguda: deterioro brusco en horas o días, potencialmente reversible si se corrige la causa.',
        'Enfermedad renal crónica: pérdida progresiva en meses o años, habitualmente no reversible.',
        'Pueden coexistir: un deterioro agudo sobre una base crónica es una situación frecuente.',
        'Prerrenal: no le llega suficiente sangre; deshidratación, hemorragia, vómitos y diarrea, shock, insuficiencia cardiaca.',
        'Renal: el problema está en el propio riñón; fármacos y sustancias, destrucción muscular, enfermedades renales.',
        'Posrenal: la orina no puede salir; litiasis, crecimiento prostático, sonda obstruida, tumores.',
        'La ausencia de orina no es un requisito del fallo renal.',
        'Complicaciones urgentes: sobrecarga de volumen, hiperpotasemia, acidosis, manifestaciones urémicas y del acceso de diálisis.',
        'Al paciente en diálisis se le pregunta la última sesión, el peso seco, el tipo de acceso y su diuresis habitual.',
        'La extremidad del acceso no se usa para presión ni para punción sin autorización expresa.',
        'Tres perfiles: hipovolemia, congestión y obstrucción, y cada uno exige una conducta inicial distinta.',
      ]),
      preguntasOrales([
        'Diferencia lesión renal aguda de enfermedad renal crónica.',
        '¿Pueden coexistir? ¿Por qué importa?',
        'Clasifica las causas en prerrenales, renales y posrenales con ejemplos.',
        '¿Es la ausencia de orina un requisito? Justifícalo.',
        'Enumera las complicaciones urgentes del paciente renal.',
        '¿Qué se le pregunta a un paciente en diálisis?',
        '¿Qué se hace y qué no con la extremidad del acceso?',
        'Di los tres perfiles de volumen y por qué no comparten conducta.',
      ]),
