    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('QUÉ LE HACE EL CUERPO AL FÁRMACO Y QUÉ LE HACE EL FÁRMACO AL CUERPO. Farmacocinética y farmacodinamia, dos preguntas simétricas de las que salen casi todos los errores de administración.'),
          masPreguntado('Que la vía intravenosa OMITE la absorción —el fármaco se deposita ya en la sangre—, pero la distribución sigue dependiendo del gasto cardiaco y del flujo regional: en shock el reparto hacia el sitio de acción puede ser más lento aunque el fármaco ya esté en la circulación. Y que la ampolleta no se identifica por su forma.'),
        ],
      },
      erroresFrecuentes([
        ['Identificar la ampolleta por su forma o su color', 'Dos medicamentos distintos pueden venir en envases casi idénticos, y un mismo medicamento en concentraciones distintas puede tener la misma presentación. La etiqueta se lee antes de cargar y otra vez antes de administrar.'],
        ['Confundir absorción con distribución en el shock', 'La vía intravenosa omite la absorción; lo que la hipoperfusión puede retrasar es la distribución hacia el sitio de efecto.'],
        ['Descartar una alergia porque la cantidad fue pequeña', 'La reacción alérgica es una respuesta inmunitaria en un paciente sensibilizado y puede desencadenarse con cantidades muy pequeñas.'],
        ['Sustituir la verificación por experiencia', 'Los errores ocurren con ruido, prisa, mala iluminación y una sola persona preparando. La comprobación se ejecuta siempre igual, y en voz alta cuando hay un segundo prestador.'],
      ]),
      repasoRapido([
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA NORMA DICE QUÉ DEBE HABER; EL PROTOCOLO DICE QUÉ SE ADMINISTRA. Una lista de dotación responde «¿qué debe existir a bordo?»; un protocolo terapéutico responde «¿qué se administra, a quién y cuánto?». Confundirlas es el error central de este tema.'),
          masPreguntado('Las tres condiciones que deben cumplirse a la vez para que una administración sea legítima: que el medicamento esté disponible en la unidad, que el prestador esté autorizado y que exista una indicación respaldada por el protocolo y la dirección médica. Si falta una, no procede.'),
        ],
      },
      erroresFrecuentes([
        ['Usar la NOM-034 como vademécum', 'No indica para qué se usa cada medicamento, ni a qué dosis, ni en qué población, ni con qué vía o velocidad.'],
        ['Suponer que lo listado está en tu unidad', 'La dotación depende del tipo de ambulancia en que se opere, y los apéndices se leen de forma acumulativa.'],
        ['Leer la agrupación por especialidad como indicación clínica', 'Es un encabezado administrativo del listado. Que la atropina figure bajo «enfermedades inmunoalérgicas» no significa que ese sea su uso.'],
        ['Estudiar la dotación en un resumen o una infografía', 'Se comprueba contra el texto publicado en el Diario Oficial de la Federación, revisando si hay modificaciones posteriores. Una lista copiada envejece con la primera reforma.'],
      ]),
      repasoRapido([
        'La NOM-034 establece criterios mínimos de organización y funcionamiento: tipos de ambulancia, personal, equipamiento e insumos.',
        'No es un vademécum: no indica indicación, dosis, población, vía ni velocidad.',
        'Tipos de unidad terrestre: de traslado, de urgencias básicas, de urgencias avanzadas y de cuidados intensivos.',
        'La de traslado es para pacientes ambulatorios que no requieren atención de urgencia ni cuidados críticos.',
        'Que un medicamento exista en el listado de un tipo de unidad no significa que exista en la tuya.',
        'Y que esté a bordo no significa que puedas administrarlo: eso depende de tu certificación y de la dirección médica.',
        'Tres condiciones simultáneas: disponibilidad, autorización del prestador e indicación respaldada.',
        'Los apéndices son acumulativos: cada uno exige cumplir además los anteriores.',
        'El apéndice de la ambulancia de traslado no tiene apartado de medicamentos, solo de soluciones, coherente con su destino.',
        'El texto publicado enuncia principio activo y forma farmacéutica, y nada más.',
        'Un mínimo no es un catálogo de lo que se puede usar: la norma fija un piso, no un techo ni una autorización.',
        'Si el listado normativo y la dotación real no coinciden, es un hallazgo que se reporta; no autoriza a improvisar ni a sustituir.',
      ]),
      preguntasOrales([
        'Distingue una norma de dotación de un protocolo terapéutico.',
        '¿Qué responde cada uno, y quién lo emite?',
        'Enumera los tipos de ambulancia terrestre que define la norma.',
        'Di las dos consecuencias que se derivan de esa clasificación.',
        '¿Cuáles son las tres condiciones que deben cumplirse a la vez?',
        '¿Qué significa que los apéndices sean acumulativos?',
        '¿Cómo se lee la agrupación por especialidad del listado?',
        '¿Qué haces si la dotación real no coincide con la norma?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('UNA CIFRA NO ES UNA DOSIS. Le faltan cinco datos más: indicación, población, vía, concentración y respaldo, además de la cantidad y el ritmo. Si falta uno, la administración no puede considerarse verificada.'),
          masPreguntado('Que la concentración es el dato que más errores produce: la orden se expresa en cantidad de principio activo y lo que se administra se mide en volumen, y la conversión depende de la presentación concreta que se tenga en la mano.'),
        ],
      },
      erroresFrecuentes([
        ['Calcular con la concentración habitual', 'Se calcula a partir de la concentración real del envase. Un mismo medicamento en dos presentaciones exige volúmenes distintos para la misma dosis, y ahí ocurren las administraciones equivocadas más graves.'],
        ['Dar la repetición de la orden por suficiente', 'Actúa antes de cargar y detecta el malentendido en su origen, pero no agota la cadena: la lectura de la etiqueta, el cálculo desde la concentración real, la doble verificación y la vigilancia posterior detectan errores distintos.'],
        ['Estimar el peso pediátrico a ojo', 'Cuando la dosificación depende del peso, se obtiene por el método que el servicio haya adoptado y se registra.'],
        ['Confiar en una tabla memorizada', 'Las presentaciones cambian, las recomendaciones cambian y el alcance cambia. La competencia no es recordar cifras, sino saber reunirlas y verificarlas.'],
      ]),
      repasoRapido([
        'Este tema declara su bloqueo: la tabla de medicamentos con sus dosis queda pendiente del formulario de la academia.',
        'Publicar cifras de otro servicio enseñaría a administrar cantidades que no coinciden con las ampolletas de la propia ambulancia.',
        'Los seis datos de una dosis: indicación, población, vía, concentración, cantidad y ritmo, y respaldo.',
        'La indicación sale de la guía vigente y del protocolo; la población, de la valoración del paciente.',
        'La vía y la concentración salen de la información para prescribir y de la etiqueta del producto que se tiene en la mano.',
        'La concentración es el dato que más errores produce, porque la orden va en cantidad y lo administrado se mide en volumen.',
        'Verificación: repetir la orden en voz alta y esperar confirmación, comprobar indicación, alergias y contraindicaciones.',
        'Leer la etiqueta, calcular desde la concentración real, verificar con un segundo prestador cuando proceda.',
        'Administrar por la vía autorizada y al ritmo indicado, registrar de inmediato y vigilar la respuesta.',
        'Modifican la dosis la edad pediátrica, el adulto mayor, el embarazo y la lactancia, la insuficiencia renal o hepática.',
        'También la obesidad y la desnutrición, y el tratamiento habitual del paciente por sus interacciones.',
        'Una tabla memorizada no vale porque cambian las presentaciones, las recomendaciones y el alcance.',
      ]),
      preguntasOrales([
        '¿Por qué este tema no publica una tabla de dosis?',
        'Enumera los seis datos de una dosis y de dónde sale cada uno.',
        '¿Por qué la concentración es el dato que más errores produce?',
        'Recorre la verificación de una orden.',
        '¿Basta con repetir la orden en voz alta? Justifícalo.',
        '¿Qué situaciones obligan a ajustar o reconsiderar una dosis?',
        '¿Cómo se obtiene el peso en el paciente pediátrico?',
        'Di las tres razones por las que no vale una tabla memorizada.',
      ]),
      FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CONCENTRACIÓN POR VELOCIDAD. Lo que recibe el paciente por unidad de tiempo no lo fija la orden: resulta de la concentración de la mezcla multiplicada por la velocidad de administración. Cambiar una de las dos cambia la dosis.'),
          masPreguntado('Que una infusión interrumpida es un evento clínico: con un fármaco vasoactivo de acción corta, que la línea se acode, se desconecte o se termine la bolsa hace desaparecer el efecto en poco tiempo. Y que una bolsa sin rotular no se administra.'),
        ],
      },
      erroresFrecuentes([
        ['Administrar una mezcla sin rótulo', 'No se conoce su concentración y por tanto no se sabe qué dosis entrega a una velocidad dada. La conducta segura es preparar una nueva, no suponer que es la habitual.'],
        ['Cambiar la bolsa sin comprobar la dilución', 'Cambiar la bolsa por otra preparada con distinta dilución cambia la dosis aunque la velocidad no se toque. Y un cambio de equipo puede cambiar el volumen entregado.'],
        ['Tratar una línea interrumpida como un contratiempo logístico', 'Con un vasoactivo de acción corta el efecto desaparece en poco tiempo y el paciente se deteriora. La línea se vigila, se rotula y se protege en cada movilización.'],
        ['Vigilar solo el monitor', 'La extravasación de un fármaco vasoactivo puede dañar el tejido donde se acumula. El sitio de infusión se palpa y se mira periódicamente.'],
      ]),
      repasoRapido([
        'Este tema declara su bloqueo: no publica diluciones, concentraciones estándar, velocidades ni rangos de ninguna amina.',
        'Por la misma razón, el taller de cálculo de aminas permanece bloqueado hasta que la academia entregue formulario, concentraciones, equipo y protocolo.',
        'El bolo entrega una cantidad en un tiempo corto: efecto rápido y decreciente.',
        'La infusión continua entrega una cantidad por unidad de tiempo: efecto sostenido mientras se mantenga.',
        'El bolo se ajusta repitiendo o no; la infusión, modificando la velocidad.',
        'Si se interrumpe un bolo, ya se administró; si se interrumpe una infusión, el efecto decae, y deprisa en fármacos de vida corta.',
        'Lo que recibe el paciente resulta de la concentración de la mezcla por la velocidad de administración.',
        'La misma velocidad con dos concentraciones distintas entrega cantidades distintas.',
        'Por eso la mezcla se rotula: qué fármaco, qué cantidad, en qué volumen, quién la preparó y a qué hora.',
        'Con «aminas» se designa a los vasoactivos que sostienen presión y gasto cardiaco; se administran en infusión continua y titulada.',
        'Su uso exige acceso seguro y vigilado, mezcla rotulada, equipo estable, vigilancia continua, indicación respaldada y registro de cada cambio.',
        'Se vigila el sitio de infusión y no solo el monitor, por el riesgo de extravasación.',
      ]),
      preguntasOrales([
        '¿Por qué este tema no publica recetas de dilución?',
        'Diferencia bolo de infusión continua en lo que se ordena y en el efecto.',
        '¿Qué pasa si se interrumpe cada uno?',
        '¿De qué depende lo que recibe realmente el paciente?',
        '¿Qué consecuencias tiene cambiar la bolsa o el equipo?',
        '¿Qué debe llevar el rótulo de una mezcla?',
        '¿Qué exige el uso de un fármaco vasoactivo?',
        '¿Por qué se vigila el sitio de infusión y no solo el monitor?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
