    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA ÚLTIMA VEZ VISTO NORMAL, Y CON HORA. No es lo mismo que «cuándo empezaron los síntomas»: se busca una referencia concreta, se registra como hora y se anota quién la aporta, porque ese testigo rara vez acompaña al paciente hasta el final.'),
          masPreguntado('Que la glucemia no es opcional: es la comprobación más rentable de toda la evaluación neurológica —causa frecuente, reversible en minutos y que se descarta con una medición—. Y que comparar es la maniobra: un lado contra el otro y este momento contra el anterior.'),
        ],
      },
      erroresFrecuentes([
        ['Omitir la glucemia', 'La hipoglucemia imita a un ictus, a una intoxicación y a una crisis convulsiva. Trasladar a un paciente hipoglucémico como si tuviera un ictus es un error evitable.'],
        ['Registrar «hace un rato»', 'La última vez visto normal se registra como una hora, con el nombre y el contacto de quien la aporta.'],
        ['Describir el hallazgo como «debilidad»', 'Vale mucho menos que «no puede sostener el brazo derecho mientras el izquierdo se mantiene»: la descripción lateralizada es la que se puede comparar.'],
        ['Sustituir el examen por una puntuación', 'Un número resume, y al resumir pierde qué lado, qué función y en qué dirección está cambiando.'],
      ]),
      repasoRapido([
        'Antes de explorar se fija la última vez que alguien vio al paciente en su estado normal.',
        'Se pregunta a quien estuvo con él, se busca una referencia concreta y se registra como hora.',
        'Si el cuadro se descubrió al despertar, la referencia es cuando se acostó o la última vez que se le vio normal.',
        'Antes de atribuirlo al cerebro se comprueban glucemia, oxigenación y ventilación, perfusión y temperatura.',
        'También tóxicos y fármacos, y el antecedente de traumatismo, que puede ser causa o consecuencia.',
        'La glucemia es la comprobación más rentable de toda la evaluación.',
        'El examen es dirigido: detecta un déficit, lo describe con precisión y se puede repetir igual.',
        'Componentes: estado mental, habla y lenguaje, cara, fuerza, sensibilidad, pupilas, coordinación y marcha si es seguro.',
        'Habla, hallazgo de palabras y comprensión son tres alteraciones distintas.',
        'Los signos vitales y la glucemia forman parte del examen, no son un añadido.',
        'Comparar es la maniobra: un lado contra el otro y este momento contra el anterior.',
        'Una puntuación no sustituye al examen, y la reevaluación seriada es el examen.',
      ]),
      preguntasOrales([
        '¿Qué es la última vez visto normal y cómo se establece?',
        '¿Por qué es un dato que solo puede recogerse en la escena?',
        'Enumera las causas no neurológicas que se comprueban antes.',
        '¿Por qué la glucemia no es opcional?',
        'Recorre los componentes del examen dirigido.',
        '¿Qué tres alteraciones del habla se distinguen?',
        '¿Por qué comparar es la maniobra?',
        '¿Qué debe contener el informe neurológico?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('«¿ESTA CEFALEA SE PARECE A LAS QUE SUELE TENER?». Es la pregunta que desactiva el error más frecuente del tema: tener migraña no protege de tener otra cosa, y un cambio de patrón vale más que el antecedente.'),
          masPreguntado('Que la tarea prehospitalaria no es clasificar sino detectar: el diagnóstico de una cefalea primaria exige haber descartado las secundarias, y ese descarte requiere estudios que no viajan en la ambulancia. Lo que sí puede hacerse es buscar banderas rojas.'),
        ],
      },
      erroresFrecuentes([
        ['Tranquilizarse por el antecedente de migraña', 'Tener migraña no protege de tener otra cosa. La pregunta obligada es si esta cefalea se parece a las anteriores.'],
        ['Confirmar una migraña por la fotofobia y la náusea', 'Acompañan a muchas cefaleas, incluidas las secundarias graves: su presencia no confirma nada.'],
        ['Creer que alguna combinación de síntomas excluye una hemorragia', 'Ninguna escala ni combinación de síntomas lo permite en el ámbito prehospitalario.'],
        ['Aplicar los esquemas hospitalarios de estudio', 'Los documentos que orientan el estudio de la cefalea aguda giran alrededor de decisiones sobre imagen y punción lumbar, que no corresponden a la ambulancia.'],
      ]),
      repasoRapido([
        'Cefalea primaria: es la enfermedad en sí misma; migraña y cefalea tensional son los ejemplos habituales.',
        'Cefalea secundaria: es un síntoma de otra condición.',
        'En la calle no se diagnostica una migraña: se buscan banderas rojas.',
        'Se caracteriza el dolor: cuándo y qué hacía, cómo empezó, dónde duele y hacia dónde se extiende.',
        'También cómo es, qué lo empeora y lo alivia, qué lo acompaña, y si se parece a cefaleas anteriores.',
        'Bandera roja: inicio súbito que alcanza su máxima intensidad de inmediato; la más citada.',
        'También déficit neurológico o alteración del estado mental, y fiebre con rigidez de nuca.',
        'También traumatismo craneal reciente, tratamiento anticoagulante, y embarazo o puerperio.',
        'También edad avanzada con patrón nuevo, inmunosupresión o cáncer, y alteración visual o pupila anormal.',
        'También la cefalea que despierta al paciente o empeora al acostarse o con el esfuerzo.',
        'La fotofobia y la náusea no confirman una migraña.',
        'En mujer en edad fértil se considera el embarazo y, si lo hay, se aplica la ruta obstétrica.',
      ]),
      preguntasOrales([
        'Diferencia cefalea primaria de secundaria como categorías.',
        '¿Por qué no se diagnostica una migraña en la calle?',
        'Recorre el esquema para caracterizar el dolor.',
        'Enumera las banderas rojas y qué obliga a considerar cada una.',
        '¿Cuál es la más citada?',
        '¿Protege el antecedente de migraña? ¿Qué pregunta lo desactiva?',
        '¿Confirman una migraña la fotofobia y la náusea?',
        '¿Qué no se traslada a la ambulancia de las fuentes hospitalarias?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('FOCAL Y BRUSCO. Focal significa que afecta a una función o a un lado concretos, no a todo el paciente por igual; brusco significa que apareció en minutos y no a lo largo de días. Con esas dos palabras se sospecha un ictus.'),
          masPreguntado('Que isquémico y hemorrágico NO se distinguen en la calle: producen el mismo tipo de déficit y ninguna combinación de síntomas, ninguna escala y ninguna exploración los separa sin imagen. Llamar «isquémico» a un ictus antes de la imagen es un error con consecuencias.'),
        ],
      },
      erroresFrecuentes([
        ['Llamar «isquémico» a un ictus antes de la imagen', 'Los dos mecanismos producen el mismo tipo de déficit y ninguna escala los separa. Es un error con consecuencias.'],
        ['Tomar la escala por un diagnóstico', 'Sirve para que profesionales distintos exploren lo mismo y activen una ruta. No confirma el ictus ni lo excluye.'],
        ['Bajar la presión de forma intensiva sin indicación', 'La elevación puede ser un mecanismo de mantenimiento del flujo en la zona afectada, y reducirla sin criterio puede ampliar el daño.'],
        ['No descartar los imitadores', 'Descartarlos no retrasa la ruta: forma parte de ella. Y la hipoglucemia es el que se descarta más rápido y el que más se lamenta cuando se omite.'],
      ]),
      repasoRapido([
        'El ictus ocurre cuando una zona del encéfalo deja de recibir el flujo que necesita.',
        'Isquémico: un vaso se obstruye. Hemorrágico: un vaso se rompe y la sangre daña y comprime.',
        'No se distinguen en la calle sin imagen.',
        'El tejido nervioso privado de flujo se pierde progresivamente: de ahí la lógica del tiempo.',
        'Se sospecha ante un déficit neurológico focal de aparición brusca.',
        'Manifestaciones: asimetría facial, debilidad de un lado, alteración del habla, pérdida de sensibilidad.',
        'También alteración visual, pérdida súbita del equilibrio, cefalea intensa de inicio brusco y alteración del alerta.',
        'La cefalea aparece más en el hemorrágico pero no lo distingue.',
        'Una escala no diagnostica: estandariza y activa una ruta.',
        'Imitadores: hipoglucemia, estado posictal, intoxicación, migraña con aura, infección y traumatismo craneal.',
        'Conducta: última vez visto normal con su hora, glucemia, examen lateralizado, monitorización y prenotificación.',
        'La exploración se completa en camino cuando es posible: se evitan retrasos.',
      ]),
      preguntasOrales([
        'Explica los dos mecanismos del ictus.',
        '¿Por qué no se distinguen sin imagen?',
        '¿Qué significan «focal» y «brusco»?',
        'Enumera las manifestaciones frecuentes.',
        '¿Para qué sirve una escala prehospitalaria de ictus?',
        'Nombra los principales imitadores y qué los sugiere.',
        'Recorre la conducta prehospitalaria.',
        'Di las tres conductas que hacen daño.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MIRAR LA HORA ES LA PRIMERA MANIOBRA. De ella dependen la definición de estado convulsivo y todo el registro posterior; y es lo primero que se pierde si nadie lo hace.'),
          masPreguntado('Las dos maniobras que hay que desaprender: introducir un objeto en la boca —no evita la mordedura, que ocurre al principio, y sí produce lesiones— y sujetar las extremidades para detener los movimientos. Y que no toda confusión posterior es un periodo posictal.'),
        ],
      },
      erroresFrecuentes([
        ['Introducir algo en la boca', 'No evita la mordedura de lengua, que ocurre al principio, y sí produce lesiones dentales, de la vía aérea y del propio reanimador.'],
        ['Sujetar las extremidades', 'No detiene la crisis y añade riesgo de lesión.'],
        ['Dar por posictal toda confusión posterior', 'El estado posictal mejora progresivamente. Si no mejora, empeora o hay un déficit que persiste, hay que buscar otra explicación.'],
        ['Asumir epilepsia ante una primera crisis', 'Ese diagnóstico exige un estudio que no se hace en urgencias ni en la calle, y etiquetar prematuramente desvía la búsqueda de la causa aguda.'],
      ]),
      repasoRapido([
        'Una crisis convulsiva es un síntoma: actividad eléctrica anormal y excesiva en el encéfalo.',
        'La epilepsia es la condición de tener crisis recurrentes; no son lo mismo.',
        'Ante una primera crisis la pregunta es qué la ha provocado.',
        'Fase ictal: pérdida de la respuesta, rigidez, sacudidas, mordedura lateral de lengua, relajación de esfínteres.',
        'Fase posictal: recuperación progresiva con confusión, somnolencia, agitación, cefalea y a veces debilidad transitoria.',
        'No toda confusión posterior es posictal: el posictal mejora progresivamente.',
        'Estado convulsivo: la crisis que se prolonga más allá de cinco minutos, o crisis repetidas sin recuperar la conciencia.',
        'Durante la crisis: mirar la hora, proteger la cabeza, retirar objetos, aflojar la ropa del cuello.',
        'No sujetar las extremidades y no introducir nada en la boca.',
        'Después: vía aérea y ventilación, glucemia, temperatura, buscar lesiones y examen dirigido seriado.',
        'Se registra hora de inicio y fin, si fue presenciada, qué se observó y si recuperó la conciencia entre crisis.',
        'Causas agudas: hipoglucemia, hipoxia, electrolitos, tóxicos y su retirada, abstinencia, traumatismo, infección, eclampsia y abandono del tratamiento.',
      ]),
      preguntasOrales([
        'Distingue crisis convulsiva de epilepsia.',
        'Describe las dos fases que se observan.',
        '¿Cuándo una confusión posterior no es posictal?',
        'Di la definición operacional de estado convulsivo.',
        'Recorre las medidas durante la crisis.',
        '¿Cuáles son las dos maniobras que hay que desaprender, y por qué?',
        'Enumera lo que se registra de la crisis.',
        '¿Qué causas agudas se buscan ante una primera crisis?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('«¿SE CAYÓ PORQUE PERDIÓ EL CONOCIMIENTO, O PERDIÓ EL CONOCIMIENTO PORQUE SE CAYÓ?». Esa pregunta separa un síncope con caída secundaria de un traumatismo craneal con pérdida posterior, y cambia por completo la orientación.'),
          masPreguntado('Que estar asintomático ahora no descarta nada: un paciente recuperado, hablando con normalidad y con exploración normal puede haber tenido un síncope de origen cardiaco. Lo que decide el riesgo no es cómo está ahora, sino cómo ocurrió y qué antecedentes tiene.'),
        ],
      },
      erroresFrecuentes([
        ['Llamar síncope a cualquier pérdida de conciencia', 'Deben cumplirse los cuatro rasgos a la vez. Si la recuperación no fue espontánea y completa, el mecanismo no fue una reducción breve del flujo cerebral.'],
        ['Tranquilizarse porque el paciente está bien ahora', 'Lo que decide el riesgo es cómo ocurrió y qué antecedentes tiene, no cómo está en este momento.'],
        ['No interrogar al testigo', 'Cuando el equipo llega el paciente suele estar recuperado y su exploración puede ser normal: toda la información útil está en lo que ocurrió antes.'],
        ['Poner de pie al paciente para comprobar si se marea', 'Puede ser útil en una consulta y peligroso en la calle: un paciente que acaba de perder el conocimiento puede volver a hacerlo y lesionarse.'],
      ]),
      repasoRapido([
        'El síncope es una pérdida transitoria de conciencia por reducción breve del flujo de sangre al encéfalo.',
        'Cuatro rasgos: pérdida completa, comienzo relativamente rápido, duración breve y recuperación espontánea y completa.',
        'No toda pérdida de conciencia es un síncope.',
        'Lo distingue de la crisis convulsiva el periodo posictal de confusión que tarda en resolverse.',
        'De la hipoglucemia, que la recuperación no es espontánea: mejora al corregir la glucosa.',
        'Del traumatismo craneal, que allí la pérdida siguió al golpe y no lo precedió.',
        'El testigo vale más que la exploración.',
        'Se pregunta qué hacía justo antes, si notó algo, cuánto duró, si hubo movimientos y cuándo empezaron.',
        'También cómo recuperó, si se lesionó al caer y si no hizo nada por protegerse.',
        'Un pródromo largo y típico apunta a un mecanismo reflejo y de mejor pronóstico.',
        'La ausencia total de pródromo, con caída sin protegerse, es lo contrario.',
        'Banderas rojas: esfuerzo, estando acostado o sentado, sin pródromo, palpitaciones o dolor torácico previos, cardiopatía, muerte súbita familiar, signos de sangrado.',
      ]),
      preguntasOrales([
        'Define el síncope y di sus cuatro rasgos.',
        '¿Es toda pérdida de conciencia un síncope? Justifícalo.',
        'Diferéncialo de la crisis convulsiva, la hipoglucemia y el traumatismo craneal.',
        'Formula la pregunta que ordena la diferencia.',
        '¿Por qué el testigo vale más que la exploración?',
        '¿Qué dos detalles orientan mucho?',
        'Enumera las banderas rojas.',
        '¿Descarta algo que el paciente esté asintomático?',
      ]),
