    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL EJE PROTEGE, LOS MIEMBROS SE MUEVEN: axial para proteger, apendicular para moverse. Y donde el esqueleto protege más se mueve menos, y al revés; ese intercambio evita memorizar región por región.'),
          masPreguntado('La diferencia entre ligamento y tendón, y la clasificación de las articulaciones por movilidad. Los ligamentos unen hueso con hueso y los tendones unen músculo con hueso. Las articulaciones son inmóviles, semimóviles o móviles, y las móviles son las que tienen cavidad articular y líquido lubricante.'),
        ],
      },
      erroresFrecuentes([
        ['Intercambiar ligamento y tendón', 'El ligamento une hueso con hueso y limita el recorrido de la articulación; el tendón une músculo con hueso y transmite la tracción. Confundirlos cambia por completo lo que se está describiendo.'],
        ['Tratar el hueso como una pieza inerte de sostén', 'Es tejido conjuntivo especializado y vivo: se está formando y reabsorbiendo de forma continua toda la vida. Ese recambio es lo que le permite repararse tras una fractura, adaptarse a la carga y servir de reserva de calcio.'],
        ['Atribuir la dureza del hueso a un solo componente', 'La matriz orgánica aporta flexibilidad y resistencia a la tracción, y las sales minerales aportan dureza y resistencia a la compresión. Solo las dos juntas explican por qué un hueso resiste mucho sin ser indeformable.'],
        ['Usar esta lección para valorar lesiones óseas', 'Este módulo se ocupa de la precisión anatómica: localizar y nombrar bien la estructura para que otro profesional entienda dónde está. La valoración de las lesiones corresponde al Módulo 5.'],
      ]),
      repasoRapido([
        'El esqueleto axial lo forman cráneo, columna vertebral, costillas y esternón, y su tarea dominante es proteger.',
        'El esqueleto apendicular lo forman las cinturas escapular y pélvica y los huesos de los miembros, y su tarea dominante es sostener y permitir el movimiento.',
        'La columna se organiza en regiones cervical, torácica, lumbar, sacra y coccígea, cada una con una movilidad distinta.',
        'Protección y movilidad se compensan: donde el esqueleto protege más se mueve menos, y al revés.',
        'El hueso es tejido conjuntivo especializado que combina matriz orgánica y depósitos minerales.',
        'La matriz orgánica da flexibilidad y resistencia a la tracción; las sales minerales, sobre todo de calcio, dan dureza y resistencia a la compresión.',
        'El periostio es la cubierta que aporta irrigación y participa en el crecimiento y la reparación; la médula ósea del interior de ciertos huesos produce células sanguíneas.',
        'Las funciones del sistema óseo son sostener, proteger, anclar músculos, almacenar minerales y producir células sanguíneas.',
        'El hueso se forma y se reabsorbe de forma continua, y ese recambio permite repararse, adaptarse a la carga y actuar como reserva de calcio.',
        'Las articulaciones se clasifican por cuánto movimiento permiten: inmóviles, semimóviles y móviles.',
        'Las articulaciones móviles comparten cartílago que reduce el rozamiento, cápsula que las envuelve, líquido que las lubrica y ligamentos que limitan el recorrido.',
        'Los ligamentos unen hueso con hueso y los tendones unen músculo con hueso.',
      ]),
      preguntasOrales([
        'Nombra los componentes del esqueleto axial y del apendicular y di la tarea dominante de cada conjunto.',
        'Explica por qué la caja torácica es rígida y el hombro muy móvil, usando el intercambio entre protección y movilidad.',
        '¿Qué aporta la matriz orgánica del hueso y qué aportan las sales minerales?',
        'Enumera las funciones del sistema óseo que menciona la lección.',
        'Explica en qué sentido el hueso es un tejido vivo y qué le permite ese recambio continuo.',
        'Clasifica las articulaciones por movilidad y da un ejemplo de cada tipo.',
        'Distingue ligamento de tendón indicando qué une cada uno.',
        '¿Qué parte del estudio del sistema óseo corresponde al Módulo 5 y no a esta lección?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ESQUELÉTICO MANDADO, CARDÍACO A SU AIRE, LISO INVISIBLE: el esquelético es voluntario y con bandas, el cardíaco es involuntario y con bandas, el liso es involuntario y sin bandas. El cardíaco tiene el aspecto del primero y el control del segundo.'),
          masPreguntado('Que contraerse y relajarse consumen energía. La contracción gasta energía al deslizar los filamentos, y devolver el calcio a su depósito para relajarse es también un transporte activo. Un músculo sin energía disponible no queda flácido: queda incapaz de completar el ciclo.'),
        ],
      },
      erroresFrecuentes([
        ['Imaginar que las fibras se encogen como un elástico', 'La contracción se produce porque dos tipos de filamentos ordenados de forma regular se deslizan unos sobre otros y acortan el conjunto, sin que ningún filamento cambie de longitud.'],
        ['Olvidar el papel del calcio en el paso intermedio', 'La señal eléctrica provoca la liberación de calcio desde un depósito interno de la célula, y es el calcio el que deja libres los puntos de unión entre los dos tipos de filamento. Sin ese paso no hay enganche ni deslizamiento.'],
        ['Suponer que solo contraerse consume energía', 'Relajarse también: devolver el calcio a su depósito es un transporte activo. Es la misma dependencia energética de la lección de la célula, aplicada al movimiento.'],
        ['Creer que un músculo puede empujar', 'El músculo solo puede tirar, y al acortarse acerca sus dos puntos de anclaje. Por eso cualquier movimiento reversible necesita al menos dos músculos que actúen en sentidos opuestos: agonista y antagonista.'],
      ]),
      repasoRapido([
        'Existen tres tejidos musculares, y se distinguen por el control, por si presentan bandas transversales al microscopio y por dónde se encuentran.',
        'El esquelético es voluntario, con bandas, unido a los huesos, y produce el movimiento del cuerpo.',
        'El cardíaco es involuntario, con bandas, y está exclusivamente en la pared del corazón.',
        'El liso es involuntario, sin bandas, y está en las paredes de vasos, vía aérea, tubo digestivo, vejiga y útero.',
        'En el músculo cardíaco las células están conectadas entre sí, de modo que la señal pasa de una a otra y el corazón se contrae como un conjunto.',
        'La contracción se produce por deslizamiento de dos tipos de filamentos, no por encogimiento de las fibras.',
        'El nervio libera un mensajero químico, se desencadena un potencial de acción en la membrana de la fibra y esa señal libera calcio de un depósito interno.',
        'El calcio deja libres los puntos de unión, los filamentos se enganchan y se deslizan consumiendo energía, y la fibra se acorta.',
        'Al cesar el estímulo el calcio vuelve a su depósito, lo que también consume energía, y la fibra se relaja.',
        'El agonista produce el movimiento, el antagonista produce el contrario y debe relajarse, los sinergistas estabilizan o afinan y los fijadores inmovilizan una parte para que otra se mueva con precisión.',
        'El músculo esquelético mantiene además la postura con contracciones sostenidas que no se perciben y protege estructuras profundas por su volumen.',
        'La contracción genera calor como subproducto, y por eso el temblor muscular participa en la producción de calor.',
      ]),
      preguntasOrales([
        'Nombra los tres tipos de músculo y clasifícalos por control y por presencia de bandas transversales.',
        '¿Por qué se dice que el músculo cardíaco es un caso aparte?',
        'Explica en qué consiste realmente la contracción, si no es un encogimiento de las fibras.',
        'Ordena los pasos que van del estímulo nervioso al acortamiento de la fibra.',
        '¿Qué papel cumple el calcio en la contracción y de dónde sale?',
        'Explica por qué relajarse también consume energía.',
        'Define agonista, antagonista, sinergista y fijador.',
        'Enumera las funciones del músculo esquelético que no son producir movimiento.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ARRIBA RECIBEN, ABAJO EXPULSAN: aurículas que reciben, ventrículos que expulsan, y válvulas que solo dejan pasar en un sentido. Y la regla que ordena los nombres: arteria es la que SALE del corazón y vena la que LLEGA, sin importar el oxígeno que lleve.'),
          masPreguntado('Que arteria no significa «con oxígeno». Arteria es el vaso que sale del corazón y vena el que llega a él, con independencia del contenido de oxígeno; por eso las arterias pulmonares llevan sangre pobre en oxígeno y las venas pulmonares la llevan rica. La definición es por la dirección respecto del corazón.'),
        ],
      },
      erroresFrecuentes([
        ['Definir arteria y vena por el oxígeno que transportan', 'Se definen por la dirección respecto del corazón: arteria sale, vena llega. Las arterias pulmonares llevan sangre pobre en oxígeno y las venas pulmonares la llevan rica, y no por eso dejan de ser arterias y venas.'],
        ['Suponer que las válvulas se abren y se cierran de forma activa', 'Lo hacen de forma pasiva, por diferencia de presión: se abren cuando la presión detrás supera a la de delante y se cierran cuando ocurre lo contrario. Esa unidireccionalidad convierte una contracción en flujo con sentido y no en vaivén.'],
        ['Explicar el grosor del ventrículo izquierdo como una diferencia sin causa', 'Es funcional: el derecho envía sangre a los pulmones, que están cerca y oponen poca resistencia, mientras que el izquierdo la envía a todo el organismo. Estructura y función se explican mutuamente.'],
        ['Pensar los dos circuitos como independientes', 'Están en serie, uno después del otro y no en paralelo, y esa disposición es la que explica que el fallo de un lado repercuta en el otro.'],
      ]),
      repasoRapido([
        'El corazón es una bomba doble alojada en el tórax, entre los pulmones y por detrás del esternón.',
        'Tiene cuatro cavidades: dos aurículas arriba, que reciben, y dos ventrículos abajo, que expulsan, con un tabique que separa por completo el lado derecho del izquierdo.',
        'La aurícula derecha recibe de las venas del organismo y el ventrículo derecho expulsa hacia las arterias pulmonares; la aurícula izquierda recibe de las venas pulmonares y el ventrículo izquierdo expulsa hacia la aorta.',
        'Las válvulas se abren y se cierran de forma pasiva por diferencia de presión, y su unidireccionalidad convierte la contracción en flujo con sentido.',
        'La pared del ventrículo izquierdo es más gruesa porque envía sangre a todo el organismo, mientras que el derecho la envía a los pulmones, que oponen poca resistencia.',
        'El circuito pulmonar lo impulsa el ventrículo derecho y sirve para que la sangre se cargue de oxígeno y libere dióxido de carbono.',
        'El circuito sistémico lo impulsa el ventrículo izquierdo y sirve para que los tejidos reciban oxígeno y nutrientes y entreguen desechos.',
        'Arteria es el vaso que sale del corazón y vena el que llega a él, con independencia del oxígeno que transporten.',
        'Las arterias tienen pared gruesa, elástica y muscular para soportar presión alta y distribuir; las arteriolas son sobre todo musculares y regulan cuánta sangre llega a cada territorio.',
        'El capilar tiene una sola capa de células, y eso es precisamente lo que permite el intercambio de gases, nutrientes y desechos.',
        'Las vénulas y venas tienen pared delgada y distensible, con válvulas en las venas de los miembros, y actúan además como reservorio.',
        'El volumen que el corazón expulsa por minuto depende de cuántas veces late y de cuánto expulsa en cada latido, y esto último depende del llenado previo, de la fuerza del músculo cardíaco y de la resistencia que debe vencer.',
      ]),
      preguntasOrales([
        'Recorre las cuatro cavidades del corazón diciendo de dónde recibe cada una y hacia dónde expulsa.',
        'Explica cómo se abren y se cierran las válvulas y para qué sirve que el flujo sea unidireccional.',
        '¿Por qué la pared del ventrículo izquierdo es más gruesa que la del derecho?',
        'Distingue el circuito pulmonar del sistémico indicando qué lado del corazón impulsa cada uno y para qué sirve.',
        '¿Por qué las arterias pulmonares llevan sangre pobre en oxígeno y siguen llamándose arterias?',
        'Relaciona cada tipo de vaso con la función que cumple y con el rasgo de su pared que la hace posible.',
        'Explica por qué a las arteriolas se les puede llamar el grifo del sistema.',
        'Di de qué dos factores depende el volumen expulsado por minuto y de qué depende lo que se expulsa en cada latido.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DÓNDE Y QUÉ: la división anatómica dice DÓNDE está cada parte —central y periférico— y la funcional dice QUÉ hace —somático y autónomo—. No se mezclan. Y dentro del autónomo, el simpático prepara para el esfuerzo y el parasimpático para la recuperación.'),
          masPreguntado('La lógica del sistema autónomo en vez de su tabla. El simpático prepara al organismo para un esfuerzo inmediato: lleva recursos al músculo, al corazón y al pulmón y aparta los que se dedicaban a digerir. El parasimpático hace lo contrario y favorece la recuperación y la digestión. Con esa lógica la tabla se deduce.'),
        ],
      },
      erroresFrecuentes([
        ['Mezclar la división anatómica con la funcional', 'Responden a preguntas distintas: central y periférico dicen dónde está cada parte; somático y autónomo dicen qué hace. Un nervio periférico puede llevar fibras somáticas y autónomas a la vez.'],
        ['Tratar la médula espinal como un simple cable', 'Además de conducir señales en ambos sentidos, genera respuestas propias sin consultar al encéfalo. Son los reflejos, y su existencia explica que la retirada ante un estímulo doloroso ocurra antes de que la persona sea consciente del dolor.'],
        ['Poner el control de la respiración y del latido en el cerebro', 'Está en el tronco encefálico, que concentra el control de funciones que no admiten interrupción, incluido el estado de alerta. Esa es la razón anatómica de que una alteración en esa zona tenga consecuencias inmediatas.'],
        ['Describir la sinapsis como una transmisión puramente eléctrica', 'En la sinapsis la señal deja de ser eléctrica y pasa a ser química: la neurona que transmite libera un mensajero que cruza el espacio y actúa sobre la siguiente. Ese cambio de naturaleza es lo que hace la transmisión regulable y unidireccional.'],
      ]),
      repasoRapido([
        'La división anatómica separa el sistema nervioso central, formado por encéfalo y médula espinal, del periférico, formado por los nervios que salen de ellos.',
        'La división funcional separa el somático, que actúa sobre músculo esquelético y sensibilidad consciente y es voluntario, del autónomo, que actúa sobre vísceras, vasos y glándulas y es involuntario.',
        'El sistema central está protegido por hueso, por membranas que lo envuelven y por un líquido que lo rodea, lo amortigua y lo sostiene.',
        'El cerebro sostiene el movimiento voluntario, la sensibilidad consciente, el lenguaje, la memoria y el razonamiento.',
        'El cerebelo se encarga de la coordinación, el equilibrio y la precisión del movimiento.',
        'El tronco encefálico controla funciones que no se detienen: respiración, latido cardíaco y estado de alerta.',
        'La médula espinal conduce señales entre el encéfalo y el cuerpo y además genera respuestas reflejas propias.',
        'La neurona recibe por las dendritas, integra en el cuerpo celular, conduce por el axón y libera el mensajero en su terminal.',
        'La vaina de mielina envuelve el axón y hace la conducción más rápida, porque la señal salta entre los tramos no cubiertos.',
        'En la sinapsis la señal pasa de eléctrica a química, y eso permite que la transmisión sea regulable y ocurra en un solo sentido.',
        'El simpático aumenta la frecuencia del latido y el diámetro de la vía aérea, reduce la actividad del tubo digestivo, dilata la pupila y aumenta la sudoración.',
        'El parasimpático disminuye la frecuencia del latido, reduce el diámetro de la vía aérea, aumenta la actividad del tubo digestivo y contrae la pupila.',
      ]),
      preguntasOrales([
        'Explica la diferencia entre la división anatómica y la funcional del sistema nervioso.',
        'Enumera los tres elementos que protegen el encéfalo y la médula espinal.',
        'Relaciona cerebro, cerebelo, tronco encefálico y médula espinal con la función que sostiene cada uno.',
        '¿Por qué una alteración del tronco encefálico tiene consecuencias inmediatas sobre la respiración y el estado de alerta?',
        'Describe las partes de la neurona y lo que hace cada una.',
        'Explica qué ocurre en la sinapsis y por qué ese cambio de naturaleza es útil.',
        '¿Qué aporta la vaina de mielina y cómo lo consigue?',
        'Deduce el efecto del simpático y del parasimpático sobre el latido, la vía aérea y el tubo digestivo a partir de su lógica general.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('UN TUBO Y UNAS GLÁNDULAS QUE TRABAJAN PARA ÉL: el tubo va de la boca al ano y por él pasa el alimento; las glándulas anexas no forman parte del tubo pero vierten en él lo que producen. Y dentro del tubo, el delgado ABSORBE y el grueso recupera agua.'),
          masPreguntado('Que el intestino delgado absorbe la mayor parte de los nutrientes y que lo consigue por plegamiento. Tres niveles superpuestos —pliegues de la pared, prolongaciones digitiformes de la mucosa y microprolongaciones sobre sus células— multiplican la superficie disponible. La función explica la forma.'),
        ],
      },
      erroresFrecuentes([
        ['Contar las glándulas anexas como parte del tubo digestivo', 'El tubo es un conducto continuo por el que pasa el alimento; las glándulas anexas no forman parte de él, pero vierten en él lo que producen. Separarlos desde el principio evita confundir recorrido con aportación.'],
        ['Creer que el alimento avanza por gravedad', 'Avanza por contracciones ordenadas de la pared del tubo, que es músculo liso involuntario. Por eso se puede tragar acostado o boca abajo, y ahí está el vínculo con la lección del sistema muscular.'],
        ['Atribuir a la vesícula biliar la producción de bilis', 'La bilis la produce el hígado. La vesícula no produce: almacena y concentra la bilis, y la libera cuando llega alimento al intestino.'],
        ['Reducir el hígado a la bilis', 'Su papel excede la digestión: transforma sustancias, incluidos muchos medicamentos y productos de desecho; almacena y libera glucosa; fabrica proteínas del plasma, entre ellas las que sostienen la presión oncótica y las de la coagulación; y almacena vitaminas y hierro.'],
      ]),
      repasoRapido([
        'El sistema digestivo tiene dos componentes: el tubo digestivo, conducto continuo de la boca al ano, y las glándulas anexas, que vierten en él lo que producen.',
        'En la boca hay fragmentación mecánica y mezcla con saliva, que inicia la digestión.',
        'Faringe y esófago transportan hacia el estómago mediante contracciones ordenadas de su pared.',
        'El estómago almacena, mezcla y digiere en medio ácido, y entrega de forma controlada al intestino.',
        'El intestino delgado hace la digestión final y absorbe la mayor parte de los nutrientes.',
        'El intestino grueso absorbe agua y sales y forma las heces; recto y ano almacenan y expulsan.',
        'El alimento no avanza por gravedad, sino por contracciones ordenadas de la pared, que es músculo liso involuntario.',
        'La absorción depende de la superficie disponible, y el intestino delgado la maximiza con tres niveles de plegamiento superpuestos.',
        'Las glándulas salivales producen saliva; el hígado produce bilis, que dispersa las grasas; la vesícula almacena y concentra la bilis; el páncreas exocrino produce jugo con enzimas.',
        'El hígado recibe la sangre que viene del tubo digestivo antes de que llegue al resto del organismo, y así procesa lo absorbido antes de repartirlo.',
        'Entre sus funciones están transformar sustancias y medicamentos, almacenar y liberar glucosa, fabricar proteínas del plasma y almacenar vitaminas y hierro.',
        'Que el hígado fabrique las proteínas del plasma lo enlaza con la presión oncótica de la lección de líquidos y electrolitos, y que transforme medicamentos anticipa por qué la farmacología se estudia con la función hepática delante.',
      ]),
      preguntasOrales([
        'Distingue el tubo digestivo de las glándulas anexas y di por qué conviene separarlos desde el principio.',
        'Ordena los tramos del tubo digestivo y di qué ocurre en cada uno.',
        '¿En qué tramo se absorbe la mayor parte de los nutrientes y en cuál se recupera el agua?',
        'Explica por qué el alimento avanza aunque la persona esté acostada.',
        'Describe los tres niveles de plegamiento del intestino delgado y para qué sirven.',
        'Di qué produce cada glándula anexa y para qué sirve lo que produce.',
        '¿Qué hace la vesícula biliar si no produce bilis?',
        'Enumera las funciones del hígado que van más allá de producir bilis.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('FILTRA, RECUPERA Y AJUSTA: filtración masiva, reabsorción de casi todo lo aprovechable y secreción de lo que conviene eliminar. Parece un derroche y es justo lo contrario: filtrar todo y decidir después es lo que da precisión.'),
          masPreguntado('Por qué el riñón filtra de forma masiva y recupera después, en vez de filtrar solo lo sobrante. Al decidir después qué se recupera, puede ajustar con exactitud cuánta agua, cuánto sodio y cuánto de cada sustancia se queda en el organismo, momento a momento. Un sistema que filtrara solo lo sobrante no tendría ese margen de ajuste.'),
        ],
      },
      erroresFrecuentes([
        ['Pensar que la orina se forma recogiendo lo que sobra', 'Se forma filtrando de forma masiva y recuperando después casi todo lo aprovechable, con un ajuste final por secreción. Ese orden es lo que da precisión al sistema.'],
        ['Cambiar el orden o el sentido de los tres procesos', 'Filtración: la presión de la sangre empuja agua y sustancias pequeñas fuera del capilar, y las células y las proteínas grandes no pasan. Reabsorción: se recupera hacia la sangre lo útil. Secreción: se añaden al túbulo sustancias que conviene eliminar y que no se filtraron.'],
        ['Explicar el flujo sanguíneo renal por una gran necesidad de oxígeno', 'Los riñones reciben una proporción muy alta del flujo sanguíneo no porque necesiten mucho oxígeno, sino porque su tarea consiste precisamente en procesar sangre.'],
        ['Reducir el riñón a un órgano de eliminación', 'Es el regulador del medio interno: decide cuánta agua se conserva, regula los electrolitos, participa en el equilibrio ácido-base y en la presión arterial a largo plazo, y produce sustancias que intervienen en la formación de células sanguíneas y en el metabolismo del calcio.'],
      ]),
      repasoRapido([
        'Los riñones filtran la sangre y forman la orina, y regulan agua, electrolitos y acidez; los uréteres la conducen a la vejiga, la vejiga la almacena y la uretra la conduce al exterior.',
        'Los riñones se sitúan en la parte posterior del abdomen, por detrás del peritoneo y a ambos lados de la columna.',
        'Reciben una proporción muy alta del flujo sanguíneo porque su tarea es procesar sangre, no porque necesiten mucho oxígeno.',
        'La unidad funcional es la nefrona, y cada riñón contiene un número enorme de ellas que hacen lo mismo en paralelo.',
        'En la filtración la presión de la sangre empuja agua y sustancias pequeñas fuera del capilar, mientras que las células y las proteínas grandes no pasan.',
        'En la reabsorción se recupera hacia la sangre casi toda el agua y las sustancias útiles filtradas, a lo largo del túbulo.',
        'En la secreción se añaden al túbulo sustancias que conviene eliminar y que no se filtraron.',
        'Filtrar de forma masiva y decidir después qué se recupera es lo que permite ajustar con exactitud lo que se queda en el organismo.',
        'Lo que queda al final del recorrido es la orina, cuya composición y volumen varían continuamente según lo que el organismo necesite.',
        'El riñón elimina desechos del metabolismo, regula el volumen de agua y la concentración de electrolitos como el sodio y el potasio.',
        'Participa en el equilibrio ácido-base eliminando hidrogeniones y recuperando bicarbonato, y en la regulación de la presión arterial a largo plazo a través del control del volumen.',
        'Produce además sustancias que intervienen en la formación de células sanguíneas y en el metabolismo del calcio.',
      ]),
      preguntasOrales([
        'Nombra los órganos del sistema urinario y di la función de cada uno.',
        '¿Cuál es la unidad funcional del riñón y por qué importa que sean muchas trabajando en paralelo?',
        'Ordena los tres procesos de formación de la orina y di qué ocurre en cada uno.',
        'Explica por qué filtrar de forma masiva y recuperar después da más precisión que filtrar solo lo sobrante.',
        '¿Qué no pasa el filtro y por qué?',
        'Enumera las funciones renales que menciona la lección.',
        'Relaciona la función renal con la lección de líquidos y electrolitos y con la de equilibrio ácido-base.',
        '¿Por qué los riñones reciben una proporción tan alta del flujo sanguíneo?',
      ]),
