    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('RESERVA, FRAGILIDAD Y COMORBILIDAD. Menos capacidad de responder por encima de lo habitual, vulnerabilidad en que un problema pequeño produce un deterioro desproporcionado, y varias enfermedades que interactúan entre sí y con sus medicamentos.'),
          masPreguntado('Que la edad cronológica es un dato pobre: dos personas de la misma edad pueden ser un paciente autónomo que camina a diario y otro dependiente y encamado con seis enfermedades. Lo que informa es la situación funcional.'),
        ],
      },
      erroresFrecuentes([
        ['Confundir envejecimiento con enfermedad', 'Los cambios del envejecimiento son previsibles y normales; no son una enfermedad.'],
        ['Equiparar fragilidad y edad avanzada', 'Hay personas mayores robustas y personas frágiles relativamente jóvenes.'],
        ['Hablar del paciente en tercera persona delante de él', 'Alzar la voz por defecto o asumir que no entiende son errores frecuentes y evitables. La pérdida auditiva no implica deterioro cognitivo.'],
        ['Entender la atención geriátrica como hacer menos', 'Consiste en reconocer antes, buscar lo que no se manifiesta y ajustar la conducta a un paciente con menos margen.'],
      ]),
      repasoRapido([
        'El envejecimiento produce cambios previsibles en todos los sistemas y no es una enfermedad.',
        'Reserva funcional: capacidad de un sistema para responder por encima de sus necesidades habituales.',
        'Disminuye con la edad y explica por qué el deterioro es más rápido.',
        'Fragilidad: estado de vulnerabilidad en que un problema pequeño produce un deterioro desproporcionado.',
        'No es sinónimo de edad avanzada.',
        'Comorbilidad: coexistencia de varias enfermedades crónicas que interactúan entre sí y con los medicamentos.',
        'La edad cronológica es un dato pobre: lo que informa es la situación funcional.',
        'La presentación de la enfermedad grave es atenuada e inespecífica.',
        'El deterioro, cuando llega, es más rápido, porque hay menos margen.',
        'La medicación modifica los signos: puede impedir la taquicardia o favorecer el sangrado.',
        'Hay que buscar la línea de base, y esa información suele aportarla otra persona.',
        'El entorno importa tanto como la clínica: quién le cuida, cómo vive, si puede comer y moverse.',
      ]),
      preguntasOrales([
        'Define la geriatría y distingue envejecimiento de enfermedad.',
        'Explica reserva funcional, fragilidad y comorbilidad.',
        '¿Es la fragilidad sinónimo de edad avanzada?',
        '¿Por qué la edad cronológica es un dato pobre?',
        'Enumera las cinco consecuencias prácticas en la atención.',
        '¿Cómo modifica la medicación los signos?',
        'Di los errores de lenguaje que hay que evitar.',
        '¿En qué consiste la atención geriátrica, si no es hacer menos?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SORDERA NO ES DEMENCIA. Un paciente que no responde puede simplemente no estar oyendo: antes de anotar «desorientado» hay que comprobar que la comunicación es posible.'),
          masPreguntado('Los tres errores que más daño hacen: infantilizar —diminutivos o tutear sin permiso—, hablar por encima del paciente como si no estuviera, y asumir que la confusión es normal a su edad.'),
        ],
      },
      erroresFrecuentes([
        ['Anotar «desorientado» sin comprobar la comunicación', 'Puede no estar oyendo. Antes hay que acercarse, hablar de frente y comprobar el audífono.'],
        ['Gritar para hacerse entender', 'Se habla despacio y con tono grave, no gritando, y se reduce el ruido ambiental.'],
        ['Infantilizar al paciente', 'Diminutivos, tutear sin permiso o hablarle como a un niño deterioran la valoración y la dignidad.'],
        ['No anotar quién aportó cada dato', 'No es lo mismo lo que refiere el paciente que lo que refiere un vecino.'],
      ]),
      repasoRapido([
        'Comunicarse bien no es una cortesía: es una técnica de obtención de información.',
        'Pérdida auditiva: colocarse de frente y a su altura, con luz en la cara, hablar despacio y con tono grave.',
        'Y reducir el ruido ambiental y comprobar si usa audífono y lo tiene puesto y encendido.',
        'Pérdida visual: identificarse en voz alta, avisar antes de tocar y comprobar si tiene gafas.',
        'Procesamiento más lento: una pregunta cada vez, esperando la respuesta sin interrumpir.',
        'Deterioro cognitivo: frases cortas, información concreta, repetición tranquila y evitar discusiones.',
        'Prótesis dental retirada: dificulta hablar y comer; si es posible y seguro, permitir que la use.',
        'Miedo o desconfianza: explicar cada paso, no apresurar y respetar el pudor.',
        'Sordera no es demencia.',
        'Se empieza por preguntas abiertas y se concreta después, dando tiempo.',
        'Se busca el listado de medicación, los informes y la caja de pastillas: es más fiable que el recuerdo.',
        'Se repite lo entendido en voz alta para que el paciente lo corrija, y se anota quién aportó cada dato.',
      ]),
      preguntasOrales([
        'Enumera las barreras de comunicación y su solución.',
        '¿Por qué no se grita?',
        '¿Por qué sordera no es demencia?',
        'Di las técnicas que funcionan para obtener información.',
        '¿Por qué es más fiable el pastillero que el recuerdo?',
        'Di los tres errores que más daño hacen.',
        '¿Por qué se anota quién aportó cada dato?',
        '¿Dónde se busca información si el paciente no puede comunicarse?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('GERIÁTRICO, ENTORNO, MÉDICO Y SOCIAL. Cuatro vértices para no olvidar lo que hace distinta esta atención, y el segundo es el que más se salta: el domicilio es exploración física.'),
          masPreguntado('Que el entorno es exploración física: una vivienda helada, una nevera vacía, la cama en el salón, la medicación intacta en su envase o repartida en tres cajas, marcas de una caída anterior. Todo eso es información clínica.'),
        ],
      },
      erroresFrecuentes([
        ['Saltarse la evaluación del entorno', 'El domicilio informa: temperatura, higiene, alimentos, obstáculos, medicación a la vista y señales de caídas previas.'],
        ['Decidir el destino solo con criterios clínicos', 'Un paciente con un cuadro leve que vive solo y no puede prepararse comida no está en la misma situación que otro con apoyo continuo.'],
        ['No preguntar por el cuidador', 'Un cuidador agotado o desbordado es un dato que predice tanto ingresos como maltrato.'],
        ['Registrar el entorno con juicios', 'Se registra de forma objetiva: describir la temperatura y la ausencia de alimentos es un hallazgo; calificar la vivienda no lo es.'],
      ]),
      repasoRapido([
        'G, paciente geriátrico: presentación atípica, reserva menor y su línea de base como referencia.',
        'E, evaluación del entorno: temperatura, higiene, alimentos, obstáculos, medicación y señales de caídas.',
        'M, evaluación médica: varias enfermedades y varios medicamentos, y ambos modifican los signos.',
        'S, evaluación social: quién le cuida, cómo se alimenta, si sale de casa y si puede manejar su medicación.',
        'El entorno es exploración física.',
        'En el entorno se busca la temperatura de la vivienda y la ropa que lleva puesta.',
        'También alimentos y agua accesible, obstáculos, alfombras sueltas, iluminación y escaleras.',
        'También adaptaciones —barras, andador, silla de ducha—, y el estado de la medicación a la vista.',
        'También la higiene general y los signos de caídas previas.',
        'En lo social: con quién vive, quién le atiende, si sale de casa y quién le prepara la comida.',
        'También si ha habido cambios recientes y si el cuidador está agotado o desbordado.',
        'Lo social cambia decisiones clínicas, y todo lo observado se registra de forma objetiva y sin juicios.',
      ]),
      preguntasOrales([
        'Describe los cuatro vértices del diamante GEMS.',
        '¿Por qué el entorno es exploración física?',
        'Enumera qué se busca en el entorno.',
        'Enumera qué se busca en lo social.',
        '¿Por qué el cuidador desbordado es un dato relevante?',
        '¿Cómo cambia lo social una decisión clínica?',
        '¿Cómo se registra lo observado?',
        'Pon un ejemplo de hallazgo objetivo frente a un juicio.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MENOS RESERVA, RESPUESTA MÁS LENTA, SIGNOS ATENUADOS. Es el hilo que recorre todos los sistemas, y explica por qué una persona mayor puede estar gravemente enferma con unas constantes que en un joven parecerían aceptables.'),
          masPreguntado('Que los signos vitales pueden mentir en las dos direcciones: una presión aparentemente normal puede ser una hipotensión grave en quien vive habitualmente mucho más alto, y una frecuencia normal puede corresponder a un paciente en shock cuya medicación le impide acelerar.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar las constantes contra la norma poblacional', 'Se interpretan contra las cifras habituales del paciente y contando con su medicación.'],
        ['Esperar síntomas precoces de un hematoma', 'Con la edad hay más espacio dentro del cráneo: una colección puede crecer bastante antes de dar síntomas.'],
        ['Arrastrar al paciente o retirar un adhesivo con brusquedad', 'Puede producir un desgarro cutáneo extenso. Se levanta, se acolcha y se usan superficies que reduzcan la fricción.'],
        ['Descartar una infección por ausencia de fiebre', 'La respuesta inmunitaria es más débil: una infección grave puede cursar sin fiebre y manifestarse solo por confusión o caídas.'],
      ]),
      repasoRapido([
        'Cardiovascular: vasos menos elásticos y respuesta al estrés más lenta; tolera mal la falta y el exceso de volumen.',
        'La taquicardia compensatoria puede no aparecer.',
        'Respiratorio: menor elasticidad, musculatura más débil y tos menos eficaz; desatura y se fatiga antes.',
        'Nervioso: menor volumen cerebral con más espacio intracraneal y reflejos más lentos.',
        'Renal: menor capacidad de concentrar orina y de eliminar fármacos; se deshidrata antes y acumula medicamentos.',
        'Musculoesquelético: menos masa muscular, hueso frágil y columna rígida; fracturas con mecanismos leves.',
        'Piel y termorregulación: piel fina y frágil, menos grasa y peor respuesta al frío y al calor.',
        'Sensorial: pérdida auditiva y visual y menor sensibilidad al dolor y a la sed; consulta más tarde y bebe menos.',
        'Inmunitario: respuesta más débil y menos fiebre ante la infección.',
        'Los signos vitales pueden mentir en las dos direcciones.',
        'El cerebro tiene más sitio para sangrar: un hematoma puede crecer antes de manifestarse.',
        'Riesgos por menor reserva: deshidratación rápida, hipotermia, lesiones cutáneas y complicaciones de la inmovilidad.',
      ]),
      preguntasOrales([
        'Recorre los cambios sistema por sistema y su consecuencia.',
        '¿Por qué puede no aparecer la taquicardia compensatoria?',
        '¿Por qué se deshidrata y acumula fármacos con más facilidad?',
        'Explica por qué los signos vitales pueden mentir en las dos direcciones.',
        '¿Por qué el cerebro tiene más sitio para sangrar?',
        'Enumera los riesgos derivados de la menor reserva.',
        '¿Qué consecuencia práctica tiene la piel frágil?',
        '¿Por qué una infección puede cursar sin fiebre?',
      ]),
      F([GEMS_3, AMLS_4, WHO_BEC, EMPACT_HISTORICO]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA CAÍDA CASI NUNCA ES SOLO UNA CAÍDA. Puede ser una infección, una arritmia, una hipotensión, una hipoglucemia, un efecto de la medicación o un problema neurológico: la pregunta no es solo qué se lesionó, sino por qué se cayó.'),
          masPreguntado('Por qué esta lección no publica porcentajes ni un orden numérico: el mandato editorial exige que todo dato epidemiológico cuantitativo proceda de una fuente oficial mexicana identificable, y esa fuente no se ha entregado.'),
        ],
      },
      erroresFrecuentes([
        ['Publicar o memorizar un orden numérico de causas', 'Exige una fuente oficial mexicana identificable que no se ha entregado.'],
        ['Quedarse en la lesión de la caída', 'La caída suele ser el síntoma de otro problema: se investiga por qué se cayó.'],
        ['Esperar dolor torácico en el síndrome coronario', 'Puede cursar sin él: disnea, debilidad, náusea o confusión pueden ser su única manifestación.'],
        ['Atribuir el déficit neurológico a la edad', 'El déficit puede atribuirse erróneamente a un deterioro previo, y la hora de inicio es información crítica que se pierde.'],
      ]),
      repasoRapido([
        'Conocer de qué enferman y mueren las personas mayores orienta la sospecha antes de llegar.',
        'Esta lección no publica porcentajes: no se dispone de la fuente oficial mexicana.',
        'Enfermedad cardiovascular: el síndrome coronario puede cursar sin dolor torácico.',
        'Enfermedad cerebrovascular: el déficit puede atribuirse a la edad, y la hora de inicio es crítica.',
        'Enfermedad respiratoria: la agudización y la neumonía son frecuentes, y esta puede cursar sin fiebre.',
        'Cáncer: aporta síntomas propios, complicaciones y tratamientos que modifican la respuesta.',
        'Diabetes y complicaciones: la hipoglucemia imita cualquier cuadro neurológico y es tratable.',
        'Infecciones: la urinaria y la respiratoria son causas frecuentísimas de confusión aguda y de caídas.',
        'Caídas: principal causa externa; producen fracturas y traumatismo craneal.',
        'La caída casi nunca es solo una caída.',
        'El deterioro cognitivo dificulta la valoración y aumenta el riesgo.',
        'La fragilidad condiciona la atención sin ser una causa de muerte en sí misma.',
      ]),
      preguntasOrales([
        '¿Por qué esta lección no trae porcentajes?',
        'Enumera los grandes grupos de causas.',
        '¿Cómo puede presentarse un síndrome coronario en la persona mayor?',
        '¿Por qué la hora de inicio es crítica en el cuadro cerebrovascular?',
        '¿Qué papel tienen las infecciones urinaria y respiratoria?',
        '¿Por qué las caídas son la principal causa externa?',
        'Explica por qué una caída casi nunca es solo una caída.',
        '¿Qué dos situaciones condicionan la atención sin ser causas de muerte?',
      ]),
      F([GEMS_3, AMLS_4, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('INTERACCIÓN, ACUMULACIÓN, CASCADA Y ERROR. Cuatro mecanismos por los que la medicación produce urgencias: se potencian entre sí, se acumulan porque se eliminan peor, se añade un fármaco para tratar el efecto de otro, y se administran mal.'),
          masPreguntado('Que la medicación enmascara lo que se busca: determinados fármacos impiden que el corazón acelere, así que un paciente en shock puede tener una frecuencia normal; otros favorecen el sangrado, y una hemorragia intracraneal puede crecer despacio.'),
        ],
      },
      erroresFrecuentes([
        ['Preguntar qué le han recetado en vez de qué toma', 'No siempre coincide. Se pregunta qué toma realmente.'],
        ['No preguntar por lo que el paciente no considera medicación', 'Productos de herbolario, suplementos, analgésicos sin receta y remedios de otras personas cuentan.'],
        ['No preguntar por cambios recientes', 'Un fármaco nuevo o una dosis modificada en los últimos días es una pista de primer orden.'],
        ['Interpretar una frecuencia normal como ausencia de shock', 'Puede deberse a un fármaco que limita la respuesta cardiaca.'],
      ]),
      repasoRapido([
        'La polifarmacia es el uso simultáneo de varios medicamentos y una causa frecuente de urgencia evitable.',
        'Interacción: dos medicamentos seguros por separado pueden potenciarse o anularse al combinarse.',
        'Acumulación: la eliminación es más lenta, y una pauta correcta puede volverse excesiva con el tiempo.',
        'Cascada terapéutica: un efecto adverso se interpreta como enfermedad nueva y se añade otro fármaco.',
        'Errores de administración: confusión de envases, dosis duplicadas, olvidos o medicación ajena.',
        'La medicación enmascara lo que se busca.',
        'Se llevan los envases, el listado o el pastillero al hospital, o se fotografían.',
        'Se pregunta qué toma realmente, no qué le han recetado.',
        'Se pregunta por cambios recientes y por lo que no considera medicación.',
        'Se comprueba quién administra la medicación y si el paciente puede manejarla, y se registra la última toma.',
        'Hacen pensar en la medicación las caídas repetidas, la confusión reciente y el sangrado desproporcionado.',
        'También la frecuencia que no sube pese al deterioro, la deshidratación y la somnolencia o depresión respiratoria.',
      ]),
      preguntasOrales([
        'Explica los cuatro mecanismos por los que la polifarmacia produce urgencias.',
        '¿Qué es una cascada terapéutica?',
        '¿Cómo enmascara la medicación los signos?',
        'Recorre cómo se recoge la medicación real.',
        '¿Por qué se pregunta qué toma y no qué le han recetado?',
        '¿Qué cuenta como medicación aunque el paciente no lo crea?',
        'Di los cuadros que deben hacer pensar en la medicación.',
        '¿Cuál es la aportación concreta del equipo?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CAERSE DE PIE NO ES UN MECANISMO MENOR. En una persona mayor puede producir fractura de cadera, fractura vertebral y hemorragia intracraneal. Es la frase que más veces hay que repetir en esta unidad.'),
          masPreguntado('El traumatismo craneal leve con anticoagulación: un golpe aparentemente trivial exige valoración aunque el paciente esté asintomático, porque el sangrado puede aparecer y crecer con retraso.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar la caída desde la propia altura como banal', 'Puede producir fractura de cadera, fractura vertebral y hemorragia intracraneal.'],
        ['Dar de alta un golpe craneal leve en un anticoagulado', 'Exige valoración aunque esté asintomático: el sangrado puede aparecer y crecer con retraso.'],
        ['Usar los criterios de triaje sin ajustar por edad', 'Los signos de gravedad están atenuados: se baja el umbral y se aplican los criterios específicos por edad.'],
        ['Forzar la posición neutra en una columna con cifosis', 'No se fuerza: se rellenan los huecos y se prefiere estabilización adaptada a un collarín que no ajusta.'],
      ]),
      repasoRapido([
        'El hueso es más frágil: una caída desde la propia altura puede fracturar cadera, vértebras, costillas o muñeca.',
        'La columna es más rígida y amortigua menos.',
        'La reserva cardiovascular y respiratoria es menor: la misma pérdida se tolera peor.',
        'Las fracturas costales limitan la ventilación en un paciente sin margen y evolucionan peor.',
        'Hay más espacio intracraneal: un hematoma puede crecer antes de manifestarse.',
        'La anticoagulación multiplica el riesgo de sangrado ante golpes triviales.',
        'Infratriaje es clasificar como leve a un paciente que es grave, y ocurre con frecuencia aquí.',
        'Se compensa bajando el umbral de sospecha y de traslado, con los criterios específicos por edad.',
        'Y comparando las constantes con las cifras habituales, no con la norma poblacional.',
        'Y preguntando siempre por anticoagulantes, buscando por qué se cayó y explorando toda la superficie.',
        'Precauciones: acolchar generosamente, respetar deformidades, levantar en vez de arrastrar.',
        'Y prevención activa de la hipotermia y analgesia conforme al alcance.',
      ]),
      preguntasOrales([
        '¿Por qué mecanismos leves producen lesiones graves?',
        '¿Qué puede producir una caída desde la propia altura?',
        '¿Qué es el infratriaje y por qué ocurre aquí?',
        '¿Cómo se compensa?',
        'Enumera las precauciones de manejo.',
        '¿Por qué un collarín que no ajusta es contraproducente?',
        '¿Qué exige un traumatismo craneal leve en un anticoagulado?',
        '¿Por qué las fracturas costales evolucionan peor?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA CONFUSIÓN AGUDA ES UN SIGNO, NO UN DIAGNÓSTICO. Un paciente mayor que empieza a estar confuso tiene, hasta que se demuestre lo contrario, un problema agudo tratable.'),
          masPreguntado('La pregunta que más resuelve: «¿desde cuándo está así?». Distingue un cuadro agudo de una situación crónica, sitúa la ventana de tiempo en los cuadros que dependen de ella y orienta toda la valoración.'),
        ],
      },
      erroresFrecuentes([
        ['Atribuir a la edad lo que es una enfermedad aguda', 'Es el sesgo central de la unidad, y el que más retrasa la atención.'],
        ['Dar por explicada la confusión con una demencia conocida', 'La confusión aguda es un signo de un problema agudo tratable hasta que se demuestre lo contrario.'],
        ['Concluir que no hay dolor porque el paciente no se queja', 'La sensibilidad al dolor está disminuida y el paciente refiere menos síntomas.'],
        ['Interpretar unas constantes normales como ausencia de gravedad', 'Se interpretan contra sus cifras habituales y contando con su medicación.'],
      ]),
      repasoRapido([
        'Los cuadros graves se presentan sin sus signos característicos.',
        'Síndrome coronario sin dolor torácico: disnea, debilidad, sudoración, náusea, síncope o confusión.',
        'Infección grave sin fiebre: confusión, caídas, debilidad, rechazo del alimento o hipotermia.',
        'Abdomen agudo sin defensa marcada, con la pared abdominal poco expresiva.',
        'Insuficiencia cardiaca como debilidad progresiva o confusión, sin la disnea clásica.',
        'Accidente cerebrovascular atribuido a un deterioro previo, con la hora de inicio perdida.',
        'Hipoglucemia como confusión, agresividad, focalidad o coma, imitando otros cuadros.',
        'Deshidratación como debilidad, caída o confusión, sin sed referida.',
        'La confusión aguda es un signo, no un diagnóstico.',
        'Estrategia: partir del cambio, descartar lo tratable y rápido, explorar entero e interpretar contra sus cifras.',
        'La pregunta que más resuelve es desde cuándo está así.',
        'Sesgos que vigilar: atribuir a la edad, aceptar el diagnóstico previo, dar la confusión por explicada y concluir que no hay dolor.',
      ]),
      preguntasOrales([
        'Enumera las presentaciones atípicas más frecuentes.',
        '¿Cómo puede presentarse una infección grave?',
        '¿Y una insuficiencia cardiaca?',
        '¿Por qué la confusión aguda es un signo y no un diagnóstico?',
        'Recorre la estrategia de cuatro pasos.',
        '¿Cuál es la pregunta que más resuelve, y por qué?',
        'Di los sesgos que hay que vigilar.',
        '¿Qué se descarta primero por tratable y rápido?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('BRUSCO Y FLUCTUANTE FRENTE A LENTO Y ESTABLE. El cuadro confusional agudo empieza en horas o días y fluctúa a lo largo del día; la demencia empieza en meses o años y es estable y progresiva. Esa distinción es la que decide la conducta.'),
          masPreguntado('Que un cambio brusco del estado mental en una persona mayor es una urgencia médica hasta que se demuestre lo contrario, y que su causa suele estar FUERA del cerebro: infección, fármaco, hipoglucemia. Y que el riesgo de suicidio es real y se pregunta de forma directa.'),
        ],
      },
      erroresFrecuentes([
        ['Confundir el cuadro confusional agudo con la demencia', 'El primero es una urgencia médica con causa tratable; el segundo, una enfermedad crónica que condiciona la atención.'],
        ['No preguntar por ideación suicida', 'La persona mayor comunica menos su intención y usa métodos más letales: hay menos avisos previos. Se pregunta de forma directa y respetuosa.'],
        ['Discutir o contradecir de frente a un paciente con deterioro cognitivo', 'Se redirige en vez de confrontar.'],
        ['Recurrir a la sujeción antes de buscar la causa', 'Primero se busca dolor, retención de orina, estreñimiento, hipoglucemia, falta de oxígeno o fármaco nuevo. La sujeción y la medicación son el último recurso.'],
      ]),
      repasoRapido([
        'Cuadro confusional agudo: inicio brusco en horas o días, curso fluctuante, atención muy alterada.',
        'Es una urgencia médica con causa tratable, y esa causa suele estar fuera del cerebro.',
        'Demencia: inicio lento en meses o años, curso estable y progresivo, atención relativamente conservada al principio.',
        'Depresión: inicio progresivo en semanas o meses, curso persistente, conciencia conservada.',
        'La depresión se manifiesta con frecuencia sin tristeza declarada.',
        'Aparece como pérdida de interés, quejas físicas repetidas, dolor sin explicación, insomnio o pérdida de apetito.',
        'El riesgo de suicidio es real: comunica menos su intención y usa métodos más letales.',
        'Preguntar de forma directa y respetuosa no induce la idea.',
        'Ante la agitación se busca primero la causa: dolor, retención, estreñimiento, hipoglucemia, hipoxia o fármaco nuevo.',
        'Se reducen estímulos, con un solo interlocutor de frente y frases cortas.',
        'No se discute de frente con un paciente con deterioro cognitivo: se redirige.',
        'Se asegura gafas y audífono: la privación sensorial agrava la agitación.',
      ]),
      preguntasOrales([
        'Diferencia cuadro confusional agudo, demencia y depresión por curso y significado.',
        '¿Qué significa un cambio brusco del estado mental?',
        '¿Dónde suele estar su causa?',
        '¿Cómo se manifiesta la depresión en la persona mayor?',
        '¿Por qué el riesgo de suicidio es particular aquí?',
        'Recorre el manejo de la agitación.',
        '¿Qué significa redirigir en vez de confrontar?',
        '¿Cómo se sitúa la capacidad de decidir?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SEÑALES EN LA RELACIÓN, NO SOLO EN EL CUERPO. Un acompañante que responde por el paciente y no le deja hablar, que impide quedarse a solas con él, o un paciente que mira al acompañante antes de responder.'),
          masPreguntado('La diferencia principal con el maltrato infantil: una persona mayor con capacidad conservada puede negarse a denunciar, a ser trasladada o a que se informe a nadie, y esa decisión merece respeto.'),
        ],
      },
      erroresFrecuentes([
        ['Confrontar o acusar en la escena', 'Aumenta el riesgo del paciente y compromete la seguridad del equipo.'],
        ['No intentar valorar al paciente a solas', 'Se intenta si la situación clínica y la seguridad lo permiten: hay información que no se dice delante del acompañante.'],
        ['Repreguntar o conducir al paciente', 'Lo que diga se registra textualmente, entrecomillado, sin repreguntar ni conducir.'],
        ['Tratar a todo cuidador como agresor', 'Muchas situaciones de negligencia proceden de alguien que cuida solo, sin apoyo, sin formación y agotado. No lo justifica, pero cambia la respuesta.'],
      ]),
      repasoRapido([
        'Incluye el daño físico, el psicológico, el sexual, el abandono, la negligencia y el abuso económico.',
        'Ocurre casi siempre en el entorno de confianza del paciente.',
        'Físico: lesiones sin explicación coherente, de distinta antigüedad, en zonas protegidas o con forma de objeto.',
        'Negligencia: higiene deficiente, deshidratación, desnutrición, lesiones por presión, medicación no administrada.',
        'Psicológico: paciente temeroso, que evita hablar delante de alguien, apático o excesivamente sumiso.',
        'Abandono: persona dependiente dejada sola durante periodos prolongados sin medios.',
        'Económico: falta de dinero para lo básico pese a tener ingresos, o control total de sus recursos por otra persona.',
        'Hay señales en la relación, no solo en el cuerpo.',
        'Conducta: atender, intentar valorar a solas, observar el entorno y describirlo con hallazgos concretos.',
        'Registrar textualmente lo que diga el paciente y no confrontar a nadie en la escena.',
        'Comunicar la sospecha de forma explícita al personal receptor, además de por escrito.',
        'El paciente capaz puede negarse a que se actúe, y esa decisión merece respeto.',
      ]),
      preguntasOrales([
        'Enumera las formas de maltrato y sus indicadores.',
        '¿Qué señales hay en la relación con el acompañante?',
        'Recorre la conducta del equipo.',
        '¿Por qué no se confronta a nadie en la escena?',
        '¿Cómo se registra lo que dice el paciente?',
        '¿Cuál es la diferencia principal con el maltrato infantil?',
        '¿Qué se hace si el paciente capaz no quiere que se actúe?',
        '¿Por qué el cuidador desbordado no siempre es un agresor?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('«¿QUÉ ES DISTINTO HOY RESPECTO A LA SEMANA PASADA?». Es la pregunta que convierte una lista de enfermedades crónicas en un cuadro agudo identificable, y sirve para el paciente, para la familia y para el cuidador profesional.'),
          masPreguntado('Lo que se busca y casi nadie mira: lesiones por presión en sacro y talones, deshidratación de mucosas y retención de orina —un globo vesical explica agitación, dolor y confusión y se palpa en segundos—.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar las constantes sin la línea de base', 'Sin saber qué hacía por sí mismo hace una semana, ninguna exploración es interpretable.'],
        ['No palpar buscando un globo vesical', 'Explica agitación, dolor y confusión, y se palpa en segundos.'],
        ['Explorar solo lo accesible', 'Se explora toda la superficie, incluida la espalda, los glúteos y los pies: las lesiones por presión se encuentran mirando.'],
        ['Arrastrar al paciente al movilizarlo', 'Se moviliza levantando, nunca arrastrando, y se acolchan las prominencias óseas.'],
      ]),
      repasoRapido([
        'La secuencia inicial no cambia; lo que se añade es el contexto sin el cual los hallazgos no significan nada.',
        'Línea de base: qué hacía por sí mismo, cómo caminaba, si salía de casa, cómo estaba de memoria y qué ha cambiado.',
        'Medicación real: envases, listado o pastillero, cambios recientes y hora de la última toma.',
        'Entorno y apoyo: cómo vive, quién le cuida, si come y si puede manejar su medicación.',
        'La pregunta que estructura la entrevista es qué es distinto hoy respecto a la semana pasada.',
        'Se expone por partes y se vuelve a cubrir: se enfría deprisa y el pudor importa.',
        'Se explora toda la superficie, incluida la espalda, los glúteos y los pies.',
        'Se moviliza levantando y se acolchan las prominencias óseas, respetando deformidades y limitaciones.',
        'Se valora el dolor de forma activa, porque el paciente puede no referirlo.',
        'Se interpretan las constantes contra sus cifras habituales y contando con su medicación.',
        'Se busca lo que casi nadie mira: lesiones por presión, deshidratación de mucosas y retención de orina.',
        'La entrega lleva la línea de base y su cambio, la medicación real, quién aportó cada dato y las voluntades anticipadas si existen.',
      ]),
      preguntasOrales([
        '¿Qué añade la evaluación geriátrica a la secuencia habitual?',
        'Di los tres añadidos y por qué cada uno.',
        '¿Cuál es la pregunta que estructura toda la entrevista?',
        '¿Cómo se adapta la exploración a la fragilidad?',
        '¿Qué se busca y casi nadie mira?',
        '¿Por qué un globo vesical merece una palpación?',
        '¿Qué debe contener la entrega?',
        '¿Cuál es la aportación que nadie más puede hacer?',
      ]),
      F([GEMS_3, AMLS_4, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA LESIÓN QUE SE VE PUEDE SER LA CONSECUENCIA. Investigar la caída forma parte del manejo del trauma: si notó algo antes, si perdió el conocimiento, si se mareó al levantarse, si ha tenido caídas recientes y qué medicación toma.'),
          masPreguntado('Lo que más se pasa por alto: las fracturas costales, que limitan la ventilación de un paciente sin margen; la hemorragia intracraneal de crecimiento lento en el anticoagulado; y la fractura vertebral de una caída aparentemente banal.'),
        ],
      },
      erroresFrecuentes([
        ['No preguntar por anticoagulantes', 'Se pregunta de forma explícita y se anota en lugar visible del informe: la hemorragia intracraneal puede crecer despacio.'],
        ['Forzar la alineación en una columna rígida', 'Se respeta la cifosis y las limitaciones articulares, y se rellenan los huecos en lugar de forzar.'],
        ['Inmovilizar sobre una superficie rígida sin acolchar', 'Produce lesión cutánea en minutos sobre una piel frágil.'],
        ['Quedarse con la lesión visible', 'La lesión que se ve puede ser la consecuencia, no el problema: investigar la caída forma parte del manejo.'],
      ]),
      repasoRapido([
        'El manejo es el habitual, con el umbral de alarma bajado.',
        'Se interpretan las constantes contra las cifras habituales y contando con su medicación.',
        'Se pregunta de forma explícita por anticoagulantes y antiagregantes y se anota en lugar visible.',
        'Se explora toda la superficie: las lesiones se acumulan y el paciente puede no referirlas.',
        'La analgesia es parte del manejo: el dolor mal controlado empeora la ventilación y favorece la confusión.',
        'Prevención activa de la hipotermia desde el primer minuto.',
        'Se pasan por alto las fracturas costales, la hemorragia intracraneal de crecimiento lento y la fractura vertebral banal.',
        'Se acolcha generosamente: una superficie rígida lesiona la piel frágil en minutos.',
        'Se respeta la cifosis y se rellenan los huecos en lugar de forzar la alineación.',
        'Se prefiere estabilización adaptada y acolchado a un collarín que no ajusta a una columna rígida.',
        'Se levanta en vez de arrastrar y se retira la tabla larga en cuanto cumpla su función de extracción.',
        'En la entrega: mecanismo real y altura, anticoagulación explícita, cifras habituales, tiempo en el suelo y sospecha sobre la causa.',
      ]),
      preguntasOrales([
        'Recorre las prioridades del manejo del paciente geriátrico traumatizado.',
        '¿Qué se pasa por alto con más frecuencia?',
        '¿Por qué la anticoagulación se anota en lugar visible?',
        'Di las adaptaciones de la inmovilización.',
        '¿Por qué se acolcha generosamente?',
        '¿Por qué investigar la caída forma parte del manejo del trauma?',
        '¿Qué se pregunta para investigarla?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PARTIR DEL CAMBIO, DESCARTAR LO TRATABLE, INTERPRETAR CONTRA SU BASE Y CONTAR CON SU MEDICACIÓN. Cuatro pasos que integran el módulo entero, y un quinto: decidir destino integrando lo clínico y lo social.'),
          masPreguntado('Las cuatro trampas del módulo juntas: un infarto sin dolor, una infección sin fiebre, un shock sin taquicardia porque su medicación lo impide, y una confusión atribuida a la edad cuando es el único signo de un cuadro agudo.'),
        ],
      },
      erroresFrecuentes([
        ['Dar por buena una constante sin compararla', 'Ninguna se da por buena hasta compararla con las cifras habituales del paciente.'],
        ['No descartar lo tratable y rápido', 'Glucemia si está dentro del alcance, oxigenación, medicación reciente, dolor no controlado y retención de orina.'],
        ['Interpretar un documento de voluntades como ausencia de atención', 'No limita el alivio del dolor, la disnea o el sufrimiento, ni el acompañamiento, ni el traslado si es lo indicado.'],
        ['Decidir el destino solo con criterios clínicos', 'También cuentan la capacidad del entorno para vigilar y cuidar, la autonomía del paciente y el riesgo de nueva caída.'],
      ]),
      repasoRapido([
        'Impresión general y secuencia inicial, sin dar por buena ninguna constante hasta compararla.',
        'Partir del cambio: qué es distinto hoy y desde cuándo, según quien le conoce.',
        'Descartar lo tratable y rápido: glucemia, oxigenación, medicación reciente, dolor y retención de orina.',
        'Explorar entero y buscar el foco: la persona mayor puede no referir el síntoma que orientaría.',
        'Decidir destino integrando lo clínico y lo social, y preparar una entrega con lo que el hospital no podrá recuperar.',
        'Las cuatro trampas: infarto sin dolor, infección sin fiebre, shock sin taquicardia y confusión atribuida a la edad.',
        'Algunos pacientes han dejado por escrito qué atención desean y cuál no, o han designado a alguien.',
        'Un documento que limita medidas no limita el alivio del dolor, la disnea o el sufrimiento.',
        'Si no hay documento pero la familia refiere una voluntad, se documenta qué se refirió y quién, y se consulta.',
        'El destino integra la gravedad, la capacidad del entorno y la autonomía del paciente.',
        'También el riesgo de nueva caída o de deterioro sin supervisión, y los deseos y la capacidad de decidir.',
        'La atención a la persona mayor no consiste en hacer menos por su edad ni en aplicar sin más lo del adulto joven.',
      ]),
      preguntasOrales([
        'Recorre los cinco pasos de la conducta.',
        '¿Por qué no se da por buena ninguna constante?',
        '¿Qué se descarta por tratable y rápido?',
        'Di las cuatro trampas del módulo.',
        '¿Qué NO significa un documento de voluntades?',
        '¿Qué se hace si la familia refiere una voluntad sin documento?',
        '¿Qué integra la decisión de destino?',
        'Resume en qué consiste la atención a la persona mayor.',
      ]),
      F([GEMS_3, AMLS_4, WHO_BEC, LEY_SALUD, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
