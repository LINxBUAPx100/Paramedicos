    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SOBRA FUERA Y FALTA DENTRO. La sangre puede estar cargada de glucosa mientras las células no pueden usarla y se comportan como si estuvieran en ayuno. Esa paradoja explica casi todo lo que sigue en la unidad.'),
          masPreguntado('Que orinar mucho y tener mucha sed no son dos problemas, sino el mismo: la glucosa que se elimina por la orina arrastra agua consigo y el organismo responde pidiendo líquido. Eso explica que un paciente hiperglucémico llegue deshidratado aunque haya estado bebiendo.'),
        ],
      },
      erroresFrecuentes([
        ['Tomar las asociaciones de tipo 1 y tipo 2 como absolutas', 'Hay pacientes con tipo 1 diagnosticados en la edad adulta y pacientes con tipo 2 que desarrollan cetoacidosis. Orientan la sospecha; no clasifican al paciente.'],
        ['Manipular una bomba de insulina o un sensor', 'Identificarlos aporta información valiosa, pero manipularlos, detenerlos o modificar su programa no es una conducta de esta lección.'],
        ['Fiarse sin más de la glucemia capilar', 'Puede alterarse por mala técnica, manos sucias o húmedas y mala perfusión periférica.'],
        ['No preguntar por la última dosis ni por la última ingesta', 'Son dos de los datos que más explican una descompensación, y solo los tiene quien pregunta.'],
      ]),
      repasoRapido([
        'La insulina permite que la glucosa entre a la mayoría de las células.',
        'Sin insulina la glucosa sobra fuera y falta dentro, y el organismo busca energía por otra vía.',
        'Tipo 1: el páncreas deja de producir insulina; inicio más frecuente en edades tempranas y a menudo brusco.',
        'Tipo 2: se produce insulina pero el organismo responde peor, y con el tiempo la producción también puede caer.',
        'El tipo 1 es más propenso a la cetoacidosis; el tipo 2, al estado hiperosmolar, aunque puede tener cetoacidosis.',
        'Ninguna de esas asociaciones es absoluta.',
        'Hiperglucemia mantenida: orinar mucho y con frecuencia, sed intensa, boca seca, piel con menos elasticidad.',
        'También cansancio y debilidad, pérdida de peso, visión borrosa fluctuante e infecciones o heridas que tardan.',
        'Poliuria y sed son el mismo problema: la glucosa eliminada arrastra agua.',
        'Historia dirigida: tipo de diabetes, tratamiento y última toma, omisiones o cambios, última ingesta.',
        'También vómito, diarrea o fiebre asociados, episodios previos y dispositivos que porta.',
        'Los dispositivos son información y también un riesgo: se identifican, no se manipulan.',
      ]),
      preguntasOrales([
        'Explica el papel de la insulina.',
        '¿Qué significa que la glucosa sobre fuera y falte dentro?',
        'Diferencia funcionalmente la diabetes tipo 1 de la tipo 2.',
        '¿Son absolutas esas diferencias? Justifícalo.',
        'Enumera las manifestaciones de hiperglucemia mantenida.',
        '¿Por qué orinar mucho y tener sed son el mismo problema?',
        'Recorre la historia dirigida de un paciente diabético.',
        '¿Qué se hace y qué no se hace con los dispositivos?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MINUTOS, HORAS, DÍAS. La hipoglucemia se instaura en minutos, la cetoacidosis en horas o pocos días y el estado hiperosmolar en días o semanas. Esa escala de tiempo es lo primero que separa los tres cuadros.'),
          masPreguntado('Que la hipoglucemia imita a casi todo —intoxicación, ictus con déficit focal, crisis convulsiva o cuadro psiquiátrico—, y por eso la glucemia se comprueba en toda alteración del estado mental. Y que la respuesta autonómica puede faltar en la hipoglucemia inadvertida.'),
        ],
      },
      erroresFrecuentes([
        ['No comprobar la glucemia en una alteración del estado mental', 'La hipoglucemia imita a casi todo, y es la que produce daño en menos tiempo.'],
        ['Esperar siempre los signos de alarma autonómicos', 'Algunos pacientes con diabetes de larga evolución o con ciertos medicamentos dejan de percibirlos y pasan directamente a las manifestaciones neurológicas.'],
        ['Atribuir a causa digestiva un dolor abdominal con vómitos', 'Un paciente joven así puede estar en cetoacidosis. La glucemia y el patrón respiratorio reorientan la sospecha.'],
        ['Etiquetar el síndrome en la escena', 'Los dos cuadros hiperglucémicos se solapan y hay presentaciones mixtas. Lo que decide la prioridad es el estado del paciente, no el nombre.'],
      ]),
      repasoRapido([
        'El sistema nervioso depende de un aporte continuo de glucosa y apenas almacena reservas.',
        'Respuesta autonómica: sudoración fría, temblor, palpitaciones, ansiedad, hambre, palidez.',
        'Neuroglucopenia: confusión, comportamiento extraño, dificultad para hablar, déficit focal, somnolencia, convulsión.',
        'La respuesta autonómica puede faltar: es la hipoglucemia inadvertida.',
        'Cetoacidosis: falta insulina, se degradan grasas y se generan cuerpos cetónicos ácidos.',
        'Da deshidratación importante, respiración profunda compensatoria y aliento afrutado.',
        'También náusea, vómito y dolor abdominal, que pueden confundir con un problema digestivo.',
        'Estado hiperosmolar: queda insulina para frenar los cuerpos cetónicos pero no para controlar la glucosa.',
        'Da instauración lenta, deshidratación profunda y alteración neurológica marcada, con cetosis escasa o ausente.',
        'Es más habitual en personas mayores con diabetes tipo 2 y suele tener un desencadenante.',
        'Los dos síndromes hiperglucémicos se solapan y existen presentaciones mixtas.',
        'La insulina y la corrección del potasio son decisiones hospitalarias que dependen de mediciones repetidas.',
      ]),
      preguntasOrales([
        'Di los dos grupos de manifestaciones de la hipoglucemia y su mecanismo.',
        '¿Por qué la hipoglucemia imita a casi todo?',
        '¿Qué es la hipoglucemia inadvertida?',
        'Explica el mecanismo de la cetoacidosis.',
        '¿Por qué su dolor abdominal despista?',
        'Explica el mecanismo del estado hiperosmolar.',
        'Compara los tres síndromes por instauración, respiración, estado mental y deshidratación.',
        '¿Qué no se hace en la ambulancia y por qué?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL NOMBRE DICE QUIÉN FALLÓ, NO QUIÉN COMPENSA. Una acidosis metabólica con respiración profunda no es un trastorno respiratorio: es metabólico con compensación respiratoria. Confundir el cambio primario con la respuesta es el error conceptual del tema.'),
          masPreguntado('Que la frecuencia respiratoria no diagnostica el trastorno: una respiración rápida puede ser una alcalosis respiratoria por ansiedad o la compensación de una acidosis metabólica grave. Son situaciones opuestas en gravedad y el patrón, por sí solo, no las separa.'),
        ],
      },
      erroresFrecuentes([
        ['Confundir el cambio primario con la compensación', 'El nombre del trastorno indica quién falló. Una respiración profunda en una acidosis metabólica es la respuesta, no el problema.'],
        ['Diagnosticar por la frecuencia respiratoria', 'El mismo patrón puede corresponder a situaciones opuestas en gravedad. Lo que orienta es el contexto.'],
        ['Leer la compensación agotada como mejoría', 'Si la respiración profunda disminuye sin que el paciente mejore, no ha mejorado el trastorno: se está agotando la compensación.'],
        ['Confundir compensación con corrección', 'La compensación atenúa la alteración del pH, pero no lo normaliza ni resuelve la causa.'],
      ]),
      repasoRapido([
        'El componente respiratorio depende del dióxido de carbono, que actúa como ácido y se elimina ventilando.',
        'El componente metabólico depende del bicarbonato, que actúa como base y se regula por vía renal.',
        'Acidosis respiratoria: retención de dióxido de carbono por ventilación insuficiente.',
        'Alcalosis respiratoria: eliminación excesiva por hiperventilación, por ansiedad, dolor, fiebre, hipoxia o tóxicos.',
        'Acidosis metabólica: acumulación de ácido o pérdida de bicarbonato; hipoperfusión con lactato, cetoacidosis, insuficiencia renal, diarrea.',
        'Alcalosis metabólica: pérdida de ácido o ganancia de bicarbonato; vómitos abundantes, pérdidas por sonda, algunos diuréticos.',
        'El nombre indica quién falló, no quién compensa.',
        'La compensación actúa en sentido contrario al trastorno.',
        'El pulmón compensa los trastornos metabólicos en minutos; el riñón, los respiratorios en horas o días.',
        'La compensación atenúa el pH pero no lo normaliza ni resuelve la causa.',
        'Compensación agotada es un signo de gravedad.',
        'La interpretación de una gasometría pertenece al ámbito hospitalario y a otro nivel de formación.',
      ]),
      preguntasOrales([
        'Diferencia el componente respiratorio del metabólico.',
        'Enumera los cuatro trastornos y el cambio primario de cada uno.',
        '¿Por qué el nombre indica quién falló y no quién compensa?',
        '¿Cómo funciona la compensación, y en qué tiempos?',
        'Distingue compensación de corrección.',
        '¿Qué significa una compensación agotada?',
        '¿Diagnostica el trastorno la frecuencia respiratoria? Justifícalo.',
        '¿Qué se puede razonar en la calle y qué no?',
      ]),
