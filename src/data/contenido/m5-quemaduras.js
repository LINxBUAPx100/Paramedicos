    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('BARRERA, LÍQUIDO, TEMPERATURA Y SENSIBILIDAD. Son las cuatro funciones de la piel que la quemadura destruye, y de ellas salen las cuatro consecuencias: infección, shock del quemado, hipotermia y una zona que deja de doler porque está más profunda.'),
          masPreguntado('Que el paciente quemado tiene un problema de HIPOTERMIA y no de exceso de calor, y que lo primero no es la piel: la primera pregunta es si la vía aérea está o va a estar comprometida. Una quemadura extensa impresiona; una vía aérea que se cierra mata antes.'),
        ],
      },
      erroresFrecuentes([
        ['Pensar que el quemado tiene exceso de calor', 'Ha perdido la capacidad de conservar temperatura en la zona lesionada, y el enfriamiento inicial y la humedad lo agravan. Cubrirlo y mantener el habitáculo caliente es tratamiento desde el primer minuto.'],
        ['Empezar por calcular la superficie', 'La primera pregunta es si la vía aérea está o va a estar comprometida: el edema tras exposición al humo o al calor progresa con los minutos.'],
        ['Leer la ausencia de dolor como buena señal', 'En las quemaduras profundas la zona deja de doler porque se destruyeron las terminaciones sensitivas: es un signo de gravedad, no de mejoría.'],
        ['Buscar la lesión por inhalación solo si hay quemadura facial', 'Puede existir sin quemadura visible en la cara, y es el factor que más cambia el pronóstico.'],
      ]),
      repasoRapido([
        'Una quemadura es la destrucción de tejido por transferencia de energía térmica, química, eléctrica o por radiación.',
        'La piel es barrera frente a la infección, retiene líquido, regula la temperatura y da sensibilidad.',
        'La superficie quemada es una puerta abierta a la infección.',
        'La pérdida de plasma hacia el tejido y hacia el exterior sostiene el shock del quemado.',
        'El paciente quemado se enfría con mucha rapidez, incluso en ambientes templados.',
        'En las quemaduras profundas la zona deja de doler: es signo de gravedad, no de mejoría.',
        'La gravedad depende de la extensión, la profundidad y la localización.',
        'Cara, cuello, manos, pies, genitales, periné y articulaciones tienen mayor repercusión funcional.',
        'Las circunferenciales pueden comprometer la circulación o la ventilación.',
        'También cuentan la edad y el estado previo, las lesiones asociadas y, sobre todo, la lesión por inhalación.',
        'La lesión por inhalación es lo que más cambia el pronóstico y puede existir sin quemadura visible en la cara.',
        'Lo primero no es la piel: es si la vía aérea está o va a estar comprometida.',
      ]),
      preguntasOrales([
        'Define quemadura y enumera los agentes que la producen.',
        '¿Qué cuatro funciones de la piel se pierden?',
        '¿Qué consecuencia sistémica corresponde a cada una?',
        '¿Por qué el quemado se enfría?',
        '¿Qué significa que una zona quemada no duela?',
        'Enumera los factores que determinan la gravedad.',
        '¿Qué localizaciones tienen mayor repercusión?',
        '¿Cuál es la primera pregunta ante un paciente quemado?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA ROPA SIGUE QUEMANDO. La empapada mantiene el líquido caliente contra la piel y la impregnada prolonga la llama: retirarla —cortándola y sin arrancar lo adherido— es la primera medida que detiene el daño.'),
          masPreguntado('Lo que hay que asegurar ANTES de tocar al paciente: en el químico, protección personal adecuada y saber qué producto es; en el eléctrico, que la fuente esté desconectada por quien tiene competencia; en el incendio en espacio cerrado, escena controlada y ventilada. Un rescatador lesionado añade un paciente y resta un recurso.'),
        ],
      },
      erroresFrecuentes([
        ['Dejar puesta la ropa empapada o impregnada', 'Mantiene el agente en contacto con la piel y prolonga la lesión. Se retira cortándola, sin arrancar lo que esté adherido.'],
        ['Irrigar antes de cepillar un producto en polvo', 'El producto en polvo se cepilla en seco primero; después se retira la ropa contaminada y se irriga de forma abundante y prolongada.'],
        ['Intentar neutralizar un producto químico', 'La reacción genera calor y añade daño. Y los álcalis penetran más y durante más tiempo que los ácidos: un aspecto poco llamativo no autoriza a irrigar menos.'],
        ['Tocar a un paciente electrocutado antes de desconectar la fuente', 'La seguridad del equipo es absoluta: no se toca hasta que la fuente esté desconectada por quien tiene competencia para hacerlo.'],
      ]),
      repasoRapido([
        'Llama: quemadura profunda, con ropa adherida y frecuente lesión por inhalación si hubo espacio cerrado.',
        'Escaldadura por líquido caliente: extensa, de profundidad irregular y muy frecuente en niños pequeños.',
        'Contacto con superficie caliente: bien delimitada, con la forma del objeto, y profunda si el contacto fue prolongado.',
        'Vapor: puede afectar la vía aérea con más facilidad que la llama, porque transporta mucho calor y penetra.',
        'Frío o congelación: zonas distales pálidas, duras e insensibles; se recalienta según protocolo y sin frotar.',
        'La ropa empapada o impregnada sigue quemando: retirarla es la primera medida que detiene el daño.',
        'Químicos: la lesión continúa mientras el producto siga en contacto; se cepilla en seco el polvo, se retira la ropa y se irriga.',
        'Los álcalis penetran más y durante más tiempo que los ácidos, y no se intenta neutralizar.',
        'Eléctricos: lo visible engaña, porque el trayecto de la corriente daña músculo, vasos y nervios en profundidad.',
        'Añaden riesgo de arritmia, de lesión por aplastamiento del músculo dañado y de traumatismo por la caída.',
        'Por radiación: la quemadura solar es la más frecuente y banal; las fuentes ionizantes exigen respuesta especializada.',
        'Antes de tocar al paciente: protección y producto identificado, fuente desconectada, o escena controlada y ventilada.',
      ]),
      preguntasOrales([
        'Diferencia los agentes térmicos y la lesión característica de cada uno.',
        '¿Por qué el vapor afecta la vía aérea con más facilidad?',
        '¿Por qué la ropa sigue quemando?',
        'Recorre cómo se detiene una quemadura química.',
        '¿Por qué no se neutraliza el producto?',
        '¿Qué diferencia hay entre álcalis y ácidos?',
        '¿Por qué engaña lo visible en la quemadura eléctrica?',
        'Di lo que hay que asegurar antes de tocar al paciente en cada agente.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA QUE NO DUELE ES LA PEOR. La ausencia de dolor significa que se destruyeron las terminaciones sensitivas, es decir, espesor total. Y como esas zonas suelen estar rodeadas de áreas menos profundas, el paciente refiere dolor intenso aunque tenga zonas insensibles.'),
          masPreguntado('Que la profundidad evoluciona: puede profundizar en las horas siguientes si el enfriamiento fue insuficiente, si el paciente está mal perfundido o si hay infección. La clasificación de la escena es una estimación que se documenta, no un diagnóstico definitivo.'),
        ],
      },
      erroresFrecuentes([
        ['Leer la ausencia de dolor como lesión leve', 'Significa destrucción de las terminaciones sensitivas: espesor total.'],
        ['Dar la profundidad por definitiva', 'Puede profundizar en las horas siguientes. La clasificación de la escena es una estimación y así se declara.'],
        ['Sumar la quemadura superficial a la extensión', 'La de primer grado no se incluye en el cálculo del porcentaje: incluirla infla la cifra y puede llevar a decisiones equivocadas. Se documenta, pero no se suma.'],
        ['Documentar solo el grado', 'Se documenta localización precisa, aspecto, ampollas, respuesta al dolor, áreas circunferenciales, la hora del accidente y la de la valoración, y las medidas aplicadas.'],
      ]),
      repasoRapido([
        'Primer grado o superficial: solo la epidermis.',
        'Segundo grado superficial o espesor parcial superficial: epidermis y parte superficial de la dermis.',
        'Segundo grado profundo o espesor parcial profundo: epidermis y parte profunda de la dermis.',
        'Tercer grado o espesor total: toda la dermis y el tejido subcutáneo.',
        'Superficial: enrojecida y seca, dolorosa, sin ampollas; enrojece y palidece al presionar.',
        'Espesor parcial superficial: roja o rosada, húmeda y brillante, muy dolorosa, con ampollas y llenado capilar presente.',
        'Espesor parcial profundo: rosada pálida o blanquecina, dolor menor o alterado, ampollas rotas y llenado lento o ausente.',
        'Espesor total: blanca nacarada, cérea, marrón o carbonizada; seca, rígida, indolora y sin llenado capilar.',
        'La quemadura que no duele es la más profunda, y suele estar rodeada de áreas que sí duelen mucho.',
        'La profundidad no es fija: puede profundizar en las horas siguientes.',
        'La clasificación de la escena es una estimación inicial que se documenta y que el centro receptor reevaluará.',
        'La quemadura superficial no se suma al porcentaje de superficie corporal quemada.',
      ]),
      preguntasOrales([
        'Correlaciona las dos terminologías de profundidad.',
        'Describe el aspecto, el dolor y el llenado capilar de cada grado.',
        '¿Por qué la quemadura que no duele es la peor?',
        '¿Por qué el paciente refiere dolor intenso aunque tenga zonas insensibles?',
        '¿Por qué la profundidad no se determina en la escena?',
        '¿Qué favorece la profundización?',
        '¿Se suma la quemadura superficial a la extensión? Justifícalo.',
        'Enumera lo que se documenta.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA PALMA DEL PACIENTE ES SU PROPIA ESCALA. Para quemaduras pequeñas, dispersas o irregulares se cuenta cuántas palmas ocupa la lesión, y en el niño esa escala se ajusta sola porque la mano crece con él.'),
          masPreguntado('Que en el niño la regla del adulto no sirve, porque la cabeza representa una proporción mucho mayor y los miembros inferiores una menor; y que el resultado se comunica siempre como ESTIMACIÓN, acompañado de la descripción de las zonas, aceptando que el centro receptor lo corrija con un instrumento más preciso.'),
        ],
      },
      erroresFrecuentes([
        ['Sumar las zonas de enrojecimiento superficial', 'En el cálculo se incluyen solo las de espesor parcial y total: son las que producen la pérdida de líquido que la estimación pretende cuantificar.'],
        ['Aplicar la regla del adulto a un niño pequeño', 'En el niño la cabeza pesa mucho más en la superficie corporal y los miembros inferiores menos. Los porcentajes por edad los define la tabla que adopte el servicio.'],
        ['Calcular sobre el paciente vestido', 'Sin exponer toda la superficie se olvidan la espalda, los glúteos y las zonas de pliegue.'],
        ['Redondear al alza «por seguridad»', 'No es una medida segura, es una fuente de error: sobrestimar lleva a administrar líquido de más y a sus complicaciones.'],
      ]),
      repasoRapido([
        'La regla de los nueve divide la superficie corporal en zonas cuyo valor es múltiplo de nueve.',
        'En el adulto: cabeza y cuello 9 %, cada miembro superior 9 %.',
        'Cara anterior del tronco 18 % y cara posterior 18 %.',
        'Cada miembro inferior 18 %, y periné y genitales 1 %.',
        'Cuando una región está quemada solo en parte, se estima la fracción y se aplica esa proporción.',
        'Solo se suman las quemaduras de espesor parcial y total; las superficiales no.',
        'En el niño la cabeza representa una proporción mucho mayor y los miembros inferiores menor.',
        'Esas proporciones se aproximan a las del adulto con el crecimiento.',
        'El diagrama de Lund y Browder es el instrumento más preciso, y el que usan los centros de quemados.',
        'La regla de la palma: la palma del propio paciente, con los dedos, equivale aproximadamente al 1 % de su superficie.',
        'Es especialmente útil en el niño, porque la mano escala con su tamaño.',
        'El porcentaje se comunica como estimación, con la descripción de las zonas, y el centro receptor puede corregirlo.',
      ]),
      preguntasOrales([
        'Recita la regla de los nueve en el adulto.',
        '¿Qué se hace cuando una región está quemada solo en parte?',
        '¿Qué quemaduras se suman y cuáles no?',
        '¿Por qué la regla del adulto no sirve en el niño?',
        '¿Qué instrumento es más preciso, y quién lo usa?',
        'Explica la regla de la palma y por qué es útil en el niño.',
        '¿Cómo se comunica el resultado?',
        'Enumera los errores frecuentes de este cálculo.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LAS OCHO HORAS CUENTAN DESDE LA QUEMADURA, NO DESDE TU LLEGADA. Si han pasado dos horas hasta el contacto, el tiempo disponible para la primera mitad ya se ha reducido. Por eso la hora de la quemadura es el dato que no se puede perder.'),
          masPreguntado('El contraste entre la fórmula clásica y la recomendación de la American Burn Association de 2024, y el significado de titular: la cifra calculada marca por dónde empezar, y el ritmo sube o baja según el estado mental, la perfusión periférica, la frecuencia, la presión y, en el hospital, la diuresis horaria.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar la cifra calculada como una dosis fija', 'Es un punto de partida que se titula según la respuesta del paciente. Ninguna fórmula sustituye a la reevaluación.'],
        ['Contar las horas desde la llegada del equipo', 'Se cuentan desde el momento de la quemadura. Perder ese dato desplaza todo el cálculo.'],
        ['Enseñar la fórmula clásica como la pauta vigente', 'Se conserva como antecedente y referencia de cálculo. La guía de 2024 recomienda iniciar en la mitad de ese valor por kilogramo y porcentaje, y ajustar según respuesta.'],
        ['Fijar solución y ritmo por cuenta propia', 'Qué solución se usa, a qué ritmo y con qué material lo determinan el protocolo y la dirección médica. Y en el paciente pediátrico los criterios son distintos.'],
      ]),
      repasoRapido([
      ...
      preguntasOrales([
        'Explica de qué depende el volumen en la fórmula clásica.',
        '¿Desde cuándo se cuentan las horas, y por qué importa?',
        '¿Qué recomienda la guía de 2024 y por qué cambió?',
        '¿Qué papel conserva entonces la fórmula clásica?',
        'Explica qué significa titular.',
        '¿Qué parámetros se usan para titular?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DETENER, VÍA AÉREA, CIRCULACIÓN, ABRIGAR. Cuatro bloques en ese orden. Y el cuarto no es un detalle estético: un quemado frío coagula peor, tolera peor la reposición y evoluciona peor.'),
          masPreguntado('Los signos de sospecha de lesión por inhalación y que la vía aérea del quemado se cierra progresivamente: un paciente que habla con normalidad al llegar el equipo puede tener una vía aérea muy comprometida más tarde. De ahí que la sospecha se comunique temprano.'),
        ],
      },
      erroresFrecuentes([
        ['Enfriar de más', 'Enfriar de más produce hipotermia. Se enfría con agua a temperatura ambiente el tiempo que indique el protocolo y después se detiene.'],
        ['Aplicar hielo o agua helada sobre la quemadura', 'Añade lesión por frío y agrava la hipotermia.'],
        ['Aplicar cremas, pomadas o remedios caseros', 'Retienen calor, favorecen la infección y dificultan la valoración de la profundidad en el hospital. Tampoco se rompen las ampollas ni se arranca la ropa adherida.'],
        ['Atribuir a la quemadura un shock inmediato', 'El shock inmediato tras una quemadura puede deberse a una hemorragia asociada: se busca antes de atribuirlo a la piel.'],
      ]),
      repasoRapido([
        'Primero seguridad de la escena y del equipo, antes de cualquier contacto.',
        'Detener el proceso: apagar, separar de la fuente, retirar ropa caliente o empapada y joyas, y cepillar en seco el polvo químico.',
        'Enfriar el tiempo que indique el protocolo y detenerlo después; nunca hielo ni agua helada.',
        'Valorar la vía aérea antes de entretenerse con la piel, y oxígeno conforme al protocolo.',
        'Sospechan inhalación: incendio en espacio cerrado, quemadura en cara y cuello, cejas o vibrisas chamuscadas.',
        'También hollín en boca, nariz o esputo, ronquera o estridor, dificultad para tragar o babeo.',
        'Y alteración del estado mental sin traumatismo craneal que la explique.',
        'El edema no aparece de golpe: crece durante minutos y horas, así que la sospecha se comunica temprano.',
        'Circulación: accesos según alcance, reposición según protocolo titulando, y vigilancia de la perfusión distal en las circunferenciales.',
        'El shock inmediato puede ser hemorrágico: se busca antes de atribuirlo a la quemadura.',
        'Temperatura: secar, cubrir con material limpio y seco, abrigar por encima y calentar el habitáculo.',
        'Dolor y cobertura: analgesia según alcance, apósitos sin apretar, sin cremas, sin romper ampollas y sin arrancar ropa adherida.',
      ]),
      preguntasOrales([
        'Ordena el tratamiento del quemado en sus cuatro bloques.',
        'Recorre las medidas de los primeros minutos.',
        '¿Por qué se detiene el enfriamiento?',
        'Enumera los signos de sospecha de lesión por inhalación.',
        '¿Por qué la vía aérea del quemado se cierra progresivamente?',
        '¿Qué vigilas en una quemadura circunferencial de un miembro?',
        '¿Qué haces ante un shock inmediato tras una quemadura?',
        '¿Qué función tiene la sonda vesical, y a qué ámbito pertenece?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CUANTO MENOS SE PONGA, MEJOR. El objetivo prehospitalario no es curar la quemadura —eso es de la valoración especializada— sino protegerla, evitar que empeore y entregarla en condiciones que permitan valorarla bien.'),
          masPreguntado('Que el apósito no se aprieta: el edema aumenta en las horas siguientes y un vendaje cómodo al colocarlo puede comprimir después, sobre todo si la quemadura rodea el segmento. Se cubre sin tensión, se comprueba la circulación distal y se reevalúa.'),
        ],
      },
      erroresFrecuentes([
        ['Apretar el apósito', 'El edema aumenta en las horas siguientes. Se cubre sin tensión, se comprueba la circulación distal después y se reevalúa durante el traslado.'],
        ['Aplicar cremas, aceites o remedios caseros', 'Retienen calor, favorecen la infección y dificultan la valoración de la profundidad en el hospital.'],
        ['Usar algodón o antisépticos coloreados', 'El algodón deja fibras adheridas a la superficie y los antisépticos coloreados enmascaran el aspecto de la lesión.'],
        ['No retirar anillos ni reloj', 'Se retiran de esa extremidad antes de que el edema lo impida.'],
      ]),
      repasoRapido([
        'Retirar anillos, pulseras y reloj de la extremidad antes de que el edema lo impida.',
        'Enfriar con agua a temperatura ambiente el tiempo que indique el protocolo, y después detener el enfriamiento.',
        'Limpiar con suavidad con solución salina o agua limpia, sin frotar ni arrastrar tejido adherido.',
        'Secar la piel sana de alrededor.',
        'No romper las ampollas intactas; si están rotas, retirar solo el tejido que se desprenda sin resistencia y si el protocolo lo contempla.',
        'Cubrir con apósito limpio y seco o con material estéril no adherente, sin apretar.',
        'Separar los dedos quemados con material limpio para que no queden en contacto.',
        'Comprobar pulso, sensibilidad y movilidad distales después de cubrir, y anotarlo.',
        'Elevar la extremidad si no hay contraindicación, y abrigar al paciente por encima del apósito.',
        'No se ponen cremas, pomadas, aceites ni remedios caseros; ni hielo directo, ni algodón, ni antisépticos coloreados.',
        'Requieren valoración especializada las circunferenciales, las de articulación, mano, pie o pliegue, las de espesor total y las de profundidad indeterminable.',
        'También las eléctricas y químicas, las de pacientes en los extremos de edad o con enfermedades, y aquellas cuyo mecanismo no encaja con la lesión.',
      ]),
      preguntasOrales([
        'Recorre la curación de una quemadura de extremidad.',
        '¿Por qué se retiran anillos y reloj al principio?',
        '¿Qué se hace con las ampollas?',
        '¿Por qué el apósito no se aprieta?',
        'Enumera lo que no se pone sobre una quemadura y el motivo de cada cosa.',
        'Di la regla que resume el tema.',
        '¿Cuándo una quemadura de extremidad requiere valoración especializada?',
        '¿Qué se explica al paciente que no se traslada?',
      ]),
