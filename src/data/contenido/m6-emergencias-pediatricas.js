    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('¿ARRIBA O ABAJO, Y CUÁNTO TRABAJA? Dos preguntas y no una etiqueta. Estridor y voz apagada llevan arriba; sibilancias y crepitantes, abajo. Y el trabajo respiratorio dice cuánto le queda al niño.'),
          masPreguntado('El niño que babea y no quiere tumbarse: con fiebre, dificultad para tragar, voz apagada y una postura concreta para respirar tiene una obstrucción alta que puede empeorar de forma brusca. Ahí no se le explora la boca ni se le fuerza la posición.'),
        ],
      },
      erroresFrecuentes([
        ['Explorar la boca en una obstrucción alta', 'No se explora ni se introduce nada: la agitación y la manipulación pueden empeorar la obstrucción.'],
        ['Hacer llorar al niño', 'Mientras la obstrucción sea alta, se evita todo lo que le haga llorar.'],
        ['Leer el silencio auscultatorio como mejoría', 'En un niño que antes tenía sibilancias significa que apenas entra aire: es uno de los signos que anuncian el paro.'],
        ['Olvidar la nariz del lactante', 'Respira preferentemente por la nariz: una obstrucción nasal por secreciones puede dificultarle de forma significativa la respiración.'],
      ]),
      repasoRapido([
        'Las infecciones respiratorias son el motivo más frecuente de consulta urgente en la infancia.',
        'Vía aérea superior: estridor sobre todo inspiratorio, voz apagada, tos perruna o metálica, y postura para abrir la vía aérea.',
        'Vía aérea inferior: sibilancias espiratorias o crepitantes, tos habitualmente húmeda, prefiere estar incorporado.',
        'En la alta la prioridad es no irritar ni forzar; en la baja, oxigenación, posición y vigilancia del agotamiento.',
        'El niño que babea y no quiere tumbarse tiene una obstrucción alta que puede empeorar de golpe.',
        'Trabajo respiratorio de menor a mayor: aumento de frecuencia, aleteo nasal y músculos accesorios, retracciones.',
        'También quejido espiratorio, balanceo de la cabeza en el lactante e incapacidad de completar frases o de alimentarse.',
        'Anuncian el paro el descenso del esfuerzo, la somnolencia o agitación creciente, la palidez o cianosis, la bradicardia y el silencio auscultatorio.',
        'Conducta: permitir la posición que el niño elija y mantenerlo con su cuidador.',
        'Oxígeno conforme al protocolo, con el método que mejor tolere, y sin explorar la boca si se sospecha obstrucción alta.',
        'Vigilancia continua del trabajo respiratorio y del estado de conciencia.',
        'El lactante respira preferentemente por la nariz: una obstrucción nasal le dificulta la respiración y la alimentación.',
      ]),
      preguntasOrales([
        'Distingue la afectación de vía aérea superior de la inferior por sus signos.',
        '¿Qué prioridad tiene cada una?',
        '¿Qué significa un niño que babea y no quiere tumbarse?',
        'Ordena los signos de trabajo respiratorio de menor a mayor.',
        'Di los signos que anuncian el paro.',
        'Recorre la conducta general.',
        '¿Por qué se evita hacer llorar al niño?',
        '¿Qué particularidad tiene la nariz del lactante?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DOS PACIENTES SIMULTÁNEOS. Anticipar la atención del recién nacido no significa desatender a la mujer: por eso pedir pronto un segundo recurso es una decisión clínica y no una comodidad.'),
          masPreguntado('Que la ubicación de este tema está pendiente de revisión: el plan lo sitúa en pediatría cuando su contenido es obstétrico y ya se desarrolla en el Módulo 4. Aquí solo se aborda lo que compete al equipo desde la perspectiva del recién nacido.'),
        ],
      },
      erroresFrecuentes([
        ['Buscar aquí el desarrollo clínico completo', 'Su lugar canónico es el tema del Módulo 4; esta lección aborda lo que compete al recién nacido que se va a atender.'],
        ['Desatender a la madre por preparar al recién nacido', 'Son dos pacientes simultáneos: por eso se solicita pronto un segundo recurso.'],
        ['No preparar el material antes del nacimiento', 'Puede hacer falta asistencia en la transición: el material de vía aérea y de ventilación neonatal se tiene listo y comprobado.'],
        ['Prealertar sin avisar de la posibilidad de un recién nacido comprometido', 'El centro necesita preparar recursos, y eso solo ocurre si se le avisa.'],
      ]),
      repasoRapido([
        'El plan sitúa el tema en pediatría, pero su contenido es obstétrico y su lugar canónico es el Módulo 4.',
        'La academia debe decidir la ubicación: queda registrado como pendiente.',
        'El compromiso del bienestar fetal significa que el feto no está recibiendo el oxígeno que necesita.',
        'Para el equipo cambia lo que hay que anticipar y preparar.',
        'Material de vía aérea y de ventilación neonatal listo y comprobado.',
        'Control térmico especialmente importante: paños secos, superficie caliente y ambiente sin corrientes.',
        'Puede requerirse un segundo operador: uno atiende a la madre y otro al recién nacido.',
        'La prealerta debe avisar de la posibilidad de un recién nacido comprometido.',
        'El reloj importa: se anota la hora del nacimiento y la evolución minuto a minuto.',
        'Se recoge y transmite semanas de gestación, seguimiento del embarazo y pérdida de líquido con su aspecto.',
        'También la disminución de movimientos fetales, los antecedentes y la medicación materna.',
        'Y qué se ha hecho hasta ese momento y a qué hora.',
      ]),
      preguntasOrales([
        '¿Por qué la ubicación de este tema está pendiente de revisión?',
        '¿Dónde está su desarrollo canónico?',
        '¿Qué significa el compromiso del bienestar fetal para el recién nacido?',
        'Enumera lo que hay que anticipar y preparar.',
        '¿Por qué puede hacer falta un segundo operador?',
        '¿Qué debe avisar la prealerta?',
        '¿Qué información se recoge y se transmite?',
        '¿Por qué la atención a la madre no se interrumpe?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL RECHAZO DEL ALIMENTO ES UN SIGNO RESPIRATORIO. En el recién nacido, no poder mantener la succión describe un problema para respirar, no un problema de apetito.'),
          masPreguntado('Que en el recién nacido casi todo se parece a casi todo: una infección grave, una cardiopatía, una hipoglucemia y un problema pulmonar pueden presentarse igual. Por eso la conducta no es identificar la causa, sino sostener y trasladar.'),
        ],
      },
      erroresFrecuentes([
        ['Quedarse con la primera explicación', 'Una infección grave, una cardiopatía, una hipoglucemia y un problema pulmonar pueden presentarse igual.'],
        ['No medir la glucemia', 'La hipoglucemia se manifiesta de forma inespecífica y es tratable.'],
        ['Manipular más de lo necesario', 'Cada manipulación consume energía y empeora al paciente.'],
        ['Tratar el control térmico como un cuidado añadido', 'La hipotermia aumenta el consumo de oxígeno, favorece la hipoglucemia y agrava la dificultad respiratoria: forma parte del tratamiento.'],
      ]),
      repasoRapido([
        'Signos: aumento mantenido de la frecuencia respiratoria, quejido espiratorio audible y aleteo nasal.',
        'También retracciones intercostales, subcostales y del esternón, y cianosis difícil de valorar según la luz.',
        'También pausas respiratorias o respiración irregular.',
        'El rechazo del alimento o la incapacidad de mantener la succión es un signo respiratorio en el recién nacido.',
        'También la hipotonía y la escasa reactividad.',
        'Grupos de causas: transición pulmonar, pulmonar, infeccioso general, cardiaco, metabólico y obstructivo o malformativo.',
        'En el recién nacido casi todo se parece a casi todo.',
        'Conducta de soporte, igual sea cual sea la causa: vía aérea en posición neutra, sin flexionar ni hiperextender.',
        'Oxígeno y apoyo ventilatorio conforme al alcance, comprobando que el tórax se mueve.',
        'Control térmico agresivo: secar, cubrir incluida la cabeza y calentar el habitáculo.',
        'Medir la glucemia si está dentro del alcance, y manipulación mínima.',
        'Traslado a centro con capacidad neonatal, con la hora de nacimiento y de inicio de los síntomas.',
      ]),
      preguntasOrales([
        'Enumera los signos de dificultad respiratoria en el recién nacido.',
        '¿Por qué el rechazo del alimento es un signo respiratorio?',
        'Nombra los grupos de causas posibles.',
        '¿Por qué la conducta no es identificar la causa?',
        'Recorre la conducta de soporte.',
        '¿Por qué la manipulación es mínima?',
        '¿Por qué el frío empeora todo?',
        '¿Qué información del parto se recoge?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('¿RESPIRA O LLORA? ¿BUEN TONO? ¿FRECUENCIA ADECUADA? Tres preguntas en los primeros segundos: si las tres son afirmativas, el recién nacido es vigoroso y solo necesita cuidados de rutina.'),
          masPreguntado('Que estimular no es zarandear: la estimulación es suave —secarlo, frotarle la espalda o las plantas—. No se le sacude, no se le sostiene boca abajo, no se le golpea y no se le sumerge en agua.'),
        ],
      },
      erroresFrecuentes([
        ['Zarandear o golpear al recién nacido', 'La estimulación es suave: secar y frotar la espalda o las plantas. Sacudirlo, sostenerlo boca abajo, golpearlo o sumergirlo no son estimulación.'],
        ['Aspirar de forma sistemática', 'Se despeja la vía aérea solo si hay obstrucción evidente.'],
        ['Buscar otras causas antes de revisar la ventilación', 'Si no mejora, se revisa sellado, posición y permeabilidad antes que cualquier otra cosa.'],
        ['Usar «asfixia» como etiqueta', 'Es un término con definición precisa basada en datos que no están disponibles en la escena: se describe lo observado.'],
      ]),
      repasoRapido([
        'La decisión de los primeros segundos se apoya en tres preguntas: respira o llora, tono y frecuencia cardiaca.',
        'Si las tres son afirmativas, el recién nacido es vigoroso y solo necesita cuidados de rutina.',
        'Cuidados del vigoroso: secarlo con energía moderada y retirar de inmediato los paños húmedos.',
        'Colocarlo piel con piel sobre su madre si la situación lo permite, y cubrir a los dos incluida su cabeza.',
        'Mantener la vía aérea libre sin aspiración sistemática y vigilar respiración, tono y color durante el traslado.',
        'El contacto piel con piel es una intervención: mantiene la temperatura mejor que casi cualquier alternativa disponible.',
        'Cuando no está vigoroso: calor, posición neutra, despejar solo si hay obstrucción evidente y estimular con suavidad.',
        'Reevaluar respiración y frecuencia cardiaca.',
        'Si no respira o la frecuencia es insuficiente, ventilación con presión positiva según guía y protocolo.',
        'Comprobar que el tórax se mueve; si no mejora, revisar sellado, posición y permeabilidad.',
        'Estimular no es zarandear.',
        'Además: vigilar la hipoglucemia, manipulación mínima, traslado a centro neonatal y atender también a la madre.',
      ]),
      preguntasOrales([
        'Di las tres preguntas de los primeros segundos.',
        '¿Qué implica que el recién nacido sea vigoroso?',
        'Recorre los cuidados del recién nacido vigoroso.',
        '¿Por qué el contacto piel con piel es una intervención?',
        'Recorre la secuencia cuando no está vigoroso.',
        '¿Qué es y qué no es estimular?',
        'Si no mejora tras iniciar la ventilación, ¿qué se revisa primero?',
        '¿Qué se dice sobre el término «asfixia»?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SE GRADÚA POR FUNCIÓN, NO POR RUIDO. Si habla en frases o en palabras sueltas, si juega o no puede caminar, si está alerta o somnoliento. Las sibilancias son el dato menos fiable de todos.'),
          masPreguntado('Las tres señales que más se malinterpretan: el silencio auscultatorio no es mejoría, la agitación suele ser hipoxia y no mal comportamiento, y el descenso del esfuerzo respiratorio es agotamiento.'),
        ],
      },
      erroresFrecuentes([
        ['Graduar la crisis por la intensidad de las sibilancias', 'Se gradúa por función: habla, actividad, esfuerzo y estado mental.'],
        ['Leer la agitación como miedo o mal comportamiento', 'En un niño con crisis suele ser hipoxia.'],
        ['Asumir que todo lo que silba es asma', 'En el lactante las sibilancias pueden deberse a bronquiolitis, a un cuerpo extraño o a otras causas, y el manejo no es el mismo.'],
        ['Esperar a que el cuadro se complete para trasladar', 'Ante cualquier signo de gravedad se traslada con prealerta, sin esperar.'],
      ]),
      repasoRapido([
        'Crisis leve o moderada: frases completas o entrecortadas, se mueve con dificultad, retracciones leves, alerta.',
        'Crisis grave: palabras sueltas o no puede hablar, no juega ni come ni camina, retracciones marcadas.',
        'También estado mental agitado, confuso o somnoliento, y sibilancias o silencio auscultatorio.',
        'El silencio auscultatorio no es mejoría: significa que apenas entra aire.',
        'La agitación suele ser hipoxia, no mal comportamiento ni miedo.',
        'El descenso del esfuerzo respiratorio es agotamiento.',
        'Conducta: permitir la posición en que respira mejor, habitualmente sentado, y mantenerlo con su cuidador.',
        'Evitar todo lo que aumente su ansiedad o su consumo de oxígeno.',
        'Oxígeno conforme al protocolo, con el método que mejor tolere.',
        'Preguntar por crisis previas, ingresos, uso de medicación en las últimas horas y atención urgente anterior.',
        'El antecedente de crisis graves es un factor de riesgo.',
        'No todo lo que silba es asma, sobre todo en el lactante.',
      ]),
      preguntasOrales([
        'Gradúa la crisis asmática pediátrica por criterios funcionales.',
        '¿Por qué no se gradúa por el ruido?',
        'Di las tres señales que más se malinterpretan.',
        '¿Qué significa el silencio auscultatorio?',
        '¿Y la agitación?',
        'Recorre la conducta de soporte.',
        '¿Qué antecedente es un factor de riesgo?',
        '¿Es asma todo lo que silba en un lactante?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CUÁNTOS PAÑALES MOJADOS, Y DESDE CUÁNDO. Es la pregunta que mejor estima la pérdida: más informativa que cualquier estimación visual, la responde el cuidador con precisión y permite comparar con lo habitual.'),
          masPreguntado('Cuándo deja de ser deshidratación y es shock: taquicardia mantenida, pulso periférico débil, piel fría y moteada, relleno capilar lento y alteración del estado mental. La presión arterial puede seguir conservada.'),
        ],
      },
      erroresFrecuentes([
        ['Insistir por vía oral en un niño que vomita o rechaza el líquido', 'Ahí no se insiste: se traslada.'],
        ['Esperar la hipotensión para reconocer el shock', 'Puede seguir conservada. Lo que lo define es la taquicardia mantenida, el pulso débil, la piel fría y moteada y la alteración del estado mental.'],
        ['Estimar la pérdida a ojo', 'La pregunta por los pañales mojados o las micciones y desde cuándo es mucho más informativa.'],
        ['No medir la glucemia', 'La hipoglucemia acompaña con frecuencia a estos cuadros.'],
      ]),
      repasoRapido([
        'El niño llega antes a la deshidratación: mayor proporción de agua corporal y recambio más rápido.',
        'Su superficie corporal relativa es grande: pierde más por la piel y por la respiración.',
        'No puede procurarse líquido por sí mismo.',
        'Las causas habituales —vómito, diarrea, fiebre, rechazo del alimento— son frecuentes y se combinan.',
        'Leve: alerta y activo, bebe con normalidad, mucosas húmedas, diuresis conservada.',
        'Moderada: irritable o decaído, sediento, mucosas secas, ojos algo hundidos, pliegue que tarda, diuresis disminuida.',
        'Grave: somnoliento o no reactivo, bebe mal o no puede, mucosas muy secas, llanto sin lágrimas.',
        'También ojos hundidos y fontanela deprimida en el lactante, piel fría y moteada, y diuresis muy escasa o ausente.',
        'Es shock cuando aparecen taquicardia mantenida, pulso débil, piel fría y moteada, relleno lento y alteración mental.',
        'En el déficit leve o moderado con tolerancia oral, rehidratación oral en pequeñas cantidades y frecuente.',
        'Con vómito persistente, rechazo del líquido o deterioro, no se insiste por vía oral y se traslada.',
        'Se registran los vómitos, las deposiciones, los pañales y el peso si el cuidador lo conoce.',
      ]),
      preguntasOrales([
        '¿Por qué el niño se deshidrata antes?',
        '¿Cuál es la pregunta que mejor estima la pérdida?',
        'Estima la gravedad con signos clínicos.',
        '¿Qué signos aparecen en el lactante que no en el niño mayor?',
        '¿Cuándo deja de ser deshidratación y es shock?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MIRA CÓMO CAMINA Y CÓMO SE SUBE A LA CAMILLA. Un niño que anda encorvado, arrastra los pies o evita saltar está mostrando irritación peritoneal sin que nadie le toque el abdomen.'),
          masPreguntado('Que la perforación llega antes en el niño pequeño y su capacidad de contener la infección es menor: el retraso pesa más que en el adulto, y un dolor abdominal que persiste o empeora se traslada.'),
        ],
      },
      erroresFrecuentes([
        ['Atribuir el cuadro a una gastroenteritis', 'El vómito, la diarrea y la fiebre hacen que se confunda con ella, que es mucho más frecuente. Y el niño puede parecer mejor un rato y empeorar después.'],
        ['Esperar la secuencia clásica', 'Puede no cumplirse, y cuanto más pequeño es el niño menos localiza y menos describe el dolor.'],
        ['Aplicar calor local, laxantes o remedios domésticos', 'No se administran. Y nada por vía oral, porque el paciente puede requerir cirugía.'],
        ['Repetir una palpación agresiva', 'La palpación es suave y empieza por la zona más alejada del dolor.'],
      ]),
      repasoRapido([
        'La apendicitis del niño se presenta de forma menos característica cuanto más pequeño es el paciente.',
        'Y su apéndice se perfora antes.',
        'Dificultan el reconocimiento la escasa localización del dolor y el incumplimiento de la secuencia clásica.',
        'También la confusión con una gastroenteritis y que el niño pueda parecer mejor un rato.',
        'También la dificultad de explorar a un niño asustado o que no colabora.',
        'Observaciones útiles: cómo camina y cómo se sube a la camilla.',
        'Si prefiere estar quieto y con las piernas flexionadas.',
        'Si el dolor le despierta por la noche o le impide jugar: dos preguntas muy discriminativas.',
        'Cuándo empezó exactamente, cómo ha cambiado y si hubo vómito antes o después del dolor.',
        'Conducta: nada por vía oral, posición cómoda y palpación suave desde la zona más alejada.',
        'Analgesia conforme al alcance: controlar el dolor no impide la valoración quirúrgica posterior.',
        'Se registra la última ingesta, dato relevante si se plantea cirugía.',
      ]),
      preguntasOrales([
        '¿Por qué se reconoce tarde la apendicitis del niño?',
        '¿Por qué la perforación llega antes?',
        'Enumera las observaciones útiles.',
        '¿Cuáles son las dos preguntas más discriminativas?',
        '¿Por qué importa el orden del vómito y el dolor?',
        'Recorre la conducta prehospitalaria.',
        '¿Qué no se administra?',
        '¿Qué aporta el equipo, si no es un diagnóstico?',
      ]),
      F([WHO_BEC, AHA_PALS_2025, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('VÓMITO BILIOSO EN UN RECIÉN NACIDO. Es uno de los pocos signos de la unidad que por sí solo obliga a actuar: hace pensar en una obstrucción que puede comprometer la irrigación.'),
          masPreguntado('Los dos cuadros que no esperan: el lactante con episodios repetidos de dolor que queda decaído o pálido entre ellos, y el niño con dolor abdominal e inguinal o escrotal por una hernia que deja de reducirse. Ambos comprometen el aporte de sangre al intestino.'),
        ],
      },
      erroresFrecuentes([
        ['Tranquilizarse porque el niño está bien entre episodios', 'En los dos cuadros que no esperan, el niño puede parecer bien entre crisis o en el momento de la valoración: esa normalidad aparente es la trampa.'],
        ['Intentar reducir una hernia', 'No se intenta reducir ni se manipula con fuerza el abdomen.'],
        ['Restar valor a un vómito bilioso en un recién nacido', 'Es uno de los pocos signos que por sí solo obliga a actuar.'],
        ['No vigilar signos de shock', 'El intestino obstruido secuestra líquido y el niño puede deteriorarse.'],
      ]),
      repasoRapido([
        'La oclusión del niño tiene causas propias de la edad que no existen en el adulto.',
        'Patrón general: dolor abdominal, que en el niño pequeño es llanto inconsolable o irritabilidad.',
        'Vómito, cuyo aspecto importa: el contenido bilioso es un signo de alarma.',
        'Distensión abdominal, más evidente cuanto más distal sea la obstrucción.',
        'Ausencia de deposición y de gases, o cambio brusco del patrón habitual.',
        'Vómito bilioso en un recién nacido obliga a actuar por sí solo.',
        'Primer cuadro que no espera: lactante con episodios repetidos de dolor intenso, con las piernas encogidas.',
        'Después queda decaído o pálido, y luego vuelve a la normalidad, repitiéndose.',
        'Segundo cuadro: niño con dolor abdominal e inguinal o escrotal por una hernia que deja de reducirse.',
        'Ambos comprometen el aporte de sangre al intestino: el resultado depende del tiempo.',
        'Conducta: nada por vía oral, no reducir la hernia, posición cómoda y palpación suave y única.',
        'Vigilar signos de shock, prevenir la hipotermia, medir la glucemia y trasladar describiendo el patrón.',
      ]),
      preguntasOrales([
        'Di los cuatro elementos del patrón general.',
        '¿Por qué importa el aspecto del vómito?',
        '¿Qué significa un vómito bilioso en un recién nacido?',
        'Describe el primer cuadro que no espera.',
        'Describe el segundo.',
        '¿Qué tienen en común?',
        '¿Por qué la normalidad entre episodios es una trampa?',
        'Recorre la conducta prehospitalaria.',
      ]),
      F([WHO_BEC, AHA_PALS_2025, PROTOCOLO_LOCAL]),
    ],
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA CIFRA NO ES EL PROBLEMA. Hay infecciones graves con poca fiebre y procesos banales con fiebre alta: lo que orienta es cómo está el niño, y especialmente cómo está cuando la fiebre baja.'),
          masPreguntado('Las manchas que no palidecen al presionar: si al presionar con un cristal transparente o con el dedo no palidecen, el hallazgo obliga a considerar una infección grave y a trasladar sin demora, aunque el niño no parezca muy afectado.'),
        ],
      },
      erroresFrecuentes([
        ['Guiarse por la cifra del termómetro', 'No mide la gravedad. Lo que orienta es el aspecto del niño y los signos de alarma.'],
        ['Sujetar al niño o meterle algo en la boca durante la convulsión', 'No se sujeta ni se intenta detener los movimientos, y no se introduce nada en la boca bajo ninguna circunstancia.'],
        ['No mirar el reloj', 'La duración es el dato clínico más importante del episodio.'],
        ['Asumir una convulsión febril simple sin comprobar', 'No se asume cuando dura más de lo habitual o no cede, cuando afecta solo a una parte, cuando se repite o cuando el niño no recupera bien.'],
      ]),
      repasoRapido([
        'La temperatura por sí sola no mide la gravedad.',
        'Alarma el aspecto general malo, la apatía, la irritabilidad que no cede o el llanto inconsolable.',
        'También la dificultad respiratoria, la piel pálida o moteada y el relleno capilar lento.',
        'También las manchas que no desaparecen al presionar.',
        'También la rigidez de nuca, la fontanela abombada en el lactante y la convulsión.',
        'También el vómito persistente, el rechazo completo del líquido y la deshidratación establecida.',
        'La fiebre en un lactante muy pequeño exige otro umbral de valoración.',
        'Durante una convulsión: proteger de golpes, no sujetar, no introducir nada y colocarlo de lado cuando sea posible.',
        'Mirar el reloj: la duración es el dato más importante, y se observa cómo fue.',
        'Después: valorar vía aérea y conciencia, medir la glucemia y buscar los signos de alarma.',
        'Acompañar a la familia, que suele estar convencida de que su hijo iba a morir.',
        'Trasladar describiendo hora de inicio, duración, características y estado posterior.',
      ]),
      preguntasOrales([
        '¿Por qué la cifra no es el problema?',
        'Enumera los signos de alarma en el niño con fiebre.',
        '¿Qué significan las manchas que no palidecen?',
        'Recorre la actuación durante la convulsión.',
        '¿Por qué mirar el reloj?',
        '¿Qué se hace después del episodio?',
        '¿Cuándo NO se asume que es una convulsión febril simple?',
        '¿Qué papel tiene el acompañamiento a la familia?',
      ]),
      F([AHA_PALS_2025, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EN EL LACTANTE NO BUSQUES LO QUE NO VA A ESTAR. Esperar rigidez de nuca para sospechar meningitis lleva a diagnosticarla tarde: lo que hay que valorar es su aspecto general.'),
          masPreguntado('La comprobación del cristal: ante cualquier mancha cutánea en un niño con fiebre se presiona con un cristal transparente o con el dedo, y si las lesiones no palidecen la sospecha de infección grave se eleva de forma inmediata.'),
        ],
      },
      erroresFrecuentes([
        ['Esperar rigidez de nuca en un lactante', 'Suele faltar. Lo que se valora es su aspecto general: come mal, está anormalmente irritable o apagado.'],
        ['No comprobar las manchas cutáneas', 'Se presionan con un cristal o con el dedo: si no palidecen, la sospecha se eleva de inmediato.'],
        ['Esperar la confirmación para protegerse', 'Algunas meningitis se transmiten por secreciones respiratorias: las precauciones se aplican desde el primer contacto.'],
        ['Prealertar sin explicitar la sospecha', 'El centro receptor necesita preparar el aislamiento y el tratamiento.'],
      ]),
      repasoRapido([
        'La meningitis es poco frecuente y muy grave, y su reconocimiento precoz cambia el desenlace.',
        'Lactante: fiebre o temperatura baja, rechazo del alimento, vómito, irritabilidad o apatía, llanto agudo, fontanela abombada.',
        'En el lactante la rigidez de nuca suele faltar.',
        'Niño pequeño: fiebre, vómito, decaimiento, irritabilidad y rechazo a moverse; la rigidez puede aparecer o no.',
        'Niño mayor y adolescente: fiebre, cefalea intensa, rigidez de nuca, molestia con la luz, vómito y alteración mental.',
        'La comprobación del cristal: si las lesiones no palidecen, la sospecha se eleva de inmediato.',
        'Conducta: valorar y sostener según la secuencia habitual, con oxígeno y vigilancia del estado mental.',
        'Medir la glucemia si está dentro del alcance.',
        'Buscar signos de shock: la infección grave puede evolucionar con rapidez a hipoperfusión.',
        'Reducir estímulos: la luz y el ruido molestan y no aportan nada.',
        'Traslado con prealerta explícita, porque el centro necesita preparar aislamiento y tratamiento.',
        'El equipo aplica las precauciones de transmisión desde el primer contacto, no cuando se confirma.',
      ]),
      preguntasOrales([
        'Describe la presentación según la edad.',
        '¿Por qué en el lactante no se busca la rigidez de nuca?',
        '¿Qué se valora entonces?',
        'Explica la comprobación del cristal y su significado.',
        'Recorre la conducta prehospitalaria.',
        '¿Por qué se reducen los estímulos?',
        '¿Qué debe explicitar la prealerta?',
        '¿Cuándo se aplican las precauciones de transmisión?',
      ]),
      F([WHO_BEC, AHA_PALS_2025, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('COME MAL, SE CANSA Y SUDA AL COMER. Un lactante que tarda mucho en cada toma, se cansa, suda mientras come, respira deprisa y no gana peso está describiendo una insuficiencia cardiaca, aunque la familia lo cuente como un problema de alimentación.'),
          masPreguntado('Que el cuidador sabe más que la escala: estas familias conocen la enfermedad, la medicación, las cifras habituales y los episodios previos. Preguntarles qué es normal en su hijo y qué es distinto hoy resuelve en un minuto lo que ninguna exploración aporta.'),
        ],
      },
      erroresFrecuentes([
        ['Leer la mala alimentación como un problema de apetito', 'En el lactante, comer poco, cansarse y sudar al comer con respiración rápida describe una insuficiencia cardiaca.'],
        ['Impedir la posición en cuclillas', 'En el niño mayor con episodios de cianosis, esa posición o las rodillas contra el pecho pueden aliviarle y no debe impedirse.'],
        ['Hacer llorar al niño', 'El llanto aumenta el consumo de oxígeno y puede empeorar la cianosis: la manipulación es mínima.'],
        ['Administrar oxígeno alto o cargar líquidos sin ajustarse al protocolo', 'En determinadas cardiopatías ninguna de las dos conductas es inocua.'],
      ]),
      repasoRapido([
        'Las cardiopatías congénitas son alteraciones estructurales presentes desde el nacimiento.',
        'En el ámbito prehospitalario no se identifican ni se clasifican: se reconocen dos patrones.',
        'Patrón con cianosis: coloración azulada de labios, lengua y mucosas, que puede empeorar con el llanto o el esfuerzo.',
        'Puede mejorar poco o nada con el oxígeno, a diferencia de la cianosis de origen respiratorio.',
        'En el niño mayor puede haber postura en cuclillas durante los episodios.',
        'Patrón de fallo de bomba: come poco y se cansa al comer, suda al alimentarse, respira rápido y gana poco peso.',
        'También hígado aumentado, edema, sudoración y palidez.',
        'La insuficiencia cardiaca del lactante se parece a un problema de alimentación.',
        'Conducta: reconocer el patrón y sostener, con oxígeno conforme al protocolo.',
        'Permitir la posición en que el niño está mejor y no impedir la posición en cuclillas.',
        'Manipulación mínima y evitar todo lo que le haga llorar.',
        'Preguntar al cuidador por el diagnóstico, las cirugías, la medicación y el centro donde se le sigue.',
      ]),
      preguntasOrales([
        'Distingue los dos grandes patrones de presentación.',
        '¿Qué diferencia la cianosis de origen cardiaco de la respiratoria?',
        'Describe la insuficiencia cardiaca del lactante.',
        '¿Por qué se parece a otra cosa?',
        '¿Qué posición no debe impedirse, y por qué?',
        '¿Por qué se evita hacer llorar al niño?',
        'Di las dos precauciones que importan.',
        '¿Por qué el cuidador sabe más que la escala?',
      ]),
