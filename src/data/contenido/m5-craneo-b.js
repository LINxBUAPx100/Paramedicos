    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA PRIMARIA YA OCURRIÓ; LA SECUNDARIA ES TU TRABAJO. El impacto no se puede deshacer, pero sí se puede evitar que el cerebro reciba un segundo golpe fisiológico. Hipoxia e hipotensión son los dos agresores secundarios mejor documentados.'),
          masPreguntado('La distinción primaria/secundaria y su consecuencia: evitar la hipoxia y la hipotensión, mantener la ventilación adecuada, medir la glucemia y prevenir la hipotermia son TRATAMIENTO del traumatismo craneoencefálico, no cuidados accesorios.'),
        ],
      },
      erroresFrecuentes([
        ['Cerrar el caso con un examen inicial normal', 'Un paciente puede estar consciente, orientado y sin déficit y tener una lesión que se manifieste más tarde, sobre todo si hay una colección que crece. Lo que informa es la evolución entre valoraciones.'],
        ['Exigir pérdida de conciencia para hablar de traumatismo craneoencefálico', 'La definición no la exige: es la alteración de la función cerebral, o la evidencia de alteración estructural, producida por una fuerza externa, y puede ser transitoria.'],
        ['Tratar la oxigenación y la presión como constantes aparte', 'Forman parte de la valoración neurológica, porque determinan la perfusión del encéfalo.'],
        ['Valorar una sola vez', 'Un valor aislado dice poco; una tendencia descendente dice mucho. Cada valoración se documenta con su hora para que la serie sea comparable.'],
      ]),
      repasoRapido([
        'Es la alteración de la función cerebral, o la evidencia de alteración estructural, producida por una fuerza externa.',
        'Puede deberse a un golpe, a una penetración o a una aceleración y desaceleración bruscas.',
        'La alteración puede ser transitoria o permanente, y no exige pérdida de conciencia.',
        'Se clasifica por mecanismo —cerrado o penetrante—, por distribución —difuso o focal— y por gravedad clínica.',
        'Un examen inicial normal no excluye lesión.',
        'Lesión primaria: en el instante del impacto, por la transferencia de energía. No se puede modificar.',
        'Lesión secundaria: en los minutos, horas y días siguientes, por hipoxia, hipotensión, edema, hipoglucemia, hipertermia, convulsiones o aumento de presión intracraneal.',
        'La secundaria sí se puede modificar: es donde actúa el ámbito prehospitalario.',
        'Hipoxia e hipotensión son los agresores secundarios mejor documentados.',
        'La valoración seriada mira conciencia, pupilas, función motora, constantes y glucemia, y se repite con la hora.',
        'La oxigenación y la presión arterial forman parte de la valoración neurológica.',
        'Los objetivos numéricos los fija el protocolo del servicio sobre la guía prehospitalaria vigente.',
      ]),
      preguntasOrales([
        'Define el traumatismo craneoencefálico.',
        '¿Exige pérdida de conciencia? Justifícalo.',
        'Enumera las formas de clasificarlo.',
        'Diferencia lesión primaria de lesión secundaria.',
        'Nombra los agresores secundarios y di cuáles son los mejor documentados.',
        '¿Dónde está la aportación real del ámbito prehospitalario?',
        'Recorre la valoración neurológica seriada.',
        '¿Por qué la oxigenación y la presión son parte de la valoración neurológica?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CAJA LLENA: SI UNO SUBE, OTRO BAJA. Encéfalo, sangre y líquido cefalorraquídeo suman un volumen prácticamente constante. Primero se desplaza líquido cefalorraquídeo y sangre venosa; cuando eso se agota, la presión se dispara.'),
          masPreguntado('El agotamiento de la compensación, que explica por qué alguien con una lesión que crece puede parecer estable un tiempo y después deteriorarse rápido. Y la consecuencia práctica gratuita: un collarín demasiado apretado, la cabeza girada o una mala posición dificultan el retorno venoso y empeoran esa relación.'),
        ],
      },
      erroresFrecuentes([
        ['Escribir «Kellie Monroe»', 'El plan lo escribe así, pero la denominación correcta es doctrina de Monro–Kellie, por los dos autores que la formularon. El título documental se conserva sin alterar en trazabilidad.'],
        ['Aprenderse proporciones de los tres componentes', 'Los porcentajes varían según la fuente y no aportan nada a la conducta. Lo que hay que entender es la relación: volumen fijo y compensación limitada.'],
        ['Interpretar la estabilidad como ausencia de problema', 'Durante la fase de compensación la presión sube poco y el paciente puede mantener un estado aceptable. Es justo la fase que engaña.'],
        ['Dejar el collarín apretado o la cabeza girada', 'Todo lo que dificulte el retorno venoso del cráneo empeora la perfusión. Son detalles mecánicos, gratuitos de corregir, que actúan sobre la propia doctrina.'],
      ]),
      repasoRapido([
        'El plan escribe «Kellie Monroe»; la denominación correcta es doctrina de Monro–Kellie.',
        'En el adulto el cráneo es una estructura rígida de volumen fijo.',
        'Contiene tres cosas: encéfalo, sangre que circula por él y líquido cefalorraquídeo.',
        'La suma de esos tres volúmenes es prácticamente constante: si uno aumenta, otro tiene que disminuir.',
        'El encéfalo puede aumentar de volumen por edema, agravando el problema.',
        'La sangre, sobre todo venosa, es de los primeros componentes en desplazarse fuera del cráneo.',
        'El líquido cefalorraquídeo se desplaza hacia el espacio raquídeo como mecanismo de compensación.',
        'Durante la compensación la presión sube poco y el paciente puede parecer estable.',
        'Agotada la compensación, un aumento pequeño de volumen produce un aumento grande de presión.',
        'El deterioro deja de ser gradual y se vuelve rápido: de ahí el valor de un cambio pequeño en poco tiempo.',
        'La perfusión cerebral depende de la relación entre la presión con que llega la sangre y la presión dentro del cráneo.',
        'Consecuencia práctica: collarín no apretado, cabeza en posición neutra y posición que no dificulte el retorno venoso.',
      ]),
      preguntasOrales([
        'Enuncia la doctrina de Monro–Kellie y sus tres componentes.',
        '¿Cómo se escribe correctamente, y qué escribe el plan?',
        '¿Qué le pasa a cada componente cuando algo ocupa espacio?',
        'Explica la fase de compensación.',
        '¿Qué ocurre cuando la compensación se agota?',
        '¿Por qué no se enseñan proporciones?',
        'Relaciona presión intracraneal, presión arterial y perfusión cerebral.',
        'Nombra las medidas mecánicas que actúan sobre esta doctrina.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO PALPAR FUERTE, NO EXPLORAR LA HERIDA, NO TAPONAR EL DRENAJE. Tres prohibiciones y una razón común: cada una puede empeorar lo que hay debajo —desplazar fragmentos, contaminar el contenido craneal o subir la presión dentro del cráneo—.'),
          masPreguntado('Que la fractura importa por lo que acompaña: indica energía considerable y obliga a buscar lesión del encéfalo, pero no la confirma. Puede haber fractura sin lesión intracraneal y lesión intracraneal grave sin fractura. Y que la equimosis periorbitaria y la retroauricular tardan horas: su ausencia en la escena no descarta nada.'),
        ],
      },
      erroresFrecuentes([
        ['Palpar con fuerza una zona hundida', 'Puede desplazar fragmentos hacia el interior y aumentar el sangrado. La palpación se hace con suavidad.'],
        ['Explorar la herida del cuero cabelludo para «ver el hueso»', 'No se introducen dedos ni instrumentos: desplaza fragmentos, aumenta el sangrado y contamina. Se describe lo que se ve y se cubre.'],
        ['Taponar la salida de líquido por oído o nariz', 'Se cubre con gasa estéril sin comprimir y se deja drenar. Ocluirlo puede aumentar la presión dentro del cráneo y favorecer la infección. Por lo mismo se evita la vía nasal para sondas o dispositivos.'],
        ['Descartar la fractura de base porque no hay equimosis', 'La periorbitaria y la retroauricular tardan horas en desarrollarse: es normal que no estén en la escena. Su presencia orienta pero no diagnostica; la confirmación es por imagen.'],
      ]),
      repasoRapido([
        'Lineal: trazo sin desplazamiento; la más frecuente, e importa por lo que pueda haber debajo.',
        'Deprimida: fragmento hundido hacia el interior, que puede comprimir o lesionar el tejido subyacente.',
        'De la base: afecta al suelo de la cavidad craneal y puede comunicar el interior con oído, nariz o senos.',
        'Abierta: hay una herida que comunica la fractura con el exterior, con riesgo de contaminación.',
        'La fractura indica energía considerable y obliga a buscar lesión del encéfalo, pero no la confirma.',
        'Puede haber fractura sin lesión intracraneal, y lesión intracraneal grave sin fractura.',
        'Signos posibles: escalón, hundimiento o deformidad palpable, y herida con fractura visible en su fondo.',
        'Equimosis periorbitaria bilateral —ojos de mapache— y equimosis retroauricular —signo de Battle—.',
        'Salida de líquido claro o sanguinolento por nariz u oído, sangre detrás del tímpano, alteración de audición o equilibrio.',
        'La equimosis periorbitaria y la retroauricular tardan horas: su ausencia no descarta la fractura de base.',
        'Tres prohibiciones: no palpar agresivamente, no explorar la herida y no ocluir el drenaje.',
        'Sí se hace: prevenir la lesión secundaria, valoración seriada con la hora, control del sangrado con cautela, cubrir con estéril, restricción espinal si procede y traslado a centro neuroquirúrgico con prealerta.',
      ]),
      preguntasOrales([
        'Describe los cuatro tipos de fractura craneal y qué implica cada uno.',
        '¿Qué indica y qué NO indica una fractura de cráneo?',
        'Enumera los signos de fractura de la base.',
        '¿Por qué su ausencia en la escena no descarta nada?',
        'Di las tres prohibiciones de esta lección.',
        '¿Por qué no se tapona la salida de líquido?',
        '¿Qué otra consecuencia tiene esa misma razón?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SUS VASOS NO SE RETRAEN. Están sujetos al tejido fibroso del cuero cabelludo, así que al seccionarse permanecen abiertos y sangran de forma continua. Eso, y nada más, explica por qué «solo es la cabeza» puede terminar en shock.'),
          masPreguntado('Que puede llegar a producir shock —con más riesgo en el paciente pediátrico y en el anticoagulado—, y a la vez que en un adulto traumatizado en shock NO se da la hipotensión por explicada solo con la herida del cuero cabelludo: se buscan las demás fuentes.'),
        ],
      },
      erroresFrecuentes([
        ['Subestimar la herida porque «solo es la cabeza»', 'Un sangrado sostenido puede producir una pérdida importante, y el riesgo es mayor en el paciente pediátrico y en el anticoagulado.'],
        ['Explicar toda la hipotensión con el escalpe', 'Ante un adulto traumatizado en shock no se da por explicada la hipotensión solo con esta herida: se buscan las demás fuentes.'],
        ['Presionar sobre un hundimiento', 'Si hay hundimiento palpable o fractura abierta, la presión se aplica con cautela alrededor de la zona, evitando presionar sobre el hundimiento o sobre fragmentos.'],
        ['No buscar entre el pelo ni en la región occipital', 'El pelo húmedo de sangre esconde la herida con facilidad, y una herida sangrante en la nuca de un paciente en decúbito supino puede pasar completamente desapercibida.'],
      ]),
      repasoRapido([
        'El cuero cabelludo tiene una vascularización muy rica.',
        'Sus vasos están sujetos al tejido fibroso, y al seccionarse no se retraen ni se colapsan.',
        'Por eso permanecen abiertos y sangran de forma continua.',
        'Puede llegar a producir shock, con más riesgo en el paciente pediátrico y en el anticoagulado.',
        'Aun así, en el adulto en shock no se da la hipotensión por explicada solo con esta herida.',
        'Conducta: protección personal, porque este sangrado salpica.',
        'Exponer la zona y separar el pelo para localizar el punto sangrante.',
        'Presión directa con apósito sobre el punto; con cautela alrededor si hay hundimiento o fractura abierta.',
        'Vendaje que mantenga la presión una vez controlado, y recolocación del colgajo sobre su lecho sin forzar.',
        'Reevaluar: los vendajes de la cabeza se aflojan con facilidad durante la movilización.',
        'La exploración incluye pasar las manos enguantadas por todo el cuero cabelludo, incluida la región occipital, y mirar los guantes.',
        'El tejido avulsionado se recoge y se traslada con el paciente; cómo se conserva lo fija el protocolo, y no se reimplanta ni se sutura en la escena.',
      ]),
      preguntasOrales([
        'Explica por qué el cuero cabelludo sangra de forma abundante.',
        '¿En qué pacientes el riesgo de shock es mayor?',
        '¿Puedes explicar toda la hipotensión de un adulto con esta herida?',
        'Recorre el control del sangrado.',
        '¿Qué cambia si hay hundimiento palpable?',
        '¿Cómo buscas heridas que no se ven?',
        '¿Qué haces con un fragmento de cuero cabelludo desprendido?',
        '¿Por qué la lesión más llamativa no es necesariamente la grave?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PARA LA CONDUCTA DA IGUAL SI ES EPIDURAL O SUBDURAL. En los dos casos se previene la lesión secundaria, se reevalúa de forma documentada y se traslada a un centro con capacidad neuroquirúrgica. Nombrar la lesión en el informe no aporta nada y puede inducir a error.'),
          masPreguntado('Que el intervalo lúcido NO identifica un hematoma epidural: no es exclusivo, no está en todos los casos y también se ve en otras lesiones. Enseñarlo como marca segura lleva a descartar lesión grave porque el paciente «está lúcido» y a afirmar un tipo de hematoma que solo la imagen distingue.'),
        ],
      },
      erroresFrecuentes([
        ['Usar el intervalo lúcido como marca de hematoma epidural', 'No es exclusivo de él, no está presente en todos los casos y también se observa en otras lesiones. Lleva a dos errores: descartar gravedad por lucidez y afirmar un tipo que solo la imagen distingue.'],
        ['Nombrar la lesión en el informe', 'No aporta nada a la conducta y puede inducir a error a quien lo lea. Lo que se comunica son hallazgos y evolución.'],
        ['Aplicar el mismo umbral a mayores y anticoagulados', 'En ellos una colección puede desarrollarse con un mecanismo aparentemente banal y manifestarse más lenta o más tarde. El umbral de sospecha y de traslado debe ser más bajo.'],
        ['Esperar a que el cuadro se complete', 'Algunas colecciones tienen tratamiento quirúrgico y su resultado depende de la rapidez de la evacuación. Una tendencia descendente, aunque el paciente siga consciente, es motivo para acelerar el traslado.'],
      ]),
      repasoRapido([
        'Una lesión focal ocupa un sitio concreto y puede comprimir lo que tiene alrededor.',
        'Algunas focales pueden tratarse quirúrgicamente: de ahí que el destino neuroquirúrgico forme parte de la decisión.',
        'Hematoma epidural: entre el cráneo y la duramadre; suele asociarse a sangrado arterial y puede crecer con rapidez.',
        'Hematoma subdural: entre la duramadre y el encéfalo; suele ser venoso y puede ser agudo o más lento.',
        'Contusión cerebral: en el propio tejido, en la zona golpeada o en la opuesta; puede crecer y edematizarse en horas.',
        'Hematoma intraparenquimatoso: dentro del tejido encefálico; ocupa espacio y puede progresar.',
        'En mayores y anticoagulados el patrón cambia: mecanismo banal y manifestación más lenta o tardía.',
        'El intervalo lúcido no identifica un hematoma epidural.',
        'Lo que sí se observa y se comunica: déficit focal, asimetría pupilar, descenso de conciencia y su velocidad, convulsiones.',
        'También vómito repetido, cefalea creciente, agitación o somnolencia progresivas, y la tendencia con la hora.',
        'La conducta es la misma para todas: prevenir la lesión secundaria, reevaluar y trasladar a centro neuroquirúrgico.',
        'Posición y manejo que favorezcan el drenaje venoso: cabeza neutra, collarín no apretado, cabecera elevada si el protocolo lo permite.',
      ]),
      preguntasOrales([
        'Describe las cuatro lesiones focales principales y dónde se localiza cada una.',
        '¿Por qué importa la distinción focal/difusa para el destino?',
        '¿En qué poblaciones cambia el patrón, y qué implica?',
        'Explica por qué el intervalo lúcido no identifica el hematoma epidural.',
        '¿A qué dos errores lleva enseñarlo como marca segura?',
        'Enumera lo que sí se observa y se comunica.',
        '¿Por qué no se nombra la lesión en el informe?',
        '¿Qué justifica acelerar el traslado aunque el paciente siga consciente?',
      ]),
