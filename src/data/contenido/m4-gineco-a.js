    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA POSIBILIDAD DE EMBARAZO SE PREGUNTA SIEMPRE. A toda paciente en edad fértil, sea cual sea el motivo de la llamada: un embarazo desconocido cambia el significado de un dolor abdominal, de un síncope y de un cuadro de shock.'),
          masPreguntado('Que en la ambulancia NO se realiza tacto vaginal ni exploración con espéculo: en una hemorragia del segundo o tercer trimestre el tacto puede agravar el sangrado, y en los demás cuadros no aporta información que cambie la conducta prehospitalaria.'),
        ],
      },
      erroresFrecuentes([
        ['No preguntar por embarazo posible', 'Se pregunta a toda paciente en edad fértil aunque el motivo parezca ajeno: cambia el significado del dolor abdominal, del síncope y del shock.'],
        ['Realizar tacto vaginal o exploración con espéculo', 'No se hacen en la ambulancia. En una hemorragia avanzada el tacto puede agravar el sangrado.'],
        ['No preguntar nunca a solas', 'Hay información que no se dice delante de terceros. Se ofrece la presencia de un acompañante de su elección y también la posibilidad de hablar a solas.'],
        ['Confiarse con signos vitales aparentemente normales', 'Una embarazada dispone de más volumen y compensa mejor: cuando esos signos se alteran, la pérdida ya es importante.'],
      ]),
      repasoRapido([
        'Una paciente que no se siente segura omite datos, y los que omite suelen ser los que deciden la conducta.',
        'Se presenta el equipo, se explica qué se va a preguntar y se pide consentimiento antes de cualquier exploración.',
        'Se busca la mayor privacidad posible, se retira a los curiosos y se cubre a la paciente.',
        'Se ofrece acompañante de su elección y también la posibilidad de hablar a solas.',
        'Atención informada por el trauma: anunciar, pedir permiso, evitar exposiciones y aceptar una negativa sin insistir.',
        'Historia: última menstruación, posibilidad de embarazo, semanas y controles, embarazos y partos previos.',
        'También cesáreas o cirugías uterinas, método anticonceptivo, tratamientos y alergias.',
        'Motivo actual: dolor, sangrado, salida de líquido, contracciones, movimientos fetales, fiebre o desmayo.',
        'Exploración: estado general y perfusión, signos vitales por su tendencia, abdomen en su orden con tono y altura uterina.',
        'Inspección externa solo cuando sea necesaria, con la privacidad máxima posible.',
        'No se realiza tacto vaginal ni exploración con espéculo.',
        'Banderas rojas: hipoperfusión, sangrado abundante, dolor con embarazo posible, síncope, alteración del estado mental, convulsión en embarazo o puerperio.',
      ]),
      preguntasOrales([
        'Enumera las condiciones que hacen posible una entrevista útil.',
        '¿Qué es la atención informada por el trauma?',
        '¿Por qué se pregunta a solas al menos una vez?',
        'Recorre la historia obstétrica y ginecológica esencial.',
        '¿Cuál es la pregunta que no puede omitirse, y por qué?',
        '¿Qué se explora y qué no se hace en la ambulancia?',
        'Di las banderas rojas que cambian la prioridad.',
        '¿Por qué la embarazada compensa y luego cae?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ESTABILIZAR A LA MADRE ES ATENDER AL FETO. El feto depende por completo de la circulación y la oxigenación maternas: no existe una intervención prehospitalaria que lo beneficie por encima de mantener a la madre.'),
          masPreguntado('Los dos cambios con traducción práctica inmediata: la reserva de oxígeno es menor —el útero eleva el diafragma y el consumo aumenta, así que la paciente se dessatura antes— y la compresión aortocava, que se corrige inclinando hacia el lado izquierdo.'),
        ],
      },
      erroresFrecuentes([
        ['Publicar o memorizar «valores normales del embarazo»', 'Varían con las semanas, con la paciente y con la fuente. Lo que se aprende es la DIRECCIÓN del cambio, no un número.'],
        ['Dejar a la paciente en decúbito supino en el embarazo avanzado', 'El peso del útero comprime los grandes vasos, reduce el retorno y puede producir hipotensión, palidez y malestar.'],
        ['Confundir la compresión aortocava con un shock', 'La diferencia es que mejora al cambiar la posición, y comprobarlo forma parte de la evaluación.'],
        ['Olvidar el riesgo de broncoaspiración', 'El vaciamiento gástrico se enlentece y el esfínter esofágico es menos competente: se prioriza la protección de la vía aérea.'],
      ]),
      repasoRapido([
        'Las adaptaciones del embarazo son normales, pero desplazan el punto de partida de casi todo lo que se valora.',
        'Cardiovascular: aumentan volumen y gasto, la frecuencia tiende a subir y la presión a bajar en la parte media.',
        'Hematológico: el plasma aumenta más que los glóbulos rojos, y hay mayor tendencia a la coagulación.',
        'Respiratorio: aumenta el volumen movilizado y disminuye la reserva; la paciente se dessatura antes.',
        'Digestivo: vaciamiento más lento y esfínter menos competente, con mayor riesgo de broncoaspiración.',
        'Anatómico: el útero desplaza las vísceras hacia arriba y desplaza las referencias habituales.',
        'Urinario: aumenta la filtración y una infección urinaria se considera complicada.',
        'No se publican valores normales del embarazo: se aprende la dirección del cambio.',
        'Compresión aortocava: con la paciente boca arriba, el útero comprime los grandes vasos y reduce el retorno.',
        'Se previene evitando el decúbito supino, inclinando hacia el lado izquierdo o desplazando el útero manualmente.',
        'La precaución se mantiene sobre la camilla y durante el traslado, compatible con la inmovilización si procede.',
        'Estabilizar a la madre es atender al feto.',
      ]),
      preguntasOrales([
        'Describe los cambios del embarazo por sistemas y su implicación.',
        '¿Por qué no se publican valores normales del embarazo?',
        'Explica por qué la reserva de oxígeno es menor.',
        'Explica la compresión aortocava y cómo se corrige.',
        '¿Cómo se distingue de un shock por otra causa?',
        '¿Qué precaución se mantiene durante el traslado?',
        '¿Por qué hay mayor riesgo de broncoaspiración?',
        'Di el principio que ordena toda la atención obstétrica de urgencia.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO SE TRACCIONA. El prestador sostiene, protege y recibe. La tracción sobre la cabeza, el cuello o el cuerpo puede producir lesiones graves y no acelera el nacimiento.'),
          masPreguntado('La única decisión que hay que tomar: trasladar o atender el nacimiento en el sitio. Todo lo demás se organiza en torno a esa decisión, y equivocarla en cualquiera de las dos direcciones tiene consecuencias.'),
        ],
      },
      erroresFrecuentes([
        ['Traccionar de la cabeza o del cuerpo', 'Puede producir lesiones graves y no acelera el nacimiento. El papel es sostener, proteger y recibir.'],
        ['Trasladar a una paciente con expulsivo iniciado', 'Si el expulsivo ya empezó, el nacimiento se atiende donde se está.'],
        ['No secar y cubrir de inmediato al recién nacido', 'El enfriamiento es rápido y evitable: se seca por completo, se retiran los paños mojados y se cubre incluida la cabeza.'],
        ['Traccionar del cordón para acelerar el alumbramiento', 'Se espera la salida de la placenta sin traccionar; si sale, se conserva y se traslada con la paciente.'],
      ]),
      repasoRapido([
        'Primera fase, dilatación: las contracciones se hacen frecuentes, intensas y regulares. Habitualmente hay tiempo para trasladar.',
        'Segunda fase, expulsivo: necesidad de pujar y descenso del feto. Si ya empezó, se atiende donde se está.',
        'Tercera fase, alumbramiento: sale la placenta; se acompaña y se vigila el sangrado.',
        'La única decisión es trasladar o atender el nacimiento en el sitio.',
        'Inminente: necesidad intensa e incontrolable de pujar, sensación de que va a salir, cabeza visible o periné abombado.',
        'También contracciones muy frecuentes con poco descanso, parto no primerizo y partos anteriores muy rápidos.',
        'Se pregunta semanas, controles, partos previos, contracciones, rotura de aguas y color del líquido.',
        'También movimientos fetales, sangrado, número de fetos, problemas del embarazo y cesáreas previas.',
        'Un líquido oscuro o verdoso —meconio— es un dato que se transmite, no un diagnóstico.',
        'Durante el nacimiento se acompaña sin apresurar, se apoya la cabeza con suavidad y no se tracciona nunca.',
        'El recién nacido necesita tres cosas: estar seco, estar caliente y respirar.',
        'La madre necesita vigilancia continua del sangrado, que es la complicación más frecuente y grave de ese momento.',
      ]),
      preguntasOrales([
        'Describe las tres fases del trabajo de parto y qué significa cada una para el prestador.',
        '¿Cuál es la única decisión que hay que tomar?',
        'Enumera los datos que indican nacimiento inminente.',
        '¿Qué se pregunta en cuanto se llega?',
        '¿Qué significa un líquido de color verdoso?',
        'Recorre la preparación y el acompañamiento del nacimiento.',
        'Di el principio que evita casi todos los daños.',
        '¿Qué necesita el recién nacido y qué necesita la madre en los primeros minutos?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('RECONOCER, PEDIR, NO EMPEORAR, TRASLADAR. Esta lección no enseña a resolver una distocia: enseña a identificarla, a pedir lo que hace falta, a no agravarla y a trasladar. Presentarla de otro modo generaría una expectativa falsa.'),
          masPreguntado('Que el prolapso de cordón es la situación que menos espera: si el cordón queda comprimido entre el feto y el canal del parto, la circulación fetal se interrumpe. Ahí el tiempo cuenta de forma más inmediata.'),
        ],
      },
      erroresFrecuentes([
        ['Intentar resolver la distocia', 'La aportación prehospitalaria es reconocer, pedir recursos, no empeorar y trasladar.'],
        ['Reintroducir un cordón prolapsado', 'Está prohibido sin formación y protocolo específicos, igual que traccionar del feto o rotarlo.'],
        ['Aplicar presión sobre el fondo del útero', 'No se empuja al feto hacia abajo: es una de las conductas prohibidas de esta lección.'],
        ['Asumir que se conocen de antemano', 'Una presentación podálica o un parto múltiple pueden descubrirse en la escena en una paciente sin controles: la anamnesis inicial importa.'],
      ]),
      repasoRapido([
        'Distocia es el parto que no progresa con normalidad.',
        'Lo primero, siempre: pedir apoyo y recursos conforme al protocolo en cuanto se identifique.',
        'También contactar con la dirección médica si el procedimiento lo contempla y registrar la hora de identificación.',
        'Presentación podálica: se presentan primero las nalgas o los pies; la parte más voluminosa sale al final.',
        'Distocia de hombros: la cabeza nace y el cuerpo no progresa con la contracción siguiente.',
        'Prolapso del cordón: el cordón se observa fuera del introito antes de que nazca el feto.',
        'Parto múltiple: multiplica la complejidad, los recursos necesarios y el riesgo.',
        'El prolapso de cordón es la que menos espera.',
        'Estas situaciones no siempre se conocen de antemano.',
        'Conducta: pedir ayuda, posición según protocolo, minimizar la manipulación y oxigenación materna.',
        'También prevenir la hipotermia, trasladar con prealerta descriptiva y registrar horas.',
        'Prohibido sin formación y protocolo: traccionar del feto, reintroducir el cordón, presionar el fondo uterino y rotar al feto.',
      ]),
      preguntasOrales([
        'Define distocia y di qué enseña y qué no enseña esta lección.',
        '¿Qué es lo primero, siempre?',
        'Describe las cuatro situaciones que hay que reconocer.',
        '¿Cuál es la que menos espera, y por qué?',
        '¿Se conocen siempre de antemano?',
        'Recorre la conducta general.',
        'Di las conductas prohibidas sin formación y protocolo.',
        '¿Qué debe declarar la academia para completar este tema?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO EXISTE UNA INTERVENCIÓN DIRIGIDA AL FETO. Corregir la posición, mantener la oxigenación, sostener la circulación y tratar la causa materna es lo que efectivamente mejora la situación fetal en el ámbito prehospitalario.'),
          masPreguntado('Por qué se prefiere «estado fetal no tranquilizador»: «sufrimiento fetal» afirma que el feto está sufriendo, y eso es una conclusión que requiere evaluación obstétrica que no existe en la calle. Los datos disponibles no confirman un compromiso: indican que no puede descartarse.'),
        ],
      },
      erroresFrecuentes([
        ['Etiquetar como «sufrimiento fetal»', 'Afirma una conclusión que requiere evaluación obstétrica. Se transmite la observación, no el diagnóstico.'],
        ['Minimizar la disminución de movimientos', 'Atribuirla a que el feto «está durmiendo» descarta el dato más accesible. La madre conoce el patrón habitual de su embarazo.'],
        ['Buscar una intervención dirigida al feto', 'No existe. La búsqueda se dirige a lo que le está ocurriendo a la madre, que es lo que puede modificarse.'],
        ['Tomar el líquido meconial por un diagnóstico', 'Es información que se transmite; no es diagnóstico por sí solo.'],
      ]),
      repasoRapido([
        'El plan titula el tema «sufrimiento fetal agudo»; la práctica actual prefiere «estado fetal no tranquilizador».',
        'El cambio importa porque los datos disponibles no confirman un compromiso: indican que no puede descartarse.',
        'Lo que se comunica es una observación, no un diagnóstico.',
        'Movimientos fetales: el dato más accesible; una disminución referida por la madre se toma en serio.',
        'Frecuencia cardiaca fetal: solo si la unidad tiene equipo y el prestador la competencia.',
        'Color del líquido amniótico: el verdoso u oscuro se transmite, sin ser diagnóstico.',
        'El estado de la madre es lo que más determina el bienestar fetal y lo que sí puede corregirse.',
        'Causas maternas reversibles: compresión aortocava, hipotensión, hipoxia, hemorragia visible u oculta.',
        'También convulsión o alteración de la conciencia, fiebre o infección, deshidratación, tóxicos y traumatismo reciente.',
        'La intervención más eficaz sobre el feto es sobre la madre.',
        'Conducta: valorar a la madre, corregir la posición, oxigenar, tratar la causa y registrar con hora.',
        'La prealerta lleva semanas estimadas, qué se observó y desde cuándo, estado de la madre y su tendencia, y qué se aplicó.',
      ]),
      preguntasOrales([
        'Justifica por qué se prefiere «estado fetal no tranquilizador».',
        '¿Qué se transmite entonces al equipo receptor?',
        'Enumera los datos que puede observar el prestador y el valor de cada uno.',
        '¿Por qué no se minimiza una disminución de movimientos?',
        'Di las causas maternas reversibles que se buscan.',
        '¿Cuál es la intervención más eficaz sobre el feto?',
        'Recorre la conducta prehospitalaria.',
        '¿Qué debe contener la prealerta?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LO QUE SE VE NO MIDE LO QUE SE HA PERDIDO. En un desprendimiento la sangre puede quedar retenida entre la placenta y la pared del útero sin salir al exterior, y a eso se suma que la embarazada compensa.'),
          masPreguntado('La prohibición del tacto vaginal y su razón concreta: si la placenta cubre la salida del útero, el tacto puede desencadenar o agravar un sangrado masivo, y la información que aportaría no cambiaría la conducta prehospitalaria.'),
        ],
      },
      erroresFrecuentes([
        ['Realizar tacto vaginal', 'Si la placenta cubre la salida del útero puede desencadenar o agravar un sangrado masivo, y no aporta información que cambie la conducta.'],
        ['Medir la pérdida por el sangrado visible', 'La sangre puede quedar retenida. Se valora por perfusión, tendencia, dolor, tono uterino y evolución.'],
        ['Etiquetar el cuadro con los patrones', 'Existen desprendimientos con sangrado abundante y placentas previas con dolor. Los patrones sirven para reconocer, no para etiquetar.'],
        ['Descartar un desprendimiento por un traumatismo leve', 'Un traumatismo, incluso aparentemente leve, puede provocarlo: el antecedente traumático es relevante.'],
      ]),
      repasoRapido([
        'Un sangrado en la segunda mitad del embarazo es siempre una situación seria.',
        'Placenta previa: la placenta cubre total o parcialmente la salida del útero.',
        'Suele ser indolora, con sangrado rojo, visible y de aparición súbita, y útero blando.',
        'Desprendimiento: la placenta se separa de la pared del útero antes del nacimiento.',
        'Suele ser doloroso, con dolor abdominal continuo, útero duro y tenso, y sangrado escaso o no visible.',
        'En el desprendimiento el estado de la madre puede ser mucho peor de lo que sugiere el sangrado visible.',
        'Ninguno de estos rasgos es absoluto.',
        'La pérdida se valora por el estado de perfusión y por la tendencia de frecuencia y presión.',
        'También por la intensidad del dolor, el tono uterino y lo que la paciente refiere sobre cuánto ha manchado.',
        'Y por la evolución: lo que cambia en unos minutos informa más que lo que se ve al llegar.',
        'A la sangre oculta se suma que la embarazada compensa durante más tiempo.',
        'No se realiza tacto vaginal, y el mejor cuidado del feto es la estabilización de la madre.',
      ]),
      preguntasOrales([
        'Compara los dos patrones clásicos sin diagnosticarlos.',
        '¿Son absolutos esos rasgos?',
        '¿Por qué lo que se ve no mide lo que se ha perdido?',
        '¿Cómo se valora entonces la pérdida?',
        '¿Qué añade la compensación de la embarazada?',
        'Recorre la conducta prehospitalaria.',
        '¿Por qué no se realiza tacto vaginal?',
        '¿Qué relevancia tiene un antecedente traumático leve?',
      ]),
