    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA DE ARRIBA Y LA DE ABAJO. Se inmoviliza incluyendo la articulación proximal y la distal al foco, y se comprueba pulso, sensibilidad y movilidad ANTES y DESPUÉS de cada maniobra. Sin el antes, no se puede saber si algo cambió.'),
          masPreguntado('Cuándo SÍ se alinea una extremidad deformada: cuando no hay pulso distal o el compromiso neurovascular es evidente, cuando la deformidad impide inmovilizar o trasladar con seguridad, y cuando el traslado será prolongado y el protocolo lo contempla. Fuera de eso, se inmoviliza en la posición encontrada.'),
        ],
      },
      erroresFrecuentes([
        ['Buscar la crepitación', 'No se busca de forma deliberada: duele y puede añadir daño. Si aparece al explorar, se anota.'],
        ['Empujar el hueso hacia dentro', 'Si un extremo asoma, no se intenta reintroducirlo. Y si al alinear por una indicación correcta el hueso se retrae solo, se anota y se comunica: el foco pasa a estar contaminado aunque ya no se vea.'],
        ['No retirar anillos, pulseras o relojes', 'Se retiran antes de que el edema lo impida; después ya no se puede sin cortar.'],
        ['Alinear por costumbre', 'La norma general es inmovilizar en la posición encontrada. La alineación tiene tres indicaciones concretas y se detiene si aparece resistencia importante o aumento marcado del dolor.'],
      ]),
      repasoRapido([
        'Una fractura es una solución de continuidad del hueso; es abierta cuando una herida comunica el foco con el exterior.',
        'Una herida pequeña sobre el foco basta para tratarla como abierta, aunque el hueso no se vea.',
        'Sospechan fractura el dolor localizado que aumenta al mover o cargar, la deformidad, el edema y la equimosis.',
        'También la impotencia funcional, la movilidad anormal del segmento y el mecanismo compatible sin deformidad.',
        'La crepitación no se busca de forma deliberada.',
        'Férula rígida para segmentos largos; maleable para adaptarse a la posición encontrada.',
        'De vacío para ajustarse al contorno sin presión desigual; neumática para inmovilizar y comprimir de forma uniforme, revisando su presión.',
        'De tracción solo para la fractura de la diáfisis del fémur; e improvisada o anatómica cuando no hay material.',
        'Secuencia: exponer y retirar anillos, valorar y anotar el estado neurovascular, cubrir heridas y controlar sangrado.',
        'Inmovilizar incluyendo la articulación proximal y la distal, acolchando huecos y prominencias sin comprimir en exceso.',
        'Volver a valorar y anotar; elevar y aplicar frío si el protocolo lo contempla, y analgesia según alcance.',
        'Se alinea solo por compromiso neurovascular, por imposibilidad de inmovilizar o trasladar, o por traslado prolongado con protocolo que lo contemple.',
      ]),
      preguntasOrales([
        '¿Cuándo una fractura es abierta?',
        'Enumera lo que hace sospechar una fractura.',
        '¿Por qué no se busca la crepitación?',
        'Nombra los tipos de férula y para qué sirve cada uno.',
        'Recorre la secuencia de inmovilización.',
        '¿Qué es la regla de las dos articulaciones?',
        '¿Cuándo sí se alinea una extremidad deformada?',
        '¿Qué haces si el hueso asoma por la herida?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LIGAMENTO, ARTICULACIÓN O FIBRA. El esguince daña un ligamento, la luxación saca el hueso de la articulación y el desgarro rompe fibras musculares o tendinosas. Y las tres se manejan igual en la escena: inmovilizar como se encuentra y comprobar el estado neurovascular.'),
          masPreguntado('Que el esguince y la fractura no se separan en la calle: pueden dar exactamente los mismos hallazgos, y decirle a un paciente que «solo es un esguince» es una conclusión que la escena no permite. Y la luxación con compromiso neurovascular, que deja de ser ortopédica y pasa a ser urgencia.'),
        ],
      },
      erroresFrecuentes([
        ['Decir al paciente que «solo es un esguince»', 'Un esguince importante y una fractura sin desplazamiento dan los mismos hallazgos. Sin imagen no se distinguen: ambos se inmovilizan y se derivan.'],
        ['Tratar toda luxación como una lesión que puede esperar', 'Si el pulso distal está ausente, la extremidad está fría o pálida o hay pérdida de sensibilidad, es una urgencia: el tiempo hasta la reducción condiciona el resultado.'],
        ['Intentar corregir la deformidad de una luxación', 'Se inmoviliza en la posición encontrada. La reducción exige formación específica, la técnica de esa articulación concreta y una indicación respaldada.'],
        ['Aplicar frío en contacto directo con la piel', 'El frío se aplica conforme al protocolo evitando el contacto directo, y la compresión suave se comprueba para que no compromete la circulación.'],
      ]),
      repasoRapido([
        'Esguince: lesión de un ligamento por un movimiento que fuerza la articulación más allá de su recorrido.',
        'Da dolor, edema, equimosis y dificultad para apoyar, y la articulación conserva su forma.',
        'Luxación: la articulación pierde la relación entre sus superficies y el hueso sale de su sitio.',
        'Da deformidad evidente, posición fija, pérdida completa del movimiento y dolor intenso.',
        'Desgarro: rotura de fibras musculares o tendinosas, con dolor brusco durante un esfuerzo y pérdida de fuerza.',
        'El esguince y la fractura sin desplazamiento no se distinguen en la calle sin imagen.',
        'En las tres: valorar y anotar el estado neurovascular distal e inmovilizar en la posición encontrada.',
        'Reposo, elevación y frío conforme al protocolo, evitando el contacto directo del frío con la piel.',
        'Compresión suave si el protocolo lo contempla, comprobando que no compromete la circulación.',
        'Analgesia según alcance, reevaluación tras cualquier maniobra y traslado con derivación.',
        'La luxación con pulso ausente, extremidad fría o pálida o pérdida de sensibilidad es una urgencia.',
        'La reducción no la enseña ni la autoriza esta lección, y nunca se intenta por primera vez sobre un paciente real.',
      ]),
      preguntasOrales([
        'Diferencia esguince, luxación y desgarro por la estructura lesionada.',
        '¿Qué se encuentra en cada uno?',
        '¿Por qué no se puede separar un esguince de una fractura en la escena?',
        'Recorre el manejo común a las tres.',
        '¿Qué convierte una luxación en urgencia?',
        '¿Por qué el tiempo importa en ese caso?',
        '¿Qué dice esta lección sobre la reducción?',
        '¿Qué precauciones tiene la aplicación de frío y compresión?',
      ]),
      F([PHTLS, AHA_PA_2024, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('FUERA EN EL MAYOR, DENTRO EN EL JOVEN. La fractura proximal de fémur deja la pierna acortada y rotada hacia FUERA; la luxación de cadera deja cadera y rodilla flexionadas con la pierna girada hacia DENTRO. La posición separa los dos cuadros antes que cualquier otra cosa.'),
          masPreguntado('Que la férula de tracción NO se usa ni en la fractura de cadera ni en la luxación —está indicada solo en la fractura de la diáfisis del fémur— y que la luxación de cadera es sensible al tiempo por el compromiso de la irrigación de la cabeza femoral.'),
        ],
      },
      erroresFrecuentes([
        ['Usar férula de tracción en la cadera', 'Está indicada solo en la fractura de la diáfisis del fémur. Ni la fractura de cadera ni la luxación son su indicación.'],
        ['No preguntar cuánto tiempo lleva en el suelo', 'Una permanencia prolongada añade hipotermia, deshidratación y riesgo de lesión por presión y por aplastamiento.'],
        ['No preguntar por qué cayó', 'Un síncope, una arritmia, una infección o una hipoglucemia previos cambian por completo la atención.'],
        ['Dar la fractura por lesión localizada', 'El foco sangra hacia el muslo y hacia la cadera sin manifestación externa, y en un paciente con poca reserva ese volumen cuenta.'],
      ]),
      repasoRapido([
        'Bajo «lesión de cadera» conviven dos cuadros muy distintos.',
        'Fractura proximal de fémur: persona mayor tras caída desde su propia altura.',
        'Deja la pierna acortada y rotada hacia fuera, con dolor en ingle o cara lateral al mover o cargar.',
        'Su riesgo principal es el sangrado en el muslo, el dolor, las complicaciones por inmovilidad y la descompensación de enfermedades previas.',
        'Luxación de cadera: adulto joven en colisión de alta energía, con impacto de la rodilla contra el salpicadero.',
        'Deja cadera y rodilla flexionadas con la pierna girada hacia dentro, con dolor intenso y bloqueo del movimiento.',
        'Su riesgo es el compromiso de la irrigación de la cabeza del fémur y la lesión del nervio ciático.',
        'La luxación es sensible al tiempo: se traslada con prioridad y la reducción es hospitalaria.',
        'En la persona mayor hay que preguntar el tiempo en el suelo, por qué cayó y qué medicación toma.',
        'Y buscar otros puntos dolorosos y signos de shock, recordando que su respuesta compensatoria puede estar limitada.',
        'Manejo: movilización cuidadosa con camilla de cuchara o colchón de vacío, sosteniendo la extremidad donde menos duela.',
        'Sin férula de tracción, con analgesia según alcance, prevención de hipotermia y valoración neurovascular antes y después.',
      ]),
      preguntasOrales([
        'Distingue los dos cuadros por la posición de la pierna.',
        '¿Qué paciente típico corresponde a cada uno?',
        '¿Cuál es el riesgo principal de cada cuadro?',
        '¿Por qué la luxación de cadera es sensible al tiempo?',
        '¿Se usa férula de tracción aquí? Justifícalo.',
        '¿Por qué la fractura de cadera no es una lesión localizada?',
        'Enumera lo que hay que preguntar en la persona mayor.',
        'Recorre el manejo.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL CAPILAR SE COLAPSA ANTES QUE LA ARTERIA. Por eso el pulso puede seguir latiendo mientras el músculo ya está isquémico, y por eso esperar a que falte el pulso es esperar demasiado.'),
          masPreguntado('Los dos signos que hay que buscar activamente: el dolor desproporcionado y el dolor al estirar pasivamente los dedos. El segundo se comprueba en segundos, y si duele mucho más de lo esperable se documenta con la hora y se comunica.'),
        ],
      },
      erroresFrecuentes([
        ['Esperar la ausencia de pulso', 'Es un signo tardío. La presión necesaria para colapsar el capilar es mucho menor que la necesaria para colapsar la arteria: el pulso conservado no descarta nada.'],
        ['Elevar la extremidad por encima del corazón', 'Reduce la presión con la que llega la sangre y puede empeorar la perfusión. Se mantiene al nivel del corazón.'],
        ['Aplicar frío directo sobre el compartimento', 'La vasoconstricción reduce aún más el aporte.'],
        ['No revisar la propia inmovilización', 'Un vendaje, una férula o un yeso demasiado apretados son una de las causas. Se retiran o aflojan y se reajusta cualquier inmovilización propia.'],
      ]),
      repasoRapido([
        'Cada compartimento contiene músculos, vasos y nervios envueltos por una capa fibrosa que apenas se distiende.',
        'Si el volumen aumenta y el continente no cede, la presión supera la de entrada en los capilares.',
        'El músculo deja de recibir oxígeno aunque siga habiendo pulso distal.',
        'La arteria puede seguir latiendo porque colapsarla exige mucha más presión que colapsar el capilar.',
        'Lo producen fracturas —sobre todo de tibia y antebrazo—, aplastamiento y liberación tras atrapamiento.',
        'También contusión muscular o hematoma en expansión, vendajes o férulas apretados, quemadura circunferencial y reperfusión tras isquemia.',
        'Precoces: dolor desproporcionado que no cede, dolor al estirar pasivamente los dedos y compartimento tenso y duro.',
        'Intermedio: parestesias en el territorio de los nervios del compartimento.',
        'Tardíos: pérdida de fuerza y parálisis, palidez y ausencia de pulso distal.',
        'Se hace: retirar o aflojar lo que comprima, mantener la extremidad al nivel del corazón y analgesia según alcance.',
        'No se hace: elevar por encima del corazón ni aplicar frío directo sobre el compartimento.',
        'En el paciente inconsciente, intoxicado o con lesión medular los signos precoces no existen: solo queda la tensión del compartimento y el mecanismo.',
      ]),
      preguntasOrales([
        'Explica el mecanismo del síndrome compartimental.',
        '¿Por qué el pulso puede estar presente?',
        'Enumera las situaciones que lo producen.',
        'Ordena los signos de precoz a tardío.',
        '¿Cuáles son los dos que se buscan activamente?',
        '¿Cómo se comprueba el dolor al estiramiento pasivo?',
        '¿Por qué no se eleva la extremidad ni se aplica frío?',
        '¿Qué pasa en el paciente que no puede referir dolor?',
      ]),
      F([PHTLS, ACS_BEST, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL PELIGRO ESTÁ EN LA LIBERACIÓN. Mientras el peso sigue encima, lo acumulado permanece confinado; al retirarlo entra de golpe en la circulación. Un paciente que hablaba tranquilamente bajo los escombros puede deteriorarse en minutos justo después de ser liberado.'),
          masPreguntado('La regla que ordena el tema: si el paciente lleva atrapado un tiempo prolongado y su situación lo permite, el tratamiento empieza ANTES de retirar el peso, no después. Y que no hace falta un derrumbe: la situación más frecuente es una persona mayor que cae y permanece horas sobre su propio brazo o cadera.'),
        ],
      },
      erroresFrecuentes([
        ['Liberar y después tratar', 'El tratamiento empieza antes de retirar el peso cuando la situación lo permite. La liberación se coordina y no se improvisa.'],
        ['Buscar solo el derrumbe clásico', 'La situación más frecuente es doméstica: una persona que cae, no puede levantarse y permanece horas sobre su propio brazo o cadera.'],
        ['Colocar un torniquete de rutina sobre la extremidad liberada', 'Su uso responde a la indicación de hemorragia y a lo que fije el protocolo, no a la contención del síndrome.'],
        ['No avisar al equipo del momento de la liberación', 'La vigilancia tiene que concentrarse justo ahí: es cuando el paciente puede deteriorarse en minutos.'],
      ]),
      repasoRapido([
        'La compresión sostenida corta el aporte de sangre y la célula muscular se rompe y libera su contenido.',
        'Libera potasio, mioglobina, ácidos y otras sustancias, que quedan confinadas mientras el peso sigue encima.',
        'Al mismo tiempo, el músculo dañado atrae líquido desde la sangre y lo secuestra.',
        'Al retirar la compresión, todo lo acumulado entra de golpe al torrente.',
        'El potasio puede alterar el ritmo cardiaco, la mioglobina puede dañar el riñón y la salida de líquido puede producir hipotensión.',
        'Se sospecha ante atrapamiento de una masa muscular importante durante un tiempo prolongado.',
        'También ante personas encontradas caídas e inmóviles durante horas, aunque no haya ningún peso encima.',
        'Y ante compresión por el propio cuerpo en pacientes inconscientes o intoxicados.',
        'Y ante cualquier extremidad que, tras la liberación, aparezca fría, dura, edematosa e insensible.',
        'Secuencia: seguridad y coordinación con rescate, valoración y protección térmica mientras sigue atrapado.',
        'Anotar el tiempo de atrapamiento y la masa comprimida, y preparar antes de liberar lo que autorice el protocolo.',
        'Avisar del momento exacto de la liberación, reevaluar de inmediato y trasladar con prealerta explícita del tiempo de atrapamiento.',
      ]),
      preguntasOrales([
        'Explica qué pasa en el músculo comprimido.',
        '¿Por qué el peligro está en la liberación?',
        '¿Qué tres consecuencias sistémicas puede tener?',
        'Enumera las situaciones de riesgo.',
        '¿Hace falta un derrumbe? Pon el ejemplo más frecuente.',
        'Di la regla que ordena todo el tema.',
        'Recorre la secuencia de trabajo.',
        '¿Qué le pasa a la extremidad después de liberarla?',
      ]),
      F([PHTLS, ACS_BEST, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('HARE APOYA EN EL ISQUION, SAGER EN LA CARA INTERNA. Y las dos sirven para lo mismo y solo para eso: la fractura de la diáfisis del fémur, aislada y cerrada.'),
          masPreguntado('Las contraindicaciones, que son tan importantes como la técnica; y que la cantidad de tracción no es una cifra: el criterio es el alivio del dolor y del espasmo con recuperación aproximada de la longitud, conforme a las instrucciones del fabricante y al protocolo.'),
        ],
      },
      erroresFrecuentes([
        ['Usarla con sospecha de fractura de pelvis o lesión de cadera', 'Está contraindicada, igual que ante lesión de rodilla o del extremo distal del fémur, fractura de pierna, tobillo o pie en esa extremidad, amputación parcial y lesiones que impidan apoyar los puntos de tracción. Ante la duda se inmoviliza con otro método.'],
        ['Perseguir una cifra de tracción', 'El criterio clínico es el alivio del dolor y del espasmo con recuperación aproximada de la longitud. Cada dispositivo tiene su sistema, y el fabricante y el protocolo fijan cómo se ajusta.'],
        ['Medir el dispositivo sobre la extremidad lesionada', 'Se mide sobre la extremidad sana antes de aplicarlo, conforme a las instrucciones del fabricante.'],
        ['Olvidar que los puntos de apoyo lesionan', 'La contratracción se ejerce sobre la región perineal o el isquion, zonas sensibles. Se acolcha, se comprueba tras cada movilización y se documenta la hora de colocación.'],
      ]),
      repasoRapido([
        'Al fracturarse la diáfisis del fémur, los músculos del muslo se contraen y los extremos óseos cabalgan.',
        'Ese acortamiento aumenta el dolor, puede lesionar tejidos y amplía el espacio donde se acumula la sangre.',
        'La tracción sostenida contrarresta el espasmo: alinea, alivia y reduce el volumen disponible para el sangrado.',
        'Su indicación es estrecha: fractura de la diáfisis del fémur, aislada y cerrada.',
        'Está contraindicada ante sospecha de fractura de pelvis, lesión o luxación de cadera y lesión de rodilla o del fémur distal.',
        'También ante fractura de pierna, tobillo o pie en esa extremidad, amputación parcial y lesiones que impidan apoyar los puntos de tracción.',
        'Hare: anillo acolchado contra el isquion; se extiende más allá del pie y requiere espacio.',
        'Sager: barra apoyada en la cara interna del muslo, contra la región perineal; más compacta y permite traccionar ambos fémures.',
        'Secuencia con dos operadores: confirmar indicación, exponer, valorar y anotar el estado neurovascular.',
        'Tracción manual suave y sostenida mientras el otro operador prepara, midiendo el dispositivo sobre la extremidad sana.',
        'Colocar contratracción y sujeciones acolchando los puntos de presión, y aplicar la tracción de forma progresiva.',
        'Volver a valorar y anotar, y reevaluar durante todo el traslado, porque la tracción puede aflojarse o excederse.',
      ]),
      preguntasOrales([
        '¿Cuál es la indicación de la férula de tracción?',
        'Explica por qué funciona.',
        'Enumera las contraindicaciones.',
        'Distingue Hare de Sager por su punto de contratracción.',
        'Recorre la secuencia de aplicación.',
        '¿Sobre qué extremidad se mide el dispositivo?',
        '¿Cuánta tracción se aplica, y quién lo fija?',
        '¿Qué riesgo tienen los puntos de apoyo?',
      ]),
      F([PHTLS, AHA_PA_2024, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('FORMULARIO, ALCANCE E INDICACIÓN. Antes de administrar cualquier cosa se comprueban tres: que el fármaco esté en el formulario y disponible, que el prestador tenga el alcance autorizado, y que exista una indicación respaldada. Si falta una de las tres, no se administra.'),
          masPreguntado('Que el cloruro de etilo es superficial y de efecto muy breve, así que NO sirve para el dolor de una fractura ni sustituye a una analgesia sistémica. Y que la inmovilización correcta, la posición, la elevación y el frío son analgesia también, y no requieren autorización farmacológica.'),
        ],
      },
      erroresFrecuentes([
        ['Usar cloruro de etilo para el dolor de una fractura', 'Su efecto es superficial y de muy corta duración: no sirve para eso ni sustituye a una analgesia sistémica. Además es inflamable y no se aplica sobre heridas, mucosas ni cerca de los ojos.'],
        ['Dar los antiinflamatorios por inocuos en el traumatizado', 'Pueden dañar la mucosa digestiva, comprometer la función renal en un paciente hipovolémico y afectar a la coagulación. En un traumatizado con sangrado o shock eso deja de ser secundario, y la alergia hay que preguntarla siempre.'],
        ['Administrar un opioide sin poder vigilar', 'Exige poder vigilar la respiración y la conciencia, tener material de soporte a mano y una autorización explícita, y preguntar por consumo previo de otros depresores, incluido el alcohol.'],
        ['Registrar solo el alivio', 'Se vigilan y se documentan los efectos, no solo el alivio, y se comunica en la entrega todo lo administrado aunque el paciente parezca cómodo.'],
      ]),
      repasoRapido([
        'Esta lección declara su bloqueo: no publica dosis, concentraciones, intervalos ni vías preferentes.',
        'Antes de administrar se comprueban formulario y disponibilidad, alcance del prestador e indicación respaldada.',
        'Los antiinflamatorios no esteroideos alivian el dolor inflamatorio y musculoesquelético sin deprimir conciencia ni respiración.',
        'Sus límites: mucosa digestiva, función renal en el hipovolémico, coagulación en algunos de ellos y alergia frecuente.',
        'Los opioides controlan un dolor intenso que los anteriores no alcanzan y permiten inmovilizar y trasladar.',
        'Su precio: depresión respiratoria, descenso de conciencia, hipotensión, náusea, vómito y picor.',
        'Exigen vigilar respiración y conciencia, material de soporte a mano y autorización explícita.',
        'El cloruro de etilo es un anestésico local por evaporación: enfría y reduce brevemente la sensibilidad superficial.',
        'No sirve para el dolor de una fractura ni sustituye a una analgesia sistémica.',
        'Es inflamable, no se aplica sobre heridas ni mucosas, no se usa cerca de los ojos y su aplicación prolongada puede producir lesión por frío.',
        'Siempre: medir el dolor antes y después, preguntar alergias, medicación, consumo y embarazo cuando corresponda.',
        'Y recordar que inmovilizar bien, la posición, la elevación y el frío son analgesia y no requieren autorización farmacológica.',
      ]),
      preguntasOrales([
        '¿Por qué esta lección no publica cifras?',
        'Di las tres comprobaciones previas a cualquier administración.',
        '¿Qué aportan los antiinflamatorios y qué los limita?',
        '¿Qué aportan los opioides y qué obligan a vigilar?',
        '¿Qué es el cloruro de etilo y cuál es su alcance real?',
        '¿Por qué no sirve para el dolor de una fractura?',
        'Enumera lo que siempre se hace antes, durante y después.',
        '¿Qué analgesia no requiere autorización farmacológica?',
      ]),
