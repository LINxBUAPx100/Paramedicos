    ...
    secciones: [
      {
        ...
        bloques: [
          ...
          masPreguntado('Lo que más se pregunta de este tema no es la secuencia: es que la intubación NO es el objetivo —oxigenar y ventilar lo son— y que ningún método aislado confirma la posición del tubo. Las dos son decisiones, y las decisiones son lo que se evalúa.'),
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PREPARAR, INTENTAR, CONFIRMAR — y de los tres, el que decide el resultado es el primero. La mayor parte de las complicaciones de la intubación prehospitalaria se originan ANTES del primer intento: material comprobado al alcance, paciente oxigenado y plan de rescate dicho en voz alta.'),
        ],
      },
      {
        titulo: 'Secuencia',
      ...
      erroresFrecuentes([
        ['Hacer palanca sobre los incisivos', 'Es el error técnico más frecuente y el que rompe dientes. La tracción se hace en el eje del mango, no apoyándose en la arcada superior.'],
        ['Prolongar el intento mientras el paciente dessatura', 'Alcanzado el límite de tiempo y de saturación acordado, se interrumpe, se ventila con bolsa-mascarilla y se replantea. Insistir en el mismo intento es la vía más rápida a una hipoxia grave.'],
        ['Confirmar con un solo método', 'Ninguno confirma con certeza por sí solo. Se combinan visualización, auscultación en epigastrio y ambos campos, elevación torácica y capnografía cuando la hay. Una intubación esofágica no reconocida es una causa evitable de muerte.'],
        ['Dar por buena la posición después de mover al paciente', 'Un tubo bien colocado puede desplazarse al pasar a la camilla o al subir a la unidad. La confirmación se repite tras cada movilización, y por eso se registra la profundidad a la altura de los dientes.'],
        ['Descubrir la vía aérea difícil a mitad del intento', 'Apertura bucal limitada, cuello corto o inmovilizado, obesidad, sangre o vómito, trauma facial, edema o antecedente de dificultad se valoran ANTES. Reconocerlo cambia el plan; descubrirlo dentro, no.'],
      ]),
      repasoRapido([
    ...
    secciones: [
      {
        ...
        bloques: [
          ...
          mnemotecnia('CURVA A LA VALÉCULA, RECTA A LA EPIGLOTIS. Ahí cabe toda la diferencia entre las dos hojas: la curva se apoya DELANTE de la epiglotis y la levanta tirando del ligamento; la recta la carga directamente con la punta.'),
      ...
      erroresFrecuentes([
        ['Memorizar una tabla de calibres que no coincide con la unidad', 'Las referencias varían entre fuentes y ediciones. Una tabla aprendida que no se corresponde con el material de la ambulancia produce errores: la academia declara qué referencia adopta y el prestador conoce su inventario.'],
        ['No preparar un calibre alternativo', 'Descubrir que el tubo no pasa cuando ya se está en laringoscopia obliga a interrumpir el intento. Con el calibre inferior listo, eso es un cambio de segundos.'],
        ['Saltarse la comprobación del globo', 'Un globo que no sella, descubierto durante el procedimiento, obliga a repetir la intubación entera. Se comprueba inflándolo y desinflándolo antes de cada uso.'],
        ['Sobreinflar el globo', 'Se emplea el volumen mínimo que consiga sellar. Un globo sobreinflado transmite presión a la mucosa traqueal y puede comprometer su irrigación.'],
      ]),
      repasoRapido([
    ...
    secciones: [
      {
        ...
        bloques: [
          ...
          masPreguntado('Se pregunta por su LUGAR y por su límite: es rescate cuando la intubación falla o alternativa cuando no se está autorizado a intubar, y su protección frente a la aspiración es parcial y limitada. Rápida y a ciegas no significa segura frente al contenido gástrico.'),
        ],
      },
      {
      ...
      erroresFrecuentes([
        ['Usar una cifra de inflado o de tamaño de otro modelo', 'Los supraglóticos no son intercambiables entre marcas: el tamaño por peso y el volumen de inflado varían. Se sigue la indicación impresa del dispositivo que hay en la unidad, no una cifra memorizada.'],
        ['Confiar en que protege de la aspiración', 'No aísla la vía aérea; la protección es parcial y limitada. Si aparece contenido gástrico se lateraliza al paciente cuando su situación lo permite, se aspira y se replantea el dispositivo.'],
        ['Insistir con presiones de ventilación altas', 'El sello puede perderse cuando se requieren presiones altas. Forzar la insuflación no mejora el sello: lo empeora y aumenta la insuflación gástrica.'],
        ['Esperar que resuelva una obstrucción baja', 'Sella POR ENCIMA de la glotis. Una obstrucción por debajo no se resuelve con un dispositivo supraglótico, por bien colocado que esté.'],
      ]),
      repasoRapido([
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          masPreguntado('De este tema se pregunta la COMPARACIÓN, no el dispositivo: el obturador bloqueaba el esófago para desviar el aire; el supraglótico moderno sella sobre la entrada de la laringe. Ese cambio de estrategia es lo que hay que saber explicar.'),
      ...
      erroresFrecuentes([
        ['Estudiarlo como una opción vigente', 'Aparece en el plan oficial y por eso se estudia, pero NO es un dispositivo estándar de la práctica actual. Confundir un antecedente con una alternativa disponible es el error que esta lección existe para evitar.'],
        ['Confundir bloquear el esófago con sellar la laringe', 'Son estrategias opuestas. El obturador obstruía el esófago para que el aire subiera a la laringe; el supraglótico sella alrededor de la entrada de la laringe y deja el esófago en paz.'],
        ['Suponer que aislaba la vía aérea', 'No evitaba la aspiración de contenido regurgitado por encima del globo, y su retirada podía acompañarse de vómito abundante justo en el peor momento.'],
      ]),
      repasoRapido([
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SE BAJA DESDE LA NUEZ HASTA CAER EN EL HUECO. El dedo parte de la prominencia del cartílago tiroides y desciende hasta la depresión blanda que precede al cricoides: esa depresión es la membrana. Dos cartílagos palpables y un hueco entre ellos, y no hace falta nada más para localizarla.'),
      ...
      },
      {
        ...
        bloques: [
          ...
          masPreguntado('Tres respuestas se piden siempre: que es un procedimiento de RESCATE —cuando no se puede ventilar por ningún medio, no un peldaño más de la escalera—, dónde está el punto de punción, y que oxigena pero elimina mal el dióxido de carbono, así que no sustituye a una vía aérea definitiva.'),
      ...
      erroresFrecuentes([
        ['Tratarlo como un peldaño más de la escalera', 'No es una alternativa a la intubación: es lo que se hace cuando la escalera se agotó y el paciente sigue sin oxigenarse. Plantearlo antes de tiempo es tan grave como plantearlo tarde.'],
        ['Dar por autorizado lo que solo está estudiado', 'La ejecución depende de la certificación del prestador, del equipamiento de la unidad y de la dirección médica. El temario describe la técnica; la autorización la dan la academia y el protocolo.'],
        ['Soltar el catéter', 'Un catéter de ese calibre se desplaza con facilidad. Se sujeta durante todo el procedimiento, se fija y se comprueba tras cada movilización.'],
        ['Insuflar sin vigilar el enfisema', 'Si el catéter quedó fuera de la luz traqueal, la insuflación produce enfisema subcutáneo. Un enfisema creciente obliga a reevaluar la posición de inmediato.'],
        ['Aplicar una presión o unos tiempos memorizados', 'El sistema conectado, la presión y los tiempos de insuflación y espiración dependen del equipo y del protocolo. Una cifra equivocada aquí produce barotrauma.'],
      ]),
      repasoRapido([
