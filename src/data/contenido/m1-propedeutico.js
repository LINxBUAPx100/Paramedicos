    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('INMEDIATOS, LIMITADOS Y TEMPORALES: esas tres palabras cargan todo el peso de la definición. Y el orden de los objetivos tampoco es decorativo: conservar la vida, evitar que empeore, aliviar, facilitar el traslado.'),
          masPreguntado('Que la diferencia entre primeros auxilios y atención prehospitalaria no es de intención sino de capacidad: el primer respondiente hace lo que puede con lo que tiene y el TUM llega con formación, equipo y un sistema detrás.'),
        ],
      },
      erroresFrecuentes([
        ['Atender primero lo que más llama la atención', 'Si el orden de los objetivos se invierte se pierde tiempo en lo cómodo en lugar de lo urgente. Una fractura evidente y aparatosa atrae la mirada; una vía aérea comprometida, no. La primera espera; la segunda, no.'],
        ['Creer que la supervivencia depende de un solo acto heroico', 'Depende de una secuencia de eslabones que solo funciona completa: si un eslabón falla, los demás pierden eficacia. Y los dos primeros dependen de un lego, no de un profesional.'],
        ['Entrar a una escena que no está segura', 'Es la regla que no se negocia: si la escena no es segura, no se entra; se asegura primero o se espera al recurso que pueda asegurarla. Un respondiente lesionado convierte a una víctima en dos y resta un par de manos.'],
        ['Extender los primeros auxilios más allá de la propia formación', 'Son limitados por definición: llegan hasta donde llega la formación de quien atiende. Rebasar ese límite no añade ayuda, añade riesgo.'],
      ]),
      repasoRapido([
        'Los primeros auxilios son los cuidados inmediatos, limitados y temporales que se prestan antes de que llegue la atención profesional.',
        'Inmediatos porque empiezan donde ocurre el hecho, limitados porque llegan hasta donde llega la formación de quien atiende, y temporales porque terminan al llegar el recurso profesional.',
        'La diferencia con la atención prehospitalaria no es de intención sino de capacidad.',
        'Los objetivos, en orden: conservar la vida, evitar que las lesiones empeoren, aliviar el dolor y el sufrimiento —incluido el emocional— y facilitar el traslado y la continuidad de la atención.',
        'Conservar la vida va primero porque lo que mata en minutos se atiende antes que lo aparatoso.',
        'La cadena de supervivencia en el paro cardiaco extrahospitalario empieza por el reconocimiento inmediato y la activación del SMU.',
        'Siguen la RCP precoz con énfasis en las compresiones y la desfibrilación rápida.',
        'Cierran la cadena el soporte vital avanzado con los cuidados posparo, y la recuperación y rehabilitación.',
        'La cadena solo funciona completa: si un eslabón falla, los demás pierden eficacia.',
        'Los dos primeros eslabones dependen de un lego, y por eso la formación de la población cambia la supervivencia más que casi cualquier tecnología a bordo.',
        'La evaluación de la escena precede siempre al contacto con el paciente.',
        'Si la escena no es segura no se entra: ninguna víctima justifica un rescatador lesionado.',
      ]),
      preguntasOrales([
        'Define primeros auxilios y explica qué aporta cada una de las tres palabras que delimitan su alcance.',
        '¿En qué se diferencian los primeros auxilios de la atención prehospitalaria?',
        'Enumera los objetivos de la atención inicial en su orden de prioridad.',
        'Explica por qué el orden de esos objetivos no es decorativo, con un ejemplo.',
        'Recita los eslabones de la cadena de supervivencia en el paro cardiaco extrahospitalario.',
        '¿Por qué se dice que la cadena solo funciona completa?',
        '¿Cuáles de los eslabones dependen de un lego y qué consecuencia tiene eso para la formación de la población?',
        'Explica la regla que no se negocia sobre la seguridad de la escena.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ALERTA, VERBAL, DOLOR, INCONSCIENTE: cuatro escalones para una sola pregunta, cuánto estímulo hace falta para que responda. Y a partir de D hay que asumir que la vía aérea está en riesgo.'),
          masPreguntado('Que la letra sola no vale: lo que informa es el cambio, no la foto. Un paciente en V que hace poco estaba en A es una urgencia mayor que uno que lleva mucho más tiempo en V, y comunicar la tendencia anticipa mientras comunicar el estado solo describe.'),
        ],
      },
      erroresFrecuentes([
        ['Registrar una letra de AVDI y darla por definitiva', 'El valor de AVDI está en la tendencia: se repite tantas veces como haga falta y se anota la hora de cada valoración, porque sin hora no hay tendencia.'],
        ['No relacionar el nivel con el riesgo de vía aérea', 'La utilidad práctica de AVDI es que predice quién no puede proteger su propia vía aérea. A partir de D hay que asumir que está en riesgo y preparar aspiración, posición y apoyo ventilatorio.'],
        ['Comunicar el estado en lugar del cambio', 'Decir que está en Verbal informa menos que decir que llegó Alerta y pasó a Verbal. Lo primero describe; lo segundo anticipa, y cambia la preparación del recurso que viene en camino.'],
        ['Colgar antes de que lo indique el operador', 'El operador puede guiar mientras llega la unidad, RCP telefónica incluida, y necesita poder volver a llamar si no encuentra el acceso.'],
      ]),
      repasoRapido([
        'AVDI responde a una sola pregunta: cuánto estímulo hace falta para que este paciente responda.',
        'A de Alerta significa que está despierto y responde espontáneamente: habla, mira y se mueve sin estímulo.',
        'V de Verbal significa que responde solo cuando se le habla, y se comprueba llamándole en voz alta.',
        'D de Dolor significa que responde solo al estímulo doloroso, aplicado con presión firme en el trapecio o el lecho ungueal.',
        'I de Inconsciente significa que ningún estímulo obtiene respuesta.',
        'Se aplica en segundos y se repite, porque su valor está en la tendencia y no en una foto aislada.',
        'Quien solo responde al dolor o no responde ha perdido, total o parcialmente, los reflejos que impiden que la lengua obstruya o que el contenido gástrico pase a la vía respiratoria.',
        'A partir de D se asume que la vía aérea está en riesgo: hay que preparar aspiración, posición y apoyo ventilatorio.',
        'El descenso de escalón suele aparecer antes que cualquier otro signo medible, y es un hallazgo que el primer respondiente detecta sin equipo.',
        'Ante un descenso se reevalúan vía aérea, ventilación y perfusión, y se buscan causas corregibles al alcance, como una vía aérea comprometida por la posición.',
        'Hay que avisar al recurso en camino o al equipo receptor, y anotar la hora de cada valoración.',
        'Activar el SMU es pedir el recurso correcto al sitio correcto con la información correcta: ubicación exacta, qué ocurrió y cuántos afectados, estado aparente, riesgos de la escena, nombre y contacto.',
      ]),
      preguntasOrales([
        'Enumera los cuatro niveles de AVDI y di cómo se comprueba cada uno.',
        '¿Qué única pregunta responde la escala AVDI?',
        'Explica por qué la letra sola no vale y qué hay que anotar para que sirva.',
        '¿A partir de qué nivel se asume riesgo de vía aérea y qué se prepara entonces?',
        'Explica qué reflejos ha perdido quien solo responde al dolor.',
        'Ordena lo que hay que hacer ante un descenso de nivel.',
        'Enumera en orden lo que hay que decir al activar el SMU.',
        '¿Por qué no se debe colgar antes de que lo indique el operador?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO RESPONDE Y NO RESPIRA: con esos dos hallazgos se reconoce el paro, y el boqueo cuenta como no respirar. Ante la duda se comprime: el daño de comprimir a quien no lo necesitaba es mucho menor que el de no comprimir a quien sí.'),
          masPreguntado('La reexpansión completa, que es el parámetro que más se descuida. Si el reanimador se queda apoyado sobre el tórax, el corazón no vuelve a llenarse y la siguiente compresión mueve mucha menos sangre, por perfecta que sea la profundidad.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar la respiración agónica como respiración', 'Las bocanadas aisladas, ruidosas e irregulares NO son respiración: son un signo de paro. Confunden a quien no las conoce y retrasan el inicio de las compresiones.'],
        ['Alargar la comprobación buscando certeza', 'La comprobación no debe superar los diez segundos. Ante la duda se asume paro y se comprime, porque el daño de comprimir a quien no lo necesitaba es mucho menor que el de no comprimir a quien sí.'],
        ['Quedarse apoyado sobre el tórax entre compresiones', 'Impide la reexpansión completa, y sin reexpansión el corazón no se llena. Es el parámetro que más se descuida y el que arruina compresiones que por profundidad y frecuencia serían correctas.'],
        ['Interrumpir las compresiones para intentar ventilar sin entrenamiento', 'Un reanimador lego sin entrenamiento en ventilación debe hacer RCP únicamente con compresiones, continuas y sin pausas. Es preferible a una RCP interrumpida por intentos mal ejecutados.'],
      ]),
      repasoRapido([
        'El paro cardiaco se reconoce con dos hallazgos: la persona no responde y no respira o solo boquea.',
        ...
        'La reexpansión completa es el parámetro que más se descuida, y sin ella la siguiente compresión mueve mucha menos sangre.',
        'Un reanimador lego sin entrenamiento en ventilación debe hacer RCP únicamente con compresiones, continuas y sin pausas.',
        'La calidad de las compresiones cae de forma medible al cabo de uno o dos minutos, antes de que el reanimador se sienta cansado, y por eso el relevo se hace por reloj y no por sensación.',
        'El relevo eficiente cambia de reanimador cada dos minutos aproximadamente, se anuncia antes, se coloca en posición mientras el otro sigue comprimiendo y se ejecuta en menos de 5 segundos.',
      ]),
      preguntasOrales([
        '¿Con qué dos hallazgos se reconoce un paro cardiaco?',
        'Explica qué es la respiración agónica y por qué confunde.',
        '¿Cuánto tiempo como máximo dura la comprobación y qué se hace ante la duda?',
        'Enumera los parámetros de una compresión de alta calidad en el adulto.',
        '¿Cuál es el parámetro que más se descuida y qué consecuencia tiene descuidarlo?',
        '¿Qué debe hacer un reanimador lego sin entrenamiento en ventilación, y por qué?',
        'Explica por qué el relevo se hace por reloj y no por sensación de cansancio.',
        'Ordena los pasos de un relevo eficiente.',
      ]),
      FUENTES_SOPORTE_VITAL,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO ARRANCA, REORDENA: el DEA no pone en marcha un corazón parado, detiene una actividad eléctrica caótica para que el marcapasos natural retome el control. Por eso la asistolia no se desfibrila: no hay nada que reorganizar.'),
          masPreguntado('Qué hacer cuando el equipo dice que la descarga no está indicada, y qué hacer justo después de una descarga. En los dos casos lo mismo: reanudar de inmediato las compresiones, sin comprobar pulso, porque son ellas las que mantienen la perfusión.'),
        ],
      },
      erroresFrecuentes([
        ['Decir que el DEA arranca un corazón parado', 'Analiza el ritmo y decide si una descarga puede ayudar. Lo que hace es detener una actividad eléctrica caótica para que el marcapasos natural retome el control, y por eso la asistolia no se desfibrila.'],
        ['Buscar pulso justo después de la descarga', 'Es una pausa larga y poco informativa: el corazón rara vez recupera circulación eficaz en ese instante. Tras la descarga se vuelve a comprimir en el acto.'],
        ['Confiar el «todos fuera» solo al aviso verbal', 'La comprobación es visual, no auditiva: hay que mirar de arriba abajo del paciente y decirlo en voz alta. No basta con avisar.'],
        ['Descargar sobre un paciente mojado o sobre superficie metálica', 'El agua dispersa la corriente por la superficie del cuerpo, de modo que llega menos al corazón, y pone en riesgo de descarga a quien esté en contacto con el charco. Hay que retirarlo del agua, secar el tórax y aislar o mover la superficie.'],
      ]),
      repasoRapido([
        'El DEA analiza el ritmo cardiaco y decide si una descarga puede ayudar.',
        'No arranca un corazón parado: detiene una actividad eléctrica caótica —fibrilación ventricular o taquicardia ventricular sin pulso— para que el marcapasos natural retome el control.',
        'La asistolia no se desfibrila porque no hay actividad eléctrica que reorganizar; el equipo dirá que la descarga no está indicada y la conducta es reanudar compresiones.',
        'La probabilidad de éxito cae de forma sostenida con cada minuto desde el colapso, y por eso el DEA se busca al mismo tiempo que se activa el SMU.',
        'La secuencia es encender y seguir las instrucciones de voz, descubrir y secar el tórax y colocar los parches, apartarse durante el análisis, verificar visualmente y pulsar si indica descarga, y reanudar compresiones de inmediato.',
        'Tras la descarga se comprime en el acto, sin comprobar pulso.',
        'Hay dos posiciones aceptadas: la anterolateral, con un parche bajo la clavícula derecha y otro en la línea axilar media izquierda, y la anteroposterior, con uno en el pecho y otro en la espalda.',
        'Lo que importa es que la corriente atraviese el corazón, y las guías de la AHA de 2025 equiparan explícitamente ambas posiciones.',
        'Esas mismas guías precisan que en el adulto los electrodos deben superar los ocho centímetros de diámetro y dejan de hablar de «ventilaciones de rescate» para decir simplemente «ventilaciones».',
        'Si el tórax está mojado se seca antes de pegar los parches; si hay vello abundante se rasura la zona o se arranca el parche y se usa uno nuevo.',
        'Un parche de medicación en el tórax se retira y se limpia la piel; ante un marcapasos o desfibrilador implantado el parche se coloca a un través de dedo del dispositivo.',
        'Antes de cada descarga se mira de arriba abajo del paciente y se dice en voz alta «yo fuera, tú fuera, todos fuera».',
      ]),
      preguntasOrales([
        'Explica qué hace y qué no hace un DEA.',
        '¿Por qué la asistolia no se desfibrila y qué se hace cuando el equipo dice que la descarga no está indicada?',
        '¿Por qué el DEA se busca al mismo tiempo que se activa el SMU y no después?',
        'Ordena los pasos de la secuencia de uso del DEA.',
        '¿Por qué no se busca pulso justo después de la descarga?',
        'Describe las dos posiciones aceptadas de los parches y di qué es lo que realmente importa.',
        'Di qué hacer ante tórax mojado, vello abundante, parche de medicación y dispositivo implantado.',
        'Explica por qué la comprobación de «todos fuera» es visual y no auditiva.',
      ]),
      FUENTES_SOPORTE_VITAL,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SI TOSE BIEN, NO ESTORBES: la tos eficaz es la mejor maniobra que existe, y golpear la espalda de quien tose con fuerza puede convertir una obstrucción leve en grave. Y la pregunta que resuelve la duda es directa: ¿te estás ahogando?'),
          masPreguntado('Que el algoritmo vigente combina dos maniobras en ciclos y no una sola repetida: cinco golpes dorsales seguidos de cinco compresiones abdominales, repitiendo los ciclos. La enseñanza anterior aplicaba compresiones abdominales repetidas sin el ciclo inicial de golpes en la espalda.'),
        ],
      },
      erroresFrecuentes([
        ['Golpear la espalda de quien tose con fuerza', 'Es el error clásico: puede desplazar el objeto y convertir una obstrucción leve en una grave. Si tose eficazmente, la mejor maniobra es no interferir y animar a toser.'],
        ['Esperar el signo universal de atragantamiento para actuar', 'Es útil, pero muchos pacientes no lo hacen. La pregunta directa resuelve la duda: quien no puede contestar tiene una obstrucción grave.'],
        ['Comprimir el abdomen cuando no procede', 'En embarazo avanzado y cuando no es posible rodear el abdomen, las compresiones abdominales se sustituyen por compresiones torácicas sobre la mitad inferior del esternón. Los golpes dorsales se mantienen igual.'],
        ['Hacer barrido digital a ciegas', 'Está proscrito: empuja el objeto más adentro y puede lesionar la vía aérea. Antes de cada ventilación se mira la boca y se retira el cuerpo extraño solo si es visible y alcanzable.'],
      ]),
      repasoRapido([
        'En la obstrucción leve la tos es eficaz y fuerte, la persona puede hablar y entra aire aunque con esfuerzo; la conducta es animar a toser y no golpear la espalda.',
        'En la obstrucción grave la tos es débil o ausente, no puede hablar ni emitir sonido y no entra aire o hay estridor; hay que intervenir de inmediato.',
        'El signo universal de atragantamiento es útil, pero la pregunta directa resuelve la duda: quien no puede contestar tiene obstrucción grave.',
        'El algoritmo de la AHA de 2025 combina dos maniobras en ciclos y no una sola repetida.',
        'Se confirma la obstrucción grave, se avisa de que se va a ayudar y se activa el sistema de emergencias.',
        'Se coloca al reanimador a un lado y ligeramente detrás, y se inclina el tronco de la persona hacia delante.',
        'Se aplican cinco golpes dorsales con el talón de la mano entre las escápulas, uno a uno y comprobando el efecto tras cada golpe.',
        'Si no se resuelve, se coloca detrás, se rodea la cintura y se sitúa el puño por encima del ombligo y por debajo del apéndice xifoides.',
        'Se aplican cinco compresiones abdominales hacia dentro y hacia arriba, y se repiten los ciclos hasta expulsar el objeto o hasta que la persona pierda la respuesta.',
        'En embarazo avanzado y cuando no se puede rodear el abdomen, las abdominales se sustituyen por torácicas sobre la mitad inferior del esternón, y los golpes dorsales se mantienen.',
        'Si el paciente se desploma la situación se maneja como un paro: se le acompaña al suelo, se activa el SMU si no se ha hecho y se inician compresiones.',
        'Las compresiones torácicas generan presión en la vía aérea y pueden desplazar el objeto; el barrido digital a ciegas está proscrito.',
      ]),
      preguntasOrales([
        'Compara la obstrucción leve y la grave en tos, habla, respiración y conducta.',
        '¿Por qué golpear la espalda de quien tose con fuerza puede empeorar la situación?',
        '¿Qué pregunta directa resuelve la duda sobre la gravedad y por qué funciona?',
        'Ordena la secuencia de la AHA de 2025 para el adulto consciente con obstrucción grave.',
        '¿En qué se diferencia el algoritmo vigente de la enseñanza anterior?',
        'Di en qué dos situaciones no se comprime el abdomen y qué se hace en su lugar.',
        '¿Qué cambia cuando el paciente pierde la respuesta y por qué comprimir ayuda ahí?',
        'Explica por qué el barrido digital a ciegas está proscrito.',
      ]),
      {
        titulo: 'Fuentes',
        bloques: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRESIONA, EMPAQUETA O TORNIQUETA: presión directa primero, empaquetamiento donde no cabe torniquete —ingle, axila, cuello— y torniquete en extremidad que la presión no controla. Y una regla: lo que se empapa se refuerza encima, nunca se retira.'),
          masPreguntado('Por qué la hemorragia exanguinante va antes que la vía aérea. Es la razón de la X que antecede al ABCDE en el abordaje del trauma: un sangrado masivo mata más rápido que casi cualquier otra cosa, así que se controla primero.'),
        ],
      },
      erroresFrecuentes([
        ['Levantar el apósito para comprobar si sigue sangrando', 'Cada comprobación rompe el coágulo que se estaba formando. Si el apósito se empapa se añade otro encima, sin retirar el anterior, y la presión se mantiene sin interrupciones hasta el relevo.'],
        ['Comprimir sin exponer la herida', 'No se puede comprimir lo que no se ve. La presión tiene que caer firme y sostenida sobre el punto exacto que sangra, con el talón de la mano.'],
        ['Colocar el torniquete sobre una articulación', 'Va proximal a la herida y sobre un segmento con un solo hueso, no sobre una articulación. La referencia habitual es unos centímetros por encima del borde de la herida, y cada dispositivo indica en sus instrucciones su propia colocación.'],
        ['Aflojar el torniquete porque el paciente se queja', 'Un torniquete bien puesto duele, y eso no es un fallo. Aflojarlo reanuda la hemorragia y desperdicia el tiempo que ya estuvo puesto; en el ámbito prehospitalario no se afloja ni se retira.'],
      ]),
      repasoRapido([
        'La hemorragia arterial es roja brillante y sale a chorro pulsátil, y su riesgo es alto porque puede exanguinar en minutos.',
        'La venosa es roja oscura y de flujo continuo, con riesgo moderado a alto según el calibre; la capilar es superficial, en sábana, y suele autolimitarse.',
        'La hemorragia exanguinante va antes que la vía aérea, y es la razón de la X que antecede al ABCDE en el abordaje del trauma.',
        'La presión directa es la primera medida y resuelve la mayoría de las hemorragias externas.',
        'Se aplica con gasa o el material más limpio disponible, firme, sobre el punto exacto que sangra, y sin levantar para mirar.',
        'Hay que exponer la herida, presionar con el talón de la mano, añadir apósito encima si se empapa y mantener la presión hasta el relevo.',
        'Las guías de primeros auxilios de la AHA y la Cruz Roja de 2024 recomiendan, ante una hemorragia que amenaza la vida, presión directa y a continuación torniquete o empaquetamiento cuando la localización lo permita.',
        'En heridas profundas de ingle, axila o cuello se introduce gasa dentro del trayecto hasta llenarlo y se comprime desde dentro.',
        'En extremidades con sangrado que la presión directa no controla, el torniquete es la medida de elección.',
        'El torniquete se coloca proximal a la herida, sobre un segmento con un solo hueso y no sobre una articulación, siguiendo las instrucciones del dispositivo.',
        'Hay que apretar hasta que el sangrado se detenga, anotar la hora de colocación de forma visible y no cubrirlo.',
        'No se afloja ni se retira en el ámbito prehospitalario, y su dolor no es motivo para aflojarlo.',
      ]),
      preguntasOrales([
        'Clasifica las hemorragias por su origen describiendo aspecto y riesgo de cada una.',
        'Explica por qué la hemorragia exanguinante se atiende antes que la vía aérea.',
        'Ordena los pasos de una presión directa bien hecha.',
        '¿Por qué no se levanta el apósito para comprobar el sangrado?',
        '¿En qué localizaciones se empaqueta la herida y por qué ahí no cabe un torniquete?',
        'Enumera las reglas de uso del torniquete.',
        '¿Qué se hace si el sangrado no cesa después de apretar el torniquete?',
        'Explica por qué el dolor del torniquete no es motivo para aflojarlo.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ARRIBA Y ABAJO DEL FOCO: inmovilizar no es sujetar, es impedir el movimiento de las articulaciones proximal y distal, porque son ellas las que transmiten el movimiento al hueso lesionado. Y antes y después, pulso, sensibilidad y movilidad.'),
          masPreguntado('La valoración neurovascular distal antes y después de inmovilizar. Se comprueban pulso, sensibilidad y movilidad distales ANTES de inmovilizar y se vuelven a comprobar DESPUÉS, porque la propia inmovilización puede comprometer lo que estaba indemne.'),
        ],
      },
      erroresFrecuentes([
        ['Buscar crepitación a propósito para confirmar la fractura', 'La crepitación es un signo que puede encontrarse, no una maniobra que se provoque. Buscarla añade dolor y daño sin cambiar la conducta.'],
        ['Inmovilizar solo el segmento lesionado', 'Hay que incluir la articulación proximal y la distal, porque son ellas las que transmiten el movimiento al hueso lesionado. Sujetar el foco sin ellas no inmoviliza.'],
        ['Omitir la comprobación distal antes o después', 'Se comprueban pulso, sensibilidad y movilidad distales antes de inmovilizar y se repiten después. Sin la comparación no se sabe si la inmovilización comprometió algo.'],
        ['Intentar reducir la fractura o reintroducir el hueso expuesto', 'Como primer respondiente no se alinea ni se reduce, salvo que la extremidad esté sin pulso y el protocolo lo autorice. Y nunca se empuja hacia dentro un hueso expuesto: se cubre con apósito estéril.'],
      ]),
      repasoRapido([
        'Los signos de fractura son dolor localizado que aumenta con el movimiento o la palpación, deformidad o angulación anormal, inflamación y hematoma.',
        'También la impotencia funcional, cuando no puede o no quiere mover el segmento, y la crepitación, que no debe buscarse a propósito.',
        'En la fractura abierta el foco comunica con el exterior.',
        'Eso cambia el pronóstico por el riesgo de infección y suele acompañarse de más sangrado.',
        'La fractura abierta se cubre con apósito estéril y no se intenta reintroducir el hueso.',
        'Inmovilizar no es solo sujetar: es impedir el movimiento de las articulaciones situadas por encima y por debajo del foco.',
        'Se comprueban pulso, sensibilidad y movilidad distales antes de inmovilizar.',
        'Se cubren las heridas si las hay.',
        'Se inmoviliza incluyendo la articulación proximal y la distal.',
        'Se acolchan los huecos para evitar puntos de presión.',
        'Se vuelven a comprobar pulso, sensibilidad y movilidad después de inmovilizar.',
        'Como primer respondiente no se alinea ni se reduce una fractura, salvo extremidad sin pulso y con autorización del protocolo.',
      ]),
      preguntasOrales([
        'Enumera los signos y síntomas de una fractura.',
        '¿Qué signo no debe buscarse a propósito y por qué?',
        'Explica la diferencia entre fractura cerrada y abierta y qué implica cada una.',
        '¿Qué se hace y qué no se hace ante un hueso expuesto?',
        'Explica por qué inmovilizar exige incluir las articulaciones proximal y distal.',
        'Ordena los pasos de la inmovilización, desde la comprobación previa hasta la posterior.',
        '¿Qué se comprueba antes y después de inmovilizar, y para qué sirve compararlo?',
        '¿En qué situación excepcional podría alinearse una extremidad y con qué condición?',
      ]),
      FUENTES_TRAUMA_BASICO,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DETÉN, ENFRÍA, CUBRE Y ABRIGA: detener el proceso, enfriar con agua a temperatura ambiente, cubrir con apósito limpio y seco, y prevenir la hipotermia cubriendo al paciente y no solo la quemadura.'),
          masPreguntado('Que la ausencia de dolor no es buena noticia. Indica destrucción de las terminaciones nerviosas, es decir, mayor profundidad: la quemadura de tercer grado es indolora en el centro y la de segundo profundo duele menos que la de segundo superficial.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar la falta de dolor como una quemadura menos grave', 'Es lo contrario: la ausencia de dolor indica destrucción de las terminaciones nerviosas y por tanto mayor profundidad. Nunca es un signo tranquilizador.'],
        ['Enfriar con hielo o agua helada', 'Profundiza la lesión y provoca hipotermia. Se enfría con agua a temperatura ambiente durante unos minutos.'],
        ['Aplicar pomadas, pasta de dientes, aceite o romper las ampollas', 'Ninguna de esas prácticas ayuda y todas interfieren con la valoración y la curación posteriores. Tampoco se retira la ropa adherida a la piel.'],
        ['Cubrir solo la quemadura y olvidar al paciente', 'Prevenir la hipotermia forma parte de las medidas iniciales: se cubre al paciente, no solo la superficie quemada.'],
      ]),
      repasoRapido([
        'La quemadura de primer grado afecta la epidermis, produce eritema sin ampollas y es dolorosa.',
        'La de segundo grado superficial afecta la dermis superficial, produce ampollas con base rosada y húmeda, y es muy dolorosa.',
        'La de segundo grado profundo afecta la dermis profunda, tiene base pálida o moteada y duele menos.',
        'La de tercer grado afecta todo el espesor, se ve blanca, marrón o carbonizada y seca, y es indolora en el centro.',
        'La ausencia de dolor indica destrucción de las terminaciones nerviosas y mayor profundidad; nunca es tranquilizadora.',
        'En el adulto la regla de los nueves reparte la superficie corporal en múltiplos de nueve: cabeza y cuello nueve por ciento, cada extremidad superior nueve, tronco anterior dieciocho, tronco posterior dieciocho, cada extremidad inferior dieciocho y periné uno.',
        'Para superficies irregulares o pequeñas, la palma de la mano del paciente, con los dedos incluidos, equivale aproximadamente al uno por ciento de su superficie corporal.',
        'Las medidas iniciales empiezan por detener el proceso: apagar, retirar de la fuente y quitar ropa no adherida y joyas.',
        'Después se enfría con agua a temperatura ambiente durante unos minutos y se cubre con apósito limpio y seco.',
        'Hay que prevenir la hipotermia cubriendo al paciente, no solo la quemadura, y valorar la vía aérea si hay sospecha de inhalación.',
        'Está contraindicado el hielo o el agua helada, romper las ampollas, aplicar pomadas o remedios caseros y retirar la ropa adherida.',
        'Quemadura facial, vibrisas nasales chamuscadas, esputo carbonáceo, disfonía o incendio en espacio cerrado obligan a vigilar la vía aérea, porque el edema puede cerrarla en minutos.',
      ]),
      preguntasOrales([
        'Clasifica las quemaduras por profundidad describiendo qué afecta, su aspecto y su dolor.',
        '¿Por qué la ausencia de dolor en una quemadura es mala señal?',
        'Recita el reparto de la superficie corporal según la regla de los nueves en el adulto.',
        'Explica la regla de la palma y de quién es la palma que se usa.',
        'Ordena las medidas iniciales ante una quemadura.',
        'Enumera lo que está contraindicado y di por qué el hielo empeora la lesión.',
        '¿Por qué hay que cubrir al paciente y no solo la quemadura?',
        'Di qué hallazgos hacen sospechar lesión por inhalación y qué obligan a hacer.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LO PRIMERO ARRIBA: guantes, torniquete y apósitos son lo que se necesita en los primeros segundos, así que van accesibles. Buscar un torniquete bajo tres capas de material es perder el tiempo que justifica tenerlo.'),
          masPreguntado('Que un botiquín de primeros auxilios no es un dispensario. La administración de medicamentos depende del alcance de la práctica y de la normativa aplicable, no de lo que quepa en la caja.'),
        ],
      },
      erroresFrecuentes([
        ['Montar un botiquín sin guantes', 'La protección personal es lo primero que se coge y lo primero que se agota. Un botiquín sin guantes es un botiquín que no se puede usar con seguridad.'],
        ['Guardar el material sin criterio de prioridad', 'Se organiza por prioridad de uso: lo que se necesita en los primeros segundos va arriba y accesible. Buscar un torniquete bajo tres capas de material desperdicia el tiempo que justifica tenerlo.'],
        ['Tener el botiquín y no revisarlo', 'Revisarlo es parte de tenerlo: hay que comprobar caducidades de forma periódica y programada, verificar la integridad de los envases estériles y mantener una lista del contenido dentro del propio botiquín.'],
        ['Convertir el botiquín en un dispensario de medicamentos', 'La administración de medicamentos depende del alcance de la práctica y de la normativa aplicable, no de lo que quepa en la caja.'],
      ]),
      repasoRapido([
        'Para control de hemorragias y heridas el botiquín lleva gasas estériles de varios tamaños y compresas.',
        'También vendas de rollo y vendas elásticas, apósitos adhesivos y cinta adhesiva microporosa.',
        'Incluye torniquete comercial y guantes de nitrilo en varias tallas.',
        'Para vía aérea y protección lleva mascarilla de barrera con válvula unidireccional para ventilación.',
        'Como utilería lleva tijera de trauma, manta térmica, solución salina para irrigación y antiséptico.',
        'También linterna y libreta con lápiz.',
        'Los guantes son la pieza que nunca falta: son lo primero que se coge y lo primero que se agota.',
        'El botiquín se organiza por prioridad: guantes, torniquete y apósitos arriba y accesibles.',
        'La rutina de revisión comprueba caducidades de forma periódica y programada.',
        'Lo consumido se repone inmediatamente después de cada uso.',
        'Se comprueba la integridad de los envases estériles y se mantiene una lista del contenido dentro del propio botiquín.',
        'Un botiquín de primeros auxilios no es un dispensario: la administración de medicamentos depende del alcance de la práctica y de la normativa aplicable.',
      ]),
      preguntasOrales([
        'Enumera el material del botiquín destinado al control de hemorragias y heridas.',
        '¿Qué elemento sirve para ventilar con barrera y por qué es unidireccional?',
        'Di qué utilería incluye el botiquín además del material de heridas.',
        '¿Por qué se dice que los guantes son la pieza que nunca falta?',
        'Explica con qué criterio se organiza el contenido del botiquín.',
        'Ordena la rutina de revisión y mantenimiento.',
        '¿Por qué hay que reponer inmediatamente después de cada uso?',
        'Explica por qué un botiquín no es un dispensario de medicamentos.',
      ]),
      FUENTES_PRIMEROS_AUXILIOS,
    ],
    conceptosClave: [
