    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('VARIAS VÍCTIMAS EN EL MISMO SITIO ES UNA EXPOSICIÓN, NO UNA ENFERMEDAD. Cuando dos o más personas presentan síntomas en un mismo espacio, la hipótesis principal deja de ser individual, y la conducta puede ser no entrar hasta que la escena sea segura.'),
          masPreguntado('Que los envases son parte del paciente: un blíster vacío, un frasco o una etiqueta identifican el producto y su concentración con una precisión que ninguna exploración alcanza. Recogerlos, trasladarlos o fotografiarlos es una de las aportaciones más útiles y más baratas.'),
        ],
      },
      erroresFrecuentes([
        ['Entrar antes de valorar la escena', 'En toxicología la primera víctima potencial es el equipo. Algunas exposiciones no se perciben por el olfato ni por la vista.'],
        ['Provocar el vómito', 'No reduce de forma útil la absorción y aumenta el riesgo de broncoaspiración.'],
        ['Creer en un «antídoto universal»', 'La idea es falsa y peligrosa. Y no se administra un antídoto por sospecha de patrón sin indicación.'],
        ['Tomar un patrón por una identificación', 'Los patrones se mezclan con varias sustancias, se distorsionan con el tiempo y pueden faltar. Un patrón es una hipótesis útil.'],
      ]),
      repasoRapido([
        'Antes de entrar se valora si hay más de una persona afectada, si el espacio es cerrado y si hay olores, humos o derrames.',
        'También la señalización de material peligroso, la protección necesaria y si hace falta un recurso especializado.',
        'Varias víctimas en el mismo sitio sugiere exposición ambiental.',
        'Retirar la ropa contaminada elimina una parte importante de la exposición, pero el cómo lo fija el protocolo.',
        'Se pregunta qué sustancia, cuánta, por qué vía y cuándo, y si hubo más de una incluida el alcohol.',
        'También si fue accidental o intencionada, con cuidado y sin juicio, y los antecedentes y el acceso a medicación.',
        'Los envases, blísteres y etiquetas se llevan al hospital o se fotografían.',
        'Patrón opioide: conciencia disminuida, respiración lenta y superficial, pupilas pequeñas.',
        'Simpaticomimético: agitación, taquicardia, hipertensión, pupilas dilatadas, piel sudorosa, temperatura elevada.',
        'Anticolinérgico: lo mismo pero con piel seca y caliente, retención urinaria y peristaltismo disminuido.',
        'Colinérgico: secreciones abundantes, pupilas pequeñas, bradicardia, vómito y diarrea, debilidad.',
        'La diferencia práctica entre anticolinérgico y simpaticomimético está en la piel: seca frente a sudorosa.',
      ]),
      preguntasOrales([
        '¿Qué se valora antes de entrar a una escena con exposición?',
        '¿Qué significa que haya varias víctimas en el mismo sitio?',
        'Enumera la información que orienta.',
        '¿Por qué los envases son parte del paciente?',
        'Describe los principales toxíndromes.',
        '¿Cómo distingues el anticolinérgico del simpaticomimético?',
        '¿Qué límite tienen los patrones?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SI DEPRIME, SU RETIRADA EXCITA. De esa lógica sale todo el cuadro de la abstinencia de alcohol y sedantes: temblor, agitación, activación autonómica y riesgo de convulsión. Y explica por qué esa abstinencia sí puede matar.'),
          masPreguntado('La etiqueta que más daño hace: registrar «paciente alcohólico agitado» y detener ahí la valoración. Esa confusión puede ser hipoglucemia, un sangrado intracraneal tras una caída que nadie presenció, o una infección.'),
        ],
      },
      erroresFrecuentes([
        ['Cerrar la valoración con la etiqueta del consumo', 'Bajo ella pueden esconderse una hipoglucemia, un sangrado intracraneal o una infección.'],
        ['Tratar la abstinencia de depresores como un problema de conducta', 'Puede evolucionar a un cuadro con convulsiones e inestabilidad que compromete la vida.'],
        ['No preguntar la última vez que consumió', 'Sin ese dato es difícil distinguir una intoxicación en curso de una abstinencia que empieza, y se manejan de forma distinta.'],
        ['Administrar sedantes o vitaminas sin respaldo', 'Requieren indicación respaldada, producto con Información para Prescribir, competencia y protocolo. Y no se enseña ninguna pauta de desintoxicación: es un tratamiento programado.'],
      ]),
      repasoRapido([
        'El organismo se adapta a la presencia de una sustancia y ajusta su funcionamiento contando con ella.',
        'Si desaparece de golpe, ese ajuste queda descompensado.',
        'Si la sustancia deprime el sistema nervioso, su retirada produce hiperexcitabilidad.',
        'Alcohol y sedantes: riesgo vital sí, por convulsiones y estado confusional grave con inestabilidad.',
        'Sus manifestaciones: temblor, sudoración, ansiedad, náusea, alucinaciones, convulsión, confusión, fiebre e inestabilidad.',
        'Opioides: habitualmente sin riesgo vital por sí misma, aunque el malestar es intenso.',
        'Sus manifestaciones: ansiedad, dolores, calambres, náusea, vómito, diarrea, lagrimeo, rinorrea, bostezos, piloerección, pupilas dilatadas.',
        'La abstinencia de depresores es una urgencia médica.',
        'Gravedad: confusión, alucinaciones, agitación intensa, temblor marcado, convulsión, fiebre, taquicardia mantenida.',
        'La última vez que consumió sitúa todo el cuadro.',
        'Antes de asumir abstinencia se buscan hipoglucemia, traumatismo craneal, infección y alteración de electrolitos.',
        'También coingesta o intoxicación en curso y enfermedad hepática descompensada.',
      ]),
      preguntasOrales([
        'Explica el mecanismo general de la abstinencia.',
        '¿Por qué la retirada de un depresor produce hiperexcitabilidad?',
        'Diferencia el perfil de riesgo del alcohol y sedantes del de opioides.',
        'Di los signos de abstinencia grave.',
        '¿Por qué la última vez que consumió sitúa el cuadro?',
        'Enumera lo que hay que descartar antes de asumir abstinencia.',
        '¿Cuál es la etiqueta que más daño hace?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL ANIMAL NO ES EL OBJETIVO; EL PACIENTE LO ES. No se intenta capturar ni matar: es la causa más frecuente de una segunda víctima. Si ya está contenido y puede transportarse con seguridad, se lleva; si no, se describe o se fotografía a distancia.'),
          masPreguntado('El daño doble de las medidas populares: añaden una lesión que antes no existía y, sobre todo, consumen el tiempo que el paciente necesitaba para llegar a donde sí puede tratarse. Y que la picadura de abeja puede matar por dos vías: la cantidad de veneno y la reacción alérgica.'),
        ],
      },
      erroresFrecuentes([
        ['Intentar capturar o matar al animal', 'Es la causa más frecuente de una segunda víctima.'],
        ['Incidir, succionar o poner torniquete', 'La incisión añade una herida y no retira veneno de forma útil; la succión no retira cantidad significativa y expone a quien succiona; el torniquete compromete la irrigación.'],
        ['Aplicar hielo directo, descargas o remedios por vía oral', 'El hielo añade lesión por frío, las descargas no tienen fundamento y los remedios dificultan la valoración posterior.'],
        ['Retrasar el traslado para observar', 'Es el error que más tiempo cuesta cuando el cuadro progresa, y el tratamiento eficaz suele ser hospitalario.'],
      ]),
      repasoRapido([
        'Primero que nadie más resulte afectado; el animal no es el objetivo de la atención.',
        'No se intenta capturar ni matar al animal.',
        'Se anota la hora exacta de la mordedura o picadura y el sitio anatómico exacto.',
        'Se retiran anillos, pulseras, relojes y todo lo que comprima, antes de que la hinchazón lo impida.',
        'Un anillo que al principio se quita con facilidad puede convertirse en un torniquete involuntario.',
        'Plano local: dolor, enrojecimiento, hinchazón, marcas, hormigueo; su progresión se marca y se vigila.',
        'Plano sistémico: es el que decide la gravedad y la prioridad.',
        'Neurotóxica: alteraciones de sensibilidad y movimiento, debilidad, dificultad para hablar o tragar, compromiso respiratorio.',
        'Hemotóxica: alteración de la coagulación y del tejido, con sangrados y daño local extenso.',
        'Autonómica: sudoración, salivación, lagrimeo, vómito y alteraciones de frecuencia y presión.',
        'Alérgica: puede llegar a anafilaxia, sobre todo tras picaduras de himenópteros.',
        'En el paciente pediátrico las manifestaciones sistémicas pueden aparecer antes y con menos veneno.',
      ]),
      preguntasOrales([
        '¿Qué se hace y qué no se hace en la escena?',
        '¿Por qué no se captura al animal?',
        'Enumera los datos iniciales que hay que recoger.',
        '¿Por qué retirar los anillos es tan importante?',
        'Distingue el plano local del sistémico.',
        'Nombra las categorías generales de efecto sistémico.',
        '¿Por qué la picadura de abeja puede matar por dos vías?',
        'Di las medidas populares y por qué no se hacen.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA PIEL NO ES EL CRITERIO. Lo que define la anafilaxia es el compromiso de la respiración, de la circulación o de la vía aérea: una parte de los casos —con frecuencia los más graves y rápidos— cursa sin urticaria ni enrojecimiento.'),
          masPreguntado('Que la adrenalina intramuscular es la primera línea y nada la sustituye: los antihistamínicos y los corticoides actúan sobre otros aspectos y con otro ritmo, y el retraso en administrarla se asocia a peor evolución.'),
        ],
      },
      erroresFrecuentes([
        ['Exigir manifestaciones cutáneas', 'Una parte de los casos cursa sin urticaria ni enrojecimiento, y con frecuencia son los más graves y de progresión más rápida.'],
        ['Sustituir la adrenalina por antihistamínicos o corticoides', 'No la sustituyen: actúan sobre otros aspectos y con otro ritmo.'],
        ['Cambiar la posición de forma brusca', 'En un paciente hipotenso, incorporarlo o ponerlo de pie de golpe puede empeorar el llenado del corazón. La posición se individualiza.'],
        ['Dar el episodio por cerrado con la mejoría', 'Puede presentar un nuevo empeoramiento horas después. Todos se trasladan y se vigilan aunque parezcan recuperados.'],
      ]),
      repasoRapido([
        'Es una reacción alérgica sistémica de instauración rápida que puede comprometer la vida.',
        'La define el compromiso de la respiración, de la circulación o de la vía aérea, no la erupción.',
        'Vía aérea: cierre de garganta, dificultad para tragar, voz apagada o ronca, estridor, hinchazón de labios, lengua o úvula.',
        'Respiración: disnea, sibilancias, tos persistente, opresión torácica, hipoxia.',
        'Circulación: hipotensión, taquicardia, mareo, síncope, palidez y frialdad.',
        'Piel y mucosas: están en la mayoría de los casos, pero no en todos.',
        'Digestivo: dolor abdominal cólico, náusea, vómito, diarrea.',
        'La ausencia de un desencadenante claro no descarta el cuadro, y su presencia no lo confirma.',
        'La adrenalina intramuscular es la primera línea y su administración temprana es lo que más influye.',
        'Los antihistamínicos y los corticoides no la sustituyen; puede ser necesaria más de una administración.',
        'La posición se individualiza: el disneico no se acuesta a la fuerza y el hipotenso no se sienta bruscamente.',
        'Se traslada y se vigila en todos los casos, incluso si el paciente mejora.',
      ]),
      preguntasOrales([
        'Define la anafilaxia por lo que la caracteriza.',
        'Enumera las manifestaciones por sistema.',
        '¿Puede ocurrir sin lesiones en la piel? ¿Por qué importa?',
        '¿Descarta el cuadro la ausencia de un desencadenante claro?',
        '¿Por qué la adrenalina intramuscular es la primera línea?',
        '¿Qué papel tienen los antihistamínicos y los corticoides?',
        '¿Por qué la posición se individualiza?',
        '¿Cierra el episodio la mejoría?',
      ]),
