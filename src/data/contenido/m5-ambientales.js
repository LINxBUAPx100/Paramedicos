    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMERO DEJAR DE PERDER, DESPUÉS DEVOLVER. Retirar del ambiente frío, quitar la ropa mojada, secar y aislar viene antes que cualquier método de recalentamiento. Y el corazón frío es irritable: se manipula despacio, en bloque y lo menos posible.'),
          masPreguntado('Que la desaparición de la tiritona NO es una buena noticia: tiritar es el mecanismo con el que el cuerpo genera calor, y dejar de hacerlo suele significar que se ha agotado. Es uno de los pocos signos que se interpretan al revés de lo que parece.'),
        ],
      },
      erroresFrecuentes([
        ['Leer la ausencia de tiritona como mejoría', 'Tiritar genera calor: dejar de hacerlo en un paciente frío suele significar que ese mecanismo se ha agotado.'],
        ['Frotar al paciente para calentarlo', 'En la hipotermia moderada y grave los movimientos bruscos y la fricción pueden desencadenar una arritmia. Se manipula despacio, en bloque y lo menos posible.'],
        ['Dejar la ropa mojada puesta', 'Se quita cortándola si es necesario, se seca la piel y se aísla con mantas, incluida la cabeza.'],
        ['Concluir rápido que no hay pulso ni respiración', 'Pueden ser tan lentos y débiles que resulten difíciles de detectar: la valoración se hace durante más tiempo del habitual.'],
      ]),
      repasoRapido([
        'El cuerpo pierde calor por conducción, convección, evaporación y radiación.',
        'El agua y la ropa mojada aceleran el proceso, y el viento lo multiplica.',
        'En riesgo: inmersión o ropa mojada, permanencia prolongada en el suelo, traumatizados, consumo de alcohol.',
        'También personas mayores, lactantes, pacientes con enfermedades que limitan la respuesta al frío y situaciones de exposición continua.',
        'La hipotermia del traumatizado no espera al invierno: se enfría dentro de una ambulancia templada.',
        'Y como el frío empeora la coagulación, forma parte de la tríada que perpetúa la hemorragia.',
        'Leve: tiritona intensa, piel fría y pálida, torpeza, habla lenta; el paciente colabora.',
        'Moderada: la tiritona disminuye o desaparece, con confusión, apatía, somnolencia y conducta inadecuada.',
        'Grave: no tirita, conciencia profundamente disminuida, rigidez, respiración y pulso muy lentos y difíciles de detectar.',
        'Primero detener la pérdida: retirar del ambiente, quitar la ropa mojada, secar, aislar y proteger del viento.',
        'Manipular con extremo cuidado y en bloque, mantener en horizontal y no dar alcohol ni nada por vía oral si hay alteración de conciencia.',
        'Las decisiones de reanimación en hipotermia siguen las guías vigentes y el protocolo, que contemplan esta circunstancia.',
      ]),
      preguntasOrales([
        'Enumera las cuatro vías de pérdida de calor.',
        '¿Quién está en riesgo de hipotermia?',
        '¿Por qué la hipotermia del traumatizado no espera al invierno?',
        'Describe los tres grados por su clínica.',
        '¿Qué significa que un paciente frío deje de tiritar?',
        'Recorre las medidas para detener la pérdida de calor.',
        '¿Por qué se manipula con tanto cuidado?',
        '¿Qué cambia en la valoración del pulso y la respiración?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL ESTADO MENTAL ES EL QUE DECIDE. Si un paciente expuesto a calor o tras un esfuerzo está confuso, agitado, con conducta extraña, con convulsión o inconsciente, es golpe de calor hasta que se demuestre otra cosa, aunque no se pueda medir su temperatura.'),
          masPreguntado('Que la piel seca es un mito peligroso: en el golpe de calor por esfuerzo el paciente con frecuencia sigue sudando de forma abundante, y descartar el diagnóstico porque suda retrasa el enfriamiento. Y que se traslada enfriando: el enfriamiento no se interrumpe para trasladar.'),
        ],
      },
      erroresFrecuentes([
        ['Descartar el diagnóstico porque el paciente suda', 'En el golpe de calor por esfuerzo el paciente con frecuencia sigue sudando de forma abundante. Descartarlo por eso retrasa el enfriamiento.'],
        ['Interrumpir el enfriamiento para trasladar', 'El enfriamiento es el tratamiento y su rapidez condiciona el resultado: se traslada enfriando.'],
        ['Administrar antitérmicos', 'El mecanismo del golpe de calor no es el de la fiebre y no responden a ellos. Tampoco se friega con alcohol.'],
        ['Retrasar el enfriamiento para tomar la temperatura', 'Si no se dispone del termómetro adecuado, no se retrasa: el criterio es la alteración del estado mental en contexto de calor o esfuerzo.'],
      ]),
      repasoRapido([
        'Agotamiento por calor: estado mental conservado; el paciente está lúcido aunque se sienta mal.',
        'Da debilidad, mareo, cefalea, náusea, calambres y sudoración abundante, y suele recuperarse con reposo, ambiente fresco e hidratación.',
        'Golpe de calor: estado mental ALTERADO, con confusión, conducta extraña, agitación, convulsión o inconsciencia.',
        'La piel puede estar seca o sudorosa; en el golpe de calor por esfuerzo con frecuencia sigue sudando.',
        'Es una urgencia con riesgo vital y de daño de órganos.',
        'En riesgo: esfuerzo físico intenso con calor, trabajadores con equipo que impide disipar, personas mayores, lactantes y niños.',
        'También pacientes con enfermedades crónicas o medicación que limita la sudoración, viviendas sin ventilación y niños en vehículos cerrados.',
        'El enfriamiento es el tratamiento y su rapidez condiciona el resultado: se traslada enfriando.',
        'Secuencia: retirar del ambiente, quitar ropa y equipo, iniciar el enfriamiento con el método que autorice el protocolo.',
        'La inmersión en agua fría es la preferente cuando está disponible y es segura.',
        'Vía aérea y soporte según alcance, nada por vía oral si la conciencia está alterada, y medir glucemia porque la hipoglucemia imita el deterioro.',
        'No se administran antitérmicos, no se friega con alcohol y no se retrasa el enfriamiento para medir la temperatura.',
      ]),
      preguntasOrales([
        '¿Qué separa el agotamiento por calor del golpe de calor?',
        '¿Qué dato decide, y qué haces si no puedes medir la temperatura?',
        '¿Por qué la piel seca es un mito peligroso?',
        'Enumera quién está en riesgo.',
        '¿Cuál es el tratamiento, y cuándo empieza?',
        'Recorre la secuencia de manejo.',
        '¿Qué método de enfriamiento es el preferente cuando es posible?',
        'Di lo que no se hace.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL NOMBRE DA IGUAL; EL ESTADO MENTAL NO. Sea insolación o golpe de calor, en la escena solo hay que decidir si el estado mental está alterado: si lo está, enfriamiento inmediato y traslado urgente; si no, retirar la exposición, refrescar, hidratar según protocolo y vigilar.'),
          masPreguntado('La ambigüedad del término: en unos textos designa el cuadro por exposición directa al sol con el paciente lúcido, y en otros se usa como sinónimo de golpe de calor. Esta lección adopta el primer sentido y lo declara; la academia debe confirmar qué acepción quiere.'),
        ],
      },
      erroresFrecuentes([
        ['Usar «insolación» sin declarar en qué sentido', 'El término se emplea con dos acepciones distintas. Esta lección adopta la de exposición directa al sol con estado mental conservado y lo declara expresamente.'],
        ['Dar el cuadro leve por cerrado', 'Puede progresar. Se reevalúa de forma repetida, y la aparición de cualquier alteración del estado mental cambia el cuadro y la conducta.'],
        ['Hidratar por vía oral sin comprobar nada', 'Solo si el paciente está lúcido, no vomita y el protocolo lo contempla.'],
        ['Aplicar sustancias sobre la quemadura solar', 'Se enfría con agua y se cubre sin apretar; no se aplican sustancias que retengan calor.'],
      ]),
      repasoRapido([
        '«Insolación» se usa en español con dos sentidos: cuadro por exposición directa al sol, o sinónimo de golpe de calor.',
        'Esta lección adopta el primero y lo declara; la academia debe confirmar la acepción.',
        'En la escena lo único que hay que decidir es si el estado mental está alterado.',
        'Si lo está, se trata como golpe de calor: enfriamiento inmediato y traslado urgente.',
        'Si no lo está, es un cuadro por calor manejable, pero puede progresar.',
        'La radiación solar directa suma el aporte de calor sobre cabeza y tronco y la quemadura de la piel.',
        'Una piel quemada disipa peor el calor y pierde más líquido: las dos agresiones se refuerzan.',
        'Se encuentra cefalea, mareo y debilidad tras horas de exposición, náusea y a veces vómito.',
        'También piel de cara, cuello y hombros enrojecida, caliente y dolorosa, sudoración abundante, sed intensa y calambres.',
        'El estado mental está conservado: el paciente está orientado y colabora.',
        'Manejo: retirar de la exposición, aflojar ropa, refrescar con agua y ventilación, hidratar por vía oral solo si procede.',
        'Se traslada aunque parezca leve si no mejora, si vomita de forma repetida, en poblaciones vulnerables, con quemadura extensa o ante cualquier confusión.',
      ]),
      preguntasOrales([
        'Aclara los dos usos del término «insolación».',
        '¿Qué acepción adopta esta lección, y qué queda pendiente?',
        '¿Qué es lo único que hay que decidir en la escena?',
        '¿Qué añade la radiación solar directa al calor ambiental?',
        '¿Por qué las dos agresiones se refuerzan?',
        'Enumera lo que se encuentra.',
        'Recorre el manejo.',
        '¿Cuándo se traslada aunque el cuadro parezca leve?',
      ]),
      F([AHA_PA_2024, WHO_BEC, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
