...
//
//  PASADA DE CALIDAD (trabajo A, lote 3 · 06-09-2026). Las cinco lecciones
//  recibieron el molde v2. Aquí la regla de «ni un dato clínico nuevo» tiene
//  un filo extra: esta unidad declara expresamente que no publica calibres,
//  volúmenes, velocidades ni composiciones, así que un repaso rápido con una
//  cifra rompería el bloqueo del archivo, no solo la regla del lote.
// ============================================================
import {
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CINCO ORÍGENES, Y EL ÚLTIMO SOY YO: el procedimiento, el catéter, la infección, lo administrado y el prestador. Los cuatro primeros los sufre el paciente; el quinto es la punción accidental con material contaminado, y se olvida precisamente porque no aparece en la piel del enfermo.'),
          ...
          masPreguntado('Tres cosas se preguntan de esta lección, y ninguna es una lista: la pregunta previa a puncionar —qué va a cambiar en el manejo—, la diferencia entre infiltración y extravasación, y dónde se intenta el acceso en el paciente que necesita quirófano.'),
        ],
      },
      erroresFrecuentes([
        ['Canalizar porque se sabe canalizar', 'Un acceso vascular que no va a usarse ni previsiblemente va a necesitarse no aporta nada al paciente y sí le añade riesgo. La indicación la da el plan de tratamiento, no la destreza del prestador ni la disponibilidad del material en la unidad.'],
        ['Quedarse en la escena hasta conseguirlo', 'En el paciente que necesita cirugía o un tratamiento que solo existe en el hospital, cada minuto invertido en el intento se resta del tratamiento definitivo. En esos casos el acceso se intenta en camino, no antes de salir.'],
        ['Usar infiltración y extravasación como sinónimos', 'La infiltración es la salida de la solución al tejido por desplazamiento del catéter fuera de la luz venosa; se llama extravasación cuando la sustancia acumulada es capaz de dañar ese tejido. No es un adorno del vocabulario: cambia la gravedad.'],
        ['Olvidar el riesgo propio', 'La punción accidental con material contaminado es la única complicación de la lista que afecta al prestador y no al paciente, y es la primera que desaparece del repaso cuando solo se piensa en el enfermo.'],
      ]),
      repasoRapido([
        'Canalizar una vena crea una comunicación directa con el compartimento intravascular.',
        'Permite tres cosas: administrar líquidos, administrar medicamentos de inicio rápido y tener el acceso listo antes de que el paciente se deteriore.',
        'La indicación nace del plan de tratamiento: la pregunta es qué va a cambiar si lo hago, no si sé hacerlo.',
        'Ventaja central: biodisponibilidad completa, sin depender de la absorción.',
        'La ventaja que se olvida: la administración puede interrumpirse si aparece un efecto adverso; una dosis ya absorbida por otra vía, no.',
        'Toda vía intravenosa rompe la barrera cutánea y crea una puerta de entrada.',
        'Los riesgos tienen cinco orígenes: el procedimiento, el catéter, la infección, lo administrado y el prestador.',
        'Infiltración: la solución sale al tejido. Extravasación: esa misma salida cuando la sustancia lo daña.',
        'Flebitis: dolor, eritema y cordón palpable en el trayecto de la vena canalizada.',
        'El coste que no se ve es el tiempo: en el paciente que necesita quirófano, el acceso se intenta en camino.',
        'Soluciones autorizadas, número de intentos y momento de canalizar los fija el protocolo del servicio.',
      ]),
      preguntasOrales([
        '¿Qué tres cosas permite un acceso vascular que ninguna otra vía consigue con la misma rapidez?',
        '¿Cuál es la pregunta que se hace antes de puncionar, y cuál no?',
        'Enumera los cinco orígenes de los riesgos de una vía intravenosa.',
        'Diferencia infiltración de extravasación.',
        '¿Cómo reconocerías una flebitis?',
        'Paciente con herida penetrante abdominal e hipotensión, cerca del hospital. ¿Dónde intentas el acceso y por qué?',
        '¿Qué ventaja tiene la vía intravenosa sobre una dosis ya absorbida por otra vía?',
        '¿Cuál de los riesgos del procedimiento afecta al prestador y no al paciente?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      {
        ...
        bloques: [
          ...
          mnemotecnia('DE LEJOS HACIA CERCA, NUNCA AL REVÉS. Toda la regla de elección cabe en la dirección: un fallo distal deja sitios proximales disponibles; un fallo proximal inutiliza todo lo que queda por debajo.'),
        ],
      },
      {
      ...
      },
      {
        ...
        bloques: [
          ...
          masPreguntado('Lo más preguntado son dos porqués y no una lista de sitios: por qué se progresa de distal a proximal y por qué la fosa antecubital no es la primera opción por defecto. El tercero es el miembro que porta una fístula de diálisis.'),
        ],
      },
      erroresFrecuentes([
        ['Ir directo a la fosa antecubital', 'Es tentadora porque suele conseguirse al primer intento, pero cruza el codo: al flexionar el brazo la infusión se detiene, y una vez puncionada quedan inutilizadas las venas distales de ese miembro. Se reserva para cuando la situación clínica justifica priorizar el éxito inmediato.'],
        ['Elegir la vena por su aspecto', 'El sitio se decide por palpación: vena de trayecto recto y suficiente longitud, piel íntegra y fuera de una articulación. Una vena que se ve y no se palpa es un intento fallido esperando su turno.'],
        ['No preguntar antes de puncionar', 'Fístula, mastectomía con disección axilar y linfedema no siempre son visibles, y ninguno se detecta mirando el brazo. La pregunta directa al paciente consciente evita una complicación que después no tiene arreglo.'],
        ['Puncionar por debajo de un intento fallido', 'La solución administrada se escaparía por la punción anterior. Tras un fallo se asciende en el mismo miembro o se cambia de miembro; nunca se baja.'],
      ]),
      repasoRapido([
        'La elección del sitio responde a qué se va a administrar, en qué condición está el paciente y qué venas hay que conservar para el resto del episodio.',
        'Buen sitio: vena palpable de trayecto recto, piel íntegra, fuera de una articulación y en un miembro sin compromiso.',
        'Se progresa de distal a proximal para conservar sitios utilizables tras un fallo.',
        'Dorso de la mano: accesible y conserva lo proximal, pero de menor calibre, molesto y móvil.',
        'Antebrazo: trayecto recto, buena fijación y cómodo para el paciente.',
        'Fosa antecubital: mayor calibre y alta tasa de éxito, pero cruza el codo y compromete lo distal.',
        'Dorso del pie: alternativa cuando los miembros superiores no son utilizables; más incómodo y limita la movilidad.',
        'Yugular externa: existe y es de buen calibre, pero exige autorización expresa del protocolo y es incompatible con collarín.',
        'Se excluyen el miembro con fístula de diálisis, el del lado de una mastectomía con disección axilar o con linfedema, y el que tiene fractura, aplastamiento o quemadura extensa proximal.',
        'También se evitan la zona con infección o lesión cutánea y el trayecto por debajo de una punción fallida.',
        'El miembro parético se evita si hay alternativa: el paciente no advertirá una complicación.',
      ]),
      preguntasOrales([
        '¿Por qué se empieza por la vena más distal?',
        '¿Qué tiene a favor y qué en contra la fosa antecubital?',
        'Nombra tres miembros que se excluyen de la punción, con el motivo de cada uno.',
        '¿Qué le preguntas a un paciente consciente antes de puncionar?',
        '¿Qué caracteriza a un buen sitio de punción?',
        'Fallas un intento en la fosa antecubital. ¿Dónde NO puncionas después y por qué?',
        '¿Por qué se evita un miembro parético si existe alternativa?',
        'Paciente estable con traslado prolongado. ¿Qué sitio eliges primero y por qué?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ISO SE QUEDA, HIPO ENTRA, HIPER SACA. La isotónica permanece en el espacio extracelular, la hipotónica pasa al interior de la célula y la hipertónica atrae agua desde la célula. De esas tres direcciones sale la elección para expandir el volumen circulante.'),
      ...
      },
      {
        ...
        bloques: [
          ...
          masPreguntado('Se pregunta casi siempre lo mismo: qué tonicidad interesa para expandir el volumen circulante y por qué, dónde se consulta la composición exacta de la bolsa —en la información para prescribir del producto registrado, no en la NOM-034 ni en esta página— y por qué el volumen no sustituye al control de la hemorragia.'),
        ],
      },
      erroresFrecuentes([
        ['Aprenderse la bolsa por su nombre comercial', 'Lo que decide adónde va el líquido es la tonicidad respecto del plasma, no la etiqueta. Sin esa propiedad, elegir una solución se convierte en memoria de marca.'],
        ['Buscar la composición en el sitio equivocado', 'La composición, la osmolaridad, las indicaciones aprobadas y las advertencias están en la información para prescribir del producto registrado ante COFEPRIS que usa el servicio. La NOM-034 regula equipamiento e insumos por tipo de ambulancia; no es un vademécum.'],
        ['Insistir con más volumen cuando la perfusión no mejora', 'Rara vez es la respuesta correcta. Obliga a reevaluar la indicación y el ritmo de administración, y a buscar qué no se ha corregido todavía.'],
        ['Olvidar que la solución enfría', 'Una solución a temperatura ambiente baja la temperatura del paciente, y en el traumatizado la hipotermia agrava la hemorragia. El líquido acompaña al control del sangrado; no lo reemplaza.'],
      ]),
      repasoRapido([
        'Cristaloide: solución acuosa de electrolitos y moléculas pequeñas que atraviesan libremente la membrana capilar.',
        'Coloide: partículas de mayor tamaño, que permanecen más tiempo en el espacio intravascular.',
        'En el ámbito prehospitalario mexicano las soluciones de uso habitual son cristaloides.',
        'La tonicidad respecto del plasma decide adónde va el líquido administrado.',
        'Isotónica: permanece en el espacio extracelular y expande el volumen circulante y el intersticio.',
        'Hipotónica: el agua entra a la célula, con poca expansión del volumen circulante.',
        'Hipertónica: atrae agua desde la célula hacia el espacio extracelular.',
        'Para expandir el volumen de un paciente hipoperfundido interesa una solución isotónica.',
        'Efectos indeseables del volumen: sobrecarga circulatoria, dilución de los componentes de la sangre y enfriamiento.',
        'Se vigila dificultad respiratoria, auscultación pulmonar, distensión yugular nueva, temperatura y respuesta clínica.',
        'El volumen acompaña al control de la hemorragia; no lo sustituye.',
        'Composición, indicación y advertencias salen de la información para prescribir del producto que usa el servicio.',
      ]),
      preguntasOrales([
        'Diferencia un cristaloide de un coloide.',
        '¿Qué propiedad decide adónde va el líquido que administras?',
        'Explica qué hace una solución hipotónica y por qué aporta poco al volumen circulante.',
        '¿Qué tipo de solución interesa en un paciente hipoperfundido y por qué?',
        'Enumera qué vigilas mientras pasa la solución.',
        '¿Dónde consultas la composición y la osmolaridad de la bolsa que llevas en la unidad?',
        '¿Por qué administrar líquido no sustituye al control de la hemorragia?',
        'Aparece dificultad respiratoria y distensión yugular nueva durante la administración. ¿Qué sospechas?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('RETORNO NO ES CÁNULA DENTRO. La sangre en la cámara dice que entró la aguja; la cánula empieza algo más atrás. Por eso se disminuye el ángulo, se avanza unos milímetros y solo entonces se desliza.'),
      ...
      },
      {
        ...
        bloques: [
          ...
          masPreguntado('Lo más preguntado de esta lección no es la técnica completa: son tres gestos de seguridad. El contenedor de punzocortantes al alcance ANTES de puncionar, avanzar unos milímetros tras el retorno y no reintroducir nunca la aguja dentro de la cánula.'),
        ],
      },
      erroresFrecuentes([
        ['Deslizar la cánula en cuanto aparece el retorno', 'El retorno indica que la punta de la aguja entró en la vena, no la cánula, que empieza algo más atrás. Deslizarla en ese momento la deja fuera del vaso y produce una infiltración inmediata.'],
        ['Reintroducir la aguja en la cánula ya avanzada', 'Puede seccionarla y liberar un fragmento en la circulación. Si el intento falla, se retira el conjunto completo y se usa material nuevo.'],
        ['Buscar el contenedor con la aguja en la mano', 'Ahí ocurre la mayoría de los pinchazos accidentales. El contenedor rígido se coloca al alcance antes de puncionar, y la aguja va a él sin trayectos intermedios.'],
        ['Dar el acceso por bueno una vez fijado', 'Cada movilización del paciente puede desplazar el catéter. Después de cada una se comprueba permeabilidad, fijación del apósito y ausencia de edema.'],
      ]),
      repasoRapido([
        'Se explica al paciente qué se le va a hacer y se obtiene su consentimiento cuando puede darlo.',
        'Todo el material se dispone antes de tocar la piel, incluido un catéter de repuesto.',
        'El contenedor rígido de punzocortantes va al alcance ANTES de puncionar.',
        'El compresor se coloca proximal al sitio elegido, sin ocluir el pulso arterial.',
        'La vena se selecciona por palpación, no solo por su aspecto.',
        'Antisepsia y secado, sin volver a palpar la zona ya preparada.',
        'Se punciona con el bisel hacia arriba y con ángulo bajo, traccionando la piel distalmente.',
        'Tras el retorno se disminuye el ángulo y se avanza unos milímetros antes de deslizar la cánula.',
        'La aguja se deposita de inmediato en el contenedor y nunca se reintroduce en la cánula.',
        'La permeabilidad se comprueba: la solución pasa sin resistencia y sin producir edema.',
        'Se fija dejando visible el sitio de inserción y se registra sitio, calibre, hora e incidencias.',
        'El acceso se reevalúa después de cada movilización del paciente.',
      ]),
      preguntasOrales([
        'Recorre en voz alta la secuencia de una venoclisis periférica, de la preparación al registro.',
        '¿Qué se coloca al alcance antes de puncionar, y por qué?',
        '¿Por qué se avanza unos milímetros después de ver el retorno de sangre?',
        '¿Qué haces si el intento falla y la cánula no avanza?',
        'Obtienes sangre roja brillante y pulsátil. ¿Qué ocurrió y qué haces?',
        '¿Cómo confirmas que la cánula quedó dentro del vaso?',
        '¿Qué se registra tras canalizar?',
        '¿Qué compruebas del acceso después de pasar al paciente a la camilla?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          masPreguntado('Tres preguntas se repiten: por qué el acceso intraóseo funciona cuando la vena periférica ya no —la cavidad medular no se colapsa porque el hueso la sostiene—, cuántos intentos admite un mismo hueso y cuál es el término correcto frente al que aparece en el plan.'),
        ],
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('UN HUESO, UN INTENTO. Y el nombre se recuerda por la misma vía: osteóLISIS es destrucción del tejido óseo, osteoCLISIS es el acceso a su cavidad medular. La primera palabra no designa ningún acceso vascular.'),
        ],
      },
      {
      ...
      erroresFrecuentes([
        ['Repetir el intento en el mismo hueso', 'La perforación previa deja escapar por ella lo que se administre después, así que ese hueso queda inutilizado aunque el intento haya fallado. El siguiente va en otro hueso.'],
        ['Administrar antes de confirmar la posición', 'La confirmación va primero: la aguja se sostiene sola, puede obtenerse aspirado de contenido medular y la solución pasa sin resistencia ni tumefacción. Sin ese paso, la extravasación se descubre cuando ya se acumuló líquido.'],
        ['No palpar la zona durante la administración', 'La extravasación al tejido blando es la complicación más frecuente y puede pasar desapercibida bajo la ropa. Una tumefacción creciente obliga a suspender de inmediato: el líquido acumulado en un compartimento cerrado puede comprometer la circulación del miembro.'],
        ['Tomar el título del plan por el nombre del procedimiento', '«Osteólisis» significa destrucción o resorción del tejido óseo y no designa un acceso vascular. Se conserva como errata documental por fidelidad al plan; lo que se enseña y se evalúa es el acceso intraóseo.'],
      ]),
      repasoRapido([
        'La cavidad medular de los huesos largos contiene una red de vasos que drena a la circulación venosa central.',
        'Esa red no se colapsa con la hipoperfusión, porque el hueso la sostiene.',
        'De ahí su ventaja: conserva su tasa de éxito justo en el paciente en que la vía intravenosa la pierde.',
        'Es funcionalmente equivalente a una vena periférica: acepta líquidos y medicamentos.',
        'Indicación general: necesidad urgente de acceso cuando la vía intravenosa no se consigue con rapidez o no es viable; el umbral lo fija el protocolo.',
        'Contraindican ese hueso la fractura propia o proximal, un intento previo en él, la infección o lesión de la piel del sitio, una prótesis u osteosíntesis y la enfermedad ósea que comprometa su resistencia.',
        'Sitios habituales: tibia proximal, tibia distal y húmero proximal, con las referencias anatómicas de cada uno.',
        'Un solo intento por hueso: si falla, se cambia de hueso.',
        'La entrada en la cavidad medular se reconoce por la pérdida de resistencia.',
        'La posición se confirma antes de administrar nada; la ausencia de aspirado no la descarta por sí sola.',
        'La extravasación al tejido blando es la complicación más frecuente y se busca palpando alrededor del sitio.',
        'Es una medida para la urgencia: el tiempo de permanencia lo fijan el fabricante y el centro receptor.',
      ]),
      preguntasOrales([
        '¿Por qué el acceso intraóseo funciona cuando la vena periférica ya no?',
        'Explica por qué «osteólisis» es una errata y cuál es el término correcto.',
        '¿Cuántos intentos admite un mismo hueso y por qué?',
        'Nombra tres contraindicaciones del acceso intraóseo.',
        'Menciona los sitios de inserción habituales.',
        '¿Cómo confirmas la posición antes de administrar algo?',
        '¿Cuál es la complicación más frecuente y cómo la detectas?',
        '¿Qué datos de este procedimiento dependen del dispositivo y del protocolo, y no de esta lección?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
