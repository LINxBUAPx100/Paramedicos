    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NUEVOS FRENTE A EXISTENTES, POBLACIÓN FRENTE A ENFERMOS. Incidencia cuenta casos nuevos y prevalencia los existentes; mortalidad se calcula sobre toda la población y letalidad solo sobre quienes enferman. Confundir cada par produce afirmaciones falsas en las dos direcciones.'),
          masPreguntado('Los tres datos sin los que una medida no es interpretable: sobre qué población se calculó, en qué periodo y con qué fuente. Y que lo frecuente orienta pero no decide: la epidemiología ajusta la probabilidad previa, y la exploración y la evolución son las que deciden.'),
        ],
      },
      erroresFrecuentes([
        ['Usar la epidemiología para diagnosticar', 'Su unidad de análisis es el grupo, no el paciente. Ajusta la probabilidad previa; la exploración y la evolución deciden.'],
        ['Descartar un cuadro porque es poco frecuente', 'Que sea poco frecuente no lo descarta en el paciente que se tiene delante, y que sea frecuente no lo confirma.'],
        ['Dar una cifra sin población, periodo y fuente', 'Sin esos tres datos no puede compararse ni actualizarse: una cifra así es peor que ninguna cifra.'],
        ['Convertir un factor de riesgo en un juicio sobre el paciente', 'Su utilidad es anticipar y prevenir, no explicar la enfermedad de alguien con su conducta ni justificar una atención distinta.'],
      ]),
      repasoRapido([
        'La epidemiología estudia cómo se distribuyen los problemas de salud en las poblaciones y qué los determina.',
        'Su unidad de análisis es el grupo: responde qué es frecuente en personas como esta, en este lugar y momento.',
        'Sirve para orientar la sospecha y para entender cómo se organiza el servicio; no para diagnosticar.',
        'Incidencia: casos nuevos en un periodo. Prevalencia: casos existentes en un momento dado.',
        'Una enfermedad de curso corto puede tener incidencia alta y prevalencia baja, porque los casos no se acumulan.',
        'Una crónica que no se cura acumula casos y su prevalencia crece aunque aparezcan pocos nuevos.',
        'Morbilidad: cuánta enfermedad hay. Mortalidad: cuántas muertes ocurren en la población.',
        'Letalidad: de los que enferman, qué proporción muere. Se calcula solo sobre los enfermos.',
        'Toda medida se expresa con población, periodo y fuente.',
        'Factor de riesgo es una asociación, no una causa; puede ser modificable o no modificable.',
        'Los determinantes de la salud son condiciones de vida, trabajo, entorno y acceso que van más allá de lo individual.',
        'El registro de atención alimenta la vigilancia epidemiológica: hora, mecanismo, localización y desenlace solo los aporta quien estuvo ahí.',
      ]),
      preguntasOrales([
        'Define epidemiología y di cuál es su unidad de análisis.',
        '¿Para qué le sirve a quien atiende urgencias, y para qué no?',
        'Diferencia incidencia de prevalencia con un ejemplo.',
        'Diferencia mortalidad de letalidad.',
        '¿Qué tres datos acompañan siempre a una medida?',
        '¿Por qué asociación no es causalidad?',
        '¿Qué son los determinantes de la salud?',
        '¿Qué papel tiene el registro prehospitalario en la vigilancia epidemiológica?',
      ]),
      FUENTES,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('QUÉ ES, DÓNDE RIGE Y A QUIÉN OBLIGA. Son tres preguntas distintas: el artículo 72 responde solo la primera. El deber del prestador prehospitalario nace del campo de aplicación de la NOM-034, no de esa definición.'),
          masPreguntado('Que la norma NO exige riesgo de muerte: un cuadro que amenaza la pérdida de un órgano o de una función es urgencia en sentido jurídico aunque la vida no corra peligro. Y que «emergencia» y «urgencia sentida» no están definidas en ninguna de las dos disposiciones: no son categorías de triage.'),
        ],
      },
      erroresFrecuentes([
        ['Atribuir al artículo 72 un deber prehospitalario universal', 'Ese artículo dice qué es una urgencia. No dice a quién obliga, ni en qué establecimientos, ni qué debe hacer una ambulancia.'],
        ['Exigir riesgo de muerte para hablar de urgencia', 'El riesgo sobre un órgano o una función basta. Es lo que impide despachar como «no urgente» todo lo que no sea un paro.'],
        ['Usar «emergencia» o «urgencia sentida» como niveles de prioridad', 'No están definidas en el reglamento citado ni en la NOM-034, no tienen criterios verificables y generan clasificaciones inconsistentes entre compañeros del mismo turno.'],
        ['Reprochar al usuario la discrepancia con lo que describió', 'La persona evalúa su situación con la información y el miedo que tiene. La discrepancia es habitual y no es mala fe; el trato no cambia, la conducta clínica sí.'],
      ]),
      repasoRapido([
        'Urgencia, en el reglamento citado: problema médico-quirúrgico agudo que pone en peligro la vida, un órgano o una función y requiere atención inmediata.',
        'Es médico-quirúrgico: abarca patología médica, traumática y quirúrgica.',
        'Es agudo: se refiere al curso, no a la intensidad del síntoma.',
        'El peligro puede ser sobre la vida, un órgano o una función: no se exige riesgo de muerte.',
        'Y requiere atención inmediata.',
        'Una definición no es, por sí sola, una obligación.',
        'Leer una disposición exige separar definición, ámbito de aplicación y sujeto obligado.',
        'El deber del prestador prehospitalario lo declara el campo de aplicación de la NOM-034, para los tres sectores.',
        'La NOM-034 define la atención prehospitalaria con la misma tríada: vida, órgano o función.',
        '«Emergencia» y «urgencia sentida» son lenguaje del gremio: sin definición normativa y sin criterios verificables.',
        'Ninguna de las dos es categoría de triage; la prioridad la fija el sistema de clasificación del protocolo.',
        'Lo que decide la conducta no es la palabra con la que se pidió ayuda, sino lo que se encuentra al valorar.',
      ]),
      preguntasOrales([
        'Enuncia la definición normativa de urgencia y sus cuatro elementos.',
        '¿Cuál es el elemento que más se olvida?',
        'Separa las tres preguntas que suelen confundirse al leer una disposición.',
        '¿Qué disposición hace obligatoria la norma para un prestador prehospitalario?',
        '¿Qué estatus tienen «emergencia» y «urgencia sentida»?',
        '¿Por qué usarlas como prioridades produce clasificaciones inconsistentes?',
        '¿Por qué la descripción telefónica y el hallazgo no siempre coinciden?',
        '¿Qué decide entonces la prioridad, el tratamiento y el destino?',
      ]),
      FUENTES_URGENCIA,
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CURSO, FRECUENCIA, ORIGEN Y SISTEMA. Cuatro ejes que describen el mismo problema desde ángulos distintos y que se usan juntos. Ninguno de los cuatro es un diagnóstico, mide gravedad ni asigna prioridad.'),
          masPreguntado('Lo que sí importa en la ambulancia: la agudización. La mayor parte de la atención prehospitalaria en patología médica no ocurre por una enfermedad nueva, sino por la descompensación aguda de una enfermedad crónica que el paciente ya tenía.'),
        ],
      },
      erroresFrecuentes([
        ['Deducir gravedad de la etiqueta', 'Un cuadro crónico puede matar hoy y uno agudo resolverse solo. La gravedad se valora en el paciente, no en la clasificación.'],
        ['Leer «endémico» como leve', 'Describe la distribución, no el peligro. Y «epidémico» tampoco describe la gravedad de cada caso: dice que hay más casos de los esperados.'],
        ['Buscar una enfermedad nueva', 'Lo habitual es la descompensación aguda de un padecimiento crónico. Reconocerlo explica el cuadro y dirige los antecedentes que hay que preguntar.'],
        ['Forzar el cuadro en una sola casilla', 'Una neumonía es infecciosa, aguda, respiratoria y puede ser endémica o epidémica según el contexto. Los ejes no compiten: se usan juntos.'],
      ]),
      repasoRapido([
        'Las cuatro clasificaciones ordenan el aprendizaje; ninguna es diagnóstico, gravedad ni prioridad.',
        'Aguda: instalación rápida y duración limitada. Crónica: instalación lenta y curso prolongado.',
        'Ni una ni otra guardan relación con la gravedad.',
        'Existe una categoría intermedia, la subaguda, que describe el tiempo de instalación.',
        'Lo frecuente en la ambulancia es la agudización de un padecimiento crónico preexistente.',
        'Por frecuencia: esporádica, endémica, epidémica y pandémica.',
        'Endémica es presencia habitual y esperable en una zona; no significa leve.',
        'Epidémica es aumento de casos por encima de lo esperado en una población y un periodo.',
        'Saber qué es endémico en la zona cambia la sospecha y las medidas de protección que conviene anticipar.',
        'Por origen: infecciosa, traumática, tóxica, metabólica y endocrina, degenerativa, neoplásica, autoinmunitaria, congénita, iatrogénica y psiquiátrica.',
        'La clasificación por sistemas es la que organiza el resto del módulo.',
        'Uso legítimo: ordenar antecedentes, anticipar protección, comunicar con precisión y situar cada tema en su sistema.',
      ]),
      preguntasOrales([
        'Diferencia enfermedad aguda de crónica por su curso.',
        '¿Guardan relación con la gravedad? Justifícalo.',
        '¿Qué es una agudización, y por qué importa en la ambulancia?',
        'Clasifica un problema de salud por su frecuencia poblacional.',
        '¿Por qué endémico no significa leve?',
        'Enumera las categorías por origen.',
        'Pon un ejemplo de un cuadro que caiga en varias casillas.',
        'Di el uso legítimo y el ilegítimo de estas clasificaciones.',
      ]),
      FUENTES,
    ],
    conceptosClave: [
