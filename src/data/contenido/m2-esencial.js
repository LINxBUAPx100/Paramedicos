    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MEMBRANA, MOTOR Y MANDO: la membrana elige qué entra, la mitocondria pone la energía y el núcleo da las instrucciones. Si falla el motor se detiene la elección, porque sin energía no hay transporte activo y la célula acaba pareciéndose al líquido que la rodea.'),
          masPreguntado('Que se distinga el transporte que gasta energía del que no. Difusión simple, difusión facilitada y ósmosis van a favor del gradiente y no consumen energía; el transporte activo es el único que mueve sustancias en contra del gradiente, y por eso es el primero que se detiene cuando falta el aporte energético.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar la membrana como una barrera cerrada o como un colador', 'Ni una cosa ni la otra: es un filtro que elige. Los lípidos dejan pasar con facilidad lo soluble en grasa y frenan lo soluble en agua; las proteínas insertadas son las que abren paso a estas últimas. Eso es la permeabilidad selectiva.'],
        ['Confundir difusión facilitada con transporte activo porque las dos usan una proteína', 'La proteína no es lo que las distingue. La difusión facilitada necesita una proteína que abra paso, pero va a favor del gradiente y no gasta energía. El transporte activo va en contra del gradiente y por eso consume energía.'],
        ['Decir que la mitocondria «es la energía» sin nombrar el oxígeno', 'La mitocondria obtiene energía aprovechable a partir de nutrientes y oxígeno. Esa dependencia del oxígeno es lo que explica que la interrupción del aporte tenga consecuencias en minutos, y es el puente con respiración y circulación.'],
        ['Aprender la lista de organelos sin la consecuencia de que falle', 'La tabla de la lección está construida al revés a propósito: cada estructura se entiende por lo que ocurre cuando deja de funcionar. Sin lisosomas se acumulan residuos dentro de la célula; sin aparato de Golgi lo fabricado no llega a su destino. La consecuencia es la que fija la función.'],
      ]),
      repasoRapido([
        'La jerarquía célula, tejido, órgano y sistema explica por qué un problema que empieza en el nivel celular termina viéndose como un signo desde fuera.',
        'Toda célula comparte membrana, citoplasma y núcleo; alrededor se organizan los organelos, cada uno con una tarea concreta.',
        'La membrana es una doble capa de lípidos con proteínas insertadas: los lípidos dejan pasar lo soluble en grasa y las proteínas abren paso a lo soluble en agua.',
        'Permeabilidad selectiva significa que la membrana elige, y por eso el interior de la célula tiene una composición distinta del líquido que la rodea.',
        'Esa diferencia de composición no se mantiene sola: la célula la sostiene activamente, gastando energía.',
        'Difusión simple, difusión facilitada y ósmosis van a favor del gradiente y no gastan energía; el transporte activo va en contra y sí gasta.',
        'La ósmosis es movimiento de agua hacia donde hay más solutos.',
        'La mitocondria necesita oxígeno para producir energía de forma eficiente, y ahí está el vínculo con respiración y circulación.',
        'El núcleo dirige la síntesis de proteínas, el retículo endoplásmico las fabrica y el aparato de Golgi las empaqueta y distribuye.',
        'Los lisosomas degradan material de desecho y el citoesqueleto da forma, sostiene los organelos y permite el movimiento interno.',
        'Los cuatro tejidos fundamentales son epitelial, conjuntivo, muscular y nervioso, y cada órgano combina varios de ellos.',
        'Reconocer de qué tejido está hecha una estructura permite anticipar cómo se comporta al lesionarse.',
      ]),
      preguntasOrales([
        'Enumera los tres elementos que comparte toda célula y di qué aporta cada uno.',
        '¿Qué significa que la membrana tenga permeabilidad selectiva y qué parte de la membrana hace pasar lo soluble en agua?',
        'Clasifica los cuatro mecanismos de transporte según gasten o no energía.',
        '¿Cuál es el único mecanismo capaz de mover una sustancia en contra de su gradiente y qué le ocurre cuando la célula deja de producir energía?',
        'Explica por qué la mitocondria es el organelo que conecta esta lección con la respiración y la circulación.',
        'Di qué ocurre en la célula si dejan de funcionar los lisosomas y qué ocurre si deja de funcionar el aparato de Golgi.',
        'Nombra los cuatro tejidos fundamentales y una función de cada uno.',
        '¿Por qué un órgano con mucho tejido conjuntivo resiste mejor la tracción que uno formado sobre todo por epitelio y vasos?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DENTRO, ENTRE Y POR DENTRO DEL VASO: intracelular, intersticial e intravascular. Los tres están comunicados y el agua pasa de uno a otro siguiendo reglas físicas; por eso puede haber edema evidente y, al mismo tiempo, poco líquido circulando.'),
          masPreguntado('La pareja de fuerzas del capilar y su consecuencia. La presión hidrostática empuja el líquido hacia fuera del vaso y la presión oncótica, que procede de las proteínas del plasma, lo retiene dentro. Si sube la hidrostática o bajan las proteínas, el líquido se acumula entre las células: eso es edema.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar el edema como exceso de agua en el cuerpo', 'Edema significa que el agua está en el compartimiento equivocado. Una persona puede tener edema evidente y a la vez poco líquido circulando dentro de los vasos. Distinguir cuánta agua hay de dónde está es la idea central de la lección.'],
        ['Intercambiar el sentido de la presión hidrostática y el de la oncótica', 'La hidrostática procede de la presión con que circula la sangre y empuja hacia fuera. La oncótica procede de las proteínas del plasma, que por su tamaño no atraviesan con facilidad la pared del capilar, y retiene hacia dentro.'],
        ['Situar el potasio fuera de la célula y el sodio dentro', 'Es al revés: el sodio predomina en el líquido extracelular y el potasio en el intracelular. Esa distribución es la que sostiene la excitabilidad de las células nerviosas y musculares.'],
        ['Pasar de este tema a corregir desequilibrios de electrolitos', 'El módulo no entra en qué alteraciones producen los desequilibrios ni en cómo se corrigen: eso corresponde a las unidades clínicas. Aquí basta reconocer qué función sostiene cada electrolito.'],
      ]),
      repasoRapido([
        'El agua corporal se reparte en compartimientos separados por membranas, y cada uno tiene una composición distinta que el organismo mantiene de forma activa.',
        'El compartimiento intracelular es el que contiene más agua del organismo.',
        'El extracelular se divide en intersticial, que es el medio por el que la célula intercambia con la sangre, e intravascular o plasma, que es el que circula y transporta.',
        'Lo decisivo no son las proporciones, sino que los tres compartimientos están comunicados: un problema en la sangre puede resolverse a costa del líquido que rodea a las células, y al revés.',
        'La presión hidrostática empuja líquido hacia fuera del capilar; la oncótica, procedente de las proteínas del plasma, lo retiene dentro.',
        'En equilibrio, el líquido que sale al principio del capilar vuelve a entrar al final y el volumen del intersticio se mantiene estable.',
        'Cuando ese equilibrio se rompe se acumula líquido entre las células, y a esa acumulación se le llama edema.',
        'Los electrolitos son sustancias que al disolverse se separan en iones, partículas con carga eléctrica.',
        'El sodio predomina fuera de la célula y determina en gran medida el reparto del agua entre compartimientos.',
        'El potasio predomina dentro y es esencial para la excitabilidad de las células nerviosas y musculares; el calcio participa en la contracción, en la coagulación y en la resistencia del hueso.',
        'El cloro acompaña al sodio en el equilibrio de cargas, el bicarbonato participa en el equilibrio ácido-base y el magnesio interviene en reacciones que requieren energía y en la función muscular.',
        'Como el agua se mueve hacia donde hay más solutos y el sodio es el soluto más abundante fuera de las células, sodio y agua se estudian juntos.',
      ]),
      preguntasOrales([
        'Nombra los compartimientos de líquido corporal y di cuál contiene más agua.',
        '¿Cuál de los compartimientos extracelulares es el que circula y transporta y cuál baña directamente a las células?',
        'Explica en qué dirección actúa la presión hidrostática y en qué dirección la oncótica, y de dónde procede cada una.',
        '¿Por qué una persona puede tener edema evidente y, al mismo tiempo, poco líquido circulando dentro de los vasos?',
        'Di dónde predomina el sodio y dónde el potasio, y qué función sostiene cada uno.',
        'Relaciona el calcio con las tres funciones que menciona la lección.',
        '¿Por qué se estudian juntos el sodio y el agua en vez de por separado?',
        'Define electrolito y explica qué propiedad les permite participar en la transmisión de señales.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('REPOSO, UMBRAL, TODO O NADA: en reposo el interior es negativo; alcanzado el umbral entra sodio y el potencial se invierte; sale potasio y vuelve la negatividad; la bomba reordena gastando energía. Sin energía no hay gradiente y sin gradiente no hay señal.'),
          masPreguntado('El movimiento iónico de cada fase. En la despolarización entra sodio a favor de su gradiente y el interior llega a positivo; en la repolarización se cierra la entrada de sodio y sale potasio, y el interior vuelve a hacerse negativo; en el restablecimiento la bomba reordena sodio y potasio consumiendo energía.'),
        ],
      },
      erroresFrecuentes([
        ['Describir el potencial de reposo como neutralidad eléctrica', 'La célula en reposo no está eléctricamente neutra respecto de su entorno: el interior es negativo comparado con el exterior. Y no es un accidente, sino una situación que la célula construye y mantiene gastando energía.'],
        ['Creer que un estímulo más intenso produce un potencial de acción mayor', 'Es una respuesta de todo o nada: por debajo del umbral no ocurre nada y, alcanzado el umbral, la respuesta se produce completa. La intensidad del estímulo no gradúa la respuesta.'],
        ['Suponer que la señal se debilita con la distancia', 'Se propaga porque se contagia: un punto que se despolariza lleva a su umbral al punto vecino, que se despolariza a su vez. Así avanza a lo largo de la célula sin perder intensidad en vez de apagarse.'],
        ['Ver el periodo refractario solo como una pausa inútil', 'Tiene dos consecuencias útiles: fija un límite a la frecuencia con que la célula puede responder a un estímulo mantenido y obliga a que la señal avance en un solo sentido, porque la zona que acaba de despolarizarse no puede volver a hacerlo de inmediato.'],
      ]),
      repasoRapido([
        'En reposo el interior de la célula es negativo respecto del exterior, y esa diferencia es el potencial de reposo de la membrana.',
        'El potasio predomina dentro de la célula y el sodio fuera; esa distribución desigual es el punto de partida.',
        'La membrana en reposo deja salir potasio con más facilidad de la que deja entrar sodio.',
        'Una bomba de la membrana expulsa sodio e introduce potasio en contra de sus gradientes, y para ello consume energía: es un transporte activo.',
        'El umbral es el valor crítico del potencial que desencadena el potencial de acción.',
        'El potencial de acción es una respuesta de todo o nada: por debajo del umbral no ocurre nada y, alcanzado, se produce completa.',
        'En la despolarización se abren canales, entra sodio y el interior se vuelve menos negativo hasta llegar a positivo.',
        'En la repolarización se cierra la entrada de sodio, sale potasio y el interior vuelve a hacerse negativo.',
        'En el restablecimiento la bomba reordena sodio y potasio consumiendo energía y se recupera la situación de partida.',
        'La señal se propaga por contagio de un punto de la membrana al vecino, sin perder intensidad con la distancia.',
        'El periodo refractario impide que la célula se dispare de forma continua y obliga a que la señal avance en un solo sentido.',
        'Esta electrofisiología es la misma que gobierna la conducción del corazón y la transmisión del impulso nervioso; su interpretación clínica corresponde a los módulos clínicos.',
      ]),
      preguntasOrales([
        '¿Cómo está cargado el interior de la célula en reposo respecto del exterior y cómo se llama esa diferencia?',
        'Enumera los hechos de los que sale el potencial de reposo.',
        'Ordena las fases del potencial de acción y di qué ion se mueve en cada una.',
        'Explica qué quiere decir respuesta de todo o nada y qué papel juega el umbral.',
        '¿Por qué la señal no se apaga con la distancia a lo largo de la célula?',
        'Di las dos consecuencias útiles del periodo refractario.',
        '¿Qué relación tiene la bomba de la membrana con el aporte de energía de la célula?',
        'Relaciona lo aprendido aquí con lo que se estudia después sobre la conducción del corazón.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('AMORTIGUAN, EXHALAN, ELIMINAN: los amortiguadores ganan tiempo en segundos, el pulmón corrige en minutos y el riñón resuelve en horas o días. Ninguno sustituye a los otros; el orden en que actúan es lo que permite tolerar la alteración.'),
          masPreguntado('La dirección del cambio y la relación del dióxido de carbono con el pH. Si aumentan los hidrogeniones el medio se acidifica y el pH baja; si disminuyen, se alcaliniza y el pH sube. Y como el dióxido de carbono se comporta como ácido, ventilar más lo elimina y el pH tiende a subir, mientras que ventilar menos lo retiene y el pH tiende a bajar.'),
        ],
      },
      erroresFrecuentes([
        ['Pensar que un pH más alto significa más hidrogeniones', 'Es al revés. El pH expresa cuántos hidrogeniones libres hay: cuantos más, más ácida la solución y más bajo el pH. Fijar esta dirección desde el principio evita equivocarse en todo lo que sigue.'],
        ['Atribuir a los amortiguadores químicos una capacidad que no tienen', 'Amortiguan, no eliminan: captan o liberan hidrogeniones para atenuar el cambio, y su capacidad es limitada. El único mecanismo que retira ácido de forma definitiva es el renal.'],
        ['Tratar los tres mecanismos como alternativas entre las que se elige', 'Son complementarios y se ordenan por rapidez y capacidad: los amortiguadores actúan en segundos, el respiratorio en minutos y el renal en horas o días. Ninguno sustituye a los otros.'],
        ['Entrar aquí en los nombres de los trastornos ácido-base y sus valores', 'Los nombres de los trastornos, sus valores de laboratorio y su interpretación pertenecen a los módulos clínicos. Esta lección establece solo quién regula, en qué sentido y a qué velocidad.'],
      ]),
      repasoRapido([
        'El pH expresa cuántos iones hidrógeno libres hay en una solución: cuantos más, más ácida.',
        'El organismo mantiene el pH de sus líquidos dentro de un margen muy estrecho, y lo hace de forma continua porque su propio metabolismo produce ácido sin parar.',
        'El margen es estrecho porque las proteínas del cuerpo, incluidas las enzimas, cambian de forma según la acidez del medio, y una proteína deformada deja de funcionar.',
        'Si aumentan los hidrogeniones el medio se acidifica y el pH baja; si disminuyen, se alcaliniza y el pH sube.',
        'Los amortiguadores químicos captan o liberan hidrogeniones para atenuar el cambio, y el principal es el sistema del bicarbonato.',
        'Los amortiguadores actúan de forma inmediata, en segundos, pero su capacidad es limitada: amortiguan y no eliminan.',
        'El mecanismo respiratorio modifica la ventilación y con ella la eliminación de dióxido de carbono, y actúa en minutos.',
        'El mecanismo renal elimina hidrogeniones y recupera bicarbonato; es el más lento, el de mayor capacidad y el único que elimina de forma definitiva.',
        'El dióxido de carbono se comporta como un ácido porque al disolverse en agua libera hidrogeniones.',
        'Ventilar más elimina dióxido de carbono y el pH tiende a subir; ventilar menos lo retiene y el pH tiende a bajar.',
        'Por eso una alteración de la acidez modifica de forma refleja la profundidad y la frecuencia de la respiración.',
        'El riñón actúa por dos vías complementarias: elimina hidrogeniones en la orina y recupera bicarbonato para devolverlo a la sangre.',
      ]),
      preguntasOrales([
        '¿Qué mide el pH y en qué sentido cambia cuando aumentan los hidrogeniones?',
        'Explica por qué el margen de acidez que tolera el organismo es tan estrecho.',
        'Ordena los tres mecanismos reguladores del más rápido al más lento y di la capacidad de cada uno.',
        '¿Cuál es el único mecanismo que elimina ácido de forma definitiva y por qué los otros no lo hacen?',
        'Explica por qué el dióxido de carbono se comporta como un ácido en el organismo.',
        '¿Hacia dónde tiende el pH de quien ventila más de lo habitual y por qué?',
        'Describe las dos vías por las que el riñón participa en el equilibrio ácido-base.',
        '¿Qué parte del estudio del equilibrio ácido-base deja esta lección para los módulos clínicos?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CATA DEGRADA Y LIBERA, ANA CONSTRUYE Y CONSUME. Y una regla para el resto: con oxígeno, mucho rendimiento en la mitocondria; sin oxígeno, poco rendimiento en el citoplasma y ácido láctico como residuo. La vía sin oxígeno es un recurso, no un sustituto.'),
          masPreguntado('Por qué la falta de oxígeno se nota tan rápido. La vía sin oxígeno permite seguir obteniendo energía, pero rinde mucho menos y acumula ácido láctico: sostiene a la célula un rato y no reemplaza a la vía aerobia. Ese es el vínculo con la lección de la célula y con todo lo que se estudia sobre oxigenación.'),
        ],
      },
      erroresFrecuentes([
        ['Cambiar los nombres de catabolismo y anabolismo', 'El catabolismo degrada moléculas grandes en pequeñas y libera energía; el anabolismo construye moléculas grandes a partir de pequeñas y la consume. Ocurren en direcciones opuestas y de forma simultánea.'],
        ['Suponer que la energía liberada se usa directamente en la reacción que la necesita', 'No se usa así: se almacena en una molécula intermediaria que funciona como moneda energética común, y la célula la gasta donde y cuando la necesita, sea contracción, transporte activo o síntesis de sus propios componentes.'],
        ['Presentar la vía sin oxígeno como una alternativa equivalente', 'Rinde mucho menos, acumula ácido láctico y no puede sostenerse mucho tiempo. Es un recurso de emergencia que da margen, no un sustituto de la vía con oxígeno.'],
        ['Poner las proteínas como fuente habitual de energía', 'Su papel principal es estructura, enzimas y transporte. Se usan como fuente de energía solo cuando faltan los hidratos de carbono y los lípidos.'],
      ]),
      repasoRapido([
        'Metabolismo es el conjunto de reacciones químicas que ocurren en el organismo, agrupadas en dos direcciones opuestas y simultáneas.',
        'El catabolismo degrada moléculas grandes en pequeñas y libera energía; el anabolismo construye a partir de pequeñas y la consume.',
        'La energía liberada no se usa directamente: se almacena en una molécula intermediaria que actúa como moneda energética común.',
        'Con esa moneda la célula paga la contracción, el transporte activo y la síntesis de sus propios componentes.',
        'La obtención de energía a partir de la glucosa empieza igual con oxígeno o sin él, y a partir de cierto punto los caminos se separan.',
        'La vía con oxígeno ocurre sobre todo en la mitocondria, tiene rendimiento alto y deja dióxido de carbono y agua como productos finales.',
        'La vía sin oxígeno ocurre en el citoplasma, rinde mucho menos, deja ácido láctico y no puede sostenerse mucho tiempo.',
        'Los hidratos de carbono son la fuente de uso inmediato y el combustible que la célula puede aprovechar sin oxígeno.',
        'Los lípidos son la reserva a largo plazo: almacenan mucha energía por unidad de peso, pero su aprovechamiento requiere oxígeno.',
        'Las proteínas sirven para estructura, enzimas y transporte, y solo se usan como energía cuando faltan las otras dos.',
        'Un tejido que gasta mucha energía y almacena poca reserva sufre antes cuando se interrumpe el aporte, y es el caso del tejido nervioso y del músculo cardíaco.',
        'El organismo mantiene un gasto de base para respirar, conservar la temperatura, hacer circular la sangre y sostener los gradientes de las membranas, incluso en reposo completo.',
      ]),
      preguntasOrales([
        'Define catabolismo y anabolismo y di qué hace cada uno con la energía.',
        '¿Por qué la energía liberada no se usa directamente y qué papel cumple la molécula intermediaria?',
        'Compara las dos rutas en dónde ocurren, qué rendimiento tienen y qué producto característico dejan.',
        'Explica por qué la interrupción del aporte de oxígeno tiene consecuencias en minutos y no en días.',
        'Di el papel principal de cada uno de los tres principios inmediatos.',
        '¿Cuál de los principios inmediatos puede aprovecharse sin oxígeno y cuál necesita oxígeno para usarse?',
        '¿Por qué el tejido nervioso y el músculo cardíaco toleran peor la interrupción del aporte que otros tejidos?',
        'Enumera las funciones que sostiene el gasto energético de base en reposo completo.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('BARRERA, SENSIBILIDAD Y ABRIGO, de fuera adentro: epidermis que aísla y no tiene vasos, dermis que siente e irriga, hipodermis que abriga y amortigua. Por eso lo superficial no sangra y en cuanto se alcanza la dermis aparecen sangrado y dolor.'),
          masPreguntado('Que la epidermis no tiene vasos sanguíneos y se nutre por difusión desde la dermis. Ese detalle estructural es el que explica por qué las lesiones limitadas a la capa más superficial no sangran, y por qué al alcanzar la dermis aparecen sangrado y dolor: es donde están los vasos y las terminaciones nerviosas.'),
        ],
      },
      erroresFrecuentes([
        ['Situar los vasos y las terminaciones nerviosas en la epidermis', 'Están en la dermis. La epidermis es epitelio en capas sin vasos sanguíneos y se nutre por difusión desde la dermis, que sí está irrigada.'],
        ['Reducir la piel a una cubierta', 'Además de proteger, informa, porque contiene terminaciones nerviosas de tacto, presión, temperatura y dolor; regula la temperatura, participa en la síntesis de vitamina D, excreta agua y sales por el sudor y guarda reserva energética.'],
        ['Interpretar el aspecto de la piel como un dato aislado', 'El calibre de los vasos dérmicos acerca o aleja la sangre de la superficie, y eso cambia a la vez la temperatura y el color. El aspecto de la piel es una consecuencia visible de lo que está haciendo la circulación.'],
        ['Convertir esta lección en una lista de signos con su significado clínico', 'Aquí se establece qué estructura produce cada dato observable. Cómo se interpreta cada hallazgo, en qué cuadros aparece y qué conducta exige pertenece a los módulos de evaluación y clínica.'],
      ]),
      repasoRapido([
        'El sistema tegumentario es el órgano más extenso del cuerpo y está formado por la piel y sus anexos: pelo, uñas y glándulas.',
        'Se organiza en tres capas superpuestas de composición y función distintas: epidermis, dermis e hipodermis.',
        'La epidermis es epitelio en capas, sin vasos sanguíneos, e incluye las células del pigmento; sostiene la barrera frente a microorganismos, sustancias y pérdida de agua.',
        'La dermis es tejido conjuntivo con vasos, terminaciones nerviosas, folículos y glándulas, y aporta resistencia, elasticidad, sensibilidad, irrigación y sudoración.',
        'La hipodermis o tejido subcutáneo es tejido conjuntivo laxo y grasa, y aporta aislamiento térmico, reserva energética y amortiguación mecánica.',
        'La epidermis se nutre por difusión desde la dermis, y de ahí que lo limitado a la capa más superficial no sangre.',
        'Las funciones del tegumento son protección, sensibilidad, regulación de la temperatura, participación en la síntesis de vitamina D, excreción de agua y sales, y reserva y amortiguación.',
        'Para perder calor los vasos de la dermis se dilatan y llega más sangre a la superficie, donde el calor se disipa; además la sudoración retira calor al evaporarse.',
        'Para conservarlo esos mismos vasos se contraen y la sangre se aleja de la superficie.',
        'El color depende de la sangre que llega a los vasos de la dermis y del pigmento de la epidermis, y la temperatura al tacto depende del calibre de esos vasos.',
        'La humedad depende de la actividad de las glándulas sudoríparas de la dermis, y la elasticidad y la recuperación al pellizco dependen del tejido conjuntivo dérmico y del contenido de agua.',
        'La piel es el único órgano que puede observarse por completo sin ningún instrumento, y por eso es el más informativo a simple vista.',
      ]),
      preguntasOrales([
        'Nombra las tres capas del tegumento de fuera adentro y di qué contiene cada una.',
        '¿Por qué una lesión limitada a la capa más superficial no sangra?',
        'Enumera las funciones del tegumento que menciona la lección.',
        'Explica qué hacen los vasos de la dermis cuando el organismo necesita perder calor y cuando necesita conservarlo.',
        'Relaciona cada dato observable de la piel, color, temperatura, humedad y elasticidad, con la estructura o función que lo produce.',
        '¿Por qué el aspecto de la piel no es un dato aislado sino una consecuencia de lo que hace la circulación?',
        'Di qué función sostiene la hipodermis y de qué está formada.',
        '¿Qué parte del estudio de la piel deja esta lección para los módulos de evaluación y clínica?',
      ]),
