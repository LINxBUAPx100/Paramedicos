    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('UNA TOMA DESCRIBE, DOS TOMAS INFORMAN: la cifra aislada dice casi nada y la tendencia entre dos tomas lo dice casi todo. Y sin hora anotada no hay tendencia que reconstruir.'),
          masPreguntado('Que la presión arterial llega tarde. La hipotensión es un signo tardío de hipoperfusión: un adulto joven puede mantener cifras normales mientras compensa una hemorragia importante, y la taquicardia, la piel fría y húmeda y la ansiedad aparecen antes.'),
        ],
      },
      erroresFrecuentes([
        ['Avisar al paciente de que se le va a contar la respiración', 'Quien se sabe observado modifica su patrón de forma involuntaria. La frecuencia respiratoria se cuenta sin avisar, observando el ascenso del tórax.'],
        ['Tomar el pulso con el pulgar', 'El pulgar tiene pulso propio y puede confundirse con el del paciente. Se palpa con los pulpejos de los dedos índice y medio, y si el radial no se palpa se busca el carotídeo comprimiendo un solo lado y sin masajear.'],
        ['Medir la presión sobre la ropa o con un brazalete de tamaño inadecuado', 'Un brazalete pequeño sobrestima la presión y uno grande la subestima. Se coloca sobre el brazo desnudo, y no se mide en un brazo con fístula, lesión, hemorragia o del lado de una mastectomía.'],
        ['Dar por buena una saturación en un paciente frío, en shock o con temblor', 'La pulsioximetría depende de que haya flujo pulsátil en el sitio de medición. Y en la intoxicación por monóxido de carbono la carboxihemoglobina se lee como si fuera oxihemoglobina, de modo que una cifra normal no descarta intoxicación.'],
      ]),
      repasoRapido([
        'Los signos vitales sirven para detectar una alteración que no es evidente, cuantificar la gravedad de la que ya se ve y seguir la evolución.',
        'El conjunto mínimo incluye frecuencia respiratoria con calidad y trabajo respiratorio, frecuencia cardiaca con ritmo y amplitud, presión arterial y saturación de oxígeno cuando se dispone del equipo.',
        'También temperatura, estado de conciencia y pupilas, y color, temperatura y humedad de la piel con llenado capilar.',
        'Una toma describe un instante: la información que cambia decisiones aparece al comparar dos tomas separadas en el tiempo.',
        'La frecuencia respiratoria se cuenta observando el tórax, sin avisar al paciente, y se registra además la calidad: profundidad, simetría, músculos accesorios, tiraje, aleteo nasal y ruidos audibles sin estetoscopio.',
        'El pulso se palpa con los pulpejos del índice y del medio, nunca con el pulgar, y se registran frecuencia, ritmo y amplitud.',
        'El brazalete debe abarcar aproximadamente el ochenta por ciento de la circunferencia del brazo y cubrir dos tercios de su longitud, sobre el brazo desnudo.',
        'Con estetoscopio, la aparición de los ruidos de Korotkoff marca la sistólica y su desaparición la diastólica; cuando el ruido ambiental lo impide se emplea el método palpatorio, que da solo la sistólica y se registra como tal.',
        'La pulsioximetría falla o miente con hipoperfusión, hipotermia, temblor, esmalte de uñas oscuro y luz ambiental intensa, y no distingue la carboxihemoglobina.',
        'La temperatura se registra junto con el método usado, porque las vías axilar, timpánica y oral no son intercambiables.',
        'Las pupilas se exploran en tamaño, simetría y reactividad, anotando el uso de lentes de contacto o el antecedente de cirugía ocular.',
        'Cada toma se anota con su hora, y se documenta el método cuando puede cambiar la interpretación: presión palpada, temperatura axilar o saturación con oxígeno suplementario.',
      ]),
      preguntasOrales([
        'Enumera el conjunto mínimo de signos vitales de toda atención prehospitalaria.',
        '¿Para qué tres cosas sirven los signos vitales en el ámbito prehospitalario?',
        'Explica por qué una sola toma no es una tendencia.',
        '¿Por qué la frecuencia respiratoria se cuenta sin avisar al paciente?',
        '¿Con qué dedos se palpa el pulso y por qué no con el pulgar?',
        'Di qué ocurre si el brazalete es demasiado pequeño y qué ocurre si es demasiado grande.',
        'Enumera las situaciones en que la pulsioximetría da lecturas falsas o ausentes.',
        'Explica por qué esperar a que caiga la presión para reconocer el shock es esperar demasiado.',
      ]),
      {
        titulo: 'Fuentes',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA HERIDA QUE ACAPARA LA MIRADA RARA VEZ ES LA QUE ESTÁ MATANDO: evisceración, proyectil y amputación impresionan, y la evaluación primaria va antes que las tres. Y en las tres, la regla es la misma: no reintroducir, no clasificar, no congelar.'),
          masPreguntado('Que no se dice «entrada» ni «salida» en una herida por proyectil. Determinar cuál orificio es de entrada corresponde al perito forense y depende de hallazgos que no se pueden valorar en la calle; una descripción equivocada en el registro puede pesar en un proceso legal. Se describe la herida y su ubicación.'),
        ],
      },
      erroresFrecuentes([
        ['Reintroducir el contenido abdominal expuesto', 'Devolver las vísceras a la cavidad arrastra contaminación al peritoneo, puede lesionar el intestino y no aporta ningún beneficio: la reparación es quirúrgica y se hará en quirófano de todos modos.'],
        ['Clasificar los orificios de una herida por proyectil', 'Eso corresponde al perito forense. Lo correcto es contar y registrar todas las heridas, incluidas espalda, axilas, periné y cuero cabelludo, y describir cada una por localización, tamaño y aspecto.'],
        ['Poner el segmento amputado en contacto con hielo o sumergirlo', 'El contacto directo con hielo congela el tejido y lo inutiliza para el reimplante, y sumergirlo en agua o en solución lo macera. El objetivo es enfriar, no congelar.'],
        ['Completar una amputación incompleta', 'El segmento que conserva unión de tejidos se alinea con suavidad, se cubre y se inmoviliza junto con la extremidad, evitando torsiones que comprometan el pedículo que aún lo irriga. No se completa la amputación en el medio prehospitalario.'],
      ]),
      repasoRapido([
        'Las tres lesiones de este tema son visualmente impactantes, y ese es su riesgo formativo: atraen la atención y desplazan la evaluación primaria.',
        'La evisceración es la salida de vísceras abdominales a través de una solución de continuidad de la pared, y el tejido expuesto pierde calor y humedad con rapidez.',
        'No se reintroduce el contenido expuesto; se retira solo la ropa que impida el acceso, sin arrastrar el tejido.',
        'Se cubre con apósitos estériles humedecidos con solución salina y, sobre ellos, una capa oclusiva que conserve humedad y calor, y el apósito se reevalúa durante el traslado porque al secarse deja de proteger.',
        'El paciente se coloca en decúbito supino con las rodillas flexionadas si el resto de sus lesiones lo permite, para reducir la tensión de la pared.',
        'El daño de un proyectil no se limita al trayecto visible: la energía transmitida produce una cavidad temporal que puede lesionar estructuras alejadas, y el proyectil puede desviarse al chocar con hueso.',
        'Una escena con arma de fuego no es segura hasta que la autoridad lo declara, y es también una escena legal.',
        'Se cuentan y registran todas las heridas y se describen por localización, tamaño y aspecto, sin clasificarlas como entrada o salida.',
        'La ropa se retira cortando por fuera de los orificios y se conserva, y lo retirado se entrega según el procedimiento del servicio.',
        'En la amputación traumática la prioridad es el paciente y no el segmento: la hemorragia se controla primero con presión directa y, si es insuficiente y el servicio lo autoriza, con torniquete.',
        'El segmento se limpia de suciedad gruesa sin frotar, se envuelve en gasa estéril ligeramente humedecida, se mete en bolsa limpia cerrada e identificada con nombre y hora, y esa bolsa se coloca sobre hielo dentro de otro recipiente.',
        'El segmento se traslada junto con el paciente al mismo hospital.',
      ]),
      preguntasOrales([
        '¿Por qué se dice que la lesión llamativa distrae, y qué hay que terminar antes de dedicarse a ella?',
        'Ordena el manejo prehospitalario de una evisceración.',
        'Explica por qué no se reintroducen las vísceras.',
        '¿Por qué el daño de un proyectil puede exceder su trayecto visible?',
        '¿Por qué no se describe un orificio como de entrada o de salida?',
        'Di qué se registra y qué se hace con la ropa en una escena con arma de fuego.',
        'Ordena la conservación de un segmento amputado.',
        'Explica la diferencia entre enfriar y congelar, y qué se hace en una amputación incompleta.',
      ]),
      {
        titulo: 'Fuentes',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LO QUE NO ESTÁ ESCRITO, NO SE HIZO: consentimiento, negativa, confidencialidad, indicios… todo el marco descansa en la constancia escrita. La ley no autoriza a actuar sin consentimiento y olvidarlo: exige dejar constancia.'),
          masPreguntado('La diferencia entre capacidad y docilidad. Capacidad para decidir significa comprender la situación, las alternativas y las consecuencias de rechazar. Que un paciente esté asustado, molesto o en desacuerdo no lo vuelve incapaz; que esté intoxicado, hipóxico, hipoglucémico o con alteración del estado mental sí compromete su capacidad.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar el desacuerdo del paciente como incapacidad', 'Que esté asustado, molesto o en desacuerdo no lo vuelve incapaz. Lo que compromete la capacidad es la intoxicación, la hipoxia, la hipoglucemia o la alteración del estado mental, y hay que descartar esas causas tratables antes de aceptar una negativa.'],
        ['Actuar en urgencia sin autorización y no dejar constancia', 'La ley no autoriza a actuar sin consentimiento y olvidarlo: exige dejar constancia. En el ámbito prehospitalario eso significa registrar por escrito la condición del paciente, la ausencia de familiar o representante y la razón por la que se procedió.'],
        ['Retirarse de un paciente que requiere atención sin transferirlo', 'Eso es abandono. Una negativa correctamente valorada y documentada no lo es; irse sin más, sí.'],
        ['Alterar un registro ya cerrado para corregir un error', 'Los errores se corrigen mediante nota aclaratoria fechada y firmada. Y el registro describe lo observado, no lo supuesto: las opiniones y los juicios sobre la conducta del paciente no caben en él.'],
      ]),
      repasoRapido([
        'La Ley General de Salud reconoce en su artículo 51 Bis 2 el derecho de la persona usuaria a otorgar o no su consentimiento respecto de tratamientos o procedimientos.',
        'El mismo artículo resuelve la urgencia: en incapacidad transitoria o permanente la autorización la otorga el familiar que acompaña o el representante legal, y si eso no es posible se procede de inmediato a preservar la vida y la salud.',
        'Hay tres formas: consentimiento informado o expreso, consentimiento por representante y actuación en urgencia sin autorización previa, que exige dejar constancia escrita de por qué no se obtuvo.',
        'Capacidad para decidir significa comprender la situación, las alternativas y las consecuencias de rechazar.',
        'Un paciente capaz puede rechazar la valoración, el tratamiento o el traslado, y la negativa se maneja como un procedimiento: valorar y documentar la capacidad, descartar causas tratables, explicar el riesgo concreto en lenguaje llano y ofrecer alternativas.',
        'La negativa se registra con la firma del paciente y, cuando sea posible, de un testigo, dejando por escrito qué se explicó y qué respondió con sus propias palabras, e informando de que puede volver a llamar sin inconveniente.',
        'Abandono es retirarse de un paciente que requiere atención sin transferirlo a alguien de igual o mayor capacidad.',
        'La Ley Federal de Protección de Datos Personales en Posesión de los Particulares clasifica el estado de salud como dato personal sensible, y prevé que no se requiere consentimiento para la asistencia sanitaria mientras la persona no está en condiciones de otorgarlo, siempre que quien trata el dato esté sujeto al secreto profesional.',
        'La NOM-004-SSA3-2012, del expediente clínico, establece criterios obligatorios de manejo, conservación y confidencialidad para el personal de salud, y la atención prehospitalaria y su registro se enmarcan además en la NOM-034-SSA3-2013.',
        'Vulneran la confidencialidad comentar el caso delante de terceros, fotografiar o grabar con el teléfono personal, publicar datos en redes aunque se omita el nombre, dejar el registro a la vista e informar por teléfono a quien dice ser familiar sin poder verificarlo.',
        'Un registro defendible anota la hora de cada hallazgo y de cada intervención, transcribe entre comillas las declaraciones relevantes, no se altera una vez cerrado y describe lo observado y no lo supuesto.',
        'El Código Nacional de Procedimientos Penales define en su artículo 227 la cadena de custodia como el sistema de control y registro aplicado al indicio desde su localización hasta que la autoridad competente disponga su destino, y quien entra en contacto con un indicio durante la atención queda dentro de ese régimen.',
      ]),
      preguntasOrales([
        'Distingue las tres formas de consentimiento que reconoce la ley y di qué exige la actuación en urgencia.',
        '¿Qué significa tener capacidad para decidir y qué situaciones la comprometen?',
        'Ordena cómo se maneja una negativa de atención o de traslado.',
        'Define abandono y di por qué una negativa bien documentada no lo es.',
        '¿Cómo clasifica la ley federal el estado de salud y qué consecuencia tiene esa clasificación?',
        'Enumera situaciones cotidianas que vulneran la confidencialidad.',
        'Di los criterios de un registro defendible y cómo se corrige un error en un registro cerrado.',
        '¿Qué es la cadena de custodia y qué medidas de preservación son compatibles con la atención?',
      ]),
      {
        titulo: 'Fuentes',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DERECHA E IZQUIERDA SON LAS DEL PACIENTE, no las del observador: una herida en el lado derecho está a la izquierda de quien la mira de frente. Y proximal y distal son solo para los miembros; en el tronco se dice superior e inferior.'),
          masPreguntado('Que la lateralidad se nombra desde el punto de vista del paciente. Confundirlo es una de las causas más frecuentes de error en un informe de entrega, porque una herida del lado derecho aparece a la izquierda de quien la mira de frente.'),
        ],
      },
      erroresFrecuentes([
        ['Nombrar la lateralidad desde el punto de vista del observador', 'Se nombra desde el punto de vista del paciente. Una herida en el lado derecho está a la izquierda de quien la mira de frente, y confundirlo es una de las causas más frecuentes de error en un informe de entrega.'],
        ['Usar proximal y distal en el tronco', 'Se reservan para los miembros, donde existe una raíz de referencia. Decir que el ombligo es distal al esternón es incorrecto: es inferior.'],
        ['Tomar el cuadrante como un diagnóstico', 'Saber qué órganos hay bajo un cuadrante orienta la sospecha, no la confirma. El dolor visceral se refiere mal, y una lesión de bazo puede doler en el hombro izquierdo.'],
        ['Registrar el hallazgo en lenguaje coloquial', '«Herida arriba del lado izquierdo» puede significar cinco cosas distintas para cinco personas. El hospital decide con lo que se le comunica, y una localización ambigua obliga a repetir la exploración y retrasa la atención.'],
      ]),
      repasoRapido([
        'La posición anatómica de referencia es persona de pie, cabeza y mirada al frente, miembros superiores a los lados, palmas hacia delante y pies dirigidos al frente.',
        'Los términos se aplican siempre respecto de esa posición, con independencia de cómo esté colocado el paciente.',
        'La lateralidad se nombra desde el punto de vista del paciente, no del observador.',
        'Superior e inferior indican más cerca de la cabeza o de los pies; anterior y posterior, hacia el frente o hacia la espalda.',
        'Medial y lateral indican más cerca o más lejos de la línea media; superficial y profundo, más cerca o más lejos de la superficie.',
        'Proximal y distal indican más cerca o más lejos de la raíz del miembro, y se reservan para los miembros; en el tronco se usan superior e inferior.',
        'El plano sagital divide el cuerpo en derecha e izquierda, y el que pasa exactamente por la línea media se llama sagital medio.',
        'El plano frontal o coronal divide en una parte anterior y una posterior, y el transversal u horizontal en una superior y una inferior.',
        'Sobre el tórax se usan la línea medioesternal, las medioclaviculares trazadas desde el punto medio de cada clavícula, las axilares anterior, media y posterior, y las escapulares.',
        'El abdomen se divide en cuatro cuadrantes trazando una línea vertical y otra horizontal que se cruzan en el ombligo.',
        'El cuadrante superior derecho aloja hígado, vesícula biliar, porción del duodeno y ángulo hepático del colon; el superior izquierdo, estómago, bazo, cola del páncreas y ángulo esplénico.',
        'El inferior derecho aloja ciego y apéndice, uréter y ovario derechos; el inferior izquierdo, colon sigmoides, uréter y ovario izquierdos.',
      ]),
      preguntasOrales([
        'Describe la posición anatómica de referencia y explica por qué hace falta un punto de partida convenido.',
        '¿Desde el punto de vista de quién se nombran derecha e izquierda, y qué error frecuente evita esa regla?',
        'Define superior, inferior, anterior, posterior, medial y lateral con un ejemplo de cada par.',
        '¿En qué parte del cuerpo se usan proximal y distal, y qué se dice en el tronco?',
        'Nombra los tres planos corporales y di qué divide cada uno.',
        'Enumera las líneas verticales de referencia del tórax.',
        'Di qué estructuras principales corresponden a cada cuadrante abdominal.',
        'Explica por qué el cuadrante localiza el hallazgo pero no constituye un diagnóstico.',
      ]),
      {
        titulo: 'Fuentes',
