    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MENOS MASA, MÁS ENERGÍA POR TEJIDO. La misma energía sobre un cuerpo pequeño se distribuye en menos masa y menos superficie: la transferencia por unidad de tejido es mayor, y los órganos están menos protegidos.'),
          masPreguntado('Que en el niño hay que asumir lesión multisistémica hasta demostrar lo contrario, y que el shock pediátrico engaña: mantiene la presión a costa de taquicardia y vasoconstricción hasta que la compensación se agota. Reconocer el shock por la hipotensión es reconocerlo tarde.'),
        ],
      },
      erroresFrecuentes([
        ['Buscar una sola lesión', 'En el niño se asume lesión multisistémica hasta demostrar lo contrario.'],
        ['Reconocer el shock por la hipotensión', 'Mantiene la presión hasta que la compensación se agota, y entonces cae con rapidez.'],
        ['Descartar lesión medular por una imagen normal', 'La lesión medular sin alteración radiológica evidente es más propia del niño: la exploración y el mecanismo mandan sobre la imagen.'],
        ['No comprobar la congruencia del relato', 'En pediatría el mecanismo añade una comprobación propia: que lo ocurrido sea compatible con lo que el niño puede hacer y con la lesión que presenta.'],
      ]),
      repasoRapido([
        'El trauma es la principal causa de muerte y de discapacidad en la infancia.',
        'La misma energía sobre un cuerpo pequeño transfiere más por unidad de tejido.',
        'Es frecuente la lesión multisistémica: se asume más de una lesión hasta demostrar lo contrario.',
        'La cabeza se lesiona con más frecuencia y el traumatismo craneal es la principal causa de muerte por trauma en esta edad.',
        'Puede haber lesión pulmonar sin fracturas costales, por la elasticidad del tórax.',
        'Hígado y bazo están más expuestos en el trauma abdominal cerrado.',
        'La lesión medular sin alteración radiológica evidente es más propia del niño.',
        'El esqueleto en crecimiento tiene lesiones propias en las zonas de crecimiento.',
        'El shock pediátrico engaña: la hipotensión es tardía.',
        'Mecanismos de especial atención: atropello, caída relativa a su estatura, retención inadecuada o mal colocada.',
        'También ahogamiento, quemaduras con distribución congruente y objetos o mobiliario que caen sobre el niño.',
        'Hipotermia e hipoglucemia aparecen antes y pesan más en el niño.',
      ]),
      preguntasOrales([
        'Explica por qué la misma energía produce lesiones distintas en el niño.',
        'Enumera las consecuencias prácticas de esas diferencias.',
        '¿Por qué el shock pediátrico engaña?',
        '¿Qué manda sobre la imagen en la lesión medular del niño?',
        'Nombra los mecanismos de especial atención.',
        '¿Qué comprobación propia añade el mecanismo en pediatría?',
        '¿Por qué la hipotermia y la hipoglucemia pesan más aquí?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA CABEZA ARRASTRA AL CUELLO. Es proporcionalmente grande y pesada, y el cuello relativamente débil: en una desaceleración la cabeza actúa como una masa que tira, y de ahí que el traumatismo craneal domine el pronóstico.'),
          masPreguntado('El cinturón mal colocado: uno de adulto sobre un niño pequeño queda alto, sobre el abdomen en lugar de sobre la pelvis, y en una desaceleración comprime las vísceras contra la columna produciendo el patrón de lesión intestinal y lumbar.'),
        ],
      },
      erroresFrecuentes([
        ['No acolchar bajo los hombros al inmovilizar', 'El occipucio prominente flexiona el cuello en decúbito supino.'],
        ['Esperar la fontanela abombada como signo precoz', 'La fontanela abierta puede absorber durante un tiempo el aumento de volumen intracraneal: su abombamiento es un signo tardío y de alarma.'],
        ['Confundir distensión gástrica con distensión abdominal', 'La distensión por llanto o por ventilación es frecuente, puede simularla y dificulta la ventilación.'],
        ['Descartar lesión abdominal por un abdomen poco expresivo', 'El niño puede tener una lesión significativa con un abdomen poco expresivo y una capacidad limitada de referir dolor.'],
      ]),
      repasoRapido([
        'La cabeza del niño es grande y pesada y su cuello relativamente débil.',
        'Al inmovilizar en decúbito supino se acolcha bajo los hombros.',
        'La fontanela abierta del lactante puede absorber el aumento de volumen: su abombamiento es tardío y de alarma.',
        'El niño puede perder un volumen significativo en una herida del cuero cabelludo.',
        'El vómito tras un traumatismo craneal es frecuente y no equivale a lesión; el repetido sí es alarma.',
        'Tórax: costillas flexibles y mediastino móvil; contusión pulmonar sin fracturas y peor tolerancia del neumotórax a tensión.',
        'Abdomen: pared con menos musculatura y parrilla que cubre menos; hígado y bazo más expuestos.',
        'El manillar de bicicleta es un mecanismo clásico de lesión abdominal.',
        'La distensión gástrica por llanto o ventilación es frecuente y puede simular distensión abdominal.',
        'Pelvis: fractura menos frecuente pero de alta energía cuando ocurre.',
        'Extremidades: hueso en crecimiento con zonas vulnerables, deformidad sin fractura completa y lesiones propias.',
        'El cinturón de adulto sobre un niño pequeño queda sobre el abdomen y produce lesión intestinal y lumbar.',
      ]),
      preguntasOrales([
        '¿Por qué la cabeza domina el pronóstico del trauma pediátrico?',
        'Enumera lo que cambia el manejo en cabeza, cuello y columna.',
        '¿Qué significa una fontanela abombada?',
        'Di las particularidades de tórax, abdomen y pelvis.',
        '¿Qué es la distensión gástrica y por qué confunde?',
        '¿Qué problema plantea un cinturón mal colocado?',
        '¿Qué tienen de propio las extremidades del niño?',
        '¿Cómo se busca la lesión abdominal que no se ve?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('UN DISPOSITIVO QUE PROVOCA LUCHA PUEDE MOVER MÁS DE LO QUE SUJETA. Un niño asustado que se retuerce contra las correas genera más movimiento espinal que el mismo niño tranquilo en brazos de su cuidador con estabilización manual.'),
          masPreguntado('Que ni el collarín ni el material de adulto valen por defecto: uno de talla incorrecta no inmoviliza y sí puede empeorar la posición de la vía aérea. Si no hay talla adecuada, es preferible la estabilización manual con acolchado lateral.'),
        ],
      },
      erroresFrecuentes([
        ['Usar un collarín que no ajusta', 'Uno grande extiende el cuello y uno pequeño lo flexiona. Si no hay talla adecuada, es preferible la estabilización manual y el acolchado lateral.'],
        ['Aplicar un dispositivo que hace luchar al niño', 'Puede generar más movimiento espinal que la estabilización manual con el niño tranquilo.'],
        ['No rellenar los huecos', 'En el niño son muchos, y sin rellenarlos el dispositivo se desplaza.'],
        ['No comprobar la ventilación tras inmovilizar', 'El dispositivo no debe comprimir el abdomen ni limitar la expansión torácica: el niño ventila sobre todo con el diafragma.'],
      ]),
      repasoRapido([
        'Los criterios son los mismos que en el adulto; lo que cambia es la técnica.',
        'Se acolcha bajo los hombros y el tronco para compensar el occipucio prominente.',
        'Se usa collarín de la talla correcta, y si no hay, estabilización manual con acolchado lateral.',
        'Se rellenan los huecos entre el cuerpo y el dispositivo, que en el niño son muchos.',
        'Se moviliza en bloque con el número de personas necesario, sosteniendo cabeza y tronco como una unidad.',
        'Se comprueba que el dispositivo no comprime el abdomen ni limita la expansión torácica.',
        'Se reevalúa la ventilación y el estado neurológico después de inmovilizar.',
        'Un dispositivo que provoca lucha puede mover más de lo que sujeta.',
        'Ayudan mantener al cuidador visible y en contacto, y explicar cada paso antes de hacerlo.',
        'También dejar que el niño toque el material y trabajar deprisa pero sin brusquedad.',
        'La analgesia según el alcance ayuda: el dolor no controlado alimenta la agitación.',
        'Se documenta la decisión adoptada, incluida la de no aplicar un dispositivo concreto y por qué.',
      ]),
      preguntasOrales([
        '¿Qué criterios se aplican, y qué cambia respecto al adulto?',
        'Recorre cómo se ajusta la técnica.',
        '¿Qué problemas da un collarín de talla incorrecta?',
        '¿Qué alternativa hay si no hay talla adecuada?',
        'Explica por qué un dispositivo puede mover más de lo que sujeta.',
        'Enumera las medidas que ayudan con el niño que se resiste.',
        '¿Por qué se comprueba la ventilación tras inmovilizar?',
        '¿Qué papel puede tener el sistema de retención del vehículo?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ANTE UN NIÑO TRAUMATIZADO QUE SE VUELVE BRADICÁRDICO, VÍA AÉREA Y OXÍGENO. Casi siempre significa hipoxia: la primera respuesta no es buscar una causa cardiaca.'),
          masPreguntado('Que el peso estimado es información clínica: de él dependen el material y la medicación que preparará el centro receptor, y comunicarlo en la prealerta ahorra minutos en la recepción. Y que el dolor del niño se infravalora de forma sistemática, sobre todo en el que no habla.'),
        ],
      },
      erroresFrecuentes([
        ['Buscar una causa cardiaca ante una bradicardia', 'Casi siempre significa hipoxia: primero se asegura la vía aérea y la oxigenación.'],
        ['No estimar ni comunicar el peso', 'De él dependen el material y la medicación del centro receptor.'],
        ['Infravalorar el dolor del que no habla', 'Se infravalora de forma sistemática. Se valora con la escala del servicio y se trata conforme al alcance.'],
        ['Valorar una sola vez', 'El niño compensa hasta que deja de hacerlo, y ese cambio puede ocurrir durante el traslado.'],
      ]),
      repasoRapido([
        'X: control inmediato del sangrado masivo, porque su volumen circulante es pequeño.',
        'A: posición neutra con acolchado bajo los hombros; la lengua es la causa más frecuente de obstrucción.',
        'B: vigilar el esfuerzo; el descenso del trabajo o la somnolencia indican agotamiento y preceden al paro.',
        'C: reconocer el shock por piel, pulso periférico, relleno capilar y comportamiento, no por la presión.',
        'D: escala adaptada a su edad y glucemia si está dentro del alcance.',
        'E: exponer por partes, explorar deprisa y cubrir de inmediato.',
        'La bradicardia en el niño traumatizado es un signo grave y casi siempre significa hipoxia.',
        'Cinco medidas de alto rendimiento: detener la hemorragia controlable de inmediato y ventilar bien sin hiperventilar.',
        'También prevenir activamente la hipotermia desde el primer minuto y medir la glucemia.',
        'Y acortar el tiempo hasta el centro adecuado, con prealerta que incluya peso estimado y hallazgos.',
        'El dolor del niño se infravalora de forma sistemática, sobre todo en el que no habla.',
        'La inmovilización correcta, la posición cómoda y el acompañamiento son también analgesia.',
      ]),
      preguntasOrales([
        'Recorre la secuencia letra por letra con su matiz pediátrico.',
        '¿Qué significa una bradicardia en un niño traumatizado?',
        '¿Cuál es la primera respuesta ante ella?',
        'Di las cinco medidas de alto rendimiento.',
        '¿Por qué el peso estimado es información clínica?',
        '¿Qué ocurre con el dolor del niño?',
        '¿Qué analgesia no requiere autorización farmacológica?',
        '¿Por qué reevaluar es la parte más importante?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA MÉDULA NO SE COLAPSA. A diferencia de una vena periférica, la red vascular del interior del hueso está sostenida por la estructura ósea: por eso sigue disponible en el paciente en shock.'),
          masPreguntado('Por qué importa tanto en pediatría: conseguir una vía venosa en un lactante en shock puede llevar varios intentos y varios minutos, tiempo que ese paciente no siempre tiene. Y el título del plan escribe «Osteólisis», que es una errata documental.'),
        ],
      },
      erroresFrecuentes([
        ['Usar el término del plan como nombre del procedimiento', '«Osteólisis» designa otra cosa: es una errata documental que se conserva solo para trazabilidad.'],
        ['Intentar en un hueso ya puncionado', 'Un intento previo en ese mismo hueso lo contraindica, aunque haya fracasado.'],
        ['Seguir infundiendo con tumefacción alrededor del punto', 'Indica extravasación: se detiene la infusión y se comunica.'],
        ['No comunicar el acceso en la entrega', 'El equipo receptor necesita saber que existe y dónde está.'],
      ]),
      repasoRapido([
        'El interior del hueso contiene una red de vasos que drenan a la circulación central.',
        'Esa red está sostenida por la estructura ósea y no se colapsa.',
        'Importa en pediatría porque conseguir una vía venosa en un lactante en shock puede llevar minutos que no tiene.',
        'Se plantea en el paciente pediátrico crítico que necesita acceso de forma inmediata.',
        'También ante fracaso o previsión de fracaso del acceso periférico en un paciente que no puede esperar.',
        'Contraindican fractura del hueso elegido o del proximal, e intento previo en ese mismo hueso.',
        'También infección, quemadura o herida en el punto, y prótesis o material de osteosíntesis.',
        'También enfermedades óseas que comprometan la resistencia y la imposibilidad de identificar las referencias.',
        'No se publican sitios exactos, calibres, longitudes ni profundidades: dependen del dispositivo y del protocolo.',
        'Confirmación: la aguja queda firme por sí sola y se infunde sin resistencia excesiva ni hinchazón alrededor.',
        'La tumefacción alrededor del punto indica extravasación: se detiene la infusión y se comunica.',
        'Es una medida temporal: se sustituye por un acceso definitivo cuando las condiciones lo permitan.',
      ]),
      preguntasOrales([
        'Explica el fundamento de la vía intraósea.',
        '¿Por qué importa tanto en pediatría?',
        '¿Cómo se escribe correctamente el procedimiento, y qué escribe el plan?',
        'Enumera las situaciones en que se plantea.',
        'Di las contraindicaciones.',
        '¿Cómo se comprueba la posición?',
        '¿Qué complicación es la más frecuente y cuál la más grave?',
        '¿Qué se documenta y qué se comunica?',
      ]),
