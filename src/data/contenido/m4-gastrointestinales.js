    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MIRAR, ESCUCHAR Y LUEGO TOCAR. En el abdomen el orden se invierte respecto del tórax, y no por ceremonia: palpar antes de auscultar modifica los ruidos intestinales, así que la información que se obtendría después ya no sirve.'),
          masPreguntado('Que hay que empezar a palpar por la zona MÁS ALEJADA del dolor: si se empieza donde más duele, el paciente contrae la pared de forma voluntaria y el resto de la exploración deja de ser interpretable. Y que ningún signo clásico confirma una enfermedad: todos pueden faltar en quien la tiene y aparecer en quien no.'),
        ],
      },
      erroresFrecuentes([
        ['Palpar antes de auscultar', 'La palpación modifica los ruidos intestinales: la auscultación posterior ya no informa.'],
        ['Empezar a palpar donde duele', 'El paciente contrae la pared y el resto de la exploración deja de ser interpretable. Se empieza por el cuadrante opuesto y se avanza hacia el dolor.'],
        ['Cerrar la hipótesis en el aparato digestivo', 'Un dolor epigástrico puede ser cardiaco, y un dolor abdominal bajo en una mujer en edad fértil obliga a considerar causa ginecológica u obstétrica.'],
        ['Preguntar solo dónde duele', 'Preguntar además dónde empezó recoge el desplazamiento del dolor, que es un dato en sí mismo y se pierde si no se pregunta.'],
      ]),
      repasoRapido([
        'Abdomen agudo es un dolor de instauración reciente que puede requerir intervención urgente; es una categoría de alarma, no un diagnóstico.',
        'En la calle no se decide qué víscera está enferma: se decide si está estable, si hay signos de alarma y con qué prioridad se traslada.',
        'La causa puede estar fuera del abdomen.',
        'El orden es inspección, auscultación y palpación, porque palpar antes altera los ruidos.',
        'La palpación va de superficial a profunda, empezando por la zona más alejada del dolor.',
        'Los signos que orientan a un foco se exploran al final, porque son los que más molestan.',
        'Murphy orienta a patología biliar; Blumberg a irritación peritoneal; Rovsing a apendicitis.',
        'Psoas y obturador orientan a foco retrocecal, retroperitoneal o pélvico.',
        'Ninguno confirma: pueden faltar en quien tiene la enfermedad y aparecer en quien no.',
        'ALICIA ordena el dolor: aparición, localización, intensidad, características, irradiación y asociados.',
        'Alarma: hipoperfusión, taquicardia o hipotensión, alteración del alerta, distensión importante, ruidos de lucha o ausentes.',
        'También masa pulsátil o pulsos asimétricos, antecedente traumático, y cambio brusco del carácter del dolor.',
      ]),
      preguntasOrales([
        '¿Qué es un abdomen agudo, y qué no es?',
        '¿Qué se decide en la calle ante un dolor abdominal?',
        'Recorre la exploración abdominal en su orden y justifica ese orden.',
        '¿Por qué se empieza a palpar lejos del dolor?',
        'Nombra los signos clásicos y hacia dónde orienta cada uno.',
        '¿Qué NO permiten concluir esos signos?',
        'Recita ALICIA y di qué recoge cada letra.',
        'Enumera los signos de alarma que hacen el cuadro tiempo-dependiente.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMERO EL DOLOR, DESPUÉS EL VÓMITO, AL FINAL LA FIEBRE. La cronología apendicular no vale por la lista de síntomas, vale por el ORDEN: que el vómito preceda al dolor apunta en otra dirección.'),
          masPreguntado('El alivio que no tranquiliza: un dolor intenso que cede de golpe y se sigue de un paciente que empeora no describe una mejoría. Es un patrón que eleva la preocupación y no la baja, y se transmite expresamente en el informe.'),
        ],
      },
      erroresFrecuentes([
        ['Registrar qué síntomas hay sin registrar en qué orden aparecieron', 'El orden es el dato: aporta más que la lista, y se pierde si no se pregunta expresamente.'],
        ['Tranquilizarse con el alivio brusco del dolor', 'Si va seguido de un paciente que empeora, es un patrón que eleva la preocupación.'],
        ['Descartarla porque la presentación no es la típica', 'La secuencia completa aparece en menos de la mitad de los casos, y la demora se produce sobre todo en las presentaciones atípicas.'],
        ['No anotar la hora de la última ingesta', 'Si el paciente requiere cirugía, es un dato que el equipo receptor necesita y que nadie podrá reconstruir después.'],
      ]),
      repasoRapido([
        'Es la inflamación del apéndice cecal y la causa más frecuente de abdomen agudo quirúrgico.',
        'Se explica por obstrucción de la luz: se distiende, sube la presión, aparece isquemia y puede perforarse.',
        'Esa cadena explica que el tiempo trabaje en contra.',
        'Su incidencia máxima se sitúa entre la pubertad y la treintena, aunque puede aparecer a cualquier edad.',
        'Cronología apendicular: dolor brusco en epigastrio o periumbilical, que después se localiza en fosa ilíaca derecha.',
        'Luego náuseas, vómito o pérdida del apetito, y por último fiebre o febrícula.',
        'La secuencia completa aparece en menos de la mitad de los casos.',
        'Engañan las localizaciones atípicas del apéndice, los adultos mayores, las gestantes y la consulta muy precoz.',
        'También los pacientes con alteración del alerta o con dificultad para comunicar.',
        'Sugieren complicación el dolor que se generaliza, la defensa marcada, la distensión con ruidos ausentes.',
        'También la hipoperfusión o alteración del alerta, y el alivio brusco seguido de empeoramiento.',
        'No se confirma ni se descarta en la ambulancia: se reconoce el abdomen doloroso con alarma, se sostiene y se traslada.',
      ]),
      preguntasOrales([
        'Describe el mecanismo de una apendicitis aguda.',
        '¿Por qué importa esa cadena en la calle?',
        'Recita la cronología apendicular.',
        '¿Por qué el orden es el dato?',
        '¿Con qué frecuencia aparece la secuencia completa?',
        'Enumera las situaciones en que la presentación engaña.',
        'Di los hallazgos que sugieren complicación.',
        '¿Qué significa un alivio brusco del dolor?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SUS PROPIAS ENZIMAS, DENTRO DE LA GLÁNDULA. En vez de actuar en el intestino, empiezan a digerir el tejido pancreático y el que lo rodea. De ahí que el cuadro pueda ir de leve a grave con el mismo punto de partida.'),
          masPreguntado('Que la intensidad del dolor NO mide la gravedad: una pancreatitis muy dolorosa puede ser leve y una menos dolorosa puede ser grave. Lo que la mide en la calle es el estado circulatorio, la respiración y el estado de alerta.'),
        ],
      },
      erroresFrecuentes([
        ['Medir la gravedad por cuánto duele', 'Es la trampa clásica del cuadro. La gravedad se mide por el estado circulatorio, la respiración y el estado de alerta.'],
        ['No preguntar por litiasis biliar ni por alcohol', 'Cubren las dos causas más frecuentes con dos preguntas breves que el paciente suele responder.'],
        ['Explicar la mala perfusión solo por los vómitos', 'La pancreatitis pierde líquido hacia el tercer espacio: el paciente puede estar deshidratado y mal perfundido sin haber sangrado ni vomitado en gran cantidad.'],
        ['Aplicar escalas de gravedad en la ambulancia', 'Se apoyan en datos analíticos y de evolución. Lo que corresponde es reconocer los signos de gravedad y transmitirlos.'],
      ]),
      repasoRapido([
        'Es la inflamación del páncreas por activación de sus propias enzimas dentro de la glándula.',
        'Causas más frecuentes: litiasis biliar y consumo de alcohol.',
        'Con menor frecuencia: alteraciones metabólicas, fármacos, traumatismos y procedimientos sobre la vía biliar.',
        'Dolor epigástrico intenso y continuo que se instaura en poco tiempo y no cede.',
        'Irradiación hacia la espalda, descrita a menudo como en cinturón.',
        'Náuseas y vómitos que no alivian el dolor.',
        'Alivio parcial al inclinarse hacia adelante y empeoramiento en decúbito supino.',
        'Distensión y disminución de los ruidos intestinales en cuadros avanzados.',
        'La intensidad del dolor no mide la gravedad.',
        'Gravedad sin laboratorio: hipoperfusión, taquicardia o hipotensión, dificultad respiratoria, alteración del alerta.',
        'También vómitos persistentes sin tolerar líquidos y distensión marcada con silencio abdominal.',
        'Pierde líquido hacia el tercer espacio: puede estar mal perfundido sin sangrado ni grandes vómitos.',
      ]),
      preguntasOrales([
        'Describe en qué consiste una pancreatitis aguda.',
        'Enumera sus causas más frecuentes.',
        '¿Qué dos preguntas rinden en la anamnesis?',
        'Di la presentación característica.',
        '¿Mide la gravedad la intensidad del dolor? Justifícalo.',
        '¿Qué signos de gravedad se detectan sin laboratorio?',
        'Explica qué es el tercer espacio y su consecuencia.',
        '¿Qué se decide en el hospital?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA ETIQUETA TRANQUILIZADORA ES EL RIESGO. Un dolor epigástrico atribuido a gastritis puede ser un síndrome coronario, y una diarrea con sangre atribuida a colitis infecciosa puede ser un sangrado digestivo.'),
          masPreguntado('La colitis isquémica: un adulto mayor con enfermedad vascular conocida, dolor abdominal de comienzo brusco y a las pocas horas una deposición con sangre. Ese patrón no se trata como una gastroenteritis. Y el dolor intenso y desproporcionado respecto de la exploración en un paciente con riesgo vascular.'),
        ],
      },
      erroresFrecuentes([
        ['Aceptar la etiqueta tranquilizadora', 'Un dolor epigástrico puede ser cardiaco y una diarrea con sangre puede ser un sangrado digestivo. La etiqueta es, en las dos, el riesgo.'],
        ['Tratar una colitis isquémica como una gastroenteritis', 'En el adulto mayor con riesgo vascular, dolor brusco seguido de deposición con sangre cambia la prioridad.'],
        ['Restar valor a un dolor desproporcionado', 'El dolor intenso y mal localizado con exploración poco expresiva en un paciente con riesgo vascular es precisamente el patrón que debe preocupar.'],
        ['Olvidar la protección personal', 'Cuando se sospecha un cuadro transmisible, se aplica conforme al protocolo del servicio.'],
      ]),
      repasoRapido([
        'La gastritis es inflamación de la mucosa del estómago: molestia epigástrica, ardor, náuseas y relación con las comidas.',
        'La colitis es inflamación de la mucosa del colon.',
        'El interés prehospitalario no está en distinguirlas —eso exige endoscopia— sino en reconocer cuándo dejan de ser banales.',
        'Colitis infecciosa: comienzo agudo, más frecuente en jóvenes, a veces con fiebre y antecedente alimentario o de viaje.',
        'Colitis inflamatoria crónica: paciente que ya conoce su enfermedad, con episodios previos y tratamiento habitual.',
        'Colitis isquémica: adulto mayor con riesgo vascular, dolor brusco seguido de deposición con sangre.',
        'La isquémica es la que cambia la prioridad.',
        'Preocupa también el dolor intenso, mal localizado y desproporcionado a la exploración con riesgo vascular.',
        'Sacan al paciente de la categoría de leve la hipoperfusión, la taquicardia mantenida y la alteración del alerta.',
        'También la sangre apreciable en vómito o deposiciones, la defensa de la pared y el dolor al retirar la mano.',
        'También los vómitos persistentes sin tolerar líquidos, la fiebre elevada o la hipotermia, y la fragilidad previa.',
        'El tratamiento específico depende de la confirmación y del ámbito: esta lección no propone ninguno.',
      ]),
      preguntasOrales([
        'Diferencia gastritis de colitis por localización y presentación.',
        '¿Por qué el plan las agrupa?',
        'Distingue las tres colitis por su mecanismo.',
        '¿Cuál cambia la prioridad, y con qué patrón?',
        '¿Qué significa un dolor desproporcionado a la exploración?',
        'Enumera los signos que sacan al paciente de la categoría de leve.',
        '¿Cuál es el riesgo de la etiqueta tranquilizadora?',
        '¿Qué no corresponde a la ambulancia en estos cuadros?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PIEDRA, CÓLICO, INFLAMACIÓN, INFECCIÓN. Colelitiasis y cólico biliar describen un problema mecánico que cede; colecistitis y colangitis añaden inflamación o infección mantenidas, y son las que cambian la prioridad.'),
          masPreguntado('La combinación que obliga a prealertar: dolor en hipocondrio derecho, fiebre y coloración amarillenta describen juntos una obstrucción con infección de la vía biliar. Si además hay hipoperfusión o alteración del alerta, el paciente es tiempo-dependiente.'),
        ],
      },
      erroresFrecuentes([
        ['Usar los cuatro términos como sinónimos', 'Cada uno describe una situación con un riesgo distinto: de la piedra asintomática a la infección de la vía biliar.'],
        ['Orientarse por la intensidad del dolor', 'Lo que orienta hacia inflamación o infección no es el dolor, sino su duración y los signos que lo acompañan.'],
        ['No buscar expresamente fiebre e ictericia', 'Son los datos que cambian la categoría del cuadro, y hay que buscarlos a propósito.'],
        ['Buscar el signo de Murphy al principio', 'Los signos que orientan a un foco se exploran al final, porque son los que más molestan.'],
      ]),
      repasoRapido([
        'Colelitiasis: presencia de cálculos en la vesícula; puede ser asintomática durante años.',
        'Cólico biliar: dolor por obstrucción transitoria que cede al resolverse, sin inflamación mantenida.',
        'Colecistitis aguda: inflamación de la pared de la vesícula por obstrucción mantenida.',
        'Colangitis: infección de la vía biliar por obstrucción de su salida; el más grave, puede llegar a compromiso sistémico.',
        'El dolor biliar se localiza en hipocondrio derecho o epigastrio.',
        'Puede irradiarse al hombro derecho o a la región escapular derecha.',
        'Suele aparecer después de una comida, especialmente abundante o grasa, con náuseas y vómitos.',
        'En el cólico es prolongado pero cede; cuando se mantiene durante horas orienta hacia inflamación.',
        'El signo de Murphy es sugestivo si el dolor interrumpe la inspiración al palpar el hipocondrio derecho.',
        'Sugieren paso a inflamación o infección el dolor mantenido, la fiebre y la coloración amarillenta.',
        'También la hipoperfusión, la alteración del alerta y los escalofríos intensos con sensación de gravedad.',
        'La confirmación exige laboratorio e imagen, y el tratamiento puede requerir antibióticos, drenaje o cirugía.',
      ]),
      preguntasOrales([
        'Diferencia colelitiasis, cólico biliar, colecistitis y colangitis.',
        '¿Qué separa las dos primeras de las dos últimas?',
        'Describe el dolor biliar y su irradiación.',
        '¿Qué orienta hacia inflamación, si no es la intensidad del dolor?',
        'Explica cómo se busca el signo de Murphy y qué vale.',
        'Enumera los datos que cambian la categoría del cuadro.',
        '¿Cuál es la combinación que obliga a prealertar?',
        '¿Qué se decide en el hospital?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL APORTE CUENTA TANTO COMO LA PÉRDIDA. Un paciente con vómitos moderados que sigue bebiendo puede mantenerse; otro con pérdidas menores que no ha bebido en un día se deshidrata. Preguntar qué ha bebido y cuándo aporta tanto como contar los vómitos.'),
          masPreguntado('Los dos signos que cambian la conducta: la alteración del estado de alerta y la incapacidad para beber sacan al paciente de cualquier plan de rehidratación oral y lo convierten en traslado prioritario, por el riesgo de broncoaspiración.'),
        ],
      },
      erroresFrecuentes([
        ['Dar líquidos por la boca a un paciente somnoliento', 'La alteración del alerta y la incapacidad para beber excluyen la vía oral, por riesgo de broncoaspiración.'],
        ['Contar solo las pérdidas visibles', 'También cuentan la fiebre, la sudoración y la respiración, y sobre todo el aporte: qué y cuánto ha bebido y cuándo.'],
        ['Fiarse del pellizco cutáneo en el adulto mayor', 'Pierde fiabilidad porque la piel ya recupera con lentitud por la edad. Se valoran el alerta, la perfusión, las mucosas y la diuresis referida.'],
        ['Graduar con un signo aislado', 'Ningún signo basta: se valoran juntos y se repiten, porque lo que informa es el conjunto y su evolución.'],
      ]),
      repasoRapido([
        'La deshidratación es el déficit de agua y electrolitos cuando las pérdidas superan al aporte.',
        'Hay pérdidas que no se ven: la fiebre, la sudoración y la respiración.',
        'Se gradúa con signos clínicos, no con cifras, y valorándolos juntos y repetidos.',
        'Leve: sed con paciente alerta, mucosas algo secas, piel que recupera de inmediato, perfusión conservada.',
        'Moderada: sed intensa con inquietud, mucosas secas, ojos hundidos, recuperación lenta de la piel, pulso rápido.',
        'Grave: somnolencia o incapacidad de beber, mucosas muy secas, piel fría y moteada, pulso rápido y débil, diuresis muy reducida.',
        'La alteración del alerta y la incapacidad de beber excluyen la vía oral y priorizan el traslado.',
        'Se descompensan antes lactantes y niños pequeños, adultos mayores y personas con enfermedad renal, cardiaca o diabetes.',
        'También quienes toman diuréticos, quienes tienen fiebre alta o calor extremo, y quienes dependen de otros para beber.',
        'En el adulto mayor el pellizco cutáneo pierde fiabilidad.',
        'La rehidratación oral con solución de electrolitos es la medida de base en el déficit leve o moderado del que puede beber.',
        'Los electrolitos orales figuran en la dotación mínima de toda ambulancia terrestre, pero la dotación no da la indicación.',
      ]),
      preguntasOrales([
        'Explica cómo se produce una deshidratación y qué la agrava.',
        '¿Qué pérdidas no se ven?',
        '¿Por qué el aporte cuenta tanto como la pérdida?',
        'Gradúa la deshidratación con signos clínicos.',
        '¿Cuáles son los dos signos que cambian la conducta?',
        'Enumera las poblaciones que se descompensan antes.',
        '¿Por qué el pellizco cutáneo falla en el adulto mayor?',
        '¿Cuándo la vía oral no es la opción?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('¿LO HAN OPERADO DEL ABDOMEN? Es la pregunta que más orienta, porque las adherencias son una causa frecuente de oclusión mecánica. Y va acompañada de mirar: cicatrices en la inspección y hernias en las regiones inguinales.'),
          masPreguntado('Que cuando los ruidos de lucha desaparecen y el abdomen queda silencioso, el cuadro ha avanzado: esa evolución es un dato, y por eso se anota expresamente si los ruidos cambiaron. Y que la oclusión deshidrata: puede llegar mal perfundido sin ninguna hemorragia.'),
        ],
      },
      erroresFrecuentes([
        ['No preguntar por cirugías abdominales previas', 'Es el dato que más apunta a oclusión mecánica. Y buscar cicatrices en la inspección lo confirma o lo completa.'],
        ['No explorar las regiones inguinales', 'Una hernia que no puede reducirse es una causa de oclusión que se detecta a simple vista y cambia la orientación.'],
        ['Auscultar después de palpar', 'Se ausculta antes, y se registra si los ruidos están aumentados, normales o ausentes: el cambio es el dato.'],
        ['Explicar la mala perfusión solo por una hemorragia', 'La oclusión deshidrata: se pierde líquido dentro de la luz intestinal y con los vómitos.'],
      ]),
      repasoRapido([
        'Es la detención del tránsito del contenido a lo largo del intestino.',
        'El contenido y el gas se acumulan por encima, el asa se distiende y esa distensión produce el dolor y el vómito.',
        'Mecánica: hay un obstáculo físico —adherencias, hernias, tumores, cuerpos extraños—.',
        'Funcional: no hay obstáculo, pero el intestino deja de moverse.',
        'La cirugía abdominal previa es el antecedente que más orienta hacia la mecánica.',
        'Tétrada: dolor cólico en oleadas, vómitos, distensión abdominal y ausencia de emisión de gases y heces.',
        'El aspecto de los vómitos orienta al nivel: más precoces y claros cuanto más alta la oclusión.',
        'La distensión es más marcada cuanto más baja es la oclusión.',
        'Al inicio de una mecánica los ruidos están aumentados y de lucha; su desaparición indica que el cuadro avanzó.',
        'Sugieren que el asa sufre el dolor cólico que se vuelve continuo, la defensa marcada, la fiebre y la hipoperfusión.',
        'Esa situación convierte la oclusión en tiempo-dependiente.',
        'La oclusión deshidrata: puede llegar mal perfundido sin ninguna hemorragia.',
      ]),
      preguntasOrales([
        'Define oclusión intestinal y distingue mecánica de funcional.',
        '¿Cuál es el antecedente que más orienta, y cómo se busca?',
        '¿Por qué se exploran las regiones inguinales?',
        'Recita la tétrada clásica.',
        '¿Qué orienta el aspecto de los vómitos?',
        '¿Qué significa que los ruidos de lucha desaparezcan?',
        'Di los signos de que el asa está sufriendo.',
        '¿Por qué una oclusión puede llegar mal perfundida sin sangrar?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SE VALORA COMO UNA HEMORRAGIA, NO COMO UN SÍNTOMA DIGESTIVO. La forma de exteriorizarse orienta el nivel y ahorra tiempo al equipo receptor, pero la conducta es la misma para alto y bajo: valorar la circulación.'),
          masPreguntado('Que la cantidad referida es poco fiable —una pequeña cantidad en el inodoro impresiona mucho y una hemorragia importante puede no haberse exteriorizado— y las dos excepciones: un sangrado alto muy rápido puede salir rojo por el ano, y una melena puede venir de un sangrado bajo proximal y lento.'),
        ],
      },
      erroresFrecuentes([
        ['Guiarse por la cantidad que refieren', 'Es una estimación poco fiable. Lo que informa es la repercusión circulatoria.'],
        ['Localizar con certeza por la forma de exteriorización', 'Un sangrado alto muy abundante puede salir rojo por el ano, y una melena puede proceder de un sangrado bajo proximal y lento.'],
        ['Pasar por alto la anticoagulación y la enfermedad hepática', 'El anticoagulado sangra más y se detiene peor; el hepatópata puede sangrar por varices esofágicas, un sangrado alto que puede ser masivo.'],
        ['Descuidar la vía aérea en la hematemesis', 'Se coloca en posición segura con prevención de la broncoaspiración, sobre todo si el estado de alerta está alterado.'],
      ]),
      repasoRapido([
        'El límite entre alto y bajo es el ángulo de Treitz, en la unión del duodeno con el yeyuno.',
        'Por encima —esófago, estómago y duodeno— es sangrado alto.',
        'Hematemesis: vómito de sangre, roja o con aspecto de poso de café. Orienta a alto.',
        'Melena: deposición negra, pegajosa y de olor característico. Orienta a alto.',
        'Hematoquecia: sangre roja u oscura mezclada con las heces. Orienta a bajo.',
        'Rectorragia: sangre roja fresca por el ano. Orienta a bajo distal.',
        'El poso de café aparece cuando la sangre ha sido modificada por el contenido ácido del estómago.',
        'Dos excepciones: un alto muy rápido puede salir rojo, y una melena puede venir de un bajo proximal y lento.',
        'La cantidad referida es poco fiable: lo que manda es la repercusión circulatoria.',
        'Repercusión: piel fría o moteada, relleno lento, taquicardia, hipotensión o descenso durante la atención.',
        'También mareo o pérdida de consciencia al incorporarse, alteración del alerta y sudoración fría.',
        'Elevan la preocupación de inmediato la anticoagulación y la enfermedad hepática crónica.',
      ]),
      preguntasOrales([
        '¿Dónde está el límite entre sangrado alto y bajo?',
        'Interpreta hematemesis, melena, hematoquecia y rectorragia.',
        '¿Por qué la sangre se ve negra o como poso de café?',
        'Di las dos excepciones que hay que conocer.',
        '¿Por qué la cantidad referida es poco fiable?',
        'Enumera los signos de repercusión circulatoria.',
        '¿Qué dos antecedentes elevan la preocupación, y por qué cada uno?',
        '¿Cómo se valora este cuadro?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA HEPATITIS ES UN EPISODIO; LA CIRROSIS ES UN ESTADO. El paciente cirrótico no llama por su cirrosis, sino por una de sus complicaciones, y reconocer cuál es lo que orienta la atención.'),
          masPreguntado('La combinación que define el fallo hepático grave: ictericia más alteración del estado de alerta más tendencia al sangrado. Cualquiera de los tres aislado puede tener otras explicaciones; los tres juntos en una hepatitis aguda son un cuadro tiempo-dependiente.'),
        ],
      },
      erroresFrecuentes([
        ['Atribuir toda confusión a la encefalopatía', 'Puede estar en encefalopatía hepática, y ese dato se transmite; pero no se dejan de valorar las demás causas de alteración del alerta.'],
        ['Olvidar que el cirrótico sangra más', 'El hígado produce factores necesarios para la coagulación: una hemorragia que en otra persona sería menor puede no detenerse en él.'],
        ['Administrar fármacos sin precaución', 'El hígado metaboliza gran parte de los medicamentos: en enfermedad avanzada pueden acumularse y algunos precipitar una encefalopatía.'],
        ['Descuidar la protección personal y los punzocortantes', 'Este grupo de pacientes exige especial cuidado en el manejo de objetos punzocortantes y en el contacto con sangre y fluidos.'],
      ]),
      repasoRapido([
        'La hepatitis aguda es una inflamación del hígado de instauración reciente y curso limitado.',
        'Puede deberse a virus, alcohol, fármacos u otras causas; una minoría evoluciona a fallo hepático grave.',
        'La cirrosis es el resultado de una lesión mantenida durante años, con sustitución del tejido por fibrosis.',
        'De la dificultad para atravesar el hígado nace la hipertensión portal.',
        'El cirrótico llama por una complicación, no por su cirrosis.',
        'Complicaciones: sangrado por varices esofágicas, ascitis, infección del líquido ascítico.',
        'También encefalopatía hepática y deterioro de la función renal.',
        'La confusión en un cirrótico puede ser encefalopatía, y se transmite expresamente.',
        'El cirrótico sangra con más facilidad porque el hígado produce factores de la coagulación.',
        'Hepatitis aguda: malestar y falta de apetito, náuseas, molestia en hipocondrio derecho, ictericia, orina oscura y fiebre.',
        'Fallo grave: alteración del alerta, tendencia al sangrado, vómitos persistentes, hipoperfusión e ictericia intensa y rápida.',
        'Precaución con los fármacos: el hígado metaboliza gran parte de ellos y pueden acumularse o precipitar encefalopatía.',
      ]),
      preguntasOrales([
        'Diferencia hepatitis aguda de cirrosis por curso y mecanismo.',
        '¿Por qué llama a la ambulancia un paciente cirrótico?',
        'Enumera las complicaciones que se presentan como urgencia.',
        '¿Qué significa la confusión en un paciente cirrótico?',
        '¿Por qué sangra más un cirrótico?',
        'Di la presentación habitual de una hepatitis aguda.',
        '¿Qué combinación define un fallo hepático grave?',
        '¿Qué precaución exigen los fármacos en este paciente?',
      ]),
