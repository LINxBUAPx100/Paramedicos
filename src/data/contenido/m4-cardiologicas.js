    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMERO SI PERFUNDE, DESPUÉS QUÉ MARCA EL MONITOR. Un corazón cumple su función si la sangre llega a los tejidos, así que la primera pregunta de una exploración cardiaca no es una cifra: es el estado mental, la piel, los pulsos y la tendencia.'),
          masPreguntado('Que una presión conservada NO significa un paciente estable: los mecanismos de compensación la mantienen mientras pueden y el descenso aparece tarde. Un paciente frío, pálido y con el sensorio alterado está mal perfundido, y llamarlo estable retrasa lo que necesita.'),
        ],
      },
      erroresFrecuentes([
        ['Llamar estable a un paciente con presión conservada', 'Si está frío, pálido y con el sensorio alterado, está compensando. El descenso de la presión aparece tarde.'],
        ['Leer la frecuencia solo en el monitor', 'La frecuencia y la regularidad se palpan además de leerse: el monitor informa de actividad eléctrica, no de contracción.'],
        ['Dar un signo aislado por diagnóstico', 'La ingurgitación yugular no confirma taponamiento, el edema no confirma insuficiencia cardiaca y unos crepitantes no confirman origen cardiogénico.'],
        ['No registrar la cronología del síntoma', 'El hospital podrá repetir la exploración y añadir estudios, pero no podrá reconstruir a qué hora empezó ni cómo evolucionó camino del hospital.'],
      ]),
      repasoRapido([
        'Los motivos cardiovasculares son pocos y se repiten, y ninguno pertenece en exclusiva al corazón.',
        'OPQRST ordena el síntoma: origen, provocación y alivio, cualidad, radiación, severidad y tiempo.',
        'Cambian la interpretación los episodios previos, los dispositivos implantados, el tratamiento y su adherencia.',
        'También los factores de riesgo, la enfermedad renal, la diabetes, la enfermedad pulmonar, el consumo y el embarazo.',
        'La cronología es el dato que no se recupera después.',
        'La perfusión se valora con estado mental, piel, pulsos centrales y periféricos, llenado capilar y tendencia de la presión.',
        'El estado mental es un órgano diana: la confusión nueva puede ser la primera manifestación de hipoperfusión.',
        'Una presión conservada no significa estabilidad.',
        'Corazón y pulmón se exploran juntos porque sus problemas se manifiestan cruzados.',
        'El monitor de ritmo no dice si la actividad produce contracción y pulso.',
        'El ECG de doce derivaciones es una fotografía: un trazo normal no excluye lo que aparezca después.',
        'La oximetría no informa de la ventilación ni de la perfusión en un paciente frío.',
      ]),
      preguntasOrales([
        'Recita OPQRST aplicado a un síntoma cardiovascular.',
        '¿Qué antecedentes cambian la interpretación?',
        '¿Por qué la cronología es el dato que no se recupera?',
        'Enumera lo que se valora para juzgar la perfusión.',
        '¿Por qué el estado mental es un órgano diana?',
        '¿Significa estabilidad una presión conservada? Justifícalo.',
        'Di qué responde y qué no responde cada dispositivo de monitorización.',
        '¿Por qué el monitor eléctrico no demuestra perfusión?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('CALIDAD, FRECUENCIA, REGULARIDAD, P, RELACIÓN, ANCHURA. Seis pasos, y el primero es una puerta: si el trazo no es interpretable, el método se detiene ahí y no se le asigna un ritmo.'),
          masPreguntado('Que la posición de los electrodos la fija el MANUAL DEL EQUIPO real de la unidad, no una lección ni otro servicio: colocar mal un electrodo produce un trazo que parece anormal sin que el paciente lo esté, y esa apariencia puede arrastrar una decisión equivocada.'),
        ],
      },
      erroresFrecuentes([
        ['Asignar un ritmo a un trazo no interpretable', 'Si la calidad impide leerlo, se corrigen las condiciones y se repite; no se asigna el ritmo que más se parezca.'],
        ['Memorizar la posición de los electrodos de otra fuente', 'Cada equipo tiene su manual y cada servicio su protocolo. Un electrodo mal colocado produce un trazo aparentemente anormal.'],
        ['Leer por reconocimiento visual', 'Es rápido y frágil. Un método ordenado tarda unos segundos más y falla mucho menos, sobre todo bajo presión.'],
        ['Descartar un síndrome coronario con un trazo normal', 'Un registro normal en un paciente con síntomas no excluye nada: puede cambiar en minutos.'],
      ]),
      repasoRapido([
        'El electrocardiograma recoge la actividad eléctrica; la actividad precede a la contracción pero no es la contracción.',
        'Registra frecuencia, regularidad y la secuencia de las ondas, en un instante concreto.',
        'No registra si hay contracción, si hay pulso, la fuerza del bombeo ni lo que ocurrirá después.',
        'Un ritmo organizado no implica pulso: ante un paciente que no responde, el trazo no sustituye la comprobación.',
        'La monitorización de ritmo vigila de forma continua; el ECG de doce derivaciones documenta un momento.',
        'La monitorización detecta un cambio mientras ocurre; el registro completo es una fotografía, no una película.',
        'La preparación decide la calidad: piel preparada según el fabricante, electrodos según el manual, cables sin tracción.',
        'El trazo se comprueba en calidad ANTES de intentar leerlo.',
        'Los seis pasos: calidad, frecuencia, regularidad, ondas P, relación P-QRS y anchura del QRS.',
        'Todo hallazgo se contrasta con el pulso palpado, el estado de perfusión y el síntoma que motivó la llamada.',
        'De cada trazo se registra hora, condiciones, qué se observó, qué se hizo y si se repitió o se transmitió.',
        'A quién se transmite y en qué casos se obtiene un registro completo lo fija el protocolo.',
      ]),
      preguntasOrales([
        'Distingue qué registra y qué no registra un electrocardiograma.',
        '¿Por qué un ritmo organizado no implica pulso?',
        'Diferencia la monitorización de ritmo del ECG de doce derivaciones.',
        '¿Dónde se gana o se pierde la calidad del trazo?',
        '¿Quién fija la posición de los electrodos?',
        'Recita los seis pasos de la lectura ordenada.',
        '¿Qué se hace con un trazo no interpretable?',
        '¿Con qué tres cosas se contrasta un hallazgo antes de que signifique algo?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL MÚSCULO NO SE PIERDE DE GOLPE, SE PIERDE MIENTRAS LA OBSTRUCCIÓN DURA. Ahí está la razón de que todo el manejo se organice alrededor del reloj, y de que la aportación del equipo sea reconocer, registrar y avisar.'),
          masPreguntado('El problema del estereotipo: decir que ciertos grupos «no dan el cuadro típico» hace daño en las dos direcciones —lleva a no considerarlo en quien no encaja en la imagen esperada y a descartarlo con facilidad en quien sí encaja—. Y por qué el desfibrilador se acerca aunque el paciente esté hablando.'),
        ],
      },
      erroresFrecuentes([
        ['Apoyarse en el estereotipo del cuadro típico', 'Hace daño en las dos direcciones. Una parte importante de los pacientes consulta por disnea, náusea, sudoración, fatiga o síncope.'],
        ['Aplicar una secuencia memorizada de fármacos como si fuera universal', 'Cada componente tiene su indicación y sus contraindicaciones, y no todos proceden en todos los pacientes.'],
        ['Administrar oxígeno de rutina', 'Solo se administra ante indicación conforme al protocolo, no de forma sistemática.'],
        ['Cerrar la hipótesis en el corazón', 'Hay cuadros de la aorta, del pulmón, del esófago y de la pared torácica que se presentan de forma parecida y cuyo manejo difiere.'],
      ]),
      repasoRapido([
        'El músculo cardiaco se irriga por las coronarias; si el flujo se reduce de forma brusca, esa zona deja de recibir oxígeno.',
        'Bajo síndrome coronario agudo se agrupa el espectro desde la isquemia que cede hasta la lesión establecida.',
        'El músculo se pierde progresivamente mientras la obstrucción persiste: de ahí la lógica del tiempo.',
        'La presentación más conocida es molestia torácica central como presión, opresión o peso.',
        'También corresponden a este cuadro la disnea dominante, la náusea o el malestar epigástrico y la sudoración profusa.',
        'También la fatiga intensa reciente, el síncope o presíncope y la sensación de gravedad referida por el paciente.',
        'El estereotipo del cuadro típico hace daño en las dos direcciones.',
        'Historia dirigida: hora exacta de inicio, qué lo provoca y alivia, cualidad e irradiación, episodios previos.',
        'También tratamiento habitual y si tomó algo antes de llamar, alergias, antecedentes de sangrado y consumo reciente.',
        'El registro eléctrico de doce derivaciones se obtiene lo antes posible conforme al protocolo.',
        'El desfibrilador se mantiene junto al paciente aunque esté hablando, por la ventana de riesgo arrítmico.',
        'La aportación decisiva es reconocer, registrar temprano, sostener y prealertar.',
      ]),
      preguntasOrales([
        'Explica en lenguaje claro qué ocurre en un síndrome coronario agudo.',
        '¿Qué agrupa el término «espectro»?',
        'Explica la lógica del tiempo.',
        'Enumera presentaciones que también corresponden a este cuadro.',
        '¿Cuál es el problema del estereotipo?',
        '¿Por qué el desfibrilador se acerca aunque el paciente esté hablando?',
        '¿Qué otros cuadros se presentan con dolor torácico?',
        'Di los tres razonamientos que hacen daño.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA MÉTRICA ES EL TIEMPO SIN COMPRIMIR. Cada segundo de pausa reduce el flujo generado, y recuperarlo cuesta varios ciclos. Por eso las tareas se preparan mientras se comprime, y las pausas se anuncian, se cronometran y se acortan.'),
          masPreguntado('Que la duda no retrasa el inicio: un paciente que no estaba en paro y recibe compresiones sufre un daño reparable; un paciente en paro que espera mientras alguien confirma pierde exactamente lo que el procedimiento venía a salvar. Y que la respiración agónica no es respiración eficaz.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar la respiración agónica como respiración', 'Lenta, ruidosa y entrecortada, no es respiración eficaz. Ante un paciente que no responde y no respira con normalidad, se inicia.'],
        ['Retrasar el inicio para confirmar', 'El daño de comprimir a quien no estaba en paro es reparable; el de esperar, no.'],
        ['Memorizar la energía de desfibrilación', 'Depende del modelo de desfibrilador de la unidad y de su manual, además del protocolo. Aplicar la de otro equipo puede significar una energía equivocada.'],
        ['Deducir el pulso de la categoría del ritmo', 'Existen ritmos organizados sin contracción eficaz: la comprobación de pulso se hace sobre el paciente, en los momentos que el protocolo establece.'],
      ]),
      repasoRapido([
        'Se reconoce en segundos: el paciente no responde y no respira con normalidad.',
        'La respiración agónica no es respiración eficaz.',
        'Primeros segundos: seguridad, comprobar respuesta, comprobar respiración y pulso brevemente, activar y pedir el desfibrilador, e iniciar.',
        'Compresión de calidad: profundidad y frecuencia según guía y protocolo, reexpansión completa, interrupciones mínimas.',
        'También relevo programado del compresor, superficie firme y dispositivo de retroalimentación si la unidad lo tiene.',
        'La fatiga degrada la calidad antes de que quien comprime la perciba.',
        'La métrica que importa es el tiempo sin comprimir.',
        'Desfibrilable: la descarga puede reorganizar la actividad; se desfibrila y se reanudan compresiones de inmediato.',
        'No desfibrilable: se continúan compresiones y se buscan causas reversibles.',
        'La categoría del ritmo no dice si hay pulso.',
        'Funciones: líder que dirige y no ejecuta, compresor, vía aérea y ventilación, monitor y desfibrilador, acceso y medicación, y registro.',
        'Circuito cerrado: orden dirigida a una persona, repetida en voz alta, ejecutada y avisada al terminar.',
      ]),
      preguntasOrales([
        '¿Cómo se reconoce un paro cardiorrespiratorio?',
        '¿Qué es la respiración agónica y cómo se interpreta?',
        '¿Por qué la duda no retrasa el inicio?',
        'Enumera qué define una compresión de calidad.',
        '¿Cuál es la métrica que importa, y por qué?',
        'Distingue ritmo desfibrilable de no desfibrilable.',
        '¿Dice la categoría del ritmo si hay pulso?',
        'Reparte las funciones del equipo y explica el circuito cerrado.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('¿ESTA FRECUENCIA CAUSA EL PROBLEMA O ES LA RESPUESTA A OTRO? La pregunta correcta no es qué frecuencia tiene. Tratar el número sin responderla lleva a corregir una compensación útil o a pasar por alto la causa.'),
          masPreguntado('Que la palabra «estable» se usa mal: un paciente con presión conservada pero frío, pálido y con el sensorio alterado no está estable, está compensando. Y que lo que ordena la conducta no es el nombre del ritmo, sino el estado del paciente que lo tiene.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar el número en vez del paciente', 'Una frecuencia alta puede ser la respuesta correcta a fiebre, dolor, ansiedad o deshidratación. Corregirla puede eliminar una compensación útil.'],
        ['Llamar estable a quien compensa', 'Presión conservada con piel fría y sensorio alterado no es estabilidad. Es el error que más retrasa la atención en esta unidad.'],
        ['Forzar la lectura de un trazo malo', 'Si la calidad impide responder las tres preguntas, se corrigen las condiciones y se repite.'],
        ['Asumir un problema eléctrico primario', 'Antes se revisan las causas reversibles: oxigenación, isquemia, electrolitos, fármacos y tóxicos, temperatura, y dolor, fiebre, hemorragia o deshidratación.'],
      ]),
      repasoRapido([
        'Una frecuencia anormal es un hallazgo, no un diagnóstico.',
        'La pregunta es si esa frecuencia causa el problema o es la respuesta a un problema que está en otra parte.',
        'Antes del trazo se recoge desde cuándo ocurre, qué hacía, si le pasó antes y qué síntomas lo acompañan.',
        'También tratamiento habitual y cambios recientes, consumo, enfermedad renal y episodios de vómito o diarrea.',
        'Tres preguntas sobre el trazo: regular o irregular, ondas P y su relación, y QRS estrecho o ancho.',
        'Un trazo no interpretable no se fuerza.',
        'Inestabilidad: hipotensión o descenso durante la atención, alteración del estado mental reciente.',
        'También signos de shock, dolor torácico isquémico y signos de insuficiencia cardiaca aguda.',
        'Frecuencia anormal sin repercusión: observación, monitorización y búsqueda de la causa.',
        'Arritmia con inestabilidad: soporte inmediato y ruta tiempo-dependiente conforme al protocolo.',
        'Paro: reanimación conforme a lo estudiado en su tema.',
        'Cardioversión, estimulación transcutánea y antiarrítmicos exigen equipo, competencia, indicación y protocolo.',
      ]),
      preguntasOrales([
        '¿Por qué la frecuencia es un hallazgo y no un diagnóstico?',
        'Formula la pregunta correcta ante una frecuencia anormal.',
        '¿Qué se recoge antes de mirar el trazo con detalle?',
        'Di las tres preguntas de la valoración del trazo.',
        'Enumera los signos de inestabilidad clínica.',
        '¿Por qué se usa mal la palabra «estable»?',
        'Distingue las tres situaciones y su conducta general.',
        'Revisa las causas reversibles de arritmia.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('POR DETRÁS SE CONGESTIONA, POR DELANTE FALTA GASTO. Son dos consecuencias distintas del mismo fallo de bomba, y no van siempre juntas: hay pacientes muy congestivos que perfunden bien y pacientes con congestión discreta mal perfundidos.'),
          masPreguntado('Que en la ambulancia lo que ordena la conducta es cuánto se ha alejado el paciente de su situación habitual, no la clasificación crónica: los sistemas que gradúan su limitación funcional sirven para el seguimiento clínico, no para decidir en la calle.'),
        ],
      },
      erroresFrecuentes([
        ['Mezclar congestión y bajo gasto', 'Son consecuencias distintas y no van siempre juntas. Distinguirlo cambia la conducta y el mensaje al hospital.'],
        ['Usar la clasificación crónica para decidir', 'Sirve para el seguimiento clínico. Lo que ordena la conducta es cuánto se ha alejado el paciente de su situación habitual.'],
        ['Aportar volumen a un paciente congestivo sin indicación', 'Puede agravarlo, y la decisión corresponde al protocolo.'],
        ['No preguntar por la adherencia al tratamiento', 'El abandono o el cambio reciente es uno de los desencadenantes más frecuentes de descompensación.'],
      ]),
      repasoRapido([
        'La insuficiencia cardiaca es no bombear lo que el organismo necesita, o solo a costa de presiones de llenado elevadas.',
        'Congestión: la sangre se acumula por detrás del ventrículo que falla.',
        'Hacia el pulmón da disnea, ortopnea y crepitantes; hacia el sistema, ingurgitación yugular, edema y aumento de peso.',
        'Bajo gasto: llega menos sangre por delante; fatiga, intolerancia al esfuerzo, piel fría y, en casos graves, alteración del sensorio e hipotensión.',
        'Congestión y bajo gasto no son lo mismo ni van siempre juntos.',
        'El paciente conoce su situación habitual: almohadas, distancia que camina y peso de referencia.',
        'Lo que motiva la llamada es un empeoramiento agudo sobre esa base.',
        'Historia dirigida: almohadas, despertares con ahogo, aumento del edema, ganancia de peso, distancia que puede caminar.',
        'También tratamiento y adherencia, y consumo de sal y de líquidos en los últimos días.',
        'Desencadenantes: abandono o cambio del tratamiento, exceso de sal o líquidos, infección, arritmia, isquemia, anemia o enfermedad renal.',
        'Banderas rojas: disnea intensa o que empeora rápido, no tolerar el decúbito, alteración del estado mental.',
        'También hipoperfusión, hipotensión o descenso durante la atención, dolor torácico isquémico y arritmia.',
      ]),
      preguntasOrales([
        'Explica el concepto de insuficiencia cardiaca y su doble consecuencia.',
        'Diferencia congestión de bajo gasto por sus manifestaciones.',
        '¿Van siempre juntas? ¿Qué cambia distinguirlas?',
        '¿Qué información aporta el propio paciente sobre su situación habitual?',
        'Recorre la historia dirigida de una descompensación.',
        'Enumera los desencadenantes frecuentes.',
        '¿Por qué la clasificación crónica no es un algoritmo de urgencia?',
        'Di las banderas rojas.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LO QUE SEPARA LAS DOS ÚLTIMAS NO ES LA CIFRA, ES EL DAÑO DE ÓRGANO. Dos pacientes con la misma presión pueden estar en situaciones completamente distintas: uno necesita seguimiento y el otro es tiempo-dependiente.'),
          masPreguntado('Por qué no se baja la presión de forma brusca: un organismo que lleva tiempo funcionando con presiones altas adapta el flujo de sus órganos a esa situación, y bajarla de golpe sin indicación puede reducir el flujo por debajo de lo que toleran y producir daño en vez de evitarlo.'),
        ],
      },
      erroresFrecuentes([
        ['Concluir a partir de una cifra aislada', 'Dolor, miedo, esfuerzo reciente y la propia presencia de una ambulancia elevan la presión de forma transitoria. Una única cifra alta en ese contexto no permite concluir nada.'],
        ['Perseguir un descenso de la cifra', 'La conducta no persigue un número. Bajar la presión de golpe y sin indicación puede producir daño.'],
        ['Aplicar este esquema a una embarazada', 'La presión elevada en embarazo o puerperio corresponde al bloque obstétrico, con la preeclampsia y la eclampsia y sus propias fuentes.'],
        ['Usar un manguito de tamaño inadecuado', 'Uno pequeño sobreestima y uno grande subestima. Y la medición se repite: una cifra aislada informa mucho menos que dos separadas por unos minutos.'],
      ]),
      repasoRapido([
        'Una cifra significa algo solo si se obtuvo en condiciones interpretables.',
        'Hacen interpretable la medición el manguito adecuado, el brazo apoyado a la altura del corazón y el reposo posible.',
        'También la ausencia de dolor, esfuerzo, frío o agitación inmediatos, la repetición y el registro de posición, brazo y hora.',
        'Hipertensión crónica: enfermedad diagnosticada con mediciones repetidas en condiciones controladas; no se diagnostica en urgencias.',
        'Medición elevada aislada: se repite, se contextualiza y no se trata el número.',
        'Presión severamente elevada sin daño agudo: valoración y seguimiento; el descenso brusco no protocolizado puede ser dañino.',
        'Emergencia hipertensiva: presión muy elevada con daño agudo de órgano en curso; ruta tiempo-dependiente por el síndrome.',
        'Lo que separa las dos últimas no es la cifra, es el daño de órgano.',
        'Se busca daño neurológico, cardiaco, aórtico, renal y obstétrico.',
        'El embarazo cambia por completo el cuadro y la ruta.',
        'Orientan el tratamiento habitual y su abandono, el consumo de estimulantes, el dolor no controlado y la retención urinaria.',
        'La conducta trata al paciente, no al número.',
      ]),
      preguntasOrales([
        'Enumera lo que hace interpretable una medición de presión.',
        '¿Por qué el contexto de la escena eleva la presión?',
        'Distingue las cuatro situaciones que se confunden.',
        '¿Qué separa la presión severamente elevada de la emergencia hipertensiva?',
        'Di en qué sistemas se busca daño de órgano y qué se busca en cada uno.',
        '¿Qué cambia si la paciente está embarazada?',
        'Enumera las causas reversibles de elevación.',
        '¿Por qué no se baja la presión de forma brusca?',
      ]),
