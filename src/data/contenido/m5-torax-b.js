    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMERO QUE ENTRE, LUEGO QUE SE INTERCAMBIE, LUEGO QUE CIRCULE. La clasificación mecánica dice qué buscar; la fisiológica dice qué corregir primero. Ventilación y oxigenación se detectan en la B; la perfusión, en la C.'),
          masPreguntado('Que la clasificación no sustituye a la evaluación: saber que un trauma es cerrado no dice cómo está el paciente, y una herida penetrante pequeña puede convivir con un cuadro grave. Y que las lesiones coexisten: encontrar una explicación plausible no autoriza a dejar de buscar.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar el ABCDE como un formulario', 'Es un orden de prioridad: un hallazgo que compromete un escalón anterior se atiende antes de pasar al siguiente.'],
        ['Sustituir la evaluación por la clasificación', 'Saber que el trauma es cerrado no dice cómo está el paciente. Lo que decide la conducta es cómo respira, cómo perfunde y cómo cambia entre valoraciones.'],
        ['Parar de buscar al encontrar una explicación', 'Un mismo paciente puede tener fracturas costales, contusión pulmonar y un hemotórax a la vez. La reevaluación periódica es lo que detecta la segunda lesión.'],
        ['Medir el daño por el tamaño de la herida', 'En el trauma abierto la herida visible no mide el daño profundo; en el cerrado puede haber lesión interna sin ninguna señal externa.'],
      ]),
      repasoRapido([
        'Primera clasificación: por integridad de la pared, cerrado o abierto.',
        'Cerrado: pared íntegra o con lesión superficial; colisión, caída, aplastamiento, onda expansiva.',
        'Abierto: pared atravesada, con comunicación con el exterior; arma blanca, proyectil, empalamiento.',
        'Segunda clasificación, la que decide el orden: qué está fallando ahora mismo.',
        'Fallo de ventilación: el aire no entra ni sale bien, por dolor, segmento inestable, herida abierta u obstrucción. Se detecta en la B.',
        'Fallo de oxigenación: el aire llega pero no se intercambia, por contusión, colapso u ocupación del espacio pleural. También en la B.',
        'Fallo de perfusión: la sangre no circula, por hemorragia u obstrucción al llenado cardiaco. En la C.',
        'El ABCDE es un orden de prioridad, no un formulario.',
        'Obligan a detenerse: vía aérea comprometida, respiración inadecuada, ruidos ausentes en un hemitórax.',
        'También la herida torácica abierta con paso de aire, los signos de shock y la ingurgitación yugular con deterioro.',
        'La clasificación no sustituye a la evaluación del paciente.',
        'Las lesiones coexisten: encontrar una explicación plausible no autoriza a dejar de buscar.',
      ]),
      preguntasOrales([
        'Clasifica el trauma torácico por integridad de la pared.',
        'Clasifícalo ahora por problema fisiológico y di dónde se detecta cada uno.',
        '¿Por qué la segunda clasificación es la que organiza la atención?',
        'Enumera los hallazgos que obligan a detenerse donde se encuentran.',
        '¿Por qué la clasificación no sustituye a la evaluación?',
        'Pon un ejemplo de varias lesiones torácicas coexistiendo.',
        '¿Qué complica el reconocimiento en el cerrado y qué en el abierto?',
        'Herida penetrante pequeña y paciente muy grave. ¿Contradicción?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA VÍA POR LA QUE RESPIRA ES LA QUE ESTÁ ROTA. De ahí sale toda la conducta: mínima manipulación, la posición en que el paciente respira mejor, apoyo a la oxigenación y aviso temprano. Cada intento innecesario puede aumentar el edema o el sangrado.'),
          masPreguntado('Que el deterioro progresivo es la señal más importante: un hematoma o un edema cervicales crecen, y un paciente que llegaba hablando puede empeorar durante el traslado. Por eso la reevaluación es continua y el traslado no espera a que el cuadro se complete.'),
        ],
      },
      erroresFrecuentes([
        ['Manipular el cuello y la vía aérea más de lo imprescindible', 'Cada intento innecesario puede aumentar el edema o el sangrado, y la vía comprometida es la única por la que respira el paciente.'],
        ['Esperar a que el cuadro se complete', 'El deterioro progresivo es la señal más importante. Un paciente que llegaba hablando puede empeorar durante el traslado; el traslado no espera.'],
        ['Aplicar un vendaje que rodee el cuello', 'No se comprime de forma circular el cuello ni se aplican vendajes que lo rodeen: el paso del aire ya está estrechado.'],
        ['Intentar una vía aérea avanzada por iniciativa propia', 'En una laringe o una tráquea lesionadas puede empeorar la lesión o cerrar definitivamente el paso del aire. Si está indicada, quién y con qué lo determinan la competencia, el equipo y la dirección médica.'],
      ]),
      repasoRapido([
        'Es poco frecuente y muy peligrosa, porque la vía por la que respira el paciente es la dañada.',
        'Mecanismo típico: golpe directo en la cara anterior del cuello, o herida penetrante cervical.',
        'También puede acompañar a una lesión por desaceleración importante.',
        'Alertan el cambio de voz —disfonía, voz apagada, afonía— y el estridor.',
        'El enfisema subcutáneo cervical se palpa como crepitación: aire donde no debería haberlo.',
        'También la herida penetrante cervical, el hematoma en expansión y la deformidad del contorno del cuello.',
        'Y la hemoptisis o sangre en la boca sin origen bucal evidente, el dolor laríngeo a la palpación y el dolor al tragar.',
        'La señal más importante es la dificultad respiratoria que aumenta con el paso de los minutos.',
        'Conducta: mínima manipulación del cuello y de la vía aérea.',
        'Permitir al paciente consciente la posición en que respira mejor, si no hay contraindicación espinal.',
        'Oxígeno, apoyo ventilatorio y aspiración conforme al alcance y al protocolo; nada circular alrededor del cuello.',
        'Traslado con prealerta explícita: el centro receptor debe poder preparar una vía aérea difícil antes de que llegue.',
      ]),
      preguntasOrales([
        '¿Cuál es el mecanismo típico de una lesión traqueal o laríngea?',
        'Enumera los signos que deben alertar.',
        '¿Qué es el estridor y qué indica?',
        '¿Cuál es la señal más importante, y por qué?',
        'Explica el principio de mínima manipulación y su razón.',
        '¿Por qué no se aplica nada circular alrededor del cuello?',
        '¿Por qué el aviso temprano al centro receptor cambia algo?',
        '¿Quién decide si se intenta una vía aérea avanzada aquí?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL PROBLEMA NO ES EL HUESO, ES QUE DUELE RESPIRAR. El paciente no respira hondo ni tose, ventila peor zonas del pulmón y acumula secreciones. Por eso el control del dolor no es comodidad: es parte del tratamiento respiratorio.'),
          masPreguntado('Que NO se venda el tórax de forma circunferencial —limita la expansión y empeora justo lo que ya está comprometido—, y que en la persona mayor o frágil una fractura costal aparentemente simple justifica un umbral de traslado y de vigilancia más bajo.'),
        ],
      },
      erroresFrecuentes([
        ['Vendar el tórax de forma circunferencial', 'El vendaje circular o las cintas que rodean el tórax limitan la expansión torácica y empeoran la ventilación, que es justo lo que ya está comprometido. Inmovilizar el tórax no es tratar una fractura costal.'],
        ['Tratar el dolor como una comodidad', 'Un paciente que no respira hondo ni tose eficazmente ventila peor y acumula secreciones. El control del dolor, cuando el protocolo lo autoriza, es parte del tratamiento respiratorio.'],
        ['Aplicar el mismo umbral a la persona mayor', 'Con caja torácica rígida y hueso frágil, la fractura puede producirse con baja energía y tolerarse mucho peor. En edad avanzada o con enfermedad respiratoria previa, el umbral de traslado y vigilancia baja.'],
        ['Cerrar la búsqueda en el arco costal', 'Debajo puede haber contusión pulmonar que evoluciona en horas, neumotórax o hemotórax, lesión de órganos abdominales superiores y un segmento con movimiento paradójico.'],
      ]),
      repasoRapido([
        'Es la lesión torácica más común.',
        'Dolor localizado que aumenta con la inspiración profunda, con la tos y con el movimiento.',
        'Sensibilidad puntual sobre el arco afectado y, a veces, crepitación ósea.',
        'Respiración superficial y rápida: el paciente evita respirar hondo porque duele.',
        'El paciente protege la zona con la mano o el brazo; puede haber equimosis o marca del mecanismo.',
        'Las costillas superiores requieren mucha energía; las inferiores dirigen la atención al abdomen superior, donde están hígado y bazo.',
        'El problema no es el hueso: es lo que el dolor provoca en la ventilación y en la tos.',
        'En la persona mayor o frágil, el mecanismo puede ser de baja energía y la tolerancia mucho peor.',
        'Debajo hay que seguir buscando contusión pulmonar, neumotórax, hemotórax y lesión abdominal superior.',
        'No se venda el tórax de forma circunferencial: es una práctica retirada.',
        'Sí se hace: posición cómoda, oxígeno y apoyo si aumenta el trabajo respiratorio, analgesia según alcance.',
        'Y animar a respirar profundo y toser dentro de lo tolerable, reevaluar durante el traslado y comunicar mecanismo, arcos afectados y evolución.',
      ]),
      preguntasOrales([
        'Enumera lo que se encuentra en una fractura costal.',
        '¿Qué orienta la localización de las costillas afectadas?',
        'Explica por qué el dolor compromete la ventilación.',
        '¿Qué complicaciones favorece esa cadena?',
        '¿Por qué no se venda el tórax de forma circunferencial?',
        '¿Por qué la persona mayor o frágil es un caso aparte?',
        'Nombra lo que hay que seguir buscando debajo.',
        'Recorre lo que sí se hace.',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PARED QUE NO VENTILA Y PULMÓN QUE NO INTERCAMBIA. Son dos problemas superpuestos: tratar solo el dolor deja fuera la mitad, y vigilar solo la oxigenación deja al paciente sin poder ventilar. Las dos cosas, a la vez, dentro del alcance autorizado.'),
          masPreguntado('Que un movimiento paradójico ausente NO descarta el segmento inestable —la contractura muscular puede ferulizarlo en las primeras horas— y que lo que más deteriora al paciente es la contusión pulmonar acompañante, no el movimiento en sí.'),
        ],
      },
      erroresFrecuentes([
        ['Descartarlo porque no se ve movimiento paradójico', 'La contractura de la musculatura de la pared puede ferulizar el segmento durante las primeras horas y ocultar el movimiento, sobre todo si el paciente respira superficialmente por el dolor.'],
        ['Estabilizar el segmento con cinta, sacos o pesos', 'Fijarlo con esparadrapo ancho, bolsas de arena o un peso encima limita la expansión de todo el hemitórax y empeora la ventilación y la oxigenación. El objetivo no es inmovilizar la pared, es conseguir que el paciente ventile.'],
        ['Atender solo uno de los dos problemas', 'Tratar el dolor sin vigilar la oxigenación deja fuera la contusión pulmonar; vigilar la oxigenación sin controlar el dolor deja al paciente sin poder ventilar.'],
        ['No reevaluar durante el traslado', 'El deterioro de la oxigenación progresa con el tiempo y la aparición tardía del movimiento paradójico no es una sorpresa. El traslado es donde se detecta.'],
      ]),
      repasoRapido([
        'Varias costillas contiguas fracturadas en más de un punto dejan un fragmento separado funcionalmente del resto de la caja.',
        'Ese segmento responde a la presión dentro del tórax: se hunde cuando el resto se expande y se abomba cuando el resto se retrae.',
        'Eso es el movimiento paradójico.',
        'Puede ser difícil de ver: la contractura muscular puede ferulizar el segmento en las primeras horas.',
        'Un movimiento paradójico ausente no descarta el segmento inestable, y su aparición tardía tampoco sorprende.',
        'Se observa mejor desde un lateral y con luz rasante.',
        'También dolor intenso y crepitación en una zona amplia, respiración superficial con esfuerzo evidente y deterioro progresivo de la oxigenación.',
        'La energía que produjo el segmento golpeó también el pulmón de debajo: la contusión pulmonar acompañante empeora en las horas siguientes.',
        'Son dos problemas superpuestos: pared que no ventila bien y pulmón que no intercambia bien.',
        'No se estabiliza con cinta, sacos ni pesos: es una práctica retirada.',
        'Sí se hace: oxígeno y vigilancia estrecha, apoyo ventilatorio si aumenta el trabajo o cae la oxigenación, analgesia según alcance.',
        'Y posición cómoda, prudencia con los líquidos en los términos del protocolo, reevaluación frecuente y traslado con prealerta.',
      ]),
      preguntasOrales([
        'Define el segmento inestable y describe el movimiento paradójico.',
        '¿Por qué puede no verse el movimiento paradójico?',
        '¿Descarta eso el diagnóstico?',
        '¿Cómo se observa mejor la pared torácica?',
        'Explica el papel de la contusión pulmonar en el deterioro.',
        '¿Cuáles son los dos problemas superpuestos?',
        '¿Por qué no se estabiliza con cinta ni con pesos?',
        'Recorre lo que sí se hace.',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SIMPLE, ABIERTO Y A TENSIÓN SE SEPARAN POR DOS PREGUNTAS: ¿comunica con el exterior? y ¿se acumula presión? El simple no hace ninguna de las dos, y por eso su conducta es vigilar, no descomprimir.'),
          masPreguntado('Que el neumotórax simple NO se descomprime —la descompresión está reservada al cuadro clínico de neumotórax a tensión— y que puede progresar a tensión, sobre todo si se ventila con presión positiva. De ahí que la conducta principal sea la vigilancia repetida.'),
        ],
      },
      erroresFrecuentes([
        ['Descomprimir un neumotórax simple', 'No aporta beneficio y añade el riesgo de un procedimiento invasivo innecesario. La descompresión está reservada al cuadro clínico de neumotórax a tensión, en los términos del protocolo.'],
        ['Descartarlo porque el cuadro no está completo', 'Un neumotórax pequeño puede cursar con ruidos aparentemente normales, y la auscultación en una ambulancia en marcha o en una vía ruidosa es poco fiable. La sospecha se sostiene por mecanismo y evolución.'],
        ['Ventilar con presión positiva sin vigilar', 'Aumenta el riesgo de que se establezca un mecanismo de válvula y evolucione a tensión. Exige atención especial.'],
        ['Dar por estable lo que puede crecer', 'Un neumotórax simple puede aumentar de tamaño. La conducta principal es la vigilancia repetida de respiración y circulación durante todo el traslado.'],
      ]),
      repasoRapido([
        'Entre pulmón y pared hay un espacio virtual con presión negativa que mantiene el pulmón expandido.',
        'Si entra aire en ese espacio, el pulmón se retrae y pierde parte de su superficie útil.',
        'El simple no comunica con el exterior y no acumula presión de forma progresiva.',
        'El abierto comunica por la herida de la pared; el que está a tensión acumula presión por mecanismo de válvula.',
        'Solo el que está a tensión produce compromiso circulatorio por obstrucción del retorno venoso.',
        'Hallazgos posibles: dolor punzante que aumenta con la inspiración y disnea de intensidad variable.',
        'También disminución de ruidos respiratorios en ese hemitórax, hipertimpanismo, taquipnea y ansiedad.',
        'Los hallazgos rara vez están completos, y su ausencia no descarta el neumotórax.',
        'El hipertimpanismo es difícil de valorar en un entorno ruidoso.',
        'Puede progresar a tensión, y el riesgo aumenta con la ventilación a presión positiva.',
        'Conducta: oxígeno según protocolo, posición cómoda, vigilancia repetida con registro de la hora.',
        'El neumotórax simple no se descomprime: se vigila y se traslada, y el tratamiento definitivo es hospitalario.',
      ]),
      preguntasOrales([
        'Define el neumotórax simple y diferéncialo del abierto y del que está a tensión.',
        '¿Qué mantiene el pulmón expandido, y qué pasa si entra aire?',
        'Enumera los hallazgos posibles.',
        '¿Por qué los hallazgos rara vez están completos?',
        '¿Descarta el diagnóstico una auscultación aparentemente normal?',
        '¿Por qué puede progresar, y qué lo favorece?',
        '¿Por qué no se descomprime?',
        'Recorre la conducta prehospitalaria.',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO SELLAR, VIGILAR. La conducta vigente prioriza no ocluir: herida expuesta, apósito limpio y seco no oclusivo o sello ventilado si se dispone de él. Y si tras colocar cualquier cosa la respiración empeora, se afloja o se retira.'),
          masPreguntado('Que el apósito de tres lados ya NO se enseña como regla universal, y por qué: sellar la herida puede favorecer la acumulación de presión. La guía AHA/Cruz Roja Americana de Primeros Auxilios 2024 prioriza no ocluir y vigilar la respuesta.'),
        ],
      },
      // Esta lección ya traía sus errores frecuentes, pero como una lista suelta.
      // En la pasada de calidad del 07-09-2026 se pasaron al formato del molde
      // v2 —un callout de alerta por error— para que se lean igual que en el
      // resto del temario: son lo que el alumno repasa la noche de antes, y cada
      // uno tiene que poder leerse suelto. NO se añadió, quitó ni reescribió
      // ningún error: son los cinco que ya estaban, con su título delante.
      erroresFrecuentes([
        ['Sellar la herida y no volver a mirarla', 'El deterioro tras el apósito es precisamente lo que hay que buscar: si la respiración empeora después de colocarlo, se afloja o se retira.'],
        ['Empaquetar la herida torácica con gasa', 'En el tórax no se empaqueta. La cavidad no tiene fondo que permita una presión útil y el material puede desplazarse hacia dentro.'],
        ['Buscar solo la herida evidente', 'Se explora toda la superficie del tórax, incluidas la espalda y las axilas. Lo que no se busca ahí no aparece.'],
        ['Retrasar el traslado para perfeccionar el apósito', 'Lo prioritario es activar la respuesta y trasladar sin demora; el apósito no es el tratamiento definitivo.'],
        ['Considerar resuelto el problema porque la herida esté cubierta', 'Cubrir la herida no resuelve el neumotórax y puede favorecer la acumulación de presión. La vigilancia continúa.'],
      ]),
      repasoRapido([
        'La respiración funciona porque la caja torácica genera presión negativa que arrastra aire por la vía aérea.',
        'Si la pared comunica con el espacio pleural, parte del aire entra por la herida y el pulmón de ese lado pierde expansión.',
        'De ahí el nombre tradicional de herida torácica aspirante.',
        'Puede evolucionar a tensión si el aire encuentra entrada y no salida, y ese riesgo gobierna la conducta sobre los apósitos.',
        'Se encuentra herida en la pared de cualquier tamaño, con paso audible de aire o burbujeo en algunos casos.',
        'También disnea, taquipnea, disminución de ruidos en ese hemitórax y signos de shock si hay hemorragia.',
        'Y deterioro respiratorio que puede aparecer o agravarse tras colocar un apósito.',
        'Conducta vigente: dejar la herida expuesta, o apósito limpio y seco NO oclusivo, o sello torácico ventilado si se dispone y está autorizado.',
        'Si la respiración empeora tras el apósito o el sello, se afloja o se retira.',
        'Se explora toda la superficie del tórax, incluidas espalda y axilas, y no se empaqueta el tórax.',
        'El apósito oclusivo de tres lados se explica como antecedente histórico, no como regla universal actual.',
        'Si el protocolo de un servicio mantiene una conducta concreta, se aplica citándola como protocolo local.',
      ]),
      preguntasOrales([
        'Explica por qué una herida torácica abierta compromete la ventilación.',
        '¿Por qué puede evolucionar a tensión?',
        'Enumera lo que se encuentra en la exploración.',
        'Di la conducta que recomienda la guía vigente.',
        '¿Qué haces si la respiración empeora tras colocar el apósito?',
        '¿Por qué el apósito de tres lados ya no se enseña como regla universal?',
        '¿Dónde más se buscan heridas, aparte de donde salta a la vista?',
        '¿Qué haces si tu protocolo local dice otra cosa?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('OCUPA Y RESTA. Ocupa el espacio del pulmón, así que compromete la ventilación; y resta volumen circulante, porque esa sangre ya salió del sistema. Por eso puede presentarse como insuficiencia respiratoria, como shock hemorrágico o como las dos cosas.'),
          masPreguntado('Que el tórax es un reservorio de hemorragia oculta —por eso se explora ante un shock sin sangrado visible, junto con abdomen, pelvis y huesos largos— y que el hemotórax NO se drena en la calle: el tratamiento definitivo es el drenaje torácico y, si el sangrado es importante, la cirugía.'),
        ],
      },
      erroresFrecuentes([
        ['Descartarlo porque no se aprecia matidez ni asimetría', 'La percusión es difícil de interpretar con ruido ambiental, con el paciente vestido o en una camilla en movimiento, y una acumulación moderada puede no alterar los ruidos de forma clara. La sospecha se apoya en el mecanismo, la región y la respuesta fisiológica.'],
        ['Puncionar el tórax buscando sangre', 'No forma parte de la conducta prehospitalaria de este cuadro. La confirmación es por imagen hospitalaria y el tratamiento, el drenaje torácico o la cirugía.'],
        ['Olvidar la hipotermia en un sangrado no compresible', 'Aquí la prevención activa de la hipotermia tiene efecto directo sobre la coagulación, y es una de las pocas medidas que el equipo puede aplicar de forma completa.'],
        ['Empaquetar la herida torácica', 'En el tórax no se empaqueta. Si el trauma es penetrante, la herida de la pared se maneja con los medios adecuados, sin rellenarla.'],
      ]),
      repasoRapido([
        'Es sangre acumulada en el espacio pleural: de la pared torácica, del propio pulmón o de estructuras mayores del mediastino.',
        'Comprime el pulmón de ese lado y reduce la superficie disponible para el intercambio.',
        'A la vez, esa sangre salió del sistema circulatorio: el paciente pierde volumen sin que se vea nada por fuera.',
        'El tórax es uno de los reservorios de hemorragia oculta, con abdomen, pelvis y huesos largos.',
        'Hallazgos posibles: disnea y taquipnea, ruidos disminuidos o ausentes en ese hemitórax.',
        'También matidez a la percusión en zonas declives y signos de shock.',
        'Y dolor torácico, herida en la pared si el trauma es penetrante, y yugulares planas si predomina la pérdida de volumen.',
        'Los signos clásicos son poco fiables en la calle, y su ausencia no descarta el hemotórax.',
        'Conducta: oxígeno y apoyo ventilatorio, tratamiento del shock según protocolo y prevención activa de la hipotermia.',
        'Manejo de la herida de la pared si es penetrante, sin empaquetar el tórax.',
        'Traslado sin demoras evitables, prealerta explícita y reevaluación repetida y documentada.',
        'No se drena en la calle ni se punciona buscando sangre: el tratamiento definitivo es el drenaje y, si el sangrado es importante, la cirugía.',
      ]),
      preguntasOrales([
        'Explica el doble efecto del hemotórax.',
        '¿De dónde puede proceder la sangre?',
        '¿Por qué el tórax se explora ante un shock sin sangrado visible?',
        'Enumera los hallazgos posibles.',
        '¿Por qué los signos clásicos son poco fiables en la escena?',
        '¿Descarta el diagnóstico que no se aprecie matidez?',
        'Recorre la conducta prehospitalaria.',
        '¿Qué NO se hace en la escena, y dónde se trata?',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA FUGA QUE NO CEDE. Un paciente al que se ha tratado un neumotórax y que sigue con enfisema en aumento o sin mejoría respiratoria: eso es el dato más característico, y se comunica como advertencia, no como diagnóstico.'),
          masPreguntado('El significado de una fuga aérea persistente, y la precaución con la ventilación a presión positiva: puede aumentar la fuga. No significa negar la ventilación a quien la necesita, sino aplicarla vigilando la respuesta.'),
        ],
      },
      erroresFrecuentes([
        ['Ventilar a presión positiva sin vigilar la respuesta', 'Puede aumentar la fuga aérea. No se niega la ventilación a quien la necesita: se aplica vigilando qué pasa.'],
        ['Interpretar la fuga persistente como fallo de la maniobra', 'Es el dato más característico de este cuadro. Se traduce en una advertencia concreta al centro receptor, no en un diagnóstico de campo.'],
        ['No medir la progresión del enfisema', 'Se vigila su extensión, su progresión y la hora de cada observación: sin esas tres cosas, «tiene enfisema» no informa de nada.'],
        ['Intentar resolverlo con instrumentación avanzada', 'El diagnóstico requiere estudios y exploración instrumental hospitalarios. La instrumentación avanzada de la vía aérea aquí depende de la competencia del prestador y de la dirección médica.'],
      ]),
      repasoRapido([
        'Se desgarra la tráquea intratorácica o un bronquio principal y el aire escapa hacia los tejidos vecinos.',
        'Ese aire se difunde por el mediastino y por el tejido subcutáneo, y puede pasar al espacio pleural.',
        'Mecanismo: desaceleración o compresión torácicas importantes, o trauma penetrante.',
        'Alertan el enfisema subcutáneo extenso y progresivo —cuello, cara, tórax e incluso más allá— y la hemoptisis.',
        'También la dificultad respiratoria que no mejora con las medidas habituales.',
        'Y la disnea con ruidos disminuidos en un hemitórax, el dolor torácico o cervical y a veces el cambio de voz.',
        'El dato más característico es la fuga de aire que persiste.',
        'En el ámbito prehospitalario eso se traduce en una advertencia al centro receptor, no en un diagnóstico.',
        'Conducta: oxígeno y apoyo ventilatorio conforme al alcance y al protocolo.',
        'Precaución con la presión positiva, que puede aumentar la fuga; se aplica vigilando la respuesta.',
        'Vigilar el enfisema: extensión, progresión y hora de cada observación.',
        'Traslado a centro con capacidad quirúrgica, prealerta con la sospecha explícita y documentación precisa del mecanismo.',
      ]),
      preguntasOrales([
        '¿Qué ocurre cuando se desgarra un bronquio principal?',
        '¿Cuál es el mecanismo típico?',
        'Enumera los signos que deben alertar.',
        'Explica el significado de una fuga aérea persistente.',
        '¿Qué precaución exige la ventilación a presión positiva, y qué NO significa?',
        '¿Qué se vigila del enfisema subcutáneo?',
        '¿Dónde se hace el diagnóstico?',
        '¿Qué aporta entonces el ámbito prehospitalario?',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ZONAS FIJAS Y ZONAS MÓVILES. La aorta no está suelta: en una desaceleración las porciones móviles siguen desplazándose mientras las fijas ya se detuvieron, y el cizallamiento se concentra en la transición entre unas y otras.'),
          masPreguntado('Que los pacientes que llegan vivos suelen tener el sangrado contenido de forma precaria por estructuras vecinas —contención que puede fallar en cualquier momento—, y que ningún signo prehospitalario la confirma ni la descarta: el mecanismo eleva la sospecha y la prioridad de destino, la imagen diagnostica.'),
        ],
      },
      erroresFrecuentes([
        ['Descartarla porque la exploración es normal', 'Un paciente puede tener una disrupción contenida con exploración prácticamente normal y sin diferencias de pulsos. Ni la ausencia de signos la descarta ni su presencia la afirma.'],
        ['Confiarse porque el paciente parece estable', 'La contención del sangrado por estructuras vecinas es precaria y puede fallar en cualquier momento. Por eso el traslado tiene prioridad aunque parezca estable.'],
        ['Convertir los hallazgos en criterios diagnósticos', 'El dolor interescapular, las diferencias de pulso o la ronquera son datos que se documentan y se comunican, no criterios diagnósticos de campo.'],
        ['Prealertar sin describir el mecanismo', 'Es el mecanismo descrito lo que permite preparar la imagen y el equipo antes de la llegada. Un aviso sin mecanismo no prepara nada.'],
      ]),
      repasoRapido([
        'La aorta tiene zonas ancladas a estructuras vecinas y zonas relativamente móviles.',
        'En una desaceleración brusca, el cizallamiento se concentra en la transición entre unas y otras.',
        'Si la pared cede en ese punto, se produce el desgarro.',
        'Cuando la rotura es completa, el desenlace suele producirse antes de la llegada del equipo.',
        'Los que llegan vivos suelen tener el sangrado contenido de forma precaria por estructuras vecinas.',
        'Mecanismos que elevan la sospecha: colisión frontal o lateral de alta energía, caída desde altura importante.',
        'También atropello a velocidad elevada, vuelco, eyección o cualquier desaceleración brusca comparable.',
        'Hallazgos posibles: dolor torácico o interescapular intenso y de aparición brusca, y diferencias de pulso o presión entre extremidades.',
        'También disnea, disfagia o ronquera por compresión de estructuras vecinas, y shock, en general tardío.',
        'Los signos externos de impacto torácico pueden faltar por completo.',
        'La sospecha se traduce en prioridad de traslado y prealerta explícita con el mecanismo descrito.',
        'La imagen es la que diagnostica, y el tratamiento es quirúrgico o endovascular.',
      ]),
      preguntasOrales([
        'Explica por qué la desaceleración desgarra la aorta en un punto concreto.',
        '¿Por qué los pacientes que llegan vivos son un grupo particular?',
        'Enumera los mecanismos que elevan la sospecha.',
        'Nombra los hallazgos posibles.',
        '¿Puedes descartarla si la exploración es normal?',
        '¿Puedes afirmarla si hay diferencia de pulsos?',
        '¿En qué se traduce la sospecha?',
        '¿Qué tiene que incluir la prealerta para servir de algo?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('SI NO SE LLENA, NO EXPULSA. El pericardio tolera mal el aumento rápido de volumen: la presión comprime las cavidades desde fuera, el corazón deja de llenarse y cae el gasto aunque el músculo esté intacto.'),
          masPreguntado('Que la tríada de Beck NO es un requisito: exigir los tres componentes lleva a reconocerlo tarde o a no reconocerlo. Y la diferencia práctica con el neumotórax a tensión: allí hay un hemitórax con ruidos ausentes e hipertimpanismo, aquí no.'),
        ],
      },
      erroresFrecuentes([
        ['Exigir la tríada de Beck completa', 'Rara vez está completa y sus tres componentes son difíciles de valorar en la escena. La sospecha se sostiene por el mecanismo compatible junto a un shock que no se explica de otro modo.'],
        ['Descartarlo porque no hay ingurgitación yugular', 'Puede faltar si el paciente además está hipovolémico por hemorragia.'],
        ['Confundirlo con un neumotórax a tensión', 'Los dos son shock obstructivo y los dos pueden dar hipotensión y yugulares ingurgitadas. La diferencia está en los hallazgos respiratorios: en el neumotórax a tensión hay un hemitórax con ruidos ausentes e hipertimpanismo.'],
        ['Plantear una pericardiocentesis de campo como conducta habitual', 'No forma parte del manejo estándar prehospitalario. Es un procedimiento con riesgo propio que exige competencia, equipo e indicación respaldada, y depende del protocolo y de la dirección médica.'],
      ]),
      repasoRapido([
        'El pericardio es una envoltura fibrosa que tolera mal el aumento rápido de volumen.',
        'La sangre que entra sube la presión dentro del saco y comprime las cavidades desde fuera.',
        'El corazón deja de llenarse bien, y si no se llena, no puede expulsar.',
        'Es un shock obstructivo: no falta volumen ni falla la bomba, hay un obstáculo mecánico al llenado.',
        'Comparte categoría con el neumotórax a tensión, y de ahí que ambos den hipotensión con yugulares ingurgitadas.',
        'La diferencia práctica está en los hallazgos respiratorios, ausentes aquí.',
        'Tríada de Beck: hipotensión, ingurgitación yugular y ruidos cardiacos apagados.',
        'La hipotensión puede aparecer tarde; la ingurgitación puede faltar con hipovolemia; los ruidos apagados son casi imposibles de valorar en la escena.',
        'La tríada se enseña porque explica la fisiología y el alumno la encontrará citada, no como requisito.',
        'Otros hallazgos: taquicardia, piel fría, alteración del estado mental, pulso que se debilita con la inspiración.',
        'También ausencia de mejoría pese al soporte y deterioro rápido en un paciente antes consciente.',
        'Conducta: soporte según alcance, manejo de la herida si es penetrante, traslado urgente a centro quirúrgico con prealerta y reevaluación continua.',
      ]),
      preguntasOrales([
        'Explica por qué el taponamiento es un shock obstructivo.',
        '¿Por qué cae el gasto si el músculo está intacto?',
        'Di la tríada de Beck y por qué puede faltar cada componente.',
        '¿Es la tríada un requisito para sospecharlo?',
        '¿Qué separa el taponamiento del neumotórax a tensión en la exploración?',
        'Nombra otros hallazgos posibles.',
        'Recorre la conducta prehospitalaria.',
        '¿Qué dices si te preguntan por la pericardiocentesis de campo?',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL CORAZÓN QUEDA ENTRE EL ESTERNÓN Y LA COLUMNA. De ahí que un impacto sobre la pared anterior pueda dañar el tejido cardiaco sin que la pared se abra, y de ahí que el término actual sea el más amplio: lesión cardiaca contusa, no solo del miocardio.'),
          masPreguntado('Que la equimosis esternal no diagnostica nada —ni su presencia confirma ni su ausencia descarta— y la distinción con la commotio cordis: allí no hay daño del tejido, hay una arritmia desencadenada por un golpe precordial en un corazón estructuralmente sano.'),
        ],
      },
      erroresFrecuentes([
        ['Diagnosticarlo por una equimosis esternal o por el volante', 'Es una marca de dónde se transfirió la energía. Ni su presencia confirma la lesión cardiaca ni su ausencia la descarta.'],
        ['Explicar la hipotensión por el corazón sin descartar la hemorragia', 'Los hallazgos son inespecíficos: el dolor puede venir de las costillas, la taquicardia del dolor o de la hemorragia, y la hipotensión de un sangrado en otro sitio. Se empieza por la causa más frecuente.'],
        ['Confundirla con la commotio cordis', 'En la commotio cordis un golpe precordial en un momento vulnerable del ciclo desencadena una arritmia potencialmente mortal en un corazón sano, sin daño del músculo. Su manejo es el del paro cardiaco según las guías vigentes.'],
        ['No reevaluar el ritmo durante el traslado', 'Las alteraciones del ritmo pueden aparecer en ese intervalo, y son parte de lo que se comunica en la entrega.'],
      ]),
      repasoRapido([
        'El plan la titula «contusión miocárdica»; el término actual es lesión cardiaca contusa.',
        'Es más amplio porque el impacto puede afectar al músculo, a la conducción, a las válvulas o al pericardio.',
        'Mecanismo habitual: impacto directo sobre la pared torácica anterior —volante, manillar, caída, golpe, compresión—.',
        'El corazón queda entre el esternón y la columna, y la energía transmitida puede dañarlo sin abrir la pared.',
        'Manifestaciones: dolor torácico difícil de separar del de la pared o de las fracturas costales.',
        'También alteraciones del ritmo, desde taquicardia hasta ritmos irregulares.',
        'Y hipotensión sin otra causa aparente, signos externos de impacto anterior y, en casos graves, fallo de bomba.',
        'Ninguno de esos hallazgos es propio de esta lesión: no se diagnostica en la calle.',
        'La equimosis esternal no diagnostica nada: es una marca de dónde se transfirió la energía.',
        'Conducta: monitorización del ritmo si hay equipo y está dentro del alcance, oxígeno y soporte según protocolo.',
        'Búsqueda activa de otras causas de hipotensión, en especial la hemorragia, y analgesia según alcance.',
        'La commotio cordis es otra entidad: arritmia por golpe precordial en un corazón sano, sin daño del músculo.',
      ]),
      preguntasOrales([
        '¿Por qué el término actual es «lesión cardiaca contusa» y no «contusión miocárdica»?',
        'Describe el mecanismo habitual.',
        'Enumera las manifestaciones posibles.',
        '¿Por qué se dice que son inespecíficas?',
        '¿Qué diagnostica una equimosis esternal?',
        'Distingue la lesión cardiaca contusa de la commotio cordis.',
        '¿Cómo se maneja la commotio cordis?',
        'Recorre la conducta prehospitalaria.',
      ]),
      F([PHTLS_TORAX, WHO_BEC, ACS_BEST]),
    ],
