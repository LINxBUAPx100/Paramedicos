    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DIFUSAS, FOCALES Y ACOMPAÑANTES. Las difusas y las focales tienen tema propio; las acompañantes son la hemorragia subaracnoidea traumática y el edema cerebral. Y ninguna se distingue en la calle.'),
          masPreguntado('Por qué no hace falta nombrar la lesión: el manejo no cambia según el tipo, así que un nombre en el informe no mejora la atención y sí puede inducir a error. Lo que sí cambia el resultado es la calidad de la descripción y de la serie de valoraciones.'),
        ],
      },
      erroresFrecuentes([
        ['Confundir la hemorragia subaracnoidea traumática con la espontánea', 'La espontánea aparece sin traumatismo, típicamente por rotura de un aneurisma, y es una urgencia médica distinta del Módulo 4. A veces la pregunta correcta es si el paciente se golpeó por haber sangrado, y no al revés.'],
        ['Esperar poder evacuar el edema', 'No es una colección: es aumento de volumen del propio tejido. Ocupa espacio en una caja rígida y empuja la presión hacia arriba cuando la compensación se agota.'],
        ['Dar el caso por estable porque han pasado horas', 'El edema se instaura y progresa en las horas siguientes al impacto: eso explica que un paciente empeore mucho después del accidente.'],
        ['Hiperventilar de rutina', 'La conducta común incluye ventilación adecuada, sin hiperventilar de rutina.'],
      ]),
      repasoRapido([
        'Difusas: concusión y lesión axonal difusa, con tema propio.',
        'Focales: hematoma epidural, subdural, contusión y hematoma intraparenquimatoso, con tema propio.',
        'Acompañantes: hemorragia subaracnoidea traumática y edema cerebral.',
        'La división separa lo que puede tener solución quirúrgica de lo que solo admite soporte.',
        'En el ámbito prehospitalario la conducta es la misma para todas, porque no se pueden distinguir sin imagen.',
        'La hemorragia subaracnoidea traumática es sangre en el espacio que rodea al encéfalo, bajo la aracnoides.',
        'Es frecuente en el traumatismo craneal y suele acompañar a otras lesiones.',
        'Puede dar cefalea intensa, náusea, rigidez de nuca y deterioro de la conciencia, ninguno exclusivo suyo.',
        'El edema cerebral es aumento de volumen del propio tejido: no se puede evacuar.',
        'Se instaura y progresa en las horas siguientes, y explica que un paciente empeore mucho después.',
        'Conducta común: evitar hipoxia e hipotensión, ventilar sin hiperventilar de rutina, cabeza neutra y collarín no compresivo.',
        'Y valoración seriada con la hora, glucemia y temperatura según alcance, y traslado a centro neuroquirúrgico con prealerta.',
      ]),
      preguntasOrales([
        'Ordena las lesiones intracraneales en tres grupos.',
        '¿Qué separa esa división?',
        'Describe la hemorragia subaracnoidea traumática.',
        '¿En qué se diferencia de la espontánea?',
        '¿Qué es el edema cerebral y por qué no se evacúa?',
        '¿Por qué un paciente puede empeorar horas después?',
        'Recorre la conducta común.',
        '¿Por qué no hace falta nombrar la lesión?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('OJOS CUATRO, VOZ CINCO, MOTOR SEIS. De ahí sale el máximo de 15, y como cada componente puntúa al menos 1, el mínimo es 3. Un «Glasgow 0» no existe: verlo escrito indica que quien lo anotó no puntuó la escala.'),
          masPreguntado('Las cuatro reglas de uso: se puntúa la MEJOR respuesta de cada componente, se comunica desglosada además del total, la respuesta motora es la que más informa, y se repite con la hora. Y las circunstancias que invalidan la puntuación, que se declaran en vez de inventar un valor.'),
        ],
      },
      erroresFrecuentes([
        ['Puntuar la peor respuesta', 'Se puntúa la mejor respuesta obtenida en cada componente.'],
        ['Comunicar solo el total', 'Un mismo total puede corresponder a situaciones muy distintas. Se comunica desglosada: ocular, verbal y motora, además del total.'],
        ['Inventar un valor cuando no se puede valorar', 'Sedación, relajación, intubación, intoxicación, barrera idiomática, déficit auditivo o visual previo y lesiones que impidan responder invalidan la puntuación. Se anota el componente valorable y se declara el motivo.'],
        ['Usar la cifra como si clasificara al paciente', 'Describe el nivel de conciencia en un momento dado: no mide el daño estructural, no predice el desenlace por sí misma y no sustituye a la exploración de pupilas y función motora.'],
      ]),
      repasoRapido([
        'Puntúa tres respuestas: apertura ocular, respuesta verbal y respuesta motora.',
        'Apertura ocular, máximo 4: espontánea, a la orden verbal, al estímulo doloroso, ninguna.',
        'Respuesta verbal, máximo 5: orientada, confusa, palabras inapropiadas, sonidos incomprensibles, ninguna.',
        'Respuesta motora, máximo 6: obedece, localiza el dolor, retirada, flexión anormal, extensión anormal, ninguna.',
        'El total va de 3 a 15: cada componente puntúa al menos 1, así que el mínimo es 3 y no 0.',
        'Se puntúa la mejor respuesta obtenida en cada componente, no la peor.',
        'Se comunica desglosada además del total.',
        'La respuesta motora es la que más información aporta sobre la gravedad.',
        'Se repite y se anota con la hora: la tendencia informa más que cualquier valor aislado.',
        'Deja de ser fiable con sedación, relajación, intubación, intoxicación, barrera idiomática, déficit previo o lesión que impida responder.',
        'En esos casos se anota el componente valorable y se declara el motivo.',
        'La adaptación pediátrica se estudia en el Módulo 6, dentro de la evaluación del paciente pediátrico.',
      ]),
      preguntasOrales([
        'Enumera los tres componentes y el máximo de cada uno.',
        '¿Cuál es el valor mínimo posible, y por qué?',
        'Recita la escala de respuesta motora.',
        'Di las cuatro reglas prácticas de uso.',
        '¿Qué componente aporta más información sobre la gravedad?',
        '¿Cuándo deja de ser fiable la escala?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMER ESCALÓN, EL DE LA AMBULANCIA. Oxigenar, mantener la presión, cabeza neutra y cabecera elevada, no comprimir yugulares, controlar dolor, agitación, convulsiones, glucemia y temperatura. El segundo y el tercero son hospital y cuidados críticos.'),
          masPreguntado('Que la tríada de Cushing es alarma y no vigilancia —cuando aparece, la herniación ya está en curso— y que su patrón es el inverso del shock hipovolémico: aquí la presión sube y el pulso baja. Confundirlos lleva a tratamientos opuestos.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar la tríada de Cushing como un signo de vigilancia', 'Cuando aparece, la herniación ya está en curso. Es una alarma.'],
        ['Confundir su patrón con el del shock', 'En el shock hipovolémico la presión cae y el pulso sube; aquí la presión sube y el pulso baja. Confundirlos lleva a tratamientos opuestos.'],
        ['Hiperventilar de rutina', 'Está proscrito en el traumatismo craneoencefálico porque la vasoconstricción que produce reduce el flujo cerebral. Se reserva de forma transitoria y controlada para signos de herniación, conforme al protocolo.'],
        ['Intentar aplicar el segundo o el tercer escalón', 'La terapia osmótica, el drenaje de líquido cefalorraquídeo, la sedación profunda, la hipotermia terapéutica, el coma barbitúrico y la cirugía descompresiva son hospitalarios y de cuidados críticos.'],
      ]),
      repasoRapido([
        'El plan titula el tema con «nivel 1, 2 y 3» sin definir la numeración; se lee como escalones de tratamiento y queda registrado como decisión pendiente.',
        'Mientras la compensación funciona la presión sube poco y el paciente puede parecer estable.',
        'Al agotarse, un aumento pequeño de volumen produce un aumento grande de presión.',
        'Signos precoces: cefalea, náusea y vómito, inquietud o irritabilidad, descenso leve de la conciencia.',
        'Intermedios: descenso progresivo de la conciencia, lentitud, asimetría pupilar incipiente, déficit motor.',
        'Tardíos: tríada de Cushing, pupila dilatada arreactiva y postura de decorticación o descerebración.',
        'La tríada de Cushing es hipertensión, bradicardia y respiración irregular: alarma, no vigilancia.',
        'Su patrón es el inverso del shock hipovolémico.',
        'Primer escalón: medidas generales, en parte prehospitalarias y en parte hospitalarias.',
        'Segundo escalón: terapia osmótica, drenaje de líquido cefalorraquídeo, sedación profunda y ventilación monitorizada. Hospitalario.',
        'Tercer escalón: hipotermia terapéutica, coma barbitúrico y cirugía descompresiva. Cuidados críticos y quirófano.',
        'La hiperventilación no es un escalón: es una excepción transitoria para signos de herniación, según protocolo.',
      ]),
      preguntasOrales([
        'Explica cómo progresa la hipertensión intracraneal.',
        'Ordena los signos de precoz a tardío.',
        'Di la tríada de Cushing y su significado.',
        '¿Por qué su patrón se confunde con el del shock, y qué lo distingue?',
        'Enumera los tres escalones y su ámbito.',
        '¿Qué hace realmente la ambulancia?',
        '¿Cuál es la posición de la hiperventilación en el manejo?',
        '¿Qué se anotó como decisión pendiente en este tema?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMERO LA PRESIÓN, DESPUÉS LA OSMOLARIDAD. Un paciente con traumatismo craneal grave e hipotensión tiene un problema de perfusión antes que de presión intracraneal, y un agente que provoca diuresis en esa situación puede agravar el cuadro.'),
          masPreguntado('Que la intubación en el traumatismo craneal no se juzga por la maniobra sino por cómo se hace: la desaturación durante los intentos y la hipotensión asociada a la sedación son dos agresores secundarios conocidos, y una vez asegurada la vía, hiperventilar sin control es un riesgo frecuente y evitable.'),
        ],
      },
      erroresFrecuentes([
        ['Administrar un agente osmótico a un paciente hipotenso', 'El manitol produce diuresis, y en un paciente hipovolémico o hipotenso esa pérdida de volumen puede empeorar la perfusión cerebral, que es justo lo que se quiere proteger.'],
        ['Tratar la terapia osmótica como tratamiento de la lesión', 'Gana tiempo hasta que el problema se resuelve, habitualmente en quirófano. No es un tratamiento de la lesión.'],
        ['Considerar la convulsión un asunto aparte', 'Aumenta el consumo cerebral de oxígeno, compromete la ventilación y eleva la presión intracraneal: su control forma parte del tratamiento del traumatismo.'],
        ['Juzgar la intubación solo por la técnica', 'La preparación, la preoxigenación y la vigilancia posterior pesan tanto como la técnica, y la desaturación durante los intentos y la hipotensión por la sedación son agresores secundarios conocidos.'],
      ]),
      repasoRapido([
        'Esta lección declara su bloqueo: no publica dosis, ni concentraciones, ni tamaños de tubo, ni frecuencias objetivo.',
        'Una cifra solo se publica cuando constan población, indicación, vía, concentración del producto y protocolo que la autoriza.',
        'El manitol es un agente osmótico: arrastra agua desde el tejido cerebral hacia el compartimento vascular.',
        'El suero salino hipertónico actúa por un principio parecido; ambos pertenecen al segundo escalón.',
        'No tratan la lesión: ganan tiempo hasta que el problema se resuelve, habitualmente en quirófano.',
        'El manitol produce diuresis, y en un paciente hipotenso eso puede empeorar la perfusión cerebral.',
        'Por eso la hipotensión limita su uso y corregir la presión precede a cualquier consideración osmótica.',
        'Su administración prehospitalaria no es universal: depende del alcance, de la disponibilidad y de una indicación respaldada.',
        'Una convulsión es un agresor secundario: su control forma parte del tratamiento del traumatismo.',
        'La indicación de intubar se establece por incapacidad de proteger la vía aérea, ventilación inadecuada o deterioro neurológico, según protocolo.',
        'El riesgo no está solo en el procedimiento: desaturación durante los intentos e hipotensión por la sedación.',
        'Lo que siempre depende de ti: evitar hipoxia e hipotensión, ventilar sin hiperventilar, medir glucemia, cabeza neutra, documentar la serie y acortar el tiempo.',
      ]),
      preguntasOrales([
        '¿Por qué esta lección no publica cifras?',
        'Explica el fundamento de la terapia osmótica.',
        '¿Por qué la hipotensión limita el uso del manitol?',
        '¿Trata el manitol la lesión? Justifícalo.',
        '¿Por qué el control de las convulsiones es parte del tratamiento del traumatismo craneal?',
        '¿Cómo se establece la indicación de intubar?',
        '¿Dónde está el riesgo de la intubación, aparte de la técnica?',
        'Enumera lo que siempre depende del equipo, sea cual sea su alcance.',
      ]),
      F([BTF_PREHOSPITAL, BTF_GRAVE, ACS_TCE_2024, PHTLS_CABEZA, PROTOCOLO_LOCAL]),
    ],
    conceptosClave: [
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('FRACTURA NO ES IGUAL A LESIÓN MEDULAR. Se puede tener una vértebra rota con exploración normal, y una lesión medular sin fractura evidente. Por eso una exploración neurológica normal no autoriza a movilizar sin precauciones.'),
          masPreguntado('Que parte del daño medular se produce DESPUÉS del accidente, al mover mal a alguien cuya columna está rota; y que el paciente mayor con osteoporosis, artritis avanzada o columna rígida se fractura con mecanismos de baja energía.'),
        ],
      },
      erroresFrecuentes([
        ['Movilizar sin precauciones porque la exploración es normal', 'Se puede tener una vértebra rota con exploración neurológica normal. Parte del daño medular se produce después del accidente, al mover mal a alguien con la columna rota.'],
        ['Aplicar el umbral del adulto joven al paciente mayor', 'Con osteoporosis, artritis avanzada o columna rígida, la fractura ocurre con mecanismos de baja energía.'],
        ['Querer clasificar la fractura en la calle', 'Eso lo hace la imagen. Lo que interesa en la escena es reconocer que existe y evitar que se convierta en una lesión medular.'],
        ['Dar por fiable la exploración de quien no puede colaborar', 'Con conciencia alterada, intoxicación o dolor distractor la valoración no es fiable: no descarta nada.'],
      ]),
      repasoRapido([
        'Compresión axial: la carga se transmite por el eje y aplasta el cuerpo vertebral. Caída de pie o zambullida.',
        'Flexión: la columna se dobla hacia delante y comprime la parte anterior. Desaceleración frontal.',
        'Extensión: la columna se dobla hacia atrás. Impacto posterior con reposacabezas mal ajustado.',
        'Rotación: giro del tronco respecto a la pelvis. Vuelco o impacto rotacional.',
        'Flexión-distracción: la parte anterior se comprime y la posterior se separa. Cinturón sobre el abdomen.',
        'El mecanismo orienta dónde mirar y con qué prioridad, no nombra la fractura.',
        'Sospechar ante dolor o hipersensibilidad en la línea media, escalón, separación entre apófisis o deformidad.',
        'También ante contractura paravertebral intensa y ante mecanismo de alto riesgo aunque no haya dolor.',
        'Y en cualquier traumatismo de paciente con osteoporosis, artritis avanzada o columna rígida, incluso de baja energía.',
        'Fractura no es igual a lesión medular, y una exploración normal no descarta la fractura.',
        'Conducta: restricción del movimiento espinal manteniendo alineación neutra y movilización en bloque.',
        'Exploración documentada con la hora y repetida, analgesia según alcance, prevención de hipotermia y traslado a centro neuroquirúrgico.',
      ]),
      preguntasOrales([
        'Relaciona cada mecanismo con su patrón de fractura y un ejemplo.',
        '¿Para qué sirve el mecanismo aquí, y para qué no?',
        'Enumera lo que hace sospechar una fractura vertebral.',
        '¿Es lo mismo fractura vertebral que lesión medular?',
        '¿Por qué una exploración normal no autoriza a movilizar sin precauciones?',
        '¿Qué cambia en el paciente con columna rígida?',
        '¿Cuándo deja de ser fiable la valoración?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('NO MUEVE, NO SIENTE EL PINCHAZO, PERO SABE DÓNDE TIENE EL PIE. Esa disociación define el síndrome anterior, y solo aparece si se explora la sensibilidad profunda además de la fuerza.'),
          masPreguntado('El patrón de pérdidas y conservaciones, y que es el síndrome medular incompleto de peor pronóstico funcional. Eso no cambia la conducta prehospitalaria, pero refuerza el valor de documentar con precisión el déficit inicial: es la referencia con la que se medirá cualquier evolución.'),
        ],
      },
      erroresFrecuentes([
        ['Explorar solo la fuerza', 'La disociación que define el síndrome solo aparece si se explora la sensibilidad profunda: propiocepción y vibración además de fuerza, dolor y temperatura.'],
        ['Dar por explicada la hipotensión por la médula', 'Se busca shock neurogénico, pero no se da por explicada la hipotensión antes de descartar hemorragia.'],
        ['Descuidar la ventilación en lesión cervical o torácica alta', 'Ahí la ventilación es parte de la vigilancia, no un extra.'],
        ['No documentar el déficit inicial por función y por nivel', 'Es la referencia con la que se medirá cualquier evolución. Sin ella, la mejoría o el empeoramiento no son demostrables.'],
      ]),
      repasoRapido([
        'Afecta a los dos tercios anteriores de la médula.',
        'Por la parte anterior viajan las vías motoras y las que llevan dolor y temperatura.',
        'Por la posterior viajan la propiocepción, la vibración y el tacto fino.',
        'Por debajo de la lesión se pierden la fuerza, el dolor y la temperatura.',
        'Se conservan la propiocepción, la vibración y el tacto fino.',
        'El hallazgo que lo delata: no mueve ni siente el pinchazo, pero sabe en qué posición está su dedo del pie con los ojos cerrados.',
        'Se produce por compresión directa de la parte anterior —fragmento óseo o discal, luxación— o por compromiso del flujo sanguíneo de ese territorio.',
        'Mecanismos típicos: flexión con carga axial e hiperflexión.',
        'Comparado con el posterior, que pierde la propiocepción y conserva lo demás.',
        'Y con Brown-Séquard, que pierde motor y propiocepción del mismo lado y dolor y temperatura del contrario.',
        'Es el síndrome medular incompleto de peor pronóstico funcional.',
        'Manejo: restricción espinal, movilización en bloque, exploración documentada, vigilancia de la ventilación, búsqueda de shock neurogénico sin descuidar la hemorragia, prevención de hipotermia y traslado neuroquirúrgico.',
      ]),
      preguntasOrales([
        'Di qué se pierde y qué se conserva en el síndrome medular anterior.',
        '¿Qué vías viajan por delante y cuáles por detrás de la médula?',
        '¿Cuál es el hallazgo que delata el síndrome?',
        '¿Por qué solo aparece si exploras la sensibilidad profunda?',
        'Explica su mecanismo y su relación con la irrigación medular.',
        'Diferéncialo del síndrome posterior y del de Brown-Séquard.',
        '¿Qué pronóstico funcional tiene, comparado con los otros?',
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA MÉDULA NO LLEGA AL FINAL. Termina en la región lumbar alta y a partir de ahí el canal solo contiene raíces: por eso esto no es una lesión medular en sentido estricto, es una lesión de raíces, y su comportamiento clínico es distinto.'),
          masPreguntado('La pregunta que no se hace y debería hacerse: un paciente con dolor lumbar rara vez cuenta por iniciativa propia que no puede orinar o que no nota el papel al limpiarse. Preguntarlo de forma directa y respetuosa es lo que separa un lumbago de una urgencia quirúrgica.'),
        ],
      },
      erroresFrecuentes([
        ['Escribir «causa equina»', 'Es la errata del plan. El término correcto es cauda equina —cola de caballo—, por el aspecto del haz de raíces. La errata se conserva solo en el título documental.'],
        ['No preguntar por esfínteres ni por sensibilidad perineal', 'El paciente no lo cuenta por iniciativa propia. Se pregunta de forma directa y respetuosa, se documenta lo que responde y se preserva su intimidad.'],
        ['Prealertar como «dolor lumbar»', 'La recuperación depende de lo pronto que se descomprimen las raíces: este cuadro se comunica de forma explícita en la prealerta.'],
        ['Sondar al paciente', 'La valoración urológica corresponde al hospital; el sondaje no es una conducta de esta lección.'],
      ]),
      repasoRapido([
        'El plan escribe «causa equina»; el término correcto es cauda equina.',
        'La médula termina en la región lumbar alta; a partir de ahí el canal contiene solo raíces nerviosas.',
        'Ese haz es la cauda equina, y su lesión es de raíces y no medular en sentido estricto.',
        'Se busca dolor lumbar intenso que puede irradiar a una o ambas piernas.',
        'Debilidad de los miembros inferiores, a menudo asimétrica.',
        'Alteración de la sensibilidad en silla de montar: periné, región genital, cara interna de los muslos y zona perianal.',
        'Retención urinaria o incapacidad de iniciar la micción, y después incontinencia por rebosamiento.',
        'Pérdida del control del esfínter anal y disfunción sexual de aparición reciente.',
        'En trauma se produce por fractura o luxación lumbar, desplazamiento de un fragmento o hematoma en el canal.',
        'También hay causas no traumáticas —hernia discal masiva, tumor, infección— sin antecedente de golpe.',
        'Es una urgencia dependiente del tiempo: la recuperación depende de lo pronto que se descomprimen las raíces.',
        'Conducta: restricción espinal si procede, exploración documentada, registro explícito de esfínteres y sensibilidad perineal, analgesia según alcance, no sondar y prealerta nombrando la sospecha.',
      ]),
      preguntasOrales([
        '¿Qué es la cauda equina y por qué su lesión no es medular?',
        '¿Cómo se escribe, y qué escribe el plan?',
        'Enumera lo que se busca en este cuadro.',
        '¿Qué es la anestesia en silla de montar?',
        '¿Qué preguntas hay que hacer, y por qué no las cuenta el paciente?',
        '¿Por qué corre prisa?',
        '¿Qué causas no traumáticas producen el mismo cuadro?',
        'Recorre la conducta prehospitalaria.',
      ]),
      F([PHTLS_COLUMNA, ACS_BEST, WHO_BEC]),
    ],
