    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('TRANSPORTA, DEFIENDE Y TAPONA: eritrocitos que transportan oxígeno, leucocitos que defienden, plaquetas que taponan, y un plasma que lleva a todos. Y en la hemostasia, las plaquetas ponen el tapón y las proteínas del plasma lo consolidan.'),
          masPreguntado('Que el tapón inicial y su consolidación tienen requisitos distintos. El tapón inicial depende de las plaquetas; su consolidación depende de las proteínas del plasma, que fabrica el hígado. Por eso un problema de plaquetas y un problema de coagulación no son lo mismo, aunque los dos se manifiesten como tendencia al sangrado.'),
        ],
      },
      erroresFrecuentes([
        ['Tratar la sangre como un líquido y no como un tejido', 'Se clasifica como tejido conjuntivo aunque su matriz sea líquida. Tiene una parte líquida, el plasma, y elementos formes que son células y fragmentos celulares suspendidos en él.'],
        ['Atribuir al eritrocito capacidades que perdió al madurar', 'Pierde el núcleo al madurar y su interior queda casi por completo ocupado por el pigmento que transporta oxígeno. Sacrificó la capacidad de dividirse y renovarse a cambio de máxima capacidad de carga.'],
        ['Suponer que cada línea celular tiene un origen propio e independiente', 'Todas proceden de una célula precursora común capaz de originar cualquiera de las líneas. Por eso una alteración de la médula ósea puede afectar a varias líneas a la vez.'],
        ['Confundir el papel de las plaquetas con el de las proteínas de la coagulación', 'Las plaquetas se adhieren y se agregan formando el tapón inicial, que es frágil. La cadena de proteínas del plasma forma la red de fibras que atrapa células y convierte ese tapón en estable.'],
      ]),
      repasoRapido([
        'La sangre se clasifica como tejido conjuntivo, con una parte líquida —el plasma— y elementos formes suspendidos en él.',
        'El plasma es agua con proteínas, electrolitos, nutrientes, gases y desechos disueltos; sus proteínas sostienen la presión oncótica y participan en la coagulación y la defensa.',
        'Los eritrocitos son células sin núcleo cargadas de un pigmento que se une al oxígeno, y lo transportan hacia los tejidos.',
        'Los leucocitos son células con núcleo, de varios tipos, y se encargan de la defensa frente a microorganismos y de participar en la inflamación.',
        'Las plaquetas son fragmentos celulares sin núcleo que inician la detención de una hemorragia formando un tapón inicial.',
        'El plasma es el compartimiento intravascular de la lección de líquidos y electrolitos, mirado ahora desde la sangre.',
        'La producción de células sanguíneas ocurre en la médula ósea, contenida en el interior de determinados huesos.',
        'Todas las líneas proceden de una célula precursora común, y la producción es continua porque las células sanguíneas tienen vida limitada.',
        'La producción se ajusta a la demanda, y el riñón participa en ese ajuste produciendo una sustancia que estimula la formación de eritrocitos.',
        'Ante una lesión, el vaso reduce su calibre y disminuye el flujo por la zona.',
        'Las plaquetas se adhieren y se agregan formando un tapón inicial, y después una cadena de proteínas del plasma forma una red de fibras que lo consolida.',
        'Cuando el vaso se ha reparado, el organismo disuelve la red y restablece el flujo.',
      ]),
      preguntasOrales([
        'Distingue el plasma de los elementos formes y di qué contiene cada parte.',
        'Relaciona cada tipo de célula sanguínea con su función.',
        'Explica por qué el eritrocito es un caso extremo del principio estructura-función.',
        '¿Dónde se producen las células de la sangre y a partir de qué?',
        '¿Por qué una alteración de la médula ósea puede afectar a varias líneas celulares a la vez?',
        'Ordena los pasos de la detención de una hemorragia.',
        'Explica la diferencia entre un problema de plaquetas y un problema de coagulación.',
        'Relaciona esta lección con la del sistema óseo y con la del sistema urinario.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL DESAGÜE DEL INTERSTICIO: el linfático no es un circuito cerrado, es un drenaje que empieza en los tejidos y desemboca en las venas grandes del tórax. Y en la defensa: la innata responde igual ante todos y no recuerda; la adaptativa reconoce y recuerda.'),
          masPreguntado('Qué aporta la memoria de la respuesta adaptativa. Que guarde memoria significa que un segundo encuentro con el mismo agresor se resuelve más rápido y con menos daño. Es el fundamento de la inmunidad adquirida tras pasar una enfermedad y el principio en que se basa la vacunación.'),
        ],
      },
      erroresFrecuentes([
        ['Pensar el sistema linfático como un circuito cerrado igual que el sanguíneo', 'No lo es: es un sistema de drenaje que empieza en los tejidos, recoge el excedente de líquido del intersticio y termina desembocando en las venas grandes del tórax.'],
        ['Buscarle al sistema linfático una bomba propia', 'No tiene ninguna. La linfa avanza por la contracción de los músculos que rodean los vasos, por los cambios de presión que produce la respiración en el tórax y por válvulas internas que impiden el retroceso.'],
        ['Atribuir a la vía innata capacidad de reconocer agresores concretos', 'La innata responde igual ante cualquier agresor, actúa de inmediato y no guarda memoria. Reconocer agresores concretos y guardar memoria es propio de la adaptativa, que es más lenta la primera vez.'],
        ['Olvidar que la primera línea de defensa es anatómica', 'La piel y las mucosas, estudiadas en la lección del tegumento como barrera, son parte de la defensa innata. La primera línea del organismo no es inmunológica en sentido estricto: es anatómica.'],
      ]),
      repasoRapido([
        'En el capilar sale algo más líquido del que vuelve a entrar, y ese excedente quedaría acumulado en el intersticio si nada lo recogiera.',
        'El sistema linfático recoge ese excedente, lo llama linfa y lo devuelve a la circulación sanguínea.',
        'No es un circuito cerrado, sino un sistema de drenaje que empieza en los tejidos y desemboca en las venas grandes del tórax.',
        'La linfa avanza sin bomba propia: por la contracción de los músculos que rodean los vasos, por los cambios de presión de la respiración y por válvulas que dan un solo sentido al flujo.',
        'El sistema linfático transporta además parte de las grasas absorbidas en el intestino y aloja a las células de la defensa.',
        'Los ganglios linfáticos filtran la linfa y albergan células de defensa, y se distribuyen a lo largo de los vasos linfáticos.',
        'El bazo filtra la sangre, retira eritrocitos envejecidos y participa en la respuesta inmunitaria.',
        'El timo madura una de las líneas de células de defensa y es prominente en la infancia.',
        'Las amígdalas y el tejido linfoide de las mucosas vigilan las puertas de entrada del organismo.',
        'Un ganglio aumenta de tamaño cuando la actividad de defensa en su territorio de drenaje aumenta, y como cada uno drena una región concreta, su localización orienta sobre dónde ocurre esa actividad.',
        'La defensa innata responde igual ante cualquier agresor, es inmediata, no guarda memoria e incluye barreras como la piel y las mucosas, la inflamación y células que engloban microorganismos.',
        'La defensa adaptativa reconoce agresores concretos, es más lenta la primera vez, guarda memoria y actúa mediante células que reconocen y proteínas dirigidas contra ellos.',
      ]),
      preguntasOrales([
        'Explica de dónde sale la linfa y por qué hace falta una segunda red además de la sanguínea.',
        '¿Por qué se dice que el sistema linfático es un drenaje y no un circuito cerrado?',
        'Enumera los tres mecanismos que hacen avanzar la linfa sin una bomba propia.',
        'Relaciona ganglios, bazo, timo y tejido linfoide de las mucosas con su función.',
        '¿Por qué la localización de un ganglio agrandado orienta sobre dónde ocurre la actividad de defensa?',
        'Compara la defensa innata y la adaptativa en especificidad, rapidez y memoria.',
        'Explica qué cambia la memoria inmunitaria en un segundo encuentro con el mismo agresor.',
        '¿Por qué la piel y las mucosas se cuentan como parte de la defensa innata?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('GÓNADAS, VÍAS Y GLÁNDULAS: los dos sistemas comparten esa organización, y reconocerla evita estudiarlos como dos listas independientes. Gónadas que producen células y hormonas, vías que conducen, glándulas que aportan secreciones.'),
          masPreguntado('Que la fecundación suele ocurrir en la trompa uterina y no en el útero. La célula liberada por el ovario es recogida por la trompa y avanza por ella hacia el útero, y ese trayecto es donde suele encontrarse con la célula masculina. Es una consecuencia directa de la anatomía del recorrido.'),
        ],
      },
      erroresFrecuentes([
        ['Estudiar los dos sistemas como dos listas sin relación', 'Comparten la organización en tres tipos de elemento: gónadas que producen células reproductoras y hormonas, vías que las conducen, y glándulas accesorias o estructuras asociadas que aportan secreciones o funciones complementarias.'],
        ['Ver la posición del escroto como un detalle anatómico curioso', 'La producción de células reproductoras requiere una temperatura menor que la interna, y el escroto la proporciona al alojar los testículos fuera de la cavidad corporal. La posición de un órgano puede ser en sí misma una función.'],
        ['Situar la fecundación en el útero', 'Suele ocurrir en la trompa uterina, que recoge la célula liberada por el ovario y la conduce hacia el útero. El útero aloja y sostiene el desarrollo, que es una función distinta.'],
        ['Adelantar aquí el embarazo, el parto y sus complicaciones', 'Esta lección establece estructura y función. El embarazo, sus cambios fisiológicos, la atención al parto y sus complicaciones pertenecen al Módulo 4, donde el plan sitúa las urgencias gineco-obstétricas, y al Módulo 6.'],
      ]),
      repasoRapido([
        'Ambos sistemas reproductores se organizan en gónadas, vías y glándulas accesorias o estructuras asociadas.',
        'Las gónadas hacen dos cosas: producen células reproductoras y producen hormonas sexuales; por eso el sistema reproductor aparece también en la lección del sistema endocrino.',
        'Los testículos producen las células reproductoras masculinas y la hormona sexual masculina.',
        'El escroto aloja los testículos fuera de la cavidad corporal, lo que mantiene una temperatura menor que la interna.',
        'El epidídimo almacena y madura las células reproductoras y el conducto deferente las conduce hacia la uretra.',
        'Las vesículas seminales y la próstata aportan secreciones que forman parte del semen, y el pene y la uretra son la vía común de salida de orina y semen.',
        'Los ovarios producen las células reproductoras femeninas y las hormonas sexuales femeninas.',
        'Las trompas uterinas recogen la célula liberada por el ovario y la conducen hacia el útero, y son donde suele ocurrir la fecundación.',
        'El útero aloja y sostiene el desarrollo, y su capa muscular, que es músculo liso, es la que se contrae en el parto.',
        'La vagina es la vía de salida y de comunicación con el exterior, y la vulva y las glándulas vestibulares son las estructuras externas y secreciones asociadas.',
        'El ciclo reproductor femenino empieza con la menstruación, sigue con la maduración de una célula en el ovario y el engrosamiento de la capa interna del útero, y continúa con la ovulación.',
        'Tras la ovulación la capa interna completa su preparación, y si no hay embarazo la preparación se interrumpe y comienza de nuevo la menstruación.',
      ]),
      preguntasOrales([
        'Explica la organización común en gónadas, vías y glándulas y di qué corresponde a cada una en el varón y en la mujer.',
        '¿Cuáles son las dos funciones de las gónadas y qué consecuencia tiene esa doble función?',
        '¿Por qué los testículos están alojados fuera de la cavidad corporal?',
        'Relaciona cada órgano reproductor femenino con su función.',
        '¿Qué tipo de músculo forma la capa muscular del útero y qué produce en el parto?',
        'Ordena las fases del ciclo reproductor femenino.',
        'Explica por qué la fecundación suele ocurrir en la trompa uterina y no en el útero.',
        '¿Qué parte del estudio del sistema reproductor deja esta lección para los módulos 4 y 6?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('TODOS TRADUCEN, LA VÍA DECIDE: cada receptor convierte una forma de energía en potenciales de acción, y todos los potenciales de acción son iguales. Que una señal se interprete como luz y otra como sonido depende de la vía y de la región del cerebro que la recibe.'),
          masPreguntado('Que la especificidad no está en la señal sino en la vía. Todos los receptores producen potenciales de acción, y un potencial de acción es igual venga de donde venga; lo que distingue luz de sonido es el camino por el que llega y la región del cerebro que lo recibe.'),
        ],
      },
      erroresFrecuentes([
        ['Creer que la señal de cada sentido es de un tipo distinto', 'Todos los receptores producen potenciales de acción, y son iguales venga de donde vengan. La diferencia está en la vía por la que llegan y en la región del cerebro que los recibe.'],
        ['Atribuir el enfoque del ojo a una sola estructura', 'La córnea empieza a desviar la luz para enfocarla y el cristalino ajusta el enfoque según la distancia del objeto. El iris no enfoca: regula el tamaño de la pupila y con ello cuánta luz entra.'],
        ['Tratar el oído como un órgano de una sola función', 'Aloja dos sistemas que comparten localización y no función: la parte auditiva detecta vibraciones del aire y la parte vestibular detecta la posición y el movimiento de la cabeza. Compartir sede explica que puedan alterarse a la vez.'],
        ['Ver el dolor solo como una molestia', 'Los receptores que producen dolor informan de que un tejido está siendo dañado o está en riesgo. Funcionalmente es un sistema de aviso: su localización y su carácter señalan de dónde procede el problema.'],
      ]),
      repasoRapido([
        'Todos los órganos de los sentidos hacen lo mismo: convertir una forma de energía del entorno en una señal nerviosa que el sistema nervioso pueda interpretar.',
        'Las células que realizan esa conversión son los receptores, y cada tipo responde a una forma de energía concreta.',
        'El ojo detecta luz, la parte auditiva del oído detecta vibraciones del aire y la parte vestibular detecta posición y movimiento de la cabeza.',
        'La lengua detecta sustancias químicas disueltas, la mucosa olfatoria las detecta volátiles y la piel detecta contacto, presión, temperatura y estímulos que dañan el tejido.',
        'La señal es siempre la misma: lo que cambia es la vía por la que llega y la región del cerebro que la recibe.',
        'En el ojo, la córnea empieza a desviar la luz, el iris regula el tamaño de la pupila, el cristalino ajusta el enfoque y la retina contiene los receptores.',
        'El nervio óptico conduce la señal desde la retina hacia el cerebro.',
        'El tamaño de la pupila depende del iris, controlado por el sistema autónomo: el simpático la dilata y el parasimpático la contrae.',
        'El sonido recorre oreja y conducto auditivo, hace vibrar una membrana, se amplifica en la cadena de huesecillos del oído medio y pone en movimiento el líquido del oído interno, que estimula los receptores.',
        'La parte vestibular contiene estructuras con líquido y receptores que informan de la orientación del cuerpo en el espacio.',
        'El gusto detecta sustancias químicas disueltas en contacto con la lengua y el olfato las detecta volátiles en el aire inspirado; están relacionados, y por eso el sabor se altera cuando el olfato está bloqueado.',
        'Entre los receptores de la piel están los que detectan estímulos capaces de dañar el tejido, que producen la sensación de dolor.',
      ]),
      preguntasOrales([
        'Explica qué hace un receptor sensorial y por qué todos comparten el mismo principio.',
        'Relaciona cada órgano o receptor con la forma de energía que detecta.',
        '¿Por qué una señal se interpreta como luz y otra como sonido, si el potencial de acción es igual?',
        'Recorre las estructuras del ojo diciendo qué función cumple cada una en el camino de la luz.',
        '¿Qué controla el tamaño de la pupila y qué efecto tiene cada división del sistema autónomo sobre ella?',
        'Ordena el recorrido del sonido desde la oreja hasta el nervio.',
        'Distingue la parte auditiva de la vestibular del oído y di qué informa cada una.',
        'Explica en qué sentido el dolor es información y no solo una molestia.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL MENSAJE LLEGA A TODOS Y SOLO LO ENTIENDE QUIEN TIENE EL LECTOR: la sangre lleva la hormona a todas partes, pero solo actúa donde hay células con el receptor capaz de reconocerla. Sin receptor no hay efecto, aunque la hormona esté presente.'),
          masPreguntado('El circuito de retroalimentación negativa. El resultado de una acción frena la señal que la produjo: la variable se aleja de su valor habitual, la glándula lo detecta y libera la hormona, la hormona corrige, la glándula detecta la corrección y reduce la liberación. Es el mecanismo general que sostiene casi toda la fisiología del módulo.'),
        ],
      },
      erroresFrecuentes([
        ['Suponer que una hormona afecta a todo el cuerpo porque viaja por la sangre', 'La sangre la lleva a todas partes, pero solo actúa donde hay células con el receptor capaz de reconocerla. Sin receptor no hay efecto, aunque la hormona esté presente.'],
        ['Presentar los dos sistemas de comunicación como independientes', 'El hipotálamo pertenece al sistema nervioso y gobierna al endocrino a través de la hipófisis. Esa bisagra explica que una situación percibida por el sistema nervioso produzca una respuesta hormonal sostenida.'],
        ['Atribuir a las glándulas suprarrenales un solo ritmo de respuesta', 'Producen tanto mensajeros de acción rápida, que colaboran con el sistema nervioso simpático, como hormonas de acción sostenida. Un mismo órgano participa en los dos ritmos de respuesta del organismo.'],
        ['Convertir esta lección en el estudio de las enfermedades endocrinas', 'Aquí importa por qué existe el circuito, no qué ocurre cuando falla. Las enfermedades endocrinas, sus manifestaciones y su tratamiento pertenecen al Módulo 4, donde el plan sitúa las urgencias metabólicas.'],
      ]),
      repasoRapido([
        'El sistema nervioso envía señales eléctricas por vías definidas y produce efectos rápidos, localizados y breves.',
        'El sistema endocrino libera hormonas a la sangre, que las reparte por todo el cuerpo, con efectos más lentos y más duraderos.',
        'El alcance endocrino es general pero selectivo: la hormona solo actúa donde hay células con el receptor capaz de reconocerla.',
        'El hipotálamo enlaza el sistema nervioso con el endocrino y controla la hipófisis.',
        'La hipófisis coordina a otras glándulas mediante hormonas que las estimulan, y regula además crecimiento y balance de agua.',
        'La tiroides regula el ritmo del metabolismo y las paratiroides regulan la concentración de calcio.',
        'Las glándulas suprarrenales regulan la respuesta al estrés, el balance de agua y sales y la respuesta rápida de alerta.',
        'El páncreas endocrino regula la concentración de glucosa en la sangre y las gónadas regulan funciones reproductoras y caracteres sexuales.',
        'Las suprarrenales producen mensajeros de acción rápida, que colaboran con el simpático, y hormonas de acción sostenida.',
        'El sistema endocrino funciona en circuitos que se corrigen a sí mismos, y el mecanismo dominante es la retroalimentación negativa.',
        'En ese circuito, la variable se aleja de su valor habitual, la glándula lo detecta y libera la hormona, la hormona corrige, la glándula detecta la corrección y reduce la liberación.',
        'Mantener una variable dentro de un margen es la tarea de fondo de casi toda la fisiología, y la retroalimentación negativa es el mecanismo general que lo hace posible.',
      ]),
      preguntasOrales([
        'Compara el sistema nervioso y el endocrino en qué envían, por dónde, con qué rapidez y con qué duración.',
        '¿Por qué una hormona no afecta a todas las células si la sangre la lleva a todas partes?',
        'Relaciona cada glándula con la función que regula.',
        'Explica por qué el hipotálamo es la bisagra entre los dos sistemas de comunicación.',
        '¿Por qué se dice que las glándulas suprarrenales participan en los dos ritmos de respuesta del organismo?',
        'Ordena los pasos de un circuito de retroalimentación negativa.',
        'Da ejemplos de otras lecciones del módulo donde una variable se mantiene dentro de un margen.',
        '¿Qué parte del estudio del sistema endocrino deja esta lección para el Módulo 4?',
      ]),
