    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('MIRAR, TOCAR, GOLPEAR, ESCUCHAR. Inspección, palpación, percusión y auscultación, en ese orden, porque cada maniobra prepara la siguiente y altera lo menos posible al paciente. Y siempre comparando: un lado contra el otro, y este momento contra el anterior.'),
          masPreguntado('La cuarta pregunta, que es la que más se olvida: ¿ha cambiado algo desde la exploración anterior? Una exploración de tórax aislada vale poco; una serie vale mucho. El dato útil no suele ser el hallazgo, sino su cambio.'),
        ],
      },
      erroresFrecuentes([
        ['Auscultar sobre la ropa', 'Introduce ruidos que se confunden con hallazgos. Y auscultar un solo punto por hemitórax no permite concluir simetría.'],
        ['Dar por buena una exploración normal como si excluyera un problema', 'Una exploración normal describe este momento, no el siguiente.'],
        ['Explorar y no registrar el hallazgo con la hora', 'Sin hora no se puede demostrar un cambio, y el cambio es el dato.'],
        ['Sustituir la exploración por el número de un dispositivo', 'Los monitores aportan datos, pero no dicen si el murmullo es simétrico. Y ninguna secuencia ordenada justifica retrasar una intervención que el cuadro exige.'],
      ]),
      repasoRapido([
        'Una exploración dirigida no es incompleta: responde preguntas concretas que la evaluación ya planteó, y termina cuando las ha contestado.',
        'Las preguntas: si entra y sale aire de ambos hemitórax, cómo es el esfuerzo, si hay una causa que resolver de inmediato y qué ha cambiado.',
        'Inspección: postura, si puede hablar y en qué frases, coloración, músculos accesorios, tiraje, simetría, deformidades, heridas y distensión venosa del cuello.',
        'Palpación: simetría de la expansión, puntos dolorosos, crepitación de la pared, inestabilidad costal y posición de la tráquea.',
        'Percusión: comparación de la resonancia entre hemitórax; más resonante sugiere aire, mate sugiere líquido o consolidación.',
        'Auscultación: campo por campo y lado por lado, con presencia y simetría del murmullo y la fase en que aparecen los ruidos agregados.',
        'Casi toda la información útil es comparativa.',
        'El murmullo disminuido en un hemitórax es común a varias causas: no dice cuál.',
        'No toda sibilancia es asma, y el estridor señala la vía aérea superior, no la inferior.',
        'La inspección es la que más rinde en el peor entorno; percusión y auscultación son las más degradadas por el ruido.',
        'Se ausculta antes de subir al paciente siempre que la urgencia lo permita, y se repite en cada parada.',
        'Los hallazgos abren hipótesis sindrómicas: la confirmación exige estudios que no viajan en la ambulancia.',
      ]),
      preguntasOrales([
        '¿Qué significa que una exploración sea dirigida?',
        'Enumera las preguntas que viene a contestar.',
        '¿Cuál es la que más se olvida, y por qué importa?',
        'Recorre las cuatro maniobras en orden y di qué se busca en cada una.',
        '¿Por qué comparar es la maniobra?',
        '¿Qué sugiere un murmullo disminuido, y qué no permite concluir?',
        '¿Qué maniobras degrada más el entorno, y qué se hace al respecto?',
        'Di los errores frecuentes de esta exploración.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('PRIMERO SOSTENER, DESPUÉS BUSCAR LA CAUSA. Es un síndrome, no una enfermedad: la vía final común de causas muy distintas. Dedicar la escena a averiguar la entidad antes de sostener al paciente es un error de secuencia con consecuencias reales.'),
          masPreguntado('El paciente que «se ha calmado»: con dificultad respiratoria grave, de pronto parece tranquilo, deja de luchar y se vuelve somnoliento. Rara vez ha mejorado; con mucha frecuencia se está agotando, y leer esa calma como mejoría es uno de los errores más graves del cuadro.'),
        ],
      },
      erroresFrecuentes([
        ['Interpretar la calma como mejoría', 'Un paciente que deja de luchar y se vuelve somnoliento con frecuencia se está agotando. Espaciar la vigilancia ahí es el error más grave del cuadro.'],
        ['Buscar la entidad antes de sostener al paciente', 'El orden es reconocer que la respiración es insuficiente y sostenerla, y después buscar la causa.'],
        ['Etiquetar en vez de describir', '«Habla en palabras sueltas, usa músculos accesorios y está somnoliento» transmite más y compromete menos que una etiqueta, que puede arrastrar al equipo receptor hacia una entidad equivocada.'],
        ['Dar una intervención por terminada sin comprobar su efecto', 'Después de cada acción se comprueba si el paciente mejoró, siguió igual o empeoró. Una intervención sin comprobación no está terminada.'],
      ]),
      repasoRapido([
        'La insuficiencia respiratoria es una situación funcional: el intercambio de gases ha dejado de ser suficiente.',
        'Es la vía final común de causas de la vía aérea, del pulmón, de la pleura, de la pared, de la circulación, del sistema nervioso o de un tóxico.',
        'Fallo de la oxigenación: paciente angustiado, taquipneico, con esfuerzo evidente y alteración de la coloración.',
        'Fallo de la ventilación: somnolencia, confusión, cefalea, respiración superficial o lenta, esfuerzo que disminuye sin mejorar.',
        'Coexisten con frecuencia, y la transición de uno a otro es el momento más peligroso del cuadro.',
        'Trabajo aumentado: postura sentada e inclinada, habla entrecortada, músculos accesorios, tiraje, respiración rápida y superficial.',
        'Claudicación: agitación y después somnolencia, esfuerzo que disminuye sin mejoría, respiración lenta o irregular.',
        'También ruidos que casi desaparecen mientras el cuadro empeora, y silencio en un paciente que antes se quejaba.',
        'Esta lección no publica objetivos de saturación, frecuencias de corte ni dosis: proceden de la guía y del protocolo.',
        'Prioridades: seguridad, vía aérea, posición que el paciente adopte, oxígeno titulado, ventilación asistida si no basta.',
        'Y buscar causas que cambien la conducta, trasladar sin demora, prealertar y reevaluar con registro horario.',
        'El informe se organiza por la trayectoria: cómo estaba al llegar y cómo está ahora.',
      ]),
      preguntasOrales([
        'Distingue dificultad respiratoria de insuficiencia respiratoria.',
        'Diferencia el fallo de la oxigenación del de la ventilación por cómo se manifiestan.',
        '¿Por qué la transición entre ambos es el momento más peligroso?',
        'Enumera los signos de trabajo respiratorio aumentado.',
        'Di los signos de claudicación inminente.',
        '¿Qué significa un paciente que de pronto se ha calmado?',
        'Recorre las prioridades de estabilización.',
        '¿Por qué describir en vez de etiquetar?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA REFERENCIA ES SU PROPIO ESTADO BASAL. La exacerbación se define como empeoramiento respecto de lo habitual del paciente, así que la información del enfermo y de su acompañante vale tanto como la exploración.'),
          masPreguntado('La oxigenoterapia controlada y su matiz: la hipoxemia grave NO se deja sin tratar por temor a la retención de dióxido de carbono, porque no tratarla es peligroso; pero el oxígeno se administra con un objetivo declarado y titulado, no «al máximo por si acaso».'),
        ],
      },
      erroresFrecuentes([
        ['Administrar oxígeno «al máximo por si acaso»', 'En un grupo de estos pacientes puede empeorar la retención de dióxido de carbono y deteriorar el estado de alerta. Se administra con objetivo declarado y titulado a la respuesta.'],
        ['Dejar sin tratar una hipoxemia grave por temor al dióxido de carbono', 'No tratarla es peligroso. El objetivo es más conservador que en otras urgencias respiratorias, no la abstención.'],
        ['Leer la somnolencia como cansancio o como mejoría de la agitación', 'Puede traducir que la ventilación se ha vuelto insuficiente: obliga a extremar la vigilancia.'],
        ['Atribuir todo hallazgo a la enfermedad de base', 'Un paciente con EPOC puede tener otra causa de disnea añadida. Una asimetría del murmullo o unos crepitantes no se dan por explicados por su enfermedad.'],
      ]),
      repasoRapido([
        'La EPOC cursa con limitación persistente del flujo aéreo y síntomas respiratorios mantenidos.',
        'Una exacerbación es el empeoramiento agudo respecto del estado basal del propio paciente.',
        'Se pregunta cómo respira habitualmente y qué ha cambiado, desde cuándo y si fue progresivo o brusco.',
        'También si aumentó la expectoración y cambió su aspecto, y qué tratamiento inhalado usa y cuántas veces hoy.',
        'Y si usa oxígeno domiciliario y a qué flujo, y si tuvo ingresos previos o requirió soporte ventilatorio.',
        'El oxígeno domiciliario es un dato clínico: indica enfermedad avanzada y da una referencia del estado basal.',
        'La gravedad se mide por cuánto se ha alejado de su basal y por los signos de claudicación.',
        'Indican gravedad: no completar frases, músculos accesorios y tiraje intensos, alteración del alerta.',
        'También el esfuerzo que disminuye sin mejorar, los ruidos que casi desaparecen y la falta de respuesta al inhalador propio.',
        'La oxigenoterapia se titula con un objetivo más conservador que en otras urgencias respiratorias.',
        'El objetivo numérico procede de la guía vigente y queda declarado como deuda de esta lección.',
        'El salbutamol figura en la dotación mínima de urgencias básicas, pero la dotación no da la indicación ni la dosis.',
      ]),
      preguntasOrales([
        '¿Qué es la EPOC y qué define una exacerbación?',
        'Enumera lo que se pregunta para situar la exacerbación.',
        '¿Por qué el oxígeno domiciliario es un dato clínico?',
        '¿Cómo se mide la gravedad aquí?',
        'Di los signos que la indican.',
        'Explica por qué la oxigenoterapia se administra de forma controlada.',
        '¿Se deja sin tratar una hipoxemia grave? Justifícalo.',
        '¿Qué significa la somnolencia en este paciente?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL DECÚBITO LO EMPEORA. Tumbado aumenta el retorno venoso hacia un corazón que ya no puede manejarlo, y la congestión pulmonar se agrava. Por eso estos pacientes se sientan solos, y por eso acostarlos para explorarlos puede empeorarlos de inmediato.'),
          masPreguntado('La combinación que cambia la recepción: congestión más estado de perfusión. Un paciente congestivo y mal perfundido —frío, moteado, con el sensorio alterado— es mucho más grave que el que solo está congestivo, y transmitirlo en la prealerta es una de las aportaciones más útiles del prestador.'),
        ],
      },
      erroresFrecuentes([
        ['Acostar al paciente para explorarlo', 'En decúbito aumenta el retorno venoso y la congestión se agrava. Se permite e incluso se favorece la posición incorporada.'],
        ['Aportar volumen sin indicación', 'En un paciente congestivo puede agravarlo. Cualquier decisión sobre fluidos corresponde al protocolo y a la dirección médica.'],
        ['Forzar una etiqueta cuando la impresión no es clara', 'El edema cardiogénico y otras causas de crepitantes no siempre se distinguen en la calle, y a veces coexisten. Se sostiene al paciente, se registra lo observado y se traslada.'],
        ['Vigilar solo la respiración', 'Este cuadro puede evolucionar a compromiso circulatorio: se vigila también la perfusión.'],
      ]),
      repasoRapido([
        'En el edema cardiogénico el corazón izquierdo no maneja la sangre que le llega y la presión se transmite hacia atrás.',
        'El líquido pasa del capilar al intersticio y después al alveolo, que ocupado no intercambia gases.',
        'En decúbito aumenta el retorno venoso y la congestión se agrava: de ahí la ortopnea.',
        'Existen otras causas de ocupación alveolar en que el problema es la permeabilidad del capilar, no la presión de retorno.',
        'Presentación: disnea rápida que empeora acostado, angustia intensa, trabajo respiratorio evidente.',
        'También crepitantes en ambos hemitórax, expectoración espumosa a veces rosada y piel fría y sudorosa.',
        'Con frecuencia hay antecedentes cardiacos, tratamiento diurético o episodios previos similares.',
        'Gravedad: no hablar en frases, alteración del alerta, esfuerzo que disminuye sin mejorar.',
        'También hipoperfusión, dolor torácico asociado —que abre la posibilidad de un síndrome coronario— y arritmia.',
        'Congestión con hipoperfusión es un enfermo mucho más grave, y su manejo cambia.',
        'Conducta: posición incorporada, oxígeno titulado, vigilancia de la perfusión, monitorización según equipo.',
        'Prudencia con los líquidos, traslado sin demora con prealerta, y reevaluación con registro horario.',
      ]),
      preguntasOrales([
        'Explica el mecanismo del edema pulmonar cardiogénico.',
        '¿Por qué empeora al acostarse?',
        '¿Qué otras causas de ocupación alveolar existen, y en qué se diferencian?',
        'Enumera la presentación habitual.',
        'Di los signos de gravedad.',
        '¿Qué significa congestión con hipoperfusión?',
        'Recorre la conducta prehospitalaria.',
        '¿Qué transmites en la prealerta?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('ESPONTÁNEO DESCRIBE EL ORIGEN, NO LA GRAVEDAD. Un espontáneo secundario en un paciente con reserva pulmonar reducida puede dar un cuadro grave con un volumen de aire que en otra persona apenas daría síntomas.'),
          masPreguntado('Que reconocer no es lo mismo que intervenir: la descompresión torácica es un procedimiento invasivo cuya autorización, material, sitio anatómico y respaldo dependen del alcance profesional y del protocolo, y esta lección no lo describe ni lo autoriza.'),
        ],
      },
      erroresFrecuentes([
        ['Leer «espontáneo» como leve', 'La palabra describe el origen. En un paciente con reserva pulmonar reducida puede producir un cuadro grave.'],
        ['Esperar la desviación traqueal', 'Es un signo tardío y su ausencia no descarta nada. Igual que la distensión venosa del cuello, que puede faltar si además hay hipovolemia.'],
        ['Concluir el diagnóstico con la exploración', 'Un murmullo disminuido con hiperresonancia es sugestivo, pero la confirmación y la medición del tamaño exigen imagen.'],
        ['Trasladar conclusiones del trauma a este cuadro', 'El neumotórax traumático comparte el mecanismo físico pero pertenece a otro bloque, con su propia valoración y sus propias fuentes.'],
      ]),
      repasoRapido([
        'Un neumotórax es aire en el espacio pleural, que colapsa el pulmón y reduce la superficie de intercambio.',
        'Espontáneo es el que aparece sin traumatismo que lo explique.',
        'Primario: en personas sin enfermedad pulmonar conocida, clásicamente jóvenes, altos y delgados, con relación con el tabaquismo.',
        'Secundario: en pacientes con enfermedad pulmonar de base.',
        'Espontáneo describe el origen, no la gravedad.',
        'Presentación: dolor torácico súbito de características pleuríticas y disnea brusca de intensidad variable.',
        'En la exploración: murmullo disminuido o ausente e hiperresonancia de ese lado, con expansión asimétrica.',
        'La sospecha aumenta en el perfil descrito, en el paciente con enfermedad pulmonar y con episodios previos.',
        'Cuando el aire entra y no sale, se acumula a presión: el pulmón colapsa, el mediastino se desplaza y se compromete el retorno venoso.',
        'Esa forma deja de ser respiratoria y pasa a ser circulatoria.',
        'La desviación traqueal es tardía y su ausencia no descarta nada.',
        'Conducta: posición, oxígeno titulado, exploración comparativa y repetida, vigilancia circulatoria, traslado con prealerta y registro horario.',
      ]),
      preguntasOrales([
        'Define neumotórax espontáneo y distingue primario de secundario.',
        '¿Por qué «espontáneo» no significa leve?',
        'Diferéncialo del neumotórax traumático en cuanto al alcance de esta lección.',
        'Enumera la presentación habitual.',
        '¿Qué aporta la exploración, y qué no permite concluir?',
        'Explica qué ocurre en la forma a tensión.',
        'Di los signos que la hacen sospechar y cuál es tardío.',
        '¿Qué dice esta lección sobre la descompresión torácica?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('UN PULMÓN QUE VENTILA Y NO PERFUNDE. Esa es la particularidad que lo explica todo: el paciente puede tener una exploración torácica poco llamativa —a veces casi normal— y estar gravemente comprometido.'),
          masPreguntado('Que la exploración normal NO tranquiliza: una auscultación sin hallazgos no reduce la sospecha ni permite bajar la vigilancia. Y la pregunta que rinde: ante una disnea súbita sin causa evidente, preguntar de forma dirigida por inmovilización, cirugía reciente, cáncer, embarazo o episodios previos.'),
        ],
      },
      erroresFrecuentes([
        ['Bajar la gravedad porque «no se oye nada»', 'En este cuadro una auscultación sin hallazgos no reduce la sospecha ni permite espaciar la vigilancia.'],
        ['No preguntar los factores de riesgo', 'Cambian la sospecha más que cualquier maniobra de exploración, y son información que el paciente rara vez ofrece por su cuenta.'],
        ['Buscar una presentación propia', 'No la tiene: sus manifestaciones son inespecíficas y ninguna combinación permite confirmarla ni excluirla en la calle.'],
        ['Quedarse con un valor aislado de presión', 'Lo que informa es la tendencia durante la atención, junto con el estado de perfusión y la repetición de síncope.'],
      ]),
      repasoRapido([
        'Un trombo formado habitualmente en el sistema venoso profundo de las piernas viaja y se enclava en la arteria pulmonar o sus ramas.',
        'La zona que depende de esa rama sigue ventilándose pero deja de perfundirse.',
        'La repercusión depende de cuánto lecho quede obstruido y de la reserva cardiopulmonar previa.',
        'Con obstrucción extensa el ventrículo derecho bombea contra una resistencia que no puede vencer, se dilata y falla.',
        'Manifestaciones: disnea súbita con frecuencia sin ortopnea, dolor torácico pleurítico, taquipnea y taquicardia.',
        'También síncope o presíncope —dato de alarma—, tos, expectoración hemoptoica y angustia desproporcionada a la exploración.',
        'Y signos en una extremidad inferior: dolor, aumento de volumen o asimetría.',
        'Factores de riesgo: inmovilización o viaje largo, cirugía o traumatismo recientes, trombosis previa.',
        'También cáncer activo, embarazo y puerperio, anticoncepción u hormonoterapia y enfermedad que obligue a cama.',
        'La inestabilidad hemodinámica identifica al grupo de mayor riesgo y de mayor mortalidad precoz.',
        'En la calle no se confirma ni se descarta: se sospecha, se sostiene y se traslada.',
        'La aportación decisiva es transmitir la sospecha junto con los factores de riesgo que la sustentan.',
      ]),
      preguntasOrales([
        'Explica el mecanismo de la tromboembolia pulmonar.',
        '¿Qué significa «un pulmón que ventila y no perfunde»?',
        '¿Por qué se pasa por alto?',
        'Enumera las manifestaciones posibles.',
        'Di los factores de riesgo que elevan la sospecha.',
        '¿Qué identifica al paciente de mayor riesgo?',
        '¿Tranquiliza una exploración normal? Justifícalo.',
        '¿Cuál es la aportación decisiva del prestador?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA PREGUNTA NO ES CUÁL DE LOS DOS, ES CUÁN GRAVE ESTÁ. En la calle no se decide si el paciente tiene neumonía o bronquitis: se decide su gravedad y su destino.'),
          masPreguntado('La confusión de aparición reciente, sobre todo en el adulto mayor: es un signo de gravedad y no un rasgo de la edad. Atribuirla a la edad retrasa la identificación de un paciente grave. Y que cuando al foco se añade disfunción de órganos, la sospecha pasa a ser de sepsis y el traslado se vuelve tiempo-dependiente.'),
        ],
      },
      erroresFrecuentes([
        ['Atribuir la confusión reciente a la edad', 'En un cuadro infeccioso respiratorio, y en especial en el adulto mayor, es un signo de gravedad.'],
        ['Etiquetar de bronquitis a un paciente con afectación general', 'La distinción no se cierra en la calle: los hallazgos orientan, pero la confirmación exige imagen y valoración.'],
        ['Pasar por alto la hipotermia en un cuadro infeccioso', 'Tanto la temperatura muy elevada como la hipotermia son datos de alarma.'],
        ['Olvidar la protección personal', 'Son cuadros potencialmente transmisibles: la protección se aplica conforme al protocolo del servicio.'],
      ]),
      repasoRapido([
        'La bronquitis aguda es inflamación de la mucosa bronquial y domina la tos, con estado general habitualmente conservado.',
        'La neumonía es infección del parénquima: los alveolos se ocupan y esa zona deja de intercambiar gases.',
        'En la bronquitis la auscultación puede ser normal o con roncus difusos.',
        'En la neumonía puede haber crepitantes o disminución localizada del murmullo.',
        'La bronquitis tiene escasa repercusión respiratoria por sí sola; la neumonía puede llegar a insuficiencia respiratoria.',
        'La distinción no se cierra en la calle: lo que se decide es cuán grave está el paciente y adónde va.',
        'Gravedad: alteración del alerta o confusión reciente, trabajo respiratorio aumentado, incapacidad de completar frases.',
        'También hipoperfusión, hipotensión o tendencia descendente, y temperatura muy elevada o hipotermia.',
        'También incapacidad de mantener la ingesta o de mantenerse en pie, y fragilidad previa.',
        'Cuando al foco se añade disfunción de órganos, la sospecha es de sepsis y cambia la prioridad.',
        'Conducta: protección personal, posición, oxígeno titulado, vigilancia de perfusión y alerta, recogida de antecedentes.',
        'El antibiótico no se decide aquí: depende de confirmación, gravedad, alergias, función renal y resistencias locales.',
      ]),
      preguntasOrales([
        'Diferencia conceptualmente neumonía y bronquitis aguda.',
        '¿Qué orienta hacia una y hacia otra?',
        '¿Se cierra esa distinción en la calle? ¿Qué se decide entonces?',
        'Enumera los signos de gravedad.',
        '¿Qué significa la confusión de aparición reciente?',
        '¿Qué convierte el cuadro en sospecha de sepsis, y qué cambia?',
        'Recorre la conducta prehospitalaria.',
        '¿Por qué el antibiótico no se decide en la ambulancia?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EL TÓRAX SILENCIOSO NO ES MEJORÍA. Que las sibilancias disminuyan o desaparezcan en un paciente que empeora indica que apenas se moviliza aire. La gravedad se juzga por el habla, el estado de alerta y el trabajo respiratorio, no por la intensidad de las sibilancias.'),
          masPreguntado('La historia previa: preguntar si alguna vez estuvo intubado o ingresado en cuidados intensivos por asma cambia el nivel de alerta desde el primer minuto, y separa a los pacientes que toleran una crisis de los que no.'),
        ],
      },
      erroresFrecuentes([
        ['Juzgar la gravedad por la intensidad de las sibilancias', 'Es la trampa clásica del cuadro. Un tórax silencioso, con incapacidad para hablar o somnolencia, describe una crisis potencialmente mortal.'],
        ['No preguntar por ingresos previos ni por soporte ventilatorio', 'Es una pregunta breve que el paciente o su familia responden con precisión, y cambia el nivel de alerta desde el primer minuto.'],
        ['Sedar al paciente para calmar su agitación', 'La agitación es un signo de hipoxia y de gravedad; suprimirla puede precipitar el fallo respiratorio.'],
        ['Forzar el decúbito', 'Se permite la posición en que respira mejor: estos pacientes se sientan inclinados hacia adelante y no toleran acostarse.'],
      ]),
      repasoRapido([
        'El asma cursa con inflamación de la vía aérea y limitación del flujo aéreo VARIABLE: empeora y mejora.',
        'Una crisis es el empeoramiento agudo respecto del estado habitual, con frecuencia con desencadenante identificable.',
        'Anuncian una crisis peligrosa el ingreso previo en cuidados intensivos o el soporte ventilatorio previo.',
        'También visitas recientes a urgencias, uso creciente del inhalador de rescate y mal cumplimiento del tratamiento de control.',
        'También las crisis de instauración muy rápida en episodios anteriores y el antecedente de alergia alimentaria.',
        'La gravedad se juzga por el habla, el estado de alerta y el trabajo respiratorio, no por las sibilancias.',
        'Crisis grave: palabras sueltas o incapacidad de hablar, no tolerar el decúbito, agitación y después somnolencia.',
        'También uso intenso de músculos accesorios con tiraje, sibilancias que disminuyen o tórax silencioso.',
        'Y falta de respuesta al inhalador propio, o respuesta escasa y breve.',
        'Potencialmente mortal: tórax silencioso, incapacidad de hablar, alteración del alerta, esfuerzo que disminuye sin mejorar.',
        'Conducta: retirar el desencadenante, posición, oxígeno titulado, broncodilatador si el protocolo lo indica, reevaluación.',
        'No se seda para calmar la agitación, y corticoides, magnesio y ventilación no invasiva dependen del alcance y del protocolo.',
      ]),
      preguntasOrales([
        '¿Qué caracteriza al asma y qué es una crisis?',
        'Enumera los antecedentes que anuncian una crisis peligrosa.',
        '¿Por qué esa historia previa forma parte de la valoración?',
        '¿Cómo se juzga la gravedad, y cómo NO?',
        'Explica qué es el tórax silencioso.',
        'Di los signos de crisis potencialmente mortal.',
        'Recorre las prioridades prehospitalarias.',
        '¿Por qué no se seda a un paciente con una crisis asmática?',
      ]),
