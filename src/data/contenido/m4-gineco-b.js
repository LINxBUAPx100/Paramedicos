    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA ATENCIÓN CLÍNICA NO DEPENDE DE LA CATEGORÍA. Sea cual sea la situación, lo que se valora es lo mismo: si la paciente está sangrando de forma peligrosa, si hay signos de infección y cuál es su estado de perfusión.'),
          masPreguntado('Que un sangrado del primer trimestre obliga a pensar también en un embarazo ectópico: la pérdida gestacional temprana y el ectópico pueden presentarse de forma parecida, y el segundo compromete la vida. El dolor intenso, el dolor referido al hombro, el síncope o una hipoperfusión desproporcionada lo ponen en primer plano.'),
        ],
      },
      erroresFrecuentes([
        ['Condicionar la atención a la categoría del caso', 'Nada de la conducta prehospitalaria cambia según cómo se produjo la interrupción.'],
        ['Intentar comprobar si la expulsión fue completa', 'Exige valoración ginecológica y estudios que no existen en la calle, y el intento no cambia la conducta. Tampoco se introduce nada en el canal vaginal ni se retira tejido.'],
        ['No considerar el ectópico', 'El dolor intenso, el dolor referido al hombro, el síncope o una hipoperfusión desproporcionada al sangrado obligan a ponerlo en primer plano.'],
        ['Compartir más información de la necesaria', 'La confidencialidad es parte de la atención: se limita a lo clínicamente necesario y a quien corresponda.'],
      ]),
      repasoRapido([
        'En lenguaje clínico, aborto designa la interrupción del embarazo antes de que el feto sea viable.',
        'El término agrupa la pérdida gestacional espontánea, la interrupción inducida y la atención posterior a un aborto.',
        'La atención clínica no depende de la categoría.',
        'Dos complicaciones concentran el riesgo vital: el sangrado y la infección.',
        'Se recoge semanas estimadas, última menstruación, desde cuándo sangra y con qué lo compara.',
        'También dolor, fiebre o secreción de mal olor, náusea o mareo, y procedimientos o medicación recientes sin juicio.',
        'Banderas rojas: sangrado abundante o que no cede, hipoperfusión, hipotensión o descenso durante la atención.',
        'También síncope, fiebre con afectación general, dolor intenso con dolor referido al hombro, y alteración del estado mental.',
        'Un sangrado del primer trimestre obliga a pensar también en ectópico.',
        'Se conserva el tejido expulsado si la paciente lo guardó, sin manipularlo ni examinarlo.',
        'No se comprueba si la expulsión fue completa ni se introduce nada en el canal vaginal.',
        'El marco jurídico varía por jurisdicción: la atención clínica de urgencia no se condiciona a la situación jurídica del caso.',
      ]),
      preguntasOrales([
        '¿Qué situaciones agrupa el término aborto?',
        '¿Por qué la atención clínica no depende de la categoría?',
        '¿Qué dos complicaciones concentran el riesgo vital?',
        'Enumera los datos que se recogen.',
        'Di las banderas rojas.',
        '¿Por qué un sangrado del primer trimestre obliga a pensar en ectópico?',
        '¿Qué no se hace en la ambulancia?',
        'Separa el plano clínico del jurídico y di qué queda pendiente.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('EMBARAZO POSIBLE MÁS DOLOR ABDOMINAL, CON O SIN SANGRADO. Esa combinación sencilla es la tríada de sospecha, y vale sobre todo por lo que descarta: el sangrado vaginal escaso no tranquiliza, porque la hemorragia es interna.'),
          masPreguntado('Que la ausencia de factores de riesgo no descarta nada: una proporción importante de los ectópicos ocurre en mujeres sin ningún factor identificable. Los factores elevan la sospecha cuando están; su ausencia no la reduce.'),
        ],
      },
      erroresFrecuentes([
        ['Descartarlo porque la paciente dice que no está embarazada', 'Se presenta con frecuencia en las primeras semanas, antes de que la mujer lo sepa.'],
        ['Tranquilizarse porque el sangrado vaginal es escaso', 'La hemorragia es interna: la sangre pasa a la cavidad abdominal y no se ve desde fuera.'],
        ['Usar los factores de riesgo para descartar', 'Una proporción importante ocurre sin ninguno. Usarlos para descartar es exactamente el razonamiento equivocado.'],
        ['Pasar por alto el dolor en el hombro', 'Es el dato que más se pasa por alto: en una paciente joven con dolor abdominal, un dolor de hombro sin lesión describe irritación del diafragma por sangre libre.'],
      ]),
      repasoRapido([
        'Un embarazo ectópico se implanta fuera de la cavidad del útero, con más frecuencia en una trompa.',
        'El problema es que ese lugar no puede acomodar el crecimiento: la estructura se distiende y puede romperse.',
        'La rotura produce una hemorragia interna que no se ve desde fuera y que puede ser masiva.',
        'Ocurre en las primeras semanas, cuando muchas mujeres todavía no saben que están embarazadas.',
        'Tríada de sospecha: embarazo posible más dolor abdominal o pélvico, con o sin sangrado.',
        'El dolor es bajo o pélvico, con frecuencia de un solo lado, y puede ser intenso y de inicio brusco.',
        'El sangrado vaginal suele ser escaso o intermitente y a veces falta por completo.',
        'El dolor referido al hombro aparece cuando la sangre irrita el diafragma: es un dato de alarma.',
        'También mareo, presíncope o síncope, e hipoperfusión desproporcionada al sangrado visible.',
        'Factores de riesgo: ectópico previo, cirugía tubárica o pélvica, infección pélvica, dispositivo intrauterino, reproducción asistida y tabaquismo.',
        'La ausencia de factores de riesgo no descarta nada.',
        'En la calle no se confirma ni se excluye: se reconoce la sospecha, se sostiene la perfusión y se traslada.',
      ]),
      preguntasOrales([
        'Explica qué es un embarazo ectópico y por qué compromete la vida.',
        '¿Por qué la hemorragia es interna y qué implica?',
        'Di la tríada de sospecha.',
        'Enumera las manifestaciones.',
        '¿Qué significa el dolor referido al hombro?',
        'Nombra los factores que aumentan el riesgo.',
        '¿Descarta algo su ausencia? Justifícalo.',
        'Di los dos errores que cuestan tiempo.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('LA MEJORÍA NO TRANQUILIZA. El ovario puede girar y desgirar de forma parcial: una paciente que llega ya sin dolor, o cuyo dolor mejoró durante el traslado, puede tener una torsión intermitente.'),
          masPreguntado('Que es una urgencia quirúrgica dependiente del tiempo, porque la consecuencia de una torsión mantenida es la pérdida del ovario; y que no hay que esperar a palpar una masa: la exploración externa rara vez la detecta y buscarla retrasa el traslado.'),
        ],
      },
      erroresFrecuentes([
        ['Descartarla porque el dolor mejoró', 'La forma intermitente es la trampa del cuadro: gira y desgira de forma parcial, con episodios que ceden espontáneamente.'],
        ['Esperar a palpar una masa', 'La exploración externa rara vez la detecta, sobre todo si la paciente contrae la pared. Buscarla retrasa el traslado y no aporta.'],
        ['No preguntar por embarazo posible', 'Si lo hay, el embarazo ectópico pasa al primer plano por su riesgo vital.'],
        ['No transmitir la mejoría del dolor', 'Ese dato, que parece tranquilizador, es precisamente el que el equipo receptor necesita para no subestimar el cuadro.'],
      ]),
      repasoRapido([
        'El ovario está suspendido por estructuras que contienen los vasos que lo irrigan.',
        'Al girar sobre ese eje, los vasos quedan comprimidos: primero se dificulta el retorno y el ovario se congestiona.',
        'Es una urgencia quirúrgica dependiente del tiempo: la torsión mantenida hace perder el ovario.',
        'Ocurre con más frecuencia cuando hay una masa o un quiste, y también en la infancia y la adolescencia.',
        'Puede ocurrir durante el embarazo: la gestación no lo descarta.',
        'Presentación: dolor pélvico de un solo lado, de inicio brusco y con frecuencia intenso.',
        'Náusea y vómito acompañantes, que pueden ser llamativos, e irradiación a ingle, flanco o espalda.',
        'A veces episodios previos similares que cedieron solos, y habitualmente sin fiebre ni síntomas urinarios al principio.',
        'La forma intermitente es la trampa del cuadro.',
        'No se espera a palpar una masa.',
        'Preguntas discriminantes: embarazo posible, dolor en hombro o síncope, irradiación desde el flanco, fiebre, episodios previos.',
        'Se traslada a centro con capacidad quirúrgica y ginecológica, sin retrasar por la mejoría del dolor.',
      ]),
      preguntasOrales([
        'Explica el mecanismo de la torsión y su consecuencia.',
        '¿Por qué es una urgencia dependiente del tiempo?',
        'Describe la presentación característica.',
        '¿Cuál es la trampa del cuadro?',
        '¿Por qué no se espera a palpar una masa?',
        'Recita las preguntas discriminantes y qué orienta cada una.',
        'Recorre la conducta.',
        '¿Qué transmites, y por qué la mejoría es el dato clave?',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('TONO, TRAUMA, TEJIDO Y TROMBINA. Cuatro categorías para no olvidar ninguna causa, y el tono va primero porque es la más frecuente y la única sobre la que el ámbito prehospitalario puede actuar dentro de ciertos alcances.'),
          masPreguntado('Que no se espera un volumen para actuar: los criterios por cantidad de sangre son útiles en el hospital, donde puede medirse, y en la calle esperar a alcanzar un volumen visual determinado es exactamente lo que hay que evitar.'),
        ],
      },
      erroresFrecuentes([
        ['Esperar un volumen visual para actuar', 'En la calle no puede medirse. Se actúa por el sangrado que continúa, el útero blando y el cambio en el estado de la paciente.'],
        ['Esperar el descenso de la presión', 'Aparece tarde: cuando la presión desciende, la pérdida ya es muy importante.'],
        ['No palpar el útero tras el nacimiento', 'Comprobar si está firme o blando es la primera exploración después del nacimiento, y se repite.'],
        ['Descuidar la hipotermia y el registro', 'Una paciente que sangra y se enfría coagula peor. Y sin horas anotadas no se puede demostrar la evolución.'],
      ]),
      repasoRapido([
        'Es la principal causa de muerte materna evitable en el mundo.',
        'Su característica más peligrosa es que puede parecer manejable hasta que deja de serlo.',
        'No se espera un volumen visual determinado para actuar.',
        'Sospechan sangrado que continúa y no disminuye, sangre que empapa con rapidez y útero blando.',
        'También taquicardia mantenida o ascendente, palidez, sudoración fría, mareo, y ansiedad o inquietud nuevas.',
        'El descenso de la presión aparece tarde y no debe esperarse.',
        'Tono: el útero no se contrae; útero blando. Es la causa más frecuente.',
        'Trauma: desgarros del canal del parto; sangrado activo con útero firme.',
        'Tejido: retención de restos de placenta; placenta que no sale o sangrado persistente tras el alumbramiento.',
        'Trombina: alteración de la coagulación; sangrado que no se detiene y sangrado por otros puntos.',
        'El tono va primero por frecuencia y porque es donde el prestador puede actuar.',
        'Secuencia: reconocer, pedir ayuda, palpar el útero, masaje si está autorizado, prevenir hipotermia, trasladar y reevaluar.',
      ]),
      preguntasOrales([
        '¿Por qué no se espera un volumen para actuar?',
        'Enumera lo que hace sospechar una hemorragia posparto.',
        '¿Por qué la presión aparece tarde?',
        'Recita el marco de las cuatro causas y qué se observa en cada una.',
        '¿Por qué el tono va primero?',
        'Recorre la secuencia completa.',
        '¿Qué depende del protocolo y no de esta lección?',
        'Di las dos medidas que a veces se descuidan y no son menores.',
      ]),
    ...
    secciones: [
      ...
      },
      {
        ...
        bloques: [
          ...
          mnemotecnia('DECÚBITO LATERAL IZQUIERDO. Es la posición que protege la vía aérea y evita a la vez la compresión aortocava, y se mantiene durante todo el traslado. Sostener a la madre es sostener al feto.'),
          masPreguntado('Que también ocurre en el puerperio: la preeclampsia puede aparecer o agravarse en los días siguientes al parto, así que una paciente que dio a luz recientemente y consulta por cefalea o alteración visual entra en este cuadro. Y que el dolor en el hipocondrio derecho engaña.'),
        ],
      },
      erroresFrecuentes([
        ['Creer que el riesgo termina con el nacimiento', 'La preeclampsia puede aparecer o agravarse en los días siguientes al parto.'],
        ['Atender un dolor en la parte alta del abdomen como un problema digestivo', 'En una gestante de más de veinte semanas, ese dolor obliga a considerar la preeclampsia con datos de gravedad.'],
        ['Perseguir un descenso de la presión', 'Un descenso brusco puede reducir el flujo a la placenta. La conducta prehospitalaria no consiste en perseguir una cifra.'],
        ['Dejar de vigilar tras la primera convulsión', 'Las nuevas convulsiones son frecuentes, y el desprendimiento de placenta puede acompañar al cuadro.'],
      ]),
      repasoRapido([
        'La preeclampsia aparece habitualmente después de la vigésima semana y combina presión elevada con signos de sufrimiento de otros órganos.',
        'También ocurre en el puerperio: puede aparecer o agravarse en los días siguientes al parto.',
        'Cuando se añade una convulsión, se llama eclampsia, y puede ocurrir antes, durante o después del parto.',
        'Cefalea intensa o persistente que no cede: afectación del sistema nervioso.',
        'Alteración visual —borrosa, luces, doble, pérdida—: sistema nervioso y retina.',
        'Dolor en epigastrio o hipocondrio derecho: afectación hepática, y se confunde con un problema digestivo.',
        'Dificultad respiratoria: congestión pulmonar. Alteración del estado mental: afectación neurológica avanzada.',
        'Reducción marcada de la diuresis: afectación renal. Edema brusco de cara y manos acompaña, pero no define.',
        'Durante la convulsión: mirar la hora, proteger la cabeza, no sujetar, no introducir nada, reducir estímulos.',
        'Al cesar: decúbito lateral izquierdo, que protege la vía aérea y evita la compresión aortocava.',
        'Después: registrar la convulsión, comprobar glucemia, vigilar nuevas convulsiones y vigilar el sangrado.',
        'La conducta no persigue un descenso de la presión: un descenso brusco puede reducir el flujo a la placenta.',
      ]),
      preguntasOrales([
        'Define preeclampsia y sitúala en el tiempo del embarazo.',
        '¿Por qué también ocurre en el puerperio?',
        '¿Qué la convierte en eclampsia?',
        'Enumera los síntomas de gravedad y qué órgano señala cada uno.',
        '¿Por qué engaña el dolor en el hipocondrio derecho?',
        'Recorre la actuación durante la convulsión.',
        '¿Por qué el decúbito lateral izquierdo?',
        '¿Qué se vigila después, y qué no se persigue?',
      ]),
