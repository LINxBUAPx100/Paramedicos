      ...
      categorias: [
        {
          ...
          subtemas: [
            { n: 33, t: 'NOM-034-SSA3-2013: regulación de la atención médica prehospitalaria', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 34, t: 'Ley General de Salud: artículos sobre urgencias y traslados', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 35, t: 'Tipificación de ambulancias (NOM-034)', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 36, t: 'Perfil del TUM/Paramédico oficial', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 37, t: 'Aspectos médico-legales: negligencia, impericia, imprudencia', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 38, t: 'Llenado y valor legal del FRAP (Formato de Registro de Atención Prehospitalaria)', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 39, t: 'Manejo de casos médico-legales e indicios', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 40, t: 'NOM-087-ECOL-SSA1-2002: manejo de RPBI en ambulancias', temaId: 'legislacion-marco-normativo-mexico' },
            { n: 41, t: 'Coordinación médica: enlace con CRUM y despacho 911', temaId: 'legislacion-marco-normativo-mexico' },
          ],
        },
        {
          ...
          subtemas: [
            ...
            { n: 45, t: 'Medicina Táctica Civil (TECC): fases de atención bajo amenaza', temaId: 'operaciones-especiales-tactica-bienestar' },
            { n: 46, t: 'Incidentes HazMat (materiales peligrosos): zonas de control', temaId: 'operaciones-especiales-tactica-bienestar' },
            { n: 47, t: 'Traslado de pacientes infectocontagiosos', temaId: 'operaciones-especiales-tactica-bienestar' },
            { n: 48, t: 'Aeromedicina de evacuación', temaId: 'operaciones-especiales-tactica-bienestar' },
            { n: 49, t: 'Psicología de emergencias y salud mental del paramédico (defusing/debriefing)', temaId: 'operaciones-especiales-tactica-bienestar' },
          ],
        },
      ],
    },
      ...
      categorias: [
        {
          ...
          subtemas: [
            ...
            { n: 81, t: 'Envenenamiento por fauna de México (ofidios, arácnidos)', temaId: 'fauna-venenosa-mexico' },
          ],
        },
        {
