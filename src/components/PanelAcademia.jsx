...
export default function PanelAcademia({ academiaId, academiaNombre = '', gestion = null, miUid = null, soloGrupo = null }) {
  ...
  return (
    <>
      ...
      {/* Solicitudes de gente de FUERA (Bloque K). Solo las gestiona el
          director/super: aceptar a alguien es meterlo en la academia. */}
      {gestion && (
        <SolicitudesDeAcceso
          academiaId={academiaId}
...
// ============================================================
export function SolicitudesDeAcceso({ academiaId, academiaNombre = '', miUid }) {
  ...
  const correr = async (fn, exito) => {
    ...
    try {
      ...
      setError(errorCodigos(err, 'gestionar las solicitudes'))
    } finally {
      setOcupado(false)
    }
  }
